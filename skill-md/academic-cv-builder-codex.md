...
display_name: academic-cv-builder
platform: Codex
category: General and specialized workflows
---

# academic-cv-builder - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `academic-cv-builder` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose academic-cv-builder, then write the task. Fallback prompt: Use the academic-cv-builder skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `academic-cv-builder` |
| Canonical name | `academic-cv-builder` |
| Platform | `Codex` |
| Category | General and specialized workflows |
