---
name: acquiring-di[redacted-token]
display_name: acquiring-di[redacted-token]
platform: Codex
category: Security, forensics, and incident response
---

# acquiring-di[redacted-token] - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `acquiring-di[redacted-token]` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose acquiring-di[redacted-token], then write the task. Fallback prompt: Use the acquiring-di[redacted-token] skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `acquiring-di[redacted-token]` |
| Canonical name | `acquiring-di[redacted-token]` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
