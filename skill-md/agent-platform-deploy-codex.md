...
display_name: agent-platform-deploy
platform: Codex
category: General and specialized workflows
---

# agent-platform-deploy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `agent-platform-deploy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Deploy open models or custom weights from Model Garden to Agent Platform endpoints, check the status of an in-progress deployment operation, or clean up resources by undeploying models and deleting endpoints. Use when as

## How To Use It In Codex

In Codex, click the chat box, press /, choose agent-platform-deploy, then write the task. Fallback prompt: Use the agent-platform-deploy skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `agent-platform-deploy` |
| Canonical name | `agent-platform-deploy` |
| Platform | `Codex` |
| Category | General and specialized workflows |
