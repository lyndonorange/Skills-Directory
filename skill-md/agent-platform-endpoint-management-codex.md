...
# agent-platform-endpoint-management - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `agent-platform-endpoint-management` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose agent-platform-endpoint-management, then write the task. Fallback prompt: Use the agent-platform-endpoint-management skill to...
