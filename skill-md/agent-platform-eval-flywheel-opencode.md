...
# agent-platform-eval-flywheel - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `agent-platform-eval-flywheel` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the agent-platform-eval-flywheel skill to...
