...
# agent-platform-inference - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `agent-platform-inference` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Connects to and performs inference with Google Cloud Agent Platform GenAI models, including First-Party Gemini models and Third-Party OpenMaaS models (Llama, DeepSeek, Qwen, etc.). Use when you need to generate code for

## How To Use It In Codex

In Codex, click the chat box, press /, choose agent-platform-inference, then write the task. Fallback prompt: Use the agent-platform-inference skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `agent-platform-inference` |
| Canonical name | `agent-platform-inference` |
| Platform | `Codex` |
| Category | General and specialized workflows |
