...
display_name: agent-platform-migrate-from-ai-studio
platform: Codex
category: General and specialized workflows
---

# agent-platform-migrate-from-ai-studio - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `agent-platform-migrate-from-ai-studio` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Guides agents and users through migrating from Gemini API in Google AI Studio to Gemini Enterprise Agent Platform (formerly Vertex AI). Use this skill when moving applications to Google Cloud, to leverage Cloud credits,

## How To Use It In Codex

In Codex, click the chat box, press /, choose agent-platform-migrate-from-ai-studio, then write the task. Fallback prompt: Use the agent-platform-migrate-from-ai-studio skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `agent-platform-migrate-from-ai-studio` |
| Canonical name | `agent-platform-migrate-from-ai-studio` |
| Platform | `Codex` |
| Category | General and specialized workflows |
