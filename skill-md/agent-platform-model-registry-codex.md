...
display_name: agent-platform-model-registry
platform: Codex
category: General and specialized workflows
---

# agent-platform-model-registry - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `agent-platform-model-registry` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Agent Platform Model Registry Management. Use when you need to upload, list, describe, update, or delete machine learning models (and their versions) in the Agent Platform Model Registry. Don't use for model training, mo

## How To Use It In Codex

In Codex, click the chat box, press /, choose agent-platform-model-registry, then write the task. Fallback prompt: Use the agent-platform-model-registry skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `agent-platform-model-registry` |
| Canonical name | `agent-platform-model-registry` |
| Platform | `Codex` |
| Category | General and specialized workflows |
