...
display_name: agent-platform-prompt-management
platform: Codex
category: General and specialized workflows
---

# agent-platform-prompt-management - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `agent-platform-prompt-management` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Manages and orchestrates prompts in Agent Platform. Use when you need to create, list, retrieve, version, or delete managed prompts in Agent Platform. Don't use for model training, model deployment to endpoints, or manag

## How To Use It In Codex

In Codex, click the chat box, press /, choose agent-platform-prompt-management, then write the task. Fallback prompt: Use the agent-platform-prompt-management skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `agent-platform-prompt-management` |
| Canonical name | `agent-platform-prompt-management` |
| Platform | `Codex` |
| Category | General and specialized workflows |
