...
display_name: agent-platform-rag-engine-management
platform: Codex
category: General and specialized workflows
---

# agent-platform-rag-engine-management - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `agent-platform-rag-engine-management` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Manage and query Agent Platform RAG Engine Corpora and retrieve grounded contexts using the Google GenAI SDK. Use when listing RAG corpora or files, inspecting a corpus, retrieving contexts, or generating content grounde

## How To Use It In Codex

In Codex, click the chat box, press /, choose agent-platform-rag-engine-management, then write the task. Fallback prompt: Use the agent-platform-rag-engine-management skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `agent-platform-rag-engine-management` |
| Canonical name | `agent-platform-rag-engine-management` |
| Platform | `Codex` |
| Category | General and specialized workflows |
