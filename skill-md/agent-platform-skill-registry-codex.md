...
# agent-platform-skill-registry - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `agent-platform-skill-registry` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose agent-platform-skill-registry, then write the task. Fallback prompt: Use the agent-platform-skill-registry skill to...
