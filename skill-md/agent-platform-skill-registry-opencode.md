...
# agent-platform-skill-registry - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `agent-platform-skill-registry` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the agent-platform-skill-registry skill to...
