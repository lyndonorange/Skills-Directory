...
display_name: agent-platform-troubleshooting
platform: Codex
category: General and specialized workflows
---

# agent-platform-troubleshooting - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `agent-platform-troubleshooting` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Troubleshoots Google Cloud Gemini Enterprise Agent Platform issues (Agent Gateway, Registry, Identity, Policies, Model Armor, Identity-Aware Proxy (IAP)). Use when agent requests fail with 403 (especially unauthorized eg

## How To Use It In Codex

In Codex, click the chat box, press /, choose agent-platform-troubleshooting, then write the task. Fallback prompt: Use the agent-platform-troubleshooting skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `agent-platform-troubleshooting` |
| Canonical name | `agent-platform-troubleshooting` |
| Platform | `Codex` |
| Category | General and specialized workflows |
