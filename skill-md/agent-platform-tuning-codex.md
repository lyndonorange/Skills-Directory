...
display_name: agent-platform-tuning
platform: Codex
category: General and specialized workflows
---

# agent-platform-tuning - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `agent-platform-tuning` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Agent Platform Model Tuning. Use when you need to fine-tune open models or Gemini models using Agent Platform infrastructure. Don't use for model training outside Agent Platform, model deployment to endpoints (use `agent

## How To Use It In Codex

In Codex, click the chat box, press /, choose agent-platform-tuning, then write the task. Fallback prompt: Use the agent-platform-tuning skill to...
...
| Canonical name | `agent-platform-tuning` |
| Platform | `Codex` |
| Category | General and specialized workflows |
