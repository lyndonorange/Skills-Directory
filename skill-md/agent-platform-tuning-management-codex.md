...
display_name: agent-platform-tuning-management
platform: Codex
category: General and specialized workflows
---

# agent-platform-tuning-management - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `agent-platform-tuning-management` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Manages GenAI tuning jobs in Agent Platform. Use this to list, get, or cancel ongoing model tuning jobs. Don't use for fine-tuning models (use `agent-platform-tuning`), deploying models to endpoints (use `agent-platform-

## How To Use It In Codex

In Codex, click the chat box, press /, choose agent-platform-tuning-management, then write the task. Fallback prompt: Use the agent-platform-tuning-management skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `agent-platform-tuning-management` |
| Canonical name | `agent-platform-tuning-management` |
| Platform | `Codex` |
| Category | General and specialized workflows |
