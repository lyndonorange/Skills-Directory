...
# Agents - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `Agents` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Compose CUSTOM agents from Base Traits + Voice + Specialization, and manage predefined functional TEAMS. Traits combine expertise (security, technical, research), personality (skeptical, analytical, enthusiastic), and ap

## How To Use It In Codex

In Codex, click the chat box, press /, choose Agents, then write the task. Fallback prompt: Use the Agents skill to...
