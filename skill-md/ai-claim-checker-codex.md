...
# ai-claim-checker - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ai-claim-checker` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose ai-claim-checker, then write the task. Fallback prompt: Use the ai-claim-checker skill to...
