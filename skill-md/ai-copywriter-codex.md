---
name: ai-copywriter
display_name: ai-copywriter
platform: Codex
category: General and specialized workflows
---

# ai-copywriter - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ai-copywriter` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Write copy that converts and doesn't sound like a robot. Two jobs in one skill: a reader-first copywriter for titles, headlines, short descriptions, microcopy, CTAs, error messages, subject lines, LinkedIn posts and job-

## How To Use It In Codex

In Codex, click the chat box, press /, choose ai-copywriter, then write the task. Fallback prompt: Use the ai-copywriter skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `ai-copywriter` |
| Canonical name | `ai-copywriter` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
---
name: ai-copywriter
description: "Write copy that converts and doesn't sound like a robot. Two jobs in one skill: a reader-first copywriter for titles, headlines, short descriptions, microcopy, CTAs, error messages, subject lines, LinkedIn posts and job-search content plans, and category-defining strategic blog posts; and a humanizer built on Wikipedia's comprehensive Signs of AI writing guide. Use when writing or improving marketing copy, UI text, titles, LinkedIn posts, a job seeker's LinkedIn posting strategy or post series, strategic blog posts, or text that should sound natural and human-written."
license: MIT
metadata:
  version: "1.7.0"
---
...
#### Job-search LinkedIn strategy

When a job seeker wants a posting strategy, a series of posts, employer visibility, recruiter interest, or interview opportunities, read `references/linkedin-job-search-playbook.md` and use its portfolio workflow. Do not jump straight to a post draft.

1. Ask first: **"How many LinkedIn posts do you want to create?"** Do not choose the count for the user. In the same compact intake, collect the target roles, desired employers or industry, time horizon, sustainable cadence, verified stories or work samples, preferred voice, privacy limits, and desired outcome.
2. Check profile readiness. Recommend `$linkedin-profile-optimizer` when the headline, About section, experience, skills, or Featured work do not support the same target role. Do not block drafting if the user wants to proceed.
3. Treat the profile and posts as a professional portfolio. Define three to five evidence-backed content pillars that show the judgment, skills, outcomes, and working style a hiring team needs to see.
4. Build a calendar with exactly the requested number of posts. For each post, include the employer signal, verified source material, format, hook direction, takeaway, optional visual, conversation prompt, and status.
5. Coach one post at a time: confirm the evidence and angle, offer 3 to 5 accurate hooks, agree on an outline, draft, humanize, review the visual and closing question, then return a publish-ready draft for the user's approval. Ask whether to revise, save, or continue to the next post.
6. Suggest authentic participation around the post only when sustainable: useful comments on relevant discussions, thoughtful replies, and optional user-written outreach. Never automate comments, direct messages, connection requests, or publishing.
7. Review LinkedIn's available post and audience analytics after a useful sample, usually three to five posts. Prioritize relevant profile views, follower demographics, saves, sends, substantive comments, recruiter conversations, and interview invitations over raw impressions. Treat the numbers as directional because LinkedIn labels several metrics as estimates.

Never promise reach, virality, recruiter contact, or an interview. Treat posting frequency, visuals, timing, calls to action, and reuse as testable choices. Quality and relevance outrank a fixed daily schedule, and a visual must add proof or understanding rather than decoration.
