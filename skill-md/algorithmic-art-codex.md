...
# algorithmic-art - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `algorithmic-art` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose algorithmic-art, then write the task. Fallback prompt: Use the algorithmic-art skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `algorithmic-art` |
| Canonical name | `algorithmic-art` |
| Platform | `Codex` |
| Category | General and specialized workflows |
