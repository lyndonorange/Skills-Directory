---
name: pm-skills-analyze-feature-requests
display_name: analyze-feature-requests
platform: Codex
category: Product delivery, planning, and execution
---

# analyze-feature-requests - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyze-feature-requests` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyze-feature-requests, then write the task. Fallback prompt: Use the analyze-feature-requests skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyze-feature-requests` |
| Canonical name | `pm-skills-analyze-feature-requests` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
