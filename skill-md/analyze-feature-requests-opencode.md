...
# analyze-feature-requests - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyze-feature-requests` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the analyze-feature-requests skill to...
