...
display_name: analyzing-active-directory-acl-abuse
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-active-directory-acl-abuse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-active-directory-acl-abuse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Active Directory Access Control Lists (ACLs) define permissions on AD objects through Discretionary Access Control Lists (DACLs) containing Access Control Entries (ACEs). Misconfigured ACEs can grant non-privileged users

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-active-directory-acl-abuse, then write the task. Fallback prompt: Use the analyzing-active-directory-acl-abuse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-active-directory-acl-abuse` |
| Canonical name | `analyzing-active-directory-acl-abuse` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
