...
display_name: analyzing-api-gateway-access-logs
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-api-gateway-access-logs - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-api-gateway-access-logs` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-api-gateway-access-logs, then write the task. Fallback prompt: Use the analyzing-api-gateway-access-logs skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-api-gateway-access-logs` |
| Canonical name | `analyzing-api-gateway-access-logs` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
