...
display_name: analyzing-apt-group-with-mitre-navigator
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-apt-group-with-mitre-navigator - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-apt-group-with-mitre-navigator` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

MITRE ATT&CK Navigator is a web-based tool for annotating and exploring ATT&CK matrices, enabling analysts to visualize threat actor technique coverage, compare multiple APT groups, identify detection gaps, and build thr

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-apt-group-with-mitre-navigator, then write the task. Fallback prompt: Use the analyzing-apt-group-with-mitre-navigator skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-apt-group-with-mitre-navigator` |
| Canonical name | `analyzing-apt-group-with-mitre-navigator` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
