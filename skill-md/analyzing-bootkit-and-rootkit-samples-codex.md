...
display_name: analyzing-bootkit-and-rootkit-samples
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-bootkit-and-rootkit-samples - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-bootkit-and-rootkit-samples` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-bootkit-and-rootkit-samples, then write the task. Fallback prompt: Use the analyzing-bootkit-and-rootkit-samples skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-bootkit-and-rootkit-samples` |
| Canonical name | `analyzing-bootkit-and-rootkit-samples` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
