...
display_name: analyzing-browser-forensics-with-hindsight
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-browser-forensics-with-hindsight - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-browser-forensics-with-hindsight` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Hindsight is an open-source browser forensics tool designed to parse artifacts from Google Chrome and other Chromium-based browsers (Microsoft Edge, Brave, Opera, Vivaldi). It extracts and correlates data from multiple b

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-browser-forensics-with-hindsight, then write the task. Fallback prompt: Use the analyzing-browser-forensics-with-hindsight skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-browser-forensics-with-hindsight` |
| Canonical name | `analyzing-browser-forensics-with-hindsight` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
