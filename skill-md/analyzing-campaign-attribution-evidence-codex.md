...
display_name: analyzing-campaign-attribution-evidence
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-campaign-attribution-evidence - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-campaign-attribution-evidence` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Campaign attribution analysis involves systematically evaluating evidence to determine which threat actor or group is responsible for a cyber operation. This skill covers collecting and weighting attribution indicators u

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-campaign-attribution-evidence, then write the task. Fallback prompt: Use the analyzing-campaign-attribution-evidence skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-campaign-attribution-evidence` |
| Canonical name | `analyzing-campaign-attribution-evidence` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
