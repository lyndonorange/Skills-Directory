...
display_name: analyzing-certificate-transparency-for-phishing
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-certificate-transparency-for-phishing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-certificate-transparency-for-phishing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Certificate Transparency (CT) is an Internet security standard that creates a public, append-only log of all issued SSL/TLS certificates. Monitoring CT logs enables early detection of phishing domains that register certi

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-certificate-transparency-for-phishing, then write the task. Fallback prompt: Use the analyzing-certificate-transparency-for-phishing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-certificate-transparency-for-phishing` |
| Canonical name | `analyzing-certificate-transparency-for-phishing` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
