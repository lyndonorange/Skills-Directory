...
display_name: analyzing-cobaltstrike-malleable-c2-profiles
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-cobaltstrike-malleable-c2-profiles - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-cobaltstrike-malleable-c2-profiles` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Cobalt Strike Malleable C2 profiles are domain-specific language scripts that customize how Beacon communicates with the team server, defining HTTP request/response transformations, sleep intervals, jitter values, user a

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-cobaltstrike-malleable-c2-profiles, then write the task. Fallback prompt: Use the analyzing-cobaltstrike-malleable-c2-profiles skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-cobaltstrike-malleable-c2-profiles` |
| Canonical name | `analyzing-cobaltstrike-malleable-c2-profiles` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
