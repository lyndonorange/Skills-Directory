...
display_name: analyzing-command-and-control-communication
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-command-and-control-communication - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-command-and-control-communication` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-command-and-control-communication, then write the task. Fallback prompt: Use the analyzing-command-and-control-communication skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-command-and-control-communication` |
| Canonical name | `analyzing-command-and-control-communication` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
