...
display_name: analyzing-cyber-kill-chain
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-cyber-kill-chain - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-cyber-kill-chain` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-cyber-kill-chain, then write the task. Fallback prompt: Use the analyzing-cyber-kill-chain skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-cyber-kill-chain` |
| Canonical name | `analyzing-cyber-kill-chain` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
