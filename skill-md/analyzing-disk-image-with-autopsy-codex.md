...
display_name: analyzing-disk-image-with-autopsy
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-disk-image-with-autopsy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-disk-image-with-autopsy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-disk-image-with-autopsy, then write the task. Fallback prompt: Use the analyzing-disk-image-with-autopsy skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-disk-image-with-autopsy` |
| Canonical name | `analyzing-disk-image-with-autopsy` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
