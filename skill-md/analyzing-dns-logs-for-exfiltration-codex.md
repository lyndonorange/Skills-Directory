...
# analyzing-dns-logs-for-exfiltration - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-dns-logs-for-exfiltration` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-dns-logs-for-exfiltration, then write the task. Fallback prompt: Use the analyzing-dns-logs-for-exfiltration skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-dns-logs-for-exfiltration` |
| Canonical name | `analyzing-dns-logs-for-exfiltration` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
