...
display_name: analyzing-docker-container-forensics
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-docker-container-forensics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-docker-container-forensics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-docker-container-forensics, then write the task. Fallback prompt: Use the analyzing-docker-container-forensics skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-docker-container-forensics` |
| Canonical name | `analyzing-docker-container-forensics` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
