...
display_name: analyzing-email-headers-for-phishing-investigation
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-email-headers-for-phishing-investigation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-email-headers-for-phishing-investigation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-email-headers-for-phishing-investigation, then write the task. Fallback prompt: Use the analyzing-email-headers-for-phishing-investigation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-email-headers-for-phishing-investigation` |
| Canonical name | `analyzing-email-headers-for-phishing-investigation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
