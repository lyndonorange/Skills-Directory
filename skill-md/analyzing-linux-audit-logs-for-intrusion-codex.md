...
display_name: analyzing-linux-audit-logs-for-intrusion
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-linux-audit-logs-for-intrusion - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-linux-audit-logs-for-intrusion` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-linux-audit-logs-for-intrusion, then write the task. Fallback prompt: Use the analyzing-linux-audit-logs-for-intrusion skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-linux-audit-logs-for-intrusion` |
| Canonical name | `analyzing-linux-audit-logs-for-intrusion` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
