...
display_name: analyzing-linux-kernel-rootkits
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-linux-kernel-rootkits - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-linux-kernel-rootkits` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Linux kernel rootkits operate at ring 0, modifying kernel data structures to hide processes, files, network connections, and kernel modules from userspace tools. Detection requires either memory forensics (analyzing phys

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-linux-kernel-rootkits, then write the task. Fallback prompt: Use the analyzing-linux-kernel-rootkits skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-linux-kernel-rootkits` |
| Canonical name | `analyzing-linux-kernel-rootkits` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
