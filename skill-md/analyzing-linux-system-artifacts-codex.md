...
display_name: analyzing-linux-system-artifacts
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-linux-system-artifacts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-linux-system-artifacts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-linux-system-artifacts, then write the task. Fallback prompt: Use the analyzing-linux-system-artifacts skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-linux-system-artifacts` |
| Canonical name | `analyzing-linux-system-artifacts` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
