...
display_name: analyzing-lnk-file-and-jump-list-artifacts
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-lnk-file-and-jump-list-artifacts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-lnk-file-and-jump-list-artifacts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Windows LNK (shortcut) files and Jump Lists are critical forensic artifacts that provide evidence of file access, program execution, and user behavior. LNK files are created automatically when a user opens a file through

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-lnk-file-and-jump-list-artifacts, then write the task. Fallback prompt: Use the analyzing-lnk-file-and-jump-list-artifacts skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-lnk-file-and-jump-list-artifacts` |
| Canonical name | `analyzing-lnk-file-and-jump-list-artifacts` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
