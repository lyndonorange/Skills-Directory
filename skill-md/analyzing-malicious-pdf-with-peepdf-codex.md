...
display_name: analyzing-malicious-pdf-with-peepdf
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-malicious-pdf-with-peepdf - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-malicious-pdf-with-peepdf` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-malicious-pdf-with-peepdf, then write the task. Fallback prompt: Use the analyzing-malicious-pdf-with-peepdf skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-malicious-pdf-with-peepdf` |
| Canonical name | `analyzing-malicious-pdf-with-peepdf` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
