...
display_name: analyzing-memory-forensics-with-lime-and-volatility
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-memory-forensics-with-lime-and-volatility - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-memory-forensics-with-lime-and-volatility` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-memory-forensics-with-lime-and-volatility, then write the task. Fallback prompt: Use the analyzing-memory-forensics-with-lime-and-volatility skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-memory-forensics-with-lime-and-volatility` |
| Canonical name | `analyzing-memory-forensics-with-lime-and-volatility` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
