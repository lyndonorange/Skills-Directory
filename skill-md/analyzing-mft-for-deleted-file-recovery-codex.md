...
# analyzing-mft-for-deleted-file-recovery - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-mft-for-deleted-file-recovery` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

The NTFS Master File Table ($MFT) is the central metadata repository for every file and directory on an NTFS volume. Each file is represented by at least one 1024-byte MFT record containing attributes such as $STANDARD_I

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-mft-for-deleted-file-recovery, then write the task. Fallback prompt: Use the analyzing-mft-for-deleted-file-recovery skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-mft-for-deleted-file-recovery` |
| Canonical name | `analyzing-mft-for-deleted-file-recovery` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
