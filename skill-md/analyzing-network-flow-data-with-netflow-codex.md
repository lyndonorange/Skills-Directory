...
display_name: analyzing-network-flow-data-with-netflow
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-network-flow-data-with-netflow - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-network-flow-data-with-netflow` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-network-flow-data-with-netflow, then write the task. Fallback prompt: Use the analyzing-network-flow-data-with-netflow skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-network-flow-data-with-netflow` |
| Canonical name | `analyzing-network-flow-data-with-netflow` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
