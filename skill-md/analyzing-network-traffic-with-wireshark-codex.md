...
display_name: analyzing-network-traffic-with-wireshark
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-network-traffic-with-wireshark - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-network-traffic-with-wireshark` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-network-traffic-with-wireshark, then write the task. Fallback prompt: Use the analyzing-network-traffic-with-wireshark skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-network-traffic-with-wireshark` |
| Canonical name | `analyzing-network-traffic-with-wireshark` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
