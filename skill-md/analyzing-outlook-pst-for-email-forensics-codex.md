...
display_name: analyzing-outlook-pst-for-email-forensics
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-outlook-pst-for-email-forensics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-outlook-pst-for-email-forensics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Microsoft Outlook PST (Personal Storage Table) and OST (Offline Storage Table) files are critical evidence sources in digital forensics investigations. PST files store email messages, calendar events, contacts, tasks, an

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-outlook-pst-for-email-forensics, then write the task. Fallback prompt: Use the analyzing-outlook-pst-for-email-forensics skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-outlook-pst-for-email-forensics` |
| Canonical name | `analyzing-outlook-pst-for-email-forensics` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
