...
display_name: analyzing-persistence-mechanisms-in-linux
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-persistence-mechanisms-in-linux - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-persistence-mechanisms-in-linux` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Adversaries establish persistence on Linux systems through crontab jobs, systemd service/timer units, LD_PRELOAD library injection, shell profile modifications (.bashrc, .profile), SSH authorized_keys backdoors, and init

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-persistence-mechanisms-in-linux, then write the task. Fallback prompt: Use the analyzing-persistence-mechanisms-in-linux skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-persistence-mechanisms-in-linux` |
| Canonical name | `analyzing-persistence-mechanisms-in-linux` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
