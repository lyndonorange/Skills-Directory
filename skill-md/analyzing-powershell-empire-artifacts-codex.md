...
display_name: analyzing-powershell-empire-artifacts
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-powershell-empire-artifacts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-powershell-empire-artifacts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

PowerShell Empire is a post-exploitation framework consisting of listeners, stagers, and agents. Its artifacts leave detectable traces in Windows event logs, particularly PowerShell Script Block Logging (Event ID 4104) a

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-powershell-empire-artifacts, then write the task. Fallback prompt: Use the analyzing-powershell-empire-artifacts skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-powershell-empire-artifacts` |
| Canonical name | `analyzing-powershell-empire-artifacts` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
