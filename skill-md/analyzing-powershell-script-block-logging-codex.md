...
display_name: analyzing-powershell-script-block-logging
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-powershell-script-block-logging - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-powershell-script-block-logging` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-powershell-script-block-logging, then write the task. Fallback prompt: Use the analyzing-powershell-script-block-logging skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-powershell-script-block-logging` |
| Canonical name | `analyzing-powershell-script-block-logging` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
