...
display_name: analyzing-prefetch-files-for-execution-history
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-prefetch-files-for-execution-history - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-prefetch-files-for-execution-history` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-prefetch-files-for-execution-history, then write the task. Fallback prompt: Use the analyzing-prefetch-files-for-execution-history skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-prefetch-files-for-execution-history` |
| Canonical name | `analyzing-prefetch-files-for-execution-history` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
