...
display_name: analyzing-ransomware-network-indicators
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-ransomware-network-indicators - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-ransomware-network-indicators` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Before and during ransomware execution, adversaries establish C2 channels, exfiltrate data, and download encryption keys. This skill analyzes Zeek conn.log and NetFlow data to detect beaconing patterns (regular-interval 

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-ransomware-network-indicators, then write the task. Fallback prompt: Use the analyzing-ransomware-network-indicators skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-ransomware-network-indicators` |
| Canonical name | `analyzing-ransomware-network-indicators` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
