...
display_name: analyzing-ransomware-payment-wallets
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-ransomware-payment-wallets - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-ransomware-payment-wallets` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-ransomware-payment-wallets, then write the task. Fallback prompt: Use the analyzing-ransomware-payment-wallets skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-ransomware-payment-wallets` |
| Canonical name | `analyzing-ransomware-payment-wallets` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
