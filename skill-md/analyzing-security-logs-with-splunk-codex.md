...
display_name: analyzing-security-logs-with-splunk
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-security-logs-with-splunk - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-security-logs-with-splunk` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-security-logs-with-splunk, then write the task. Fallback prompt: Use the analyzing-security-logs-with-splunk skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-security-logs-with-splunk` |
| Canonical name | `analyzing-security-logs-with-splunk` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
