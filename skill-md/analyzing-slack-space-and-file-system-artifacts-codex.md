...
display_name: analyzing-slack-space-and-file-system-artifacts
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-slack-space-and-file-system-artifacts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-slack-space-and-file-system-artifacts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-slack-space-and-file-system-artifacts, then write the task. Fallback prompt: Use the analyzing-slack-space-and-file-system-artifacts skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-slack-space-and-file-system-artifacts` |
| Canonical name | `analyzing-slack-space-and-file-system-artifacts` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
