...
display_name: analyzing-threat-actor-ttps-with-mitre-navigator
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-threat-actor-ttps-with-mitre-navigator - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-threat-actor-ttps-with-mitre-navigator` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-threat-actor-ttps-with-mitre-navigator, then write the task. Fallback prompt: Use the analyzing-threat-actor-ttps-with-mitre-navigator skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-threat-actor-ttps-with-mitre-navigator` |
| Canonical name | `analyzing-threat-actor-ttps-with-mitre-navigator` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
