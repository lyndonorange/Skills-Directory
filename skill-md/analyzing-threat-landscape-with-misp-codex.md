...
display_name: analyzing-threat-landscape-with-misp
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-threat-landscape-with-misp - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-threat-landscape-with-misp` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-threat-landscape-with-misp, then write the task. Fallback prompt: Use the analyzing-threat-landscape-with-misp skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-threat-landscape-with-misp` |
| Canonical name | `analyzing-threat-landscape-with-misp` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
