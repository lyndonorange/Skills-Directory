...
display_name: analyzing-typosquatting-domains-with-dnstwist
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-typosquatting-domains-with-dnstwist - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-typosquatting-domains-with-dnstwist` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

DNSTwist is a domain name permutation engine that generates similar-looking domain names to detect typosquatting, homograph phishing attacks, and brand impersonation. It creates thousands of domain permutations using tec

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-typosquatting-domains-with-dnstwist, then write the task. Fallback prompt: Use the analyzing-typosquatting-domains-with-dnstwist skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-typosquatting-domains-with-dnstwist` |
| Canonical name | `analyzing-typosquatting-domains-with-dnstwist` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
