...
display_name: analyzing-uefi-bootkit-persistence
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-uefi-bootkit-persistence - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-uefi-bootkit-persistence` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-uefi-bootkit-persistence, then write the task. Fallback prompt: Use the analyzing-uefi-bootkit-persistence skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-uefi-bootkit-persistence` |
| Canonical name | `analyzing-uefi-bootkit-persistence` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
