...
display_name: analyzing-usb-device-connection-history
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-usb-device-connection-history - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-usb-device-connection-history` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-usb-device-connection-history, then write the task. Fallback prompt: Use the analyzing-usb-device-connection-history skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-usb-device-connection-history` |
| Canonical name | `analyzing-usb-device-connection-history` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
