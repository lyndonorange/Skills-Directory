...
display_name: analyzing-web-server-logs-for-intrusion
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-web-server-logs-for-intrusion - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-web-server-logs-for-intrusion` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-web-server-logs-for-intrusion, then write the task. Fallback prompt: Use the analyzing-web-server-logs-for-intrusion skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-web-server-logs-for-intrusion` |
| Canonical name | `analyzing-web-server-logs-for-intrusion` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
