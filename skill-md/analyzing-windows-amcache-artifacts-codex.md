...
display_name: analyzing-windows-amcache-artifacts
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-windows-amcache-artifacts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-windows-amcache-artifacts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-windows-amcache-artifacts, then write the task. Fallback prompt: Use the analyzing-windows-amcache-artifacts skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-windows-amcache-artifacts` |
| Canonical name | `analyzing-windows-amcache-artifacts` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
