...
display_name: analyzing-windows-lnk-files-for-artifacts
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-windows-lnk-files-for-artifacts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-windows-lnk-files-for-artifacts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-windows-lnk-files-for-artifacts, then write the task. Fallback prompt: Use the analyzing-windows-lnk-files-for-artifacts skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-windows-lnk-files-for-artifacts` |
| Canonical name | `analyzing-windows-lnk-files-for-artifacts` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
