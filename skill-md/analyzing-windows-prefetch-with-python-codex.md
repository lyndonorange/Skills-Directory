...
display_name: analyzing-windows-prefetch-with-python
platform: Codex
category: Security, forensics, and incident response
---

# analyzing-windows-prefetch-with-python - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-windows-prefetch-with-python` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Windows Prefetch files (.pf) record application execution data including executable names, run counts, timestamps, loaded DLLs, and accessed directories. This skill covers parsing Prefetch files using the windowsprefetch

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-windows-prefetch-with-python, then write the task. Fallback prompt: Use the analyzing-windows-prefetch-with-python skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-windows-prefetch-with-python` |
| Canonical name | `analyzing-windows-prefetch-with-python` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
