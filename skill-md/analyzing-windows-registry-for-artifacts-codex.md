...
# analyzing-windows-registry-for-artifacts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-windows-registry-for-artifacts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose analyzing-windows-registry-for-artifacts, then write the task. Fallback prompt: Use the analyzing-windows-registry-for-artifacts skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-windows-registry-for-artifacts` |
| Canonical name | `analyzing-windows-registry-for-artifacts` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
