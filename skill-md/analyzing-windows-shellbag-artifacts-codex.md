...
# analyzing-windows-shellbag-artifacts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `analyzing-windows-shellbag-artifacts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Shellbags are Windows registry artifacts that track how users interact with folders through Windows Explorer, storing view settings such as icon size, window position, sort order, and view mode. From a forensic perspecti

## How To Use It In Codex

In Codex, click the chat box, press /, choose analyzing-windows-shellbag-artifacts, then write the task. Fallback prompt: Use the analyzing-windows-shellbag-artifacts skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `analyzing-windows-shellbag-artifacts` |
| Canonical name | `analyzing-windows-shellbag-artifacts` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
