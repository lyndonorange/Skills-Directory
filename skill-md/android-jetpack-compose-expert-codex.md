...
# android-jetpack-compose-expert - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `android-jetpack-compose-expert` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose android-jetpack-compose-expert, then write the task. Fallback prompt: Use the android-jetpack-compose-expert skill to...
