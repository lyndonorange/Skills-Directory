...
# animation-vocabulary - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `animation-vocabulary` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose animation-vocabulary, then write the task. Fallback prompt: Use the animation-vocabulary skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `animation-vocabulary` |
| Canonical name | `animation-vocabulary` |
| Platform | `Codex` |
| Category | General and specialized workflows |
