---
name: pm-skills-ansoff-matrix
display_name: ansoff-matrix
platform: Codex
category: Business creation, ideas, and validation
---

# ansoff-matrix - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ansoff-matrix` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose ansoff-matrix, then write the task. Fallback prompt: Use the ansoff-matrix skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `ansoff-matrix` |
| Canonical name | `pm-skills-ansoff-matrix` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
