...
# Apify - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `Apify` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Scrape social platforms, business data, and e-commerce via Apify actors — Instagram, LinkedIn, TikTok, YouTube, Facebook, Google Maps business search with contact/review extraction, Amazon products/reviews/pricing, and m

## How To Use It In Codex

In Codex, click the chat box, press /, choose Apify, then write the task. Fallback prompt: Use the Apify skill to...
