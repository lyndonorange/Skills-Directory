---
name: apk-reverse
display_name: apk-reverse
platform: Codex
category: General and specialized workflows
---

# apk-reverse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `apk-reverse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose apk-reverse, then write the task. Fallback prompt: Use the apk-reverse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `apk-reverse` |
| Canonical name | `apk-reverse` |
| Platform | `Codex` |
| Category | General and specialized workflows |
