...
# apple-build-supervisor - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `apple-build-supervisor` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose apple-build-supervisor, then write the task. Fallback prompt: Use the apple-build-supervisor skill to...
