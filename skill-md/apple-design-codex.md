...
# apple-design - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `apple-design` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose apple-design, then write the task. Fallback prompt: Use the apple-design skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `apple-design` |
| Canonical name | `apple-design` |
| Platform | `Codex` |
| Category | General and specialized workflows |
