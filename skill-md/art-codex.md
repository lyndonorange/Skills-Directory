...
# Art - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `Art` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Static visual content across 20+ formats via Flux, Nano Banana Pro (Gemini 3 Pro), and GPT-Image-2. Workflows: Essay, D3Dashboards, Visualize, Mermaid, TechnicalDiagrams, Taxonomies, Timelines, Frameworks, Comparisons, A

## How To Use It In Codex

In Codex, click the chat box, press /, choose Art, then write the task. Fallback prompt: Use the Art skill to...
