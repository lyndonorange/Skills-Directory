...
# ArXiv - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ArXiv` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Search and retrieve arXiv academic papers by topic, category, or paper ID — with AlphaXiv-enriched AI-generated overviews. Uses arXiv Atom API across cs.AI/cs.LG/cs.CL/cs.CR/cs.MA/cs.SE/cs.IR. Three workflows: Latest, Se

## How To Use It In Codex

In Codex, click the chat box, press /, choose ArXiv, then write the task. Fallback prompt: Use the ArXiv skill to...
