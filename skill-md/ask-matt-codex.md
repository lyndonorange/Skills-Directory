...
# ask-matt - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ask-matt` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose ask-matt, then write the task. Fallback prompt: Use the ask-matt skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `ask-matt` |
| Canonical name | `ask-matt` |
| Platform | `Codex` |
| Category | General and specialized workflows |
