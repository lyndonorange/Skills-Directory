...
# aso - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `aso` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose aso, then write the task. Fallback prompt: Use the aso skill to...
