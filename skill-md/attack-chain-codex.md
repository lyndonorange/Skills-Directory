---
name: attack-chain
display_name: attack-chain
platform: Codex
category: General and specialized workflows
---

# attack-chain - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `attack-chain` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Use for authorized multi-stage attack-path planning and orchestration when a task spans reconnaissance, initial access, privilege escalation, lateral movement, or impact assessment. Route single-stage tasks directly to t

## How To Use It In Codex

In Codex, click the chat box, press /, choose attack-chain, then write the task. Fallback prompt: Use the attack-chain skill to...
