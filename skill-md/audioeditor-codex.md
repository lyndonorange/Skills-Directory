---
name: AudioEditor
display_name: AudioEditor
platform: Codex
category: General and specialized workflows
---

# AudioEditor - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `AudioEditor` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

AI audio editing pipeline: Whisper word-level transcription → Claude segment classification (KEEP/CUT_FILLER/CUT_FALSE_START/CUT_STUTTER/CUT_DEAD_AIR) → ffmpeg with 40ms qsin crossfades and room-tone fill → optional Clea

## How To Use It In Codex

In Codex, click the chat box, press /, choose AudioEditor, then write the task. Fallback prompt: Use the AudioEditor skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `AudioEditor` |
| Canonical name | `AudioEditor` |
| Platform | `Codex` |
| Category | General and specialized workflows |
