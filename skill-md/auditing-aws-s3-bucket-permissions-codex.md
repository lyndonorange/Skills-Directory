...
# auditing-aws-s3-bucket-permissions - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `auditing-aws-s3-bucket-permissions` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose auditing-aws-s3-bucket-permissions, then write the task. Fallback prompt: Use the auditing-aws-s3-bucket-permissions skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `auditing-aws-s3-bucket-permissions` |
| Canonical name | `auditing-aws-s3-bucket-permissions` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
