...
display_name: auditing-azure-active-directory-configuration
platform: Codex
category: Security, forensics, and incident response
---

# auditing-azure-active-directory-configuration - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `auditing-azure-active-directory-configuration` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose auditing-azure-active-directory-configuration, then write the task. Fallback prompt: Use the auditing-azure-active-directory-configuration skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `auditing-azure-active-directory-configuration` |
| Canonical name | `auditing-azure-active-directory-configuration` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
