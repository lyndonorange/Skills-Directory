...
display_name: auditing-cloud-with-cis-benchmarks
platform: Codex
category: Security, forensics, and incident response
---

# auditing-cloud-with-cis-benchmarks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `auditing-cloud-with-cis-benchmarks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose auditing-cloud-with-cis-benchmarks, then write the task. Fallback prompt: Use the auditing-cloud-with-cis-benchmarks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `auditing-cloud-with-cis-benchmarks` |
| Canonical name | `auditing-cloud-with-cis-benchmarks` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
