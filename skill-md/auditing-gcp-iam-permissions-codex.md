...
display_name: auditing-gcp-iam-permissions
platform: Codex
category: Security, forensics, and incident response
---

# auditing-gcp-iam-permissions - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `auditing-gcp-iam-permissions` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose auditing-gcp-iam-permissions, then write the task. Fallback prompt: Use the auditing-gcp-iam-permissions skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `auditing-gcp-iam-permissions` |
| Canonical name | `auditing-gcp-iam-permissions` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
