...
display_name: auditing-kubernetes-cluster-rbac
platform: Codex
category: Security, forensics, and incident response
---

# auditing-kubernetes-cluster-rbac - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `auditing-kubernetes-cluster-rbac` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose auditing-kubernetes-cluster-rbac, then write the task. Fallback prompt: Use the auditing-kubernetes-cluster-rbac skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `auditing-kubernetes-cluster-rbac` |
| Canonical name | `auditing-kubernetes-cluster-rbac` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
