...
display_name: auditing-terraform-infrastructure-for-security
platform: Codex
category: Security, forensics, and incident response
---

# auditing-terraform-infrastructure-for-security - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `auditing-terraform-infrastructure-for-security` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose auditing-terraform-infrastructure-for-security, then write the task. Fallback prompt: Use the auditing-terraform-infrastructure-for-security skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `auditing-terraform-infrastructure-for-security` |
| Canonical name | `auditing-terraform-infrastructure-for-security` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
