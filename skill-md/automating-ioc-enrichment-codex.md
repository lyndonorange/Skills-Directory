...
# automating-ioc-enrichment - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `automating-ioc-enrichment` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose automating-ioc-enrichment, then write the task. Fallback prompt: Use the automating-ioc-enrichment skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `automating-ioc-enrichment` |
| Canonical name | `automating-ioc-enrichment` |
| Platform | `Codex` |
| Category | General and specialized workflows |
