---
name: autoplan
display_name: autoplan
platform: Codex
category: General and specialized workflows
---

# autoplan - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `autoplan` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose autoplan, then write the task. Fallback prompt: Use the autoplan skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `autoplan` |
| Canonical name | `autoplan` |
| Platform | `Codex` |
| Category | General and specialized workflows |
