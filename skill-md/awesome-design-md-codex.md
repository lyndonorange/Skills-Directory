...
# awesome-design-md - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `awesome-design-md` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose awesome-design-md, then write the task. Fallback prompt: Use the awesome-design-md skill to...
