---
name: BeCreative
display_name: BeCreative
platform: Codex
category: General and specialized workflows
---

# BeCreative - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `BeCreative` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Divergent ideation and corpus expansion via Verbalized Sampling + extended thinking. Single-shot generates 5 internally diverse candidates (p<0.10 each), surfaces strongest. Multi-turn expands seed corpus (5-20 examples)

## How To Use It In Codex

In Codex, click the chat box, press /, choose BeCreative, then write the task. Fallback prompt: Use the BeCreative skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `BeCreative` |
| Canonical name | `BeCreative` |
| Platform | `Codex` |
| Category | General and specialized workflows |
