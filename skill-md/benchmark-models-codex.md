...
# benchmark-models - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `benchmark-models` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose benchmark-models, then write the task. Fallback prompt: Use the benchmark-models skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `benchmark-models` |
| Canonical name | `benchmark-models` |
| Platform | `Codex` |
| Category | General and specialized workflows |
