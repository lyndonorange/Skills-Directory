---
name: BiasCheck
display_name: BiasCheck
platform: Codex
category: General and specialized workflows
---

# BiasCheck - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `BiasCheck` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Three-layer bias analysis on any source — URL, file path, or raw text. Auto-fetches the content plus any underlying study cited, then audits (1) data-level biases (funding, sampling, question design, self-report, causal

## How To Use It In Codex

In Codex, click the chat box, press /, choose BiasCheck, then write the task. Fallback prompt: Use the BiasCheck skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `BiasCheck` |
| Canonical name | `BiasCheck` |
| Platform | `Codex` |
| Category | General and specialized workflows |
