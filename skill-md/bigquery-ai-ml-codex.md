...
# bigquery-ai-ml - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bigquery-ai-ml` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bigquery-ai-ml, then write the task. Fallback prompt: Use the bigquery-ai-ml skill to...
