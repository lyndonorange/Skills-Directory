...
# bigquery-bigframes - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bigquery-bigframes` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bigquery-bigframes, then write the task. Fallback prompt: Use the bigquery-bigframes skill to...
