---
name: binary-diff
display_name: binary-diff
platform: Codex
category: General and specialized workflows
---

# binary-diff - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `binary-diff` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose binary-diff, then write the task. Fallback prompt: Use the binary-diff skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `binary-diff` |
| Canonical name | `binary-diff` |
| Platform | `Codex` |
| Category | General and specialized workflows |
