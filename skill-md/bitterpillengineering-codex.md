...
display_name: BitterPillEngineering
platform: Codex
category: General and specialized workflows
---

# BitterPillEngineering - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `BitterPillEngineering` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Audits any AI instruction set for over-prompting using the core test — would a smarter model make this rule unnecessary? Applies Five Questions to every rule (Claude already does this? Contradiction? Redundant? One-off f

## How To Use It In Codex

In Codex, click the chat box, press /, choose BitterPillEngineering, then write the task. Fallback prompt: Use the BitterPillEngineering skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `BitterPillEngineering` |
| Canonical name | `BitterPillEngineering` |
| Platform | `Codex` |
| Category | General and specialized workflows |
