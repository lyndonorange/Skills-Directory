...
display_name: bmad-advanced-elicitation
platform: Codex
category: General and specialized workflows
---

# bmad-advanced-elicitation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-advanced-elicitation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-advanced-elicitation, then write the task. Fallback prompt: Use the bmad-advanced-elicitation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-advanced-elicitation` |
| Canonical name | `bmad-advanced-elicitation` |
| Platform | `Codex` |
| Category | General and specialized workflows |
