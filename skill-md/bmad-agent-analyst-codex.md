...
display_name: bmad-agent-analyst
platform: Codex
category: General and specialized workflows
---

# bmad-agent-analyst - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-agent-analyst` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-agent-analyst, then write the task. Fallback prompt: Use the bmad-agent-analyst skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-agent-analyst` |
| Canonical name | `bmad-agent-analyst` |
| Platform | `Codex` |
| Category | General and specialized workflows |
