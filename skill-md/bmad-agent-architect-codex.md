...
display_name: bmad-agent-architect
platform: Codex
category: General and specialized workflows
---

# bmad-agent-architect - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-agent-architect` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-agent-architect, then write the task. Fallback prompt: Use the bmad-agent-architect skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-agent-architect` |
| Canonical name | `bmad-agent-architect` |
| Platform | `Codex` |
| Category | General and specialized workflows |
