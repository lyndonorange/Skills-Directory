---
name: bmad-agent-dev
display_name: bmad-agent-dev
platform: Codex
category: General and specialized workflows
---

# bmad-agent-dev - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-agent-dev` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-agent-dev, then write the task. Fallback prompt: Use the bmad-agent-dev skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-agent-dev` |
| Canonical name | `bmad-agent-dev` |
| Platform | `Codex` |
| Category | General and specialized workflows |
