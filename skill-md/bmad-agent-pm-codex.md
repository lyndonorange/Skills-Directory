---
name: bmad-agent-pm
display_name: bmad-agent-pm
platform: Codex
category: General and specialized workflows
---

# bmad-agent-pm - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-agent-pm` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-agent-pm, then write the task. Fallback prompt: Use the bmad-agent-pm skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-agent-pm` |
| Canonical name | `bmad-agent-pm` |
| Platform | `Codex` |
| Category | General and specialized workflows |
