...
display_name: bmad-agent-tech-writer
platform: Codex
category: General and specialized workflows
---

# bmad-agent-tech-writer - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-agent-tech-writer` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-agent-tech-writer, then write the task. Fallback prompt: Use the bmad-agent-tech-writer skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-agent-tech-writer` |
| Canonical name | `bmad-agent-tech-writer` |
| Platform | `Codex` |
| Category | General and specialized workflows |
