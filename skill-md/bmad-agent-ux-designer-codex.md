...
display_name: bmad-agent-ux-designer
platform: Codex
category: General and specialized workflows
---

# bmad-agent-ux-designer - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-agent-ux-designer` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-agent-ux-designer, then write the task. Fallback prompt: Use the bmad-agent-ux-designer skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-agent-ux-designer` |
| Canonical name | `bmad-agent-ux-designer` |
| Platform | `Codex` |
| Category | General and specialized workflows |
