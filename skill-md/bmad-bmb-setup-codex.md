---
name: bmad-bmb-setup
display_name: bmad-bmb-setup
platform: Codex
category: General and specialized workflows
---

# bmad-bmb-setup - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-bmb-setup` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-bmb-setup, then write the task. Fallback prompt: Use the bmad-bmb-setup skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-bmb-setup` |
| Canonical name | `bmad-bmb-setup` |
| Platform | `Codex` |
| Category | General and specialized workflows |
