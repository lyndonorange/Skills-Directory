...
display_name: bmad-check-implementation-readiness
platform: Codex
category: General and specialized workflows
---

# bmad-check-implementation-readiness - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-check-implementation-readiness` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-check-implementation-readiness, then write the task. Fallback prompt: Use the bmad-check-implementation-readiness skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-check-implementation-readiness` |
| Canonical name | `bmad-check-implementation-readiness` |
| Platform | `Codex` |
| Category | General and specialized workflows |
