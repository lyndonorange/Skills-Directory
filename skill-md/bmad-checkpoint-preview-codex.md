...
display_name: bmad-checkpoint-preview
platform: Codex
category: General and specialized workflows
---

# bmad-checkpoint-preview - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-checkpoint-preview` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-checkpoint-preview, then write the task. Fallback prompt: Use the bmad-checkpoint-preview skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-checkpoint-preview` |
| Canonical name | `bmad-checkpoint-preview` |
| Platform | `Codex` |
| Category | General and specialized workflows |
