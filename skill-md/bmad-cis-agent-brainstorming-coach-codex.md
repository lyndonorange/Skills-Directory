...
display_name: bmad-cis-agent-brainstorming-coach
platform: Codex
category: General and specialized workflows
---

# bmad-cis-agent-brainstorming-coach - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-cis-agent-brainstorming-coach` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-cis-agent-brainstorming-coach, then write the task. Fallback prompt: Use the bmad-cis-agent-brainstorming-coach skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-cis-agent-brainstorming-coach` |
| Canonical name | `bmad-cis-agent-brainstorming-coach` |
| Platform | `Codex` |
| Category | General and specialized workflows |
