...
display_name: bmad-cis-agent-creative-problem-solver
platform: Codex
category: General and specialized workflows
---

# bmad-cis-agent-creative-problem-solver - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-cis-agent-creative-problem-solver` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-cis-agent-creative-problem-solver, then write the task. Fallback prompt: Use the bmad-cis-agent-creative-problem-solver skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-cis-agent-creative-problem-solver` |
| Canonical name | `bmad-cis-agent-creative-problem-solver` |
| Platform | `Codex` |
| Category | General and specialized workflows |
