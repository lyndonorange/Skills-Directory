...
display_name: bmad-cis-agent-design-thinking-coach
platform: Codex
category: General and specialized workflows
---

# bmad-cis-agent-design-thinking-coach - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-cis-agent-design-thinking-coach` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-cis-agent-design-thinking-coach, then write the task. Fallback prompt: Use the bmad-cis-agent-design-thinking-coach skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-cis-agent-design-thinking-coach` |
| Canonical name | `bmad-cis-agent-design-thinking-coach` |
| Platform | `Codex` |
| Category | General and specialized workflows |
