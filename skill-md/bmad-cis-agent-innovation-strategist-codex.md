...
display_name: bmad-cis-agent-innovation-strategist
platform: Codex
category: General and specialized workflows
---

# bmad-cis-agent-innovation-strategist - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-cis-agent-innovation-strategist` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-cis-agent-innovation-strategist, then write the task. Fallback prompt: Use the bmad-cis-agent-innovation-strategist skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-cis-agent-innovation-strategist` |
| Canonical name | `bmad-cis-agent-innovation-strategist` |
| Platform | `Codex` |
| Category | General and specialized workflows |
