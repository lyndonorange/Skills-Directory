...
# bmad-cis-agent-innovation-strategist - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-cis-agent-innovation-strategist` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the bmad-cis-agent-innovation-strategist skill to...
