...
display_name: bmad-cis-agent-presentation-master
platform: Codex
category: General and specialized workflows
---

# bmad-cis-agent-presentation-master - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-cis-agent-presentation-master` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-cis-agent-presentation-master, then write the task. Fallback prompt: Use the bmad-cis-agent-presentation-master skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-cis-agent-presentation-master` |
| Canonical name | `bmad-cis-agent-presentation-master` |
| Platform | `Codex` |
| Category | General and specialized workflows |
