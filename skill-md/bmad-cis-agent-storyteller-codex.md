...
display_name: bmad-cis-agent-storyteller
platform: Codex
category: General and specialized workflows
---

# bmad-cis-agent-storyteller - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-cis-agent-storyteller` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-cis-agent-storyteller, then write the task. Fallback prompt: Use the bmad-cis-agent-storyteller skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-cis-agent-storyteller` |
| Canonical name | `bmad-cis-agent-storyteller` |
| Platform | `Codex` |
| Category | General and specialized workflows |
