...
# bmad-cis-design-thinking - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-cis-design-thinking` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the bmad-cis-design-thinking skill to...
