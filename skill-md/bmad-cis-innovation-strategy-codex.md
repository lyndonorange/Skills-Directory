...
display_name: bmad-cis-innovation-strategy
platform: Codex
category: General and specialized workflows
---

# bmad-cis-innovation-strategy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-cis-innovation-strategy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-cis-innovation-strategy, then write the task. Fallback prompt: Use the bmad-cis-innovation-strategy skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-cis-innovation-strategy` |
| Canonical name | `bmad-cis-innovation-strategy` |
| Platform | `Codex` |
| Category | General and specialized workflows |
