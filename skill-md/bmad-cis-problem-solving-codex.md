...
display_name: bmad-cis-problem-solving
platform: Codex
category: General and specialized workflows
---

# bmad-cis-problem-solving - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-cis-problem-solving` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-cis-problem-solving, then write the task. Fallback prompt: Use the bmad-cis-problem-solving skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-cis-problem-solving` |
| Canonical name | `bmad-cis-problem-solving` |
| Platform | `Codex` |
| Category | General and specialized workflows |
