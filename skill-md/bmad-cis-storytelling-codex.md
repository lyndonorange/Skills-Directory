...
display_name: bmad-cis-storytelling
platform: Codex
category: General and specialized workflows
---

# bmad-cis-storytelling - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-cis-storytelling` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-cis-storytelling, then write the task. Fallback prompt: Use the bmad-cis-storytelling skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-cis-storytelling` |
| Canonical name | `bmad-cis-storytelling` |
| Platform | `Codex` |
| Category | General and specialized workflows |
