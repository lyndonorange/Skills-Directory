...
display_name: bmad-correct-course
platform: Codex
category: General and specialized workflows
---

# bmad-correct-course - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-correct-course` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-correct-course, then write the task. Fallback prompt: Use the bmad-correct-course skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-correct-course` |
| Canonical name | `bmad-correct-course` |
| Platform | `Codex` |
| Category | General and specialized workflows |
