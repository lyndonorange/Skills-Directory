...
# bmad-correct-course - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-correct-course` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the bmad-correct-course skill to...
