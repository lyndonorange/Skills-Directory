...
display_name: bmad-create-architecture
platform: Codex
category: General and specialized workflows
---

# bmad-create-architecture - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-create-architecture` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-create-architecture, then write the task. Fallback prompt: Use the bmad-create-architecture skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-create-architecture` |
| Canonical name | `bmad-create-architecture` |
| Platform | `Codex` |
| Category | General and specialized workflows |
