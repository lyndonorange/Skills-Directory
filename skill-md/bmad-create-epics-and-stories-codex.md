...
display_name: bmad-create-epics-and-stories
platform: Codex
category: General and specialized workflows
---

# bmad-create-epics-and-stories - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-create-epics-and-stories` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-create-epics-and-stories, then write the task. Fallback prompt: Use the bmad-create-epics-and-stories skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-create-epics-and-stories` |
| Canonical name | `bmad-create-epics-and-stories` |
| Platform | `Codex` |
| Category | General and specialized workflows |
