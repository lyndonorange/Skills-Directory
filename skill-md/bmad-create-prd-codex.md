...
display_name: bmad-create-prd
platform: Codex
category: General and specialized workflows
---

# bmad-create-prd - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-create-prd` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-create-prd, then write the task. Fallback prompt: Use the bmad-create-prd skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-create-prd` |
| Canonical name | `bmad-create-prd` |
| Platform | `Codex` |
| Category | General and specialized workflows |
