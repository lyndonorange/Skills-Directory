...
display_name: bmad-create-story
platform: Codex
category: General and specialized workflows
---

# bmad-create-story - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-create-story` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-create-story, then write the task. Fallback prompt: Use the bmad-create-story skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-create-story` |
| Canonical name | `bmad-create-story` |
| Platform | `Codex` |
| Category | General and specialized workflows |
