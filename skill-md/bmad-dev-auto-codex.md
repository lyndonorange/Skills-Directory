---
name: bmad-dev-auto
display_name: bmad-dev-auto
platform: Codex
category: General and specialized workflows
---

# bmad-dev-auto - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-dev-auto` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-dev-auto, then write the task. Fallback prompt: Use the bmad-dev-auto skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-dev-auto` |
| Canonical name | `bmad-dev-auto` |
| Platform | `Codex` |
| Category | General and specialized workflows |
