---
name: bmad-dev-story
display_name: bmad-dev-story
platform: Codex
category: General and specialized workflows
---

# bmad-dev-story - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-dev-story` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-dev-story, then write the task. Fallback prompt: Use the bmad-dev-story skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-dev-story` |
| Canonical name | `bmad-dev-story` |
| Platform | `Codex` |
| Category | General and specialized workflows |
