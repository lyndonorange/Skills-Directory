...
display_name: bmad-domain-research
platform: Codex
category: General and specialized workflows
---

# bmad-domain-research - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-domain-research` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-domain-research, then write the task. Fallback prompt: Use the bmad-domain-research skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-domain-research` |
| Canonical name | `bmad-domain-research` |
| Platform | `Codex` |
| Category | General and specialized workflows |
