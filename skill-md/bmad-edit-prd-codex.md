...
# bmad-edit-prd - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-edit-prd` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-edit-prd, then write the task. Fallback prompt: Use the bmad-edit-prd skill to...
