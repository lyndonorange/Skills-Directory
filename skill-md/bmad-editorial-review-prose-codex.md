...
display_name: bmad-editorial-review-prose
platform: Codex
category: General and specialized workflows
---

# bmad-editorial-review-prose - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-editorial-review-prose` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-editorial-review-prose, then write the task. Fallback prompt: Use the bmad-editorial-review-prose skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-editorial-review-prose` |
| Canonical name | `bmad-editorial-review-prose` |
| Platform | `Codex` |
| Category | General and specialized workflows |
