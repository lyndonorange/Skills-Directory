...
display_name: bmad-eval-runner
platform: Codex
category: General and specialized workflows
---

# bmad-eval-runner - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-eval-runner` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-eval-runner, then write the task. Fallback prompt: Use the bmad-eval-runner skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-eval-runner` |
| Canonical name | `bmad-eval-runner` |
| Platform | `Codex` |
| Category | General and specialized workflows |
