...
display_name: bmad-forge-idea
platform: Codex
category: General and specialized workflows
---

# bmad-forge-idea - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-forge-idea` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-forge-idea, then write the task. Fallback prompt: Use the bmad-forge-idea skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-forge-idea` |
| Canonical name | `bmad-forge-idea` |
| Platform | `Codex` |
| Category | General and specialized workflows |
