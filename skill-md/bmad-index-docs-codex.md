...
display_name: bmad-index-docs
platform: Codex
category: General and specialized workflows
---

# bmad-index-docs - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-index-docs` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-index-docs, then write the task. Fallback prompt: Use the bmad-index-docs skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-index-docs` |
| Canonical name | `bmad-index-docs` |
| Platform | `Codex` |
| Category | General and specialized workflows |
