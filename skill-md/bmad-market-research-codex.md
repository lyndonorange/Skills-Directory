...
display_name: bmad-market-research
platform: Codex
category: General and specialized workflows
---

# bmad-market-research - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-market-research` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-market-research, then write the task. Fallback prompt: Use the bmad-market-research skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-market-research` |
| Canonical name | `bmad-market-research` |
| Platform | `Codex` |
| Category | General and specialized workflows |
