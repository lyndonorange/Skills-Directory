...
display_name: bmad-module-builder
platform: Codex
category: General and specialized workflows
---

# bmad-module-builder - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-module-builder` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-module-builder, then write the task. Fallback prompt: Use the bmad-module-builder skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-module-builder` |
| Canonical name | `bmad-module-builder` |
| Platform | `Codex` |
| Category | General and specialized workflows |
