...
display_name: bmad-party-mode
platform: Codex
category: General and specialized workflows
---

# bmad-party-mode - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-party-mode` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

'Orchestrates lively group discussions between installed BMAD agents or custom personas, and helps author custom parties. Use when the user requests party mode, a roundtable, or multiple agent perspectives — or wants to

## How To Use It In Codex

In Codex, click the chat box, press /, choose bmad-party-mode, then write the task. Fallback prompt: Use the bmad-party-mode skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-party-mode` |
| Canonical name | `bmad-party-mode` |
| Platform | `Codex` |
| Category | General and specialized workflows |
