---
name: bmad-prd
display_name: bmad-prd
platform: Codex
category: General and specialized workflows
---

# bmad-prd - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-prd` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-prd, then write the task. Fallback prompt: Use the bmad-prd skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-prd` |
| Canonical name | `bmad-prd` |
| Platform | `Codex` |
| Category | General and specialized workflows |
