---
name: bmad-prfaq
display_name: bmad-prfaq
platform: Codex
category: General and specialized workflows
---

# bmad-prfaq - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-prfaq` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-prfaq, then write the task. Fallback prompt: Use the bmad-prfaq skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-prfaq` |
| Canonical name | `bmad-prfaq` |
| Platform | `Codex` |
| Category | General and specialized workflows |
