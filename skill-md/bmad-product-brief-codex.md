...
display_name: bmad-product-brief
platform: Codex
category: General and specialized workflows
---

# bmad-product-brief - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-product-brief` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-product-brief, then write the task. Fallback prompt: Use the bmad-product-brief skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-product-brief` |
| Canonical name | `bmad-product-brief` |
| Platform | `Codex` |
| Category | General and specialized workflows |
