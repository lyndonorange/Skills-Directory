...
# bmad-product-brief - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-product-brief` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the bmad-product-brief skill to...
