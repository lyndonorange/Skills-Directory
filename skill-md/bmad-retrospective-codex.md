...
display_name: bmad-retrospective
platform: Codex
category: General and specialized workflows
---

# bmad-retrospective - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-retrospective` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-retrospective, then write the task. Fallback prompt: Use the bmad-retrospective skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-retrospective` |
| Canonical name | `bmad-retrospective` |
| Platform | `Codex` |
| Category | General and specialized workflows |
