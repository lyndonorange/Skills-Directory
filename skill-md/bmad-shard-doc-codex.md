---
name: bmad-shard-doc
display_name: bmad-shard-doc
platform: Codex
category: General and specialized workflows
---

# bmad-shard-doc - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-shard-doc` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-shard-doc, then write the task. Fallback prompt: Use the bmad-shard-doc skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-shard-doc` |
| Canonical name | `bmad-shard-doc` |
| Platform | `Codex` |
| Category | General and specialized workflows |
