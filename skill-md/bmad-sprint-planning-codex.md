...
display_name: bmad-sprint-planning
platform: Codex
category: General and specialized workflows
---

# bmad-sprint-planning - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-sprint-planning` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-sprint-planning, then write the task. Fallback prompt: Use the bmad-sprint-planning skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-sprint-planning` |
| Canonical name | `bmad-sprint-planning` |
| Platform | `Codex` |
| Category | General and specialized workflows |
