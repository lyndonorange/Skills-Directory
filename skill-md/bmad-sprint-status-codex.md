...
display_name: bmad-sprint-status
platform: Codex
category: General and specialized workflows
---

# bmad-sprint-status - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-sprint-status` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-sprint-status, then write the task. Fallback prompt: Use the bmad-sprint-status skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-sprint-status` |
| Canonical name | `bmad-sprint-status` |
| Platform | `Codex` |
| Category | General and specialized workflows |
