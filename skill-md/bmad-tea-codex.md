---
name: bmad-tea
display_name: bmad-tea
platform: Codex
category: General and specialized workflows
---

# bmad-tea - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-tea` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-tea, then write the task. Fallback prompt: Use the bmad-tea skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-tea` |
| Canonical name | `bmad-tea` |
| Platform | `Codex` |
| Category | General and specialized workflows |
