...
display_name: bmad-teach-me-testing
platform: Codex
category: General and specialized workflows
---

# bmad-teach-me-testing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-teach-me-testing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-teach-me-testing, then write the task. Fallback prompt: Use the bmad-teach-me-testing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-teach-me-testing` |
| Canonical name | `bmad-teach-me-testing` |
| Platform | `Codex` |
| Category | General and specialized workflows |
