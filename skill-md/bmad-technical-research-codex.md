...
display_name: bmad-technical-research
platform: Codex
category: General and specialized workflows
---

# bmad-technical-research - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-technical-research` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-technical-research, then write the task. Fallback prompt: Use the bmad-technical-research skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-technical-research` |
| Canonical name | `bmad-technical-research` |
| Platform | `Codex` |
| Category | General and specialized workflows |
