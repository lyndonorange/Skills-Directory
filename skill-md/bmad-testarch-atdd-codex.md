...
display_name: bmad-testarch-atdd
platform: Codex
category: General and specialized workflows
---

# bmad-testarch-atdd - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-testarch-atdd` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-testarch-atdd, then write the task. Fallback prompt: Use the bmad-testarch-atdd skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-testarch-atdd` |
| Canonical name | `bmad-testarch-atdd` |
| Platform | `Codex` |
| Category | General and specialized workflows |
