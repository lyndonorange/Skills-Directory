...
display_name: bmad-testarch-automate
platform: Codex
category: General and specialized workflows
---

# bmad-testarch-automate - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-testarch-automate` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-testarch-automate, then write the task. Fallback prompt: Use the bmad-testarch-automate skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-testarch-automate` |
| Canonical name | `bmad-testarch-automate` |
| Platform | `Codex` |
| Category | General and specialized workflows |
