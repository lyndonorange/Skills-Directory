...
# bmad-testarch-automate - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-testarch-automate` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the bmad-testarch-automate skill to...
