...
display_name: bmad-testarch-ci
platform: Codex
category: General and specialized workflows
---

# bmad-testarch-ci - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-testarch-ci` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-testarch-ci, then write the task. Fallback prompt: Use the bmad-testarch-ci skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-testarch-ci` |
| Canonical name | `bmad-testarch-ci` |
| Platform | `Codex` |
| Category | General and specialized workflows |
