...
display_name: bmad-testarch-framework
platform: Codex
category: General and specialized workflows
---

# bmad-testarch-framework - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-testarch-framework` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-testarch-framework, then write the task. Fallback prompt: Use the bmad-testarch-framework skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-testarch-framework` |
| Canonical name | `bmad-testarch-framework` |
| Platform | `Codex` |
| Category | General and specialized workflows |
