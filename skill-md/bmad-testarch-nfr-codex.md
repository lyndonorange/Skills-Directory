...
display_name: bmad-testarch-nfr
platform: Codex
category: General and specialized workflows
---

# bmad-testarch-nfr - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-testarch-nfr` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

'Audit NFR evidence for performance, security, reliability, and scalability. Use when implementation evidence exists and the user says "audit NFR evidence", "audit NFRs", or "evaluate non-functional requirements"'

## How To Use It In Codex

In Codex, click the chat box, press /, choose bmad-testarch-nfr, then write the task. Fallback prompt: Use the bmad-testarch-nfr skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-testarch-nfr` |
| Canonical name | `bmad-testarch-nfr` |
| Platform | `Codex` |
| Category | General and specialized workflows |
