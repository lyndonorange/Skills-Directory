...
display_name: bmad-testarch-test-design
platform: Codex
category: General and specialized workflows
---

# bmad-testarch-test-design - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-testarch-test-design` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-testarch-test-design, then write the task. Fallback prompt: Use the bmad-testarch-test-design skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-testarch-test-design` |
| Canonical name | `bmad-testarch-test-design` |
| Platform | `Codex` |
| Category | General and specialized workflows |
