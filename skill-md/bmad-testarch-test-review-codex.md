...
display_name: bmad-testarch-test-review
platform: Codex
category: General and specialized workflows
---

# bmad-testarch-test-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-testarch-test-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-testarch-test-review, then write the task. Fallback prompt: Use the bmad-testarch-test-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-testarch-test-review` |
| Canonical name | `bmad-testarch-test-review` |
| Platform | `Codex` |
| Category | General and specialized workflows |
