...
# bmad-testarch-test-review - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-testarch-test-review` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the bmad-testarch-test-review skill to...
