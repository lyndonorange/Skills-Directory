...
display_name: bmad-testarch-trace
platform: Codex
category: General and specialized workflows
---

# bmad-testarch-trace - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-testarch-trace` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-testarch-trace, then write the task. Fallback prompt: Use the bmad-testarch-trace skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-testarch-trace` |
| Canonical name | `bmad-testarch-trace` |
| Platform | `Codex` |
| Category | General and specialized workflows |
