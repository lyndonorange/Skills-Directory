---
name: bmad-ux
display_name: bmad-ux
platform: Codex
category: General and specialized workflows
---

# bmad-ux - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-ux` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-ux, then write the task. Fallback prompt: Use the bmad-ux skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-ux` |
| Canonical name | `bmad-ux` |
| Platform | `Codex` |
| Category | General and specialized workflows |
