...
display_name: bmad-validate-prd
platform: Codex
category: General and specialized workflows
---

# bmad-validate-prd - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-validate-prd` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-validate-prd, then write the task. Fallback prompt: Use the bmad-validate-prd skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-validate-prd` |
| Canonical name | `bmad-validate-prd` |
| Platform | `Codex` |
| Category | General and specialized workflows |
