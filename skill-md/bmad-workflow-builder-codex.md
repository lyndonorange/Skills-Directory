...
display_name: bmad-workflow-builder
platform: Codex
category: General and specialized workflows
---

# bmad-workflow-builder - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bmad-workflow-builder` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bmad-workflow-builder, then write the task. Fallback prompt: Use the bmad-workflow-builder skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bmad-workflow-builder` |
| Canonical name | `bmad-workflow-builder` |
| Platform | `Codex` |
| Category | General and specialized workflows |
