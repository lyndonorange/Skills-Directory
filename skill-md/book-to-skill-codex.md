...
# book-to-skill - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `book-to-skill` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Converts books and documents (PDF, EPUB, DOCX, HTML, Markdown, plain text, RTF, MOBI/AZW with Calibre) into structured agent skills, extracting frameworks, mental models, principles, techniques, and anti-patterns. Use wh

## How To Use It In Codex

In Codex, click the chat box, press /, choose book-to-skill, then write the task. Fallback prompt: Use the book-to-skill skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `book-to-skill` |
| Canonical name | `book-to-skill` |
| Platform | `Codex` |
| Category | General and specialized workflows |
