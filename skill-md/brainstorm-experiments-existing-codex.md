---
name: pm-skills-brainstorm-experiments-existing
display_name: brainstorm-experiments-existing
platform: Codex
category: Business creation, ideas, and validation
---

# brainstorm-experiments-existing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `brainstorm-experiments-existing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose brainstorm-experiments-existing, then write the task. Fallback prompt: Use the brainstorm-experiments-existing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `brainstorm-experiments-existing` |
| Canonical name | `pm-skills-brainstorm-experiments-existing` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
