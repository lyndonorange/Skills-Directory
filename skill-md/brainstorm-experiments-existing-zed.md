...
# brainstorm-experiments-existing - Zed Skill Package

## What This Is

This is a friend-safe Markdown copy of `brainstorm-experiments-existing` for Zed. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Zed, open the Agent panel and type: Use the brainstorm-experiments-existing skill to...
