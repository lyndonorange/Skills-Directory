---
name: pm-skills-brainstorm-experiments-new
display_name: brainstorm-experiments-new
platform: Universal Agents
category: Business creation, ideas, and validation
---

# brainstorm-experiments-new - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `brainstorm-experiments-new` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the brainstorm-experiments-new skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `brainstorm-experiments-new` |
| Canonical name | `pm-skills-brainstorm-experiments-new` |
| Platform | `Universal Agents` |
| Category | Business creation, ideas, and validation |
