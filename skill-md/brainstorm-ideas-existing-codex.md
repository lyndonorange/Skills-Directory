---
name: pm-skills-brainstorm-ideas-existing
display_name: brainstorm-ideas-existing
platform: Codex
category: Business creation, ideas, and validation
---

# brainstorm-ideas-existing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `brainstorm-ideas-existing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose brainstorm-ideas-existing, then write the task. Fallback prompt: Use the brainstorm-ideas-existing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `brainstorm-ideas-existing` |
| Canonical name | `pm-skills-brainstorm-ideas-existing` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
