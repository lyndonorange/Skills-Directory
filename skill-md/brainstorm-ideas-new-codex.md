---
name: pm-skills-brainstorm-ideas-new
display_name: brainstorm-ideas-new
platform: Codex
category: Business creation, ideas, and validation
---

# brainstorm-ideas-new - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `brainstorm-ideas-new` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose brainstorm-ideas-new, then write the task. Fallback prompt: Use the brainstorm-ideas-new skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `brainstorm-ideas-new` |
| Canonical name | `pm-skills-brainstorm-ideas-new` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
