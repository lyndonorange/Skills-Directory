---
name: pm-skills-brainstorm-okrs
display_name: brainstorm-okrs
platform: Codex
category: Product delivery, planning, and execution
---

# brainstorm-okrs - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `brainstorm-okrs` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose brainstorm-okrs, then write the task. Fallback prompt: Use the brainstorm-okrs skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `brainstorm-okrs` |
| Canonical name | `pm-skills-brainstorm-okrs` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
