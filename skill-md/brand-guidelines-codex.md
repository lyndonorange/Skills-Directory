...
# brand-guidelines - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `brand-guidelines` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose brand-guidelines, then write the task. Fallback prompt: Use the brand-guidelines skill to...
