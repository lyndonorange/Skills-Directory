---
name: brandkit
display_name: brandkit
platform: Codex
category: General and specialized workflows
---

# brandkit - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `brandkit` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose brandkit, then write the task. Fallback prompt: Use the brandkit skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `brandkit` |
| Canonical name | `brandkit` |
| Platform | `Codex` |
| Category | General and specialized workflows |
