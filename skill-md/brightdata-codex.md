...
# BrightData - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `BrightData` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

4-tier progressive scraping with automatic escalation: Tier 1 WebFetch, Tier 2 curl with Chrome headers, Tier 3 agent-browser (headless JS rendering), Tier 4 Bright Data MCP proxy (CAPTCHA, advanced bot detection, reside

## How To Use It In Codex

In Codex, click the chat box, press /, choose BrightData, then write the task. Fallback prompt: Use the BrightData skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `BrightData` |
| Canonical name | `BrightData` |
| Platform | `Codex` |
| Category | General and specialized workflows |
