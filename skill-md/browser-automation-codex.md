...
# browser-automation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `browser-automation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose browser-automation, then write the task. Fallback prompt: Use the browser-automation skill to...
...
| Canonical name | `browser-automation` |
| Platform | `Codex` |
| Category | Agent platforms, tools, and automation |
