...
display_name: browser-extension-reverse
platform: Codex
category: Agent platforms, tools, and automation
---

# browser-extension-reverse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `browser-extension-reverse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose browser-extension-reverse, then write the task. Fallback prompt: Use the browser-extension-reverse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `browser-extension-reverse` |
| Canonical name | `browser-extension-reverse` |
| Platform | `Codex` |
| Category | Agent platforms, tools, and automation |
