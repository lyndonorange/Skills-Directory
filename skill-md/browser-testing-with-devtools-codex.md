...
display_name: browser-testing-with-devtools
platform: Codex
category: Software engineering and app building
---

# browser-testing-with-devtools - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `browser-testing-with-devtools` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose browser-testing-with-devtools, then write the task. Fallback prompt: Use the browser-testing-with-devtools skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `browser-testing-with-devtools` |
| Canonical name | `browser-testing-with-devtools` |
| Platform | `Codex` |
| Category | Software engineering and app building |
