...
# browser-use - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `browser-use` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose browser-use, then write the task. Fallback prompt: Use the browser-use skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `browser-use` |
| Canonical name | `browser-use` |
| Platform | `Codex` |
| Category | Agent platforms, tools, and automation |
