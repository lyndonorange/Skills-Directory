...
display_name: building-adversary-infrastructure-tracking-system
platform: Codex
category: Security, forensics, and incident response
---

# building-adversary-infrastructure-tracking-system - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-adversary-infrastructure-tracking-system` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Adversary infrastructure tracking uses passive DNS records, certificate transparency logs, WHOIS registration data, and IP enrichment to discover, map, and monitor threat actor command-and-control (C2) networks. Attacker

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-adversary-infrastructure-tracking-system, then write the task. Fallback prompt: Use the building-adversary-infrastructure-tracking-system skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-adversary-infrastructure-tracking-system` |
| Canonical name | `building-adversary-infrastructure-tracking-system` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
