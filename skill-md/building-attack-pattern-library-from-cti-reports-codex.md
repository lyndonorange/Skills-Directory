...
display_name: building-attack-pattern-library-from-cti-reports
platform: Codex
category: Security, forensics, and incident response
---

# building-attack-pattern-library-from-cti-reports - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-attack-pattern-library-from-cti-reports` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Cyber threat intelligence (CTI) reports from vendors like Mandiant, CrowdStrike, Talos, and Microsoft contain detailed descriptions of adversary behaviors that can be extracted, normalized, and cataloged into a structure

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-attack-pattern-library-from-cti-reports, then write the task. Fallback prompt: Use the building-attack-pattern-library-from-cti-reports skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-attack-pattern-library-from-cti-reports` |
| Canonical name | `building-attack-pattern-library-from-cti-reports` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
