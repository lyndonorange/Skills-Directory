...
display_name: building-cloud-siem-with-sentinel
platform: Codex
category: Security, forensics, and incident response
---

# building-cloud-siem-with-sentinel - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-cloud-siem-with-sentinel` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose building-cloud-siem-with-sentinel, then write the task. Fallback prompt: Use the building-cloud-siem-with-sentinel skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-cloud-siem-with-sentinel` |
| Canonical name | `building-cloud-siem-with-sentinel` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
