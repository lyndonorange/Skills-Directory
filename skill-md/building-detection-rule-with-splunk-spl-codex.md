...
display_name: building-detection-rule-with-splunk-spl
platform: Codex
category: Security, forensics, and incident response
---

# building-detection-rule-with-splunk-spl - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-detection-rule-with-splunk-spl` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Splunk Search Processing Language (SPL) is the primary query language used in Splunk Enterprise Security for building correlation searches that detect suspicious events and patterns. A well-crafted detection rule aggrega

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-detection-rule-with-splunk-spl, then write the task. Fallback prompt: Use the building-detection-rule-with-splunk-spl skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-detection-rule-with-splunk-spl` |
| Canonical name | `building-detection-rule-with-splunk-spl` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
