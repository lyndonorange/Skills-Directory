...
# building-detection-rules-with-sigma - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-detection-rules-with-sigma` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose building-detection-rules-with-sigma, then write the task. Fallback prompt: Use the building-detection-rules-with-sigma skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-detection-rules-with-sigma` |
| Canonical name | `building-detection-rules-with-sigma` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
