...
display_name: building-devsecops-pipeline-with-gitlab-ci
platform: Codex
category: General and specialized workflows
---

# building-devsecops-pipeline-with-gitlab-ci - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-devsecops-pipeline-with-gitlab-ci` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

GitLab provides an integrated DevSecOps platform that embeds security testing directly into the CI/CD pipeline. By leveraging GitLab's built-in security scanners---SAST, DAST, container scanning, dependency scanning, sec

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-devsecops-pipeline-with-gitlab-ci, then write the task. Fallback prompt: Use the building-devsecops-pipeline-with-gitlab-ci skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-devsecops-pipeline-with-gitlab-ci` |
| Canonical name | `building-devsecops-pipeline-with-gitlab-ci` |
| Platform | `Codex` |
| Category | General and specialized workflows |
