...
display_name: building-identity-federation-with-saml-azure-ad
platform: Codex
category: General and specialized workflows
---

# building-identity-federation-with-saml-azure-ad - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-identity-federation-with-saml-azure-ad` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Identity federation enables users authenticated by one identity provider to access resources managed by another without maintaining separate credentials. This skill covers establishing SAML 2.0 federation between an orga

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-identity-federation-with-saml-azure-ad, then write the task. Fallback prompt: Use the building-identity-federation-with-saml-azure-ad skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-identity-federation-with-saml-azure-ad` |
| Canonical name | `building-identity-federation-with-saml-azure-ad` |
| Platform | `Codex` |
| Category | General and specialized workflows |
