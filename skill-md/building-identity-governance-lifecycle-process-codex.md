...
display_name: building-identity-governance-lifecycle-process
platform: Codex
category: General and specialized workflows
---

# building-identity-governance-lifecycle-process - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-identity-governance-lifecycle-process` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose building-identity-governance-lifecycle-process, then write the task. Fallback prompt: Use the building-identity-governance-lifecycle-process skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-identity-governance-lifecycle-process` |
| Canonical name | `building-identity-governance-lifecycle-process` |
| Platform | `Codex` |
| Category | General and specialized workflows |
