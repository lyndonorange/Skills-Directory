...
display_name: building-incident-response-dashboard
platform: Codex
category: Security, forensics, and incident response
---

# building-incident-response-dashboard - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-incident-response-dashboard` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose building-incident-response-dashboard, then write the task. Fallback prompt: Use the building-incident-response-dashboard skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-incident-response-dashboard` |
| Canonical name | `building-incident-response-dashboard` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
