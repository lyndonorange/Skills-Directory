...
display_name: building-incident-response-playbook
platform: Codex
category: Security, forensics, and incident response
---

# building-incident-response-playbook - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-incident-response-playbook` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose building-incident-response-playbook, then write the task. Fallback prompt: Use the building-incident-response-playbook skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-incident-response-playbook` |
| Canonical name | `building-incident-response-playbook` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
