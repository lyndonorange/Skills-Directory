...
# building-incident-timeline-with-timesketch - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-incident-timeline-with-timesketch` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Timesketch is an open-source collaborative forensic timeline analysis tool developed by Google that enables security teams to visualize and analyze chronological data from multiple sources during incident investigations.

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-incident-timeline-with-timesketch, then write the task. Fallback prompt: Use the building-incident-timeline-with-timesketch skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-incident-timeline-with-timesketch` |
| Canonical name | `building-incident-timeline-with-timesketch` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
