...
display_name: building-ioc-defanging-and-sharing-pipeline
platform: Codex
category: Security, forensics, and incident response
---

# building-ioc-defanging-and-sharing-pipeline - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-ioc-defanging-and-sharing-pipeline` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

IOC defanging modifies potentially malicious indicators (URLs, IP addresses, domains, email addresses) to prevent accidental clicks or execution while preserving readability for analysis and sharing. This skill covers bu

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-ioc-defanging-and-sharing-pipeline, then write the task. Fallback prompt: Use the building-ioc-defanging-and-sharing-pipeline skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-ioc-defanging-and-sharing-pipeline` |
| Canonical name | `building-ioc-defanging-and-sharing-pipeline` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
