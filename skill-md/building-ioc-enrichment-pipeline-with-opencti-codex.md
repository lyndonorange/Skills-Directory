...
display_name: building-ioc-enrichment-pipeline-with-opencti
platform: Codex
category: Security, forensics, and incident response
---

# building-ioc-enrichment-pipeline-with-opencti - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-ioc-enrichment-pipeline-with-opencti` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

OpenCTI is an open-source platform for managing cyber threat intelligence knowledge, built on STIX 2.1 as its native data model. This skill covers building an automated IOC enrichment pipeline using OpenCTI's connector e

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-ioc-enrichment-pipeline-with-opencti, then write the task. Fallback prompt: Use the building-ioc-enrichment-pipeline-with-opencti skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-ioc-enrichment-pipeline-with-opencti` |
| Canonical name | `building-ioc-enrichment-pipeline-with-opencti` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
