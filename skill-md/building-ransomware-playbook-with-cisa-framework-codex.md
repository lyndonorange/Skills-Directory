...
display_name: building-ransomware-playbook-with-cisa-framework
platform: Codex
category: Security, forensics, and incident response
---

# building-ransomware-playbook-with-cisa-framework - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-ransomware-playbook-with-cisa-framework` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose building-ransomware-playbook-with-cisa-framework, then write the task. Fallback prompt: Use the building-ransomware-playbook-with-cisa-framework skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-ransomware-playbook-with-cisa-framework` |
| Canonical name | `building-ransomware-playbook-with-cisa-framework` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
