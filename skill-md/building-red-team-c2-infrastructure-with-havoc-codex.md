...
display_name: building-red-team-c2-infrastructure-with-havoc
platform: Codex
category: Security, forensics, and incident response
---

# building-red-team-c2-infrastructure-with-havoc - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-red-team-c2-infrastructure-with-havoc` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Havoc is a modern, open-source post-exploitation command and control (C2) framework created by C5pider. It provides a collaborative multi-operator interface similar to Cobalt Strike, featuring the Demon agent for Windows

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-red-team-c2-infrastructure-with-havoc, then write the task. Fallback prompt: Use the building-red-team-c2-infrastructure-with-havoc skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-red-team-c2-infrastructure-with-havoc` |
| Canonical name | `building-red-team-c2-infrastructure-with-havoc` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
