...
display_name: building-role-mining-for-rbac-optimization
platform: Codex
category: General and specialized workflows
---

# building-role-mining-for-rbac-optimization - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-role-mining-for-rbac-optimization` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Role mining is the process of analyzing existing user-permission assignments to discover optimal roles for a Role-Based Access Control (RBAC) system. Organizations accumulate excessive permissions over time through job c

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-role-mining-for-rbac-optimization, then write the task. Fallback prompt: Use the building-role-mining-for-rbac-optimization skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-role-mining-for-rbac-optimization` |
| Canonical name | `building-role-mining-for-rbac-optimization` |
| Platform | `Codex` |
| Category | General and specialized workflows |
