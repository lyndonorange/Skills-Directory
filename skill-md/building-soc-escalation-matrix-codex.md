...
display_name: building-soc-escalation-matrix
platform: Codex
category: Security, forensics, and incident response
---

# building-soc-escalation-matrix - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-soc-escalation-matrix` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

A SOC escalation matrix defines how security incidents move through the organization based on severity, impact, and response requirements. Modern SOCs use context-driven escalation combining business risk, asset critical

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-soc-escalation-matrix, then write the task. Fallback prompt: Use the building-soc-escalation-matrix skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-soc-escalation-matrix` |
| Canonical name | `building-soc-escalation-matrix` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
