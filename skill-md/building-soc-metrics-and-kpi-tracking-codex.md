...
display_name: building-soc-metrics-and-kpi-tracking
platform: Codex
category: Security, forensics, and incident response
---

# building-soc-metrics-and-kpi-tracking - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-soc-metrics-and-kpi-tracking` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose building-soc-metrics-and-kpi-tracking, then write the task. Fallback prompt: Use the building-soc-metrics-and-kpi-tracking skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-soc-metrics-and-kpi-tracking` |
| Canonical name | `building-soc-metrics-and-kpi-tracking` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
