...
display_name: building-soc-playbook-for-ransomware
platform: Codex
category: Security, forensics, and incident response
---

# building-soc-playbook-for-ransomware - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-soc-playbook-for-ransomware` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose building-soc-playbook-for-ransomware, then write the task. Fallback prompt: Use the building-soc-playbook-for-ransomware skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-soc-playbook-for-ransomware` |
| Canonical name | `building-soc-playbook-for-ransomware` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
