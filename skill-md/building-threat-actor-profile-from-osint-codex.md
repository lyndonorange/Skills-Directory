...
display_name: building-threat-actor-profile-from-osint
platform: Codex
category: Security, forensics, and incident response
---

# building-threat-actor-profile-from-osint - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-threat-actor-profile-from-osint` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Threat actor profiling using OSINT systematically gathers and analyzes publicly available information to build comprehensive profiles of adversary groups. This skill covers collecting intelligence from public sources (se

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-threat-actor-profile-from-osint, then write the task. Fallback prompt: Use the building-threat-actor-profile-from-osint skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-threat-actor-profile-from-osint` |
| Canonical name | `building-threat-actor-profile-from-osint` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
