...
display_name: building-threat-feed-aggregation-with-misp
platform: Codex
category: Security, forensics, and incident response
---

# building-threat-feed-aggregation-with-misp - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-threat-feed-aggregation-with-misp` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

MISP is the leading open-source threat intelligence platform for collecting, storing, distributing, and sharing cybersecurity indicators and threat intelligence. It aggregates feeds from OSINT sources, commercial provide

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-threat-feed-aggregation-with-misp, then write the task. Fallback prompt: Use the building-threat-feed-aggregation-with-misp skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-threat-feed-aggregation-with-misp` |
| Canonical name | `building-threat-feed-aggregation-with-misp` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
