...
display_name: building-threat-hunt-hypothesis-framework
platform: Codex
category: Security, forensics, and incident response
---

# building-threat-hunt-hypothesis-framework - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-threat-hunt-hypothesis-framework` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose building-threat-hunt-hypothesis-framework, then write the task. Fallback prompt: Use the building-threat-hunt-hypothesis-framework skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-threat-hunt-hypothesis-framework` |
| Canonical name | `building-threat-hunt-hypothesis-framework` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
