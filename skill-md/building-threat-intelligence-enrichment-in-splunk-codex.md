...
display_name: building-threat-intelligence-enrichment-in-splunk
platform: Codex
category: Security, forensics, and incident response
---

# building-threat-intelligence-enrichment-in-splunk - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-threat-intelligence-enrichment-in-splunk` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Splunk's Threat Intelligence Framework in Enterprise Security enables SOC teams to automatically correlate indicators of compromise (IOCs) against security events. The framework ingests threat feeds, normalizes indicator

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-threat-intelligence-enrichment-in-splunk, then write the task. Fallback prompt: Use the building-threat-intelligence-enrichment-in-splunk skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-threat-intelligence-enrichment-in-splunk` |
| Canonical name | `building-threat-intelligence-enrichment-in-splunk` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
