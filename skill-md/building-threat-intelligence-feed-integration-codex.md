...
display_name: building-threat-intelligence-feed-integration
platform: Codex
category: Security, forensics, and incident response
---

# building-threat-intelligence-feed-integration - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-threat-intelligence-feed-integration` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose building-threat-intelligence-feed-integration, then write the task. Fallback prompt: Use the building-threat-intelligence-feed-integration skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-threat-intelligence-feed-integration` |
| Canonical name | `building-threat-intelligence-feed-integration` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
