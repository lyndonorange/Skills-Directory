...
display_name: building-threat-intelligence-platform
platform: Codex
category: Security, forensics, and incident response
---

# building-threat-intelligence-platform - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `building-threat-intelligence-platform` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Building a Threat Intelligence Platform (TIP) involves deploying and integrating multiple CTI tools into a unified system for collecting, analyzing, enriching, and disseminating threat intelligence. This skill covers des

## How To Use It In Codex

In Codex, click the chat box, press /, choose building-threat-intelligence-platform, then write the task. Fallback prompt: Use the building-threat-intelligence-platform skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `building-threat-intelligence-platform` |
| Canonical name | `building-threat-intelligence-platform` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
