...
# bulk-import - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bulk-import` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bulk-import, then write the task. Fallback prompt: Use the bulk-import skill to...
