---
name: pm-skills-business-model
display_name: business-model
platform: Codex
category: Business creation, ideas, and validation
---

# business-model - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `business-model` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose business-model, then write the task. Fallback prompt: Use the business-model skill to...
...
| Canonical name | `pm-skills-business-model` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
