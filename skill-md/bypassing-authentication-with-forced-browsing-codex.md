...
display_name: bypassing-authentication-with-forced-browsing
platform: Codex
category: Security, forensics, and incident response
---

# bypassing-authentication-with-forced-browsing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `bypassing-authentication-with-forced-browsing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose bypassing-authentication-with-forced-browsing, then write the task. Fallback prompt: Use the bypassing-authentication-with-forced-browsing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `bypassing-authentication-with-forced-browsing` |
| Canonical name | `bypassing-authentication-with-forced-browsing` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
