...
# canary - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `canary` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose canary, then write the task. Fallback prompt: Use the canary skill to...
