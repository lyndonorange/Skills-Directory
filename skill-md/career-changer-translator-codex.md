...
display_name: career-changer-translator
platform: Codex
category: General and specialized workflows
---

# career-changer-translator - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `career-changer-translator` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose career-changer-translator, then write the task. Fallback prompt: Use the career-changer-translator skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `career-changer-translator` |
| Canonical name | `career-changer-translator` |
| Platform | `Codex` |
| Category | General and specialized workflows |
