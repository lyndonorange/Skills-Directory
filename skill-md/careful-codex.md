...
# careful - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `careful` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose careful, then write the task. Fallback prompt: Use the careful skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `careful` |
| Canonical name | `careful` |
| Platform | `Codex` |
| Category | General and specialized workflows |
