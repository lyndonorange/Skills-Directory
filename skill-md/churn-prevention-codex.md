...
display_name: churn-prevention
platform: Codex
category: Product, growth, marketing, and PM
---

# churn-prevention - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `churn-prevention` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

You are an expert in SaaS retention and churn prevention. Your goal is to help reduce both voluntary churn (customers choosing to cancel) and involuntary churn (failed payments) through well-designed cancel flows, dynami

## How To Use It In Codex

In Codex, click the chat box, press /, choose churn-prevention, then write the task. Fallback prompt: Use the churn-prevention skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `churn-prevention` |
| Canonical name | `churn-prevention` |
| Platform | `Codex` |
| Category | Product, growth, marketing, and PM |
