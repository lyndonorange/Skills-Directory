...
# cli-compression - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `cli-compression` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose cli-compression, then write the task. Fallback prompt: Use the cli-compression skill to...
