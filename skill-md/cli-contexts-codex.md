...
# cli-contexts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `cli-contexts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose cli-contexts, then write the task. Fallback prompt: Use the cli-contexts skill to...
