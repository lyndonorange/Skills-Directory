---
name: cli-cost-usage
display_name: cli-cost-usage
platform: Codex
category: General and specialized workflows
---

# cli-cost-usage - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `cli-cost-usage` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose cli-cost-usage, then write the task. Fallback prompt: Use the cli-cost-usage skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `cli-cost-usage` |
| Canonical name | `cli-cost-usage` |
| Platform | `Codex` |
| Category | General and specialized workflows |
