...
# cli-mcp - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `cli-mcp` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose cli-mcp, then write the task. Fallback prompt: Use the cli-mcp skill to...
