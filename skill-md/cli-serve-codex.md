---
name: cli-serve
display_name: cli-serve
platform: Codex
category: General and specialized workflows
---

# cli-serve - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `cli-serve` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose cli-serve, then write the task. Fallback prompt: Use the cli-serve skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `cli-serve` |
| Canonical name | `cli-serve` |
| Platform | `Codex` |
| Category | General and specialized workflows |
