---
name: cli-setup
display_name: cli-setup
platform: Codex
category: General and specialized workflows
---

# cli-setup - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `cli-setup` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose cli-setup, then write the task. Fallback prompt: Use the cli-setup skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `cli-setup` |
| Canonical name | `cli-setup` |
| Platform | `Codex` |
| Category | General and specialized workflows |
