...
# cloud-k8s - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `cloud-k8s` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the cloud-k8s skill to...
