...
# cloud-k8s - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `cloud-k8s` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the cloud-k8s skill to...
