...
display_name: cloud-logging-configuration-basics
platform: Codex
category: General and specialized workflows
---

# cloud-logging-configuration-basics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `cloud-logging-configuration-basics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Configure single-project Google Cloud Logging: regional log buckets, log sinks, log views, restricting or hiding sensitive logs in the default view (_Default) filter, IAM permissions for views (Logs View Accessor, IAM co

## How To Use It In Codex

In Codex, click the chat box, press /, choose cloud-logging-configuration-basics, then write the task. Fallback prompt: Use the cloud-logging-configuration-basics skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `cloud-logging-configuration-basics` |
| Canonical name | `cloud-logging-configuration-basics` |
| Platform | `Codex` |
| Category | General and specialized workflows |
