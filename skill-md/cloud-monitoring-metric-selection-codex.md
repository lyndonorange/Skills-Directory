...
display_name: cloud-monitoring-metric-selection
platform: Codex
category: General and specialized workflows
---

# cloud-monitoring-metric-selection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `cloud-monitoring-metric-selection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Retrieve, query, and identify relevant Google Cloud Monitoring metric descriptors for a GCP service or resource (such as Compute Engine, Spanner, BigQuery, Cloud Run, Cloud SQL, Pub/Sub, Cloud Storage, etc.). Use when as

## How To Use It In Codex

In Codex, click the chat box, press /, choose cloud-monitoring-metric-selection, then write the task. Fallback prompt: Use the cloud-monitoring-metric-selection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `cloud-monitoring-metric-selection` |
| Canonical name | `cloud-monitoring-metric-selection` |
| Platform | `Codex` |
| Category | General and specialized workflows |
