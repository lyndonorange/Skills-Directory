...
display_name: cloud-run-basics
platform: Codex
category: General and specialized workflows
---

# cloud-run-basics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `cloud-run-basics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Manages Cloud Run services, jobs, and worker pools. Use when you need to deploy applications responding to HTTP requests (services), run event-triggered or scheduled tasks (jobs), or handle always-on pull-based backgroun

## How To Use It In Codex

In Codex, click the chat box, press /, choose cloud-run-basics, then write the task. Fallback prompt: Use the cloud-run-basics skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `cloud-run-basics` |
| Canonical name | `cloud-run-basics` |
| Platform | `Codex` |
| Category | General and specialized workflows |
