...
# cloud-sql-basics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `cloud-sql-basics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose cloud-sql-basics, then write the task. Fallback prompt: Use the cloud-sql-basics skill to...
