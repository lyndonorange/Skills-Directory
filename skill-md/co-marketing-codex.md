---
name: co-marketing
display_name: co-marketing
platform: Codex
category: Product, growth, marketing, and PM
---

# co-marketing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `co-marketing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose co-marketing, then write the task. Fallback prompt: Use the co-marketing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `co-marketing` |
| Canonical name | `co-marketing` |
| Platform | `Codex` |
| Category | Product, growth, marketing, and PM |
