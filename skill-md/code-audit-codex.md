...
# code-audit - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `code-audit` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose code-audit, then write the task. Fallback prompt: Use the code-audit skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `code-audit` |
| Canonical name | `code-audit` |
| Platform | `Codex` |
| Category | Software engineering and app building |
