...
# code-review-and-quality - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `code-review-and-quality` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the code-review-and-quality skill to...
