...
# cognitive-load-analyser - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `cognitive-load-analyser` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose cognitive-load-analyser, then write the task. Fallback prompt: Use the cognitive-load-analyser skill to...
