---
name: pm-skills-cohort-analysis
display_name: cohort-analysis
platform: Codex
category: Product analytics, experiments, and measurement
---

# cohort-analysis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `cohort-analysis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose cohort-analysis, then write the task. Fallback prompt: Use the cohort-analysis skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `cohort-analysis` |
| Canonical name | `pm-skills-cohort-analysis` |
| Platform | `Codex` |
| Category | Product analytics, experiments, and measurement |
