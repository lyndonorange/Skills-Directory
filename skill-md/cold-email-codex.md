...
# cold-email - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `cold-email` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose cold-email, then write the task. Fallback prompt: Use the cold-email skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `cold-email` |
| Canonical name | `cold-email` |
| Platform | `Codex` |
| Category | Product, growth, marketing, and PM |
