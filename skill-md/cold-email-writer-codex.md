...
display_name: cold-email-writer
platform: Codex
category: Product, growth, marketing, and PM
---

# cold-email-writer - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `cold-email-writer` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose cold-email-writer, then write the task. Fallback prompt: Use the cold-email-writer skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `cold-email-writer` |
| Canonical name | `cold-email-writer` |
| Platform | `Codex` |
| Category | Product, growth, marketing, and PM |
...
Draft only. Do not discover private contact details, scrape profiles, send email, schedule follow-ups, or claim outreach occurred. Use public professional contact channels or user-supplied addresses and require human review before sending.
