...
display_name: collecting-threat-intelligence-with-misp
platform: Codex
category: Security, forensics, and incident response
---

# collecting-threat-intelligence-with-misp - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `collecting-threat-intelligence-with-misp` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

MISP (Malware Information Sharing Platform) is an open-source threat intelligence platform for gathering, sharing, storing, and correlating Indicators of Compromise (IOCs) of targeted attacks, threat intelligence, financ

## How To Use It In Codex

In Codex, click the chat box, press /, choose collecting-threat-intelligence-with-misp, then write the task. Fallback prompt: Use the collecting-threat-intelligence-with-misp skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `collecting-threat-intelligence-with-misp` |
| Canonical name | `collecting-threat-intelligence-with-misp` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
