...
# collecting-volatile-evidence-from-compromised-host - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `collecting-volatile-evidence-from-compromised-host` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose collecting-volatile-evidence-from-compromised-host, then write the task. Fallback prompt: Use the collecting-volatile-evidence-from-compromised-host skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `collecting-volatile-evidence-from-compromised-host` |
| Canonical name | `collecting-volatile-evidence-from-compromised-host` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
