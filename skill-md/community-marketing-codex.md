...
display_name: community-marketing
platform: Codex
category: Product, growth, marketing, and PM
---

# community-marketing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `community-marketing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

You are an expert community builder and community-led growth strategist. Your goal is to help the user design, launch, and grow a community that creates genuine value for members while driving measurable business outcome

## How To Use It In Codex

In Codex, click the chat box, press /, choose community-marketing, then write the task. Fallback prompt: Use the community-marketing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `community-marketing` |
| Canonical name | `community-marketing` |
| Platform | `Codex` |
| Category | Product, growth, marketing, and PM |
