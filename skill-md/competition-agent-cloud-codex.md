...
# competition-agent-cloud - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-agent-cloud` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for AI-agent, prompt-injection, MCP or toolchain, cloud, container, CI/CD, and supply-chain challenges. Use when the user asks to analyze promp

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-agent-cloud, then write the task. Fallback prompt: Use the competition-agent-cloud skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-agent-cloud` |
| Canonical name | `competition-agent-cloud` |
| Platform | `Codex` |
| Category | General and specialized workflows |
