...
# competition-android-hooking - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-android-hooking` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for Android APK hooking, Frida tracing, request-signing recovery, SSL pinning bypass, JNI boundary inspection, and app trust-boundary analysis.

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-android-hooking, then write the task. Fallback prompt: Use the competition-android-hooking skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-android-hooking` |
| Canonical name | `competition-android-hooking` |
| Platform | `Codex` |
| Category | General and specialized workflows |
