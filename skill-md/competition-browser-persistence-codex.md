...
# competition-browser-persistence - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-browser-persistence` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for browser cookies, localStorage, sessionStorage, IndexedDB, Cache Storage, service workers, offline caches, and client-side session persisten

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-browser-persistence, then write the task. Fallback prompt: Use the competition-browser-persistence skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-browser-persistence` |
| Canonical name | `competition-browser-persistence` |
| Platform | `Codex` |
| Category | General and specialized workflows |
