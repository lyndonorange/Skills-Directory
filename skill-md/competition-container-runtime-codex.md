...
# competition-container-runtime - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-container-runtime` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for live container runtime analysis, mounted secrets, sidecars, namespaces, init containers, entrypoint drift, and route-to-container resolutio

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-container-runtime, then write the task. Fallback prompt: Use the competition-container-runtime skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-container-runtime` |
| Canonical name | `competition-container-runtime` |
| Platform | `Codex` |
| Category | General and specialized workflows |
