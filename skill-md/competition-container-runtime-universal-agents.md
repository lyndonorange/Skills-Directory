...
# competition-container-runtime - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-container-runtime` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the competition-container-runtime skill to...
