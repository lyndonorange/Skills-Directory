...
# competition-crypto-mobile - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-crypto-mobile` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for crypto, encoding, steganography, APK, IPA, and mobile trust-boundary challenges. Use when the user asks to decode a blob, recover a transfo

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-crypto-mobile, then write the task. Fallback prompt: Use the competition-crypto-mobile skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-crypto-mobile` |
| Canonical name | `competition-crypto-mobile` |
| Platform | `Codex` |
| Category | General and specialized workflows |
