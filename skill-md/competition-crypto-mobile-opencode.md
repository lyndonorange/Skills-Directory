...
# competition-crypto-mobile - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-crypto-mobile` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the competition-crypto-mobile skill to...
