...
# competition-custom-protocol-replay - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-custom-protocol-replay` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for custom binary or text protocol recovery, handshake reconstruction, framing, sequence control, checksums, stateful replay, and accepted-sess

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-custom-protocol-replay, then write the task. Fallback prompt: Use the competition-custom-protocol-replay skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-custom-protocol-replay` |
| Canonical name | `competition-custom-protocol-replay` |
| Platform | `Codex` |
| Category | General and specialized workflows |
