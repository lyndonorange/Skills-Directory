...
# competition-dpapi-credential-chain - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-dpapi-credential-chain` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for DPAPI masterkeys, vault blobs, browser credential stores, protected secrets, domain backup keys, and secret-to-acceptance replay chains. Us

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-dpapi-credential-chain, then write the task. Fallback prompt: Use the competition-dpapi-credential-chain skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-dpapi-credential-chain` |
| Canonical name | `competition-dpapi-credential-chain` |
| Platform | `Codex` |
| Category | General and specialized workflows |
