...
# competition-file-parser-chain - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-file-parser-chain` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for file uploads, imports, previews, archive extraction, format conversion, parser invocation, and deserialization chains. Use when the user as

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-file-parser-chain, then write the task. Fallback prompt: Use the competition-file-parser-chain skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-file-parser-chain` |
| Canonical name | `competition-file-parser-chain` |
| Platform | `Codex` |
| Category | General and specialized workflows |
