...
# competition-forensic-timeline - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-forensic-timeline` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for DFIR chronology, cross-artifact correlation, persistence chains, and incident timeline reconstruction. Use when the user asks to build a fo

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-forensic-timeline, then write the task. Fallback prompt: Use the competition-forensic-timeline skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-forensic-timeline` |
| Canonical name | `competition-forensic-timeline` |
| Platform | `Codex` |
| Category | General and specialized workflows |
