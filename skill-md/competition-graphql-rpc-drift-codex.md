...
# competition-graphql-rpc-drift - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-graphql-rpc-drift` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for GraphQL schemas, persisted queries, RPC manifests, generated clients, OpenAPI drift, hidden operations, and contract-to-handler mismatches.

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-graphql-rpc-drift, then write the task. Fallback prompt: Use the competition-graphql-rpc-drift skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-graphql-rpc-drift` |
| Canonical name | `competition-graphql-rpc-drift` |
| Platform | `Codex` |
| Category | General and specialized workflows |
