...
# competition-graphql-rpc-drift - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-graphql-rpc-drift` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the competition-graphql-rpc-drift skill to...
