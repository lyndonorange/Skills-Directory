...
# competition-identity-windows - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-identity-windows` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for Active Directory, Kerberos, LDAP, OAuth, enterprise messaging, Windows host forensics, credential material, and lateral-movement challenges

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-identity-windows, then write the task. Fallback prompt: Use the competition-identity-windows skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-identity-windows` |
| Canonical name | `competition-identity-windows` |
| Platform | `Codex` |
| Category | General and specialized workflows |
