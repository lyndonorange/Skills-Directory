...
# competition-ios-runtime - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-ios-runtime` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for IPA runtime analysis, Frida hooks, Objective-C or Swift method tracing, Keychain inspection, SSL pinning bypass, URL scheme handling, and i

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-ios-runtime, then write the task. Fallback prompt: Use the competition-ios-runtime skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-ios-runtime` |
| Canonical name | `competition-ios-runtime` |
| Platform | `Codex` |
| Category | General and specialized workflows |
