...
# competition-jwt-claim-confusion - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-jwt-claim-confusion` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for JWT, JWS, and JWE validation paths, header parsing, key selection, claim acceptance, audience and issuer checks, role derivation, and token

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-jwt-claim-confusion, then write the task. Fallback prompt: Use the competition-jwt-claim-confusion skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-jwt-claim-confusion` |
| Canonical name | `competition-jwt-claim-confusion` |
| Platform | `Codex` |
| Category | General and specialized workflows |
