...
# competition-k8s-control-plane - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-k8s-control-plane` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose competition-k8s-control-plane, then write the task. Fallback prompt: Use the competition-k8s-control-plane skill to...
