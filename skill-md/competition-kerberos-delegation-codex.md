...
# competition-kerberos-delegation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-kerberos-delegation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for Kerberos delegation, SPN trust edges, S4U abuse, RBCD, constrained or unconstrained delegation, and service-ticket acceptance. Use when the

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-kerberos-delegation, then write the task. Fallback prompt: Use the competition-kerberos-delegation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-kerberos-delegation` |
| Canonical name | `competition-kerberos-delegation` |
| Platform | `Codex` |
| Category | General and specialized workflows |
