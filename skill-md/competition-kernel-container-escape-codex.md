...
# competition-kernel-container-escape - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-kernel-container-escape` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for kernel attack surface, namespace and cgroup boundaries, container isolation assumptions, syscall paths, and escape primitive verification.

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-kernel-container-escape, then write the task. Fallback prompt: Use the competition-kernel-container-escape skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-kernel-container-escape` |
| Canonical name | `competition-kernel-container-escape` |
| Platform | `Codex` |
| Category | General and specialized workflows |
