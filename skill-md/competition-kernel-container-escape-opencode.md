...
# competition-kernel-container-escape - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-kernel-container-escape` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the competition-kernel-container-escape skill to...
