...
# competition-kernel-container-escape - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-kernel-container-escape` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the competition-kernel-container-escape skill to...
