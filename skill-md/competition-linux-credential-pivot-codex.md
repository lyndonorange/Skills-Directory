...
# competition-linux-credential-pivot - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-linux-credential-pivot` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for Linux credential artifacts, service tokens, SSH material, cloud and container secrets, socket-level trust, and host-to-host pivot chains. U

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-linux-credential-pivot, then write the task. Fallback prompt: Use the competition-linux-credential-pivot skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-linux-credential-pivot` |
| Canonical name | `competition-linux-credential-pivot` |
| Platform | `Codex` |
| Category | General and specialized workflows |
