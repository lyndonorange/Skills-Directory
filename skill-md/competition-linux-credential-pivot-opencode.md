...
# competition-linux-credential-pivot - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-linux-credential-pivot` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the competition-linux-credential-pivot skill to...
