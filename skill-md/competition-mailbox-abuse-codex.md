...
# competition-mailbox-abuse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-mailbox-abuse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for enterprise mail abuse, OAuth consent, inbox or forwarding rules, transport rules, shared mailbox access, phishing chains, and token-to-mail

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-mailbox-abuse, then write the task. Fallback prompt: Use the competition-mailbox-abuse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-mailbox-abuse` |
| Canonical name | `competition-mailbox-abuse` |
| Platform | `Codex` |
| Category | General and specialized workflows |
