...
# competition-oauth-oidc-chain - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-oauth-oidc-chain` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for OAuth, OIDC, redirect flows, state or nonce handling, PKCE, token exchange, refresh logic, claim mapping, and accepted login paths. Use whe

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-oauth-oidc-chain, then write the task. Fallback prompt: Use the competition-oauth-oidc-chain skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-oauth-oidc-chain` |
| Canonical name | `competition-oauth-oidc-chain` |
| Platform | `Codex` |
| Category | General and specialized workflows |
