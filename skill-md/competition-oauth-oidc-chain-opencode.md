...
# competition-oauth-oidc-chain - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-oauth-oidc-chain` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the competition-oauth-oidc-chain skill to...
