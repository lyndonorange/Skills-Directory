...
# competition-pcap-protocol - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-pcap-protocol` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for packet capture analysis, session reconstruction, application-protocol decoding, stream reassembly, beacon timing, and packet-to-process cor

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-pcap-protocol, then write the task. Fallback prompt: Use the competition-pcap-protocol skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-pcap-protocol` |
| Canonical name | `competition-pcap-protocol` |
| Platform | `Codex` |
| Category | General and specialized workflows |
