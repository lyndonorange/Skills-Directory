...
# competition-pcap-protocol - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-pcap-protocol` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the competition-pcap-protocol skill to...
