...
# competition-queue-worker-drift - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-queue-worker-drift` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for queues, async workers, cron jobs, delayed tasks, retry behavior, worker-only config drift, and payload-to-side-effect chains. Use when the

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-queue-worker-drift, then write the task. Fallback prompt: Use the competition-queue-worker-drift skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-queue-worker-drift` |
| Canonical name | `competition-queue-worker-drift` |
| Platform | `Codex` |
| Category | General and specialized workflows |
