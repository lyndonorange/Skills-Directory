...
# competition-race-condition-state-drift - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-race-condition-state-drift` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose competition-race-condition-state-drift, then write the task. Fallback prompt: Use the competition-race-condition-state-drift skill to...
