...
# competition-relay-coercion-chain - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-relay-coercion-chain` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for forced-auth coercion, relay chains, target selection, NTLM or related acceptance paths, and coercion-to-privilege transitions. Use when the

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-relay-coercion-chain, then write the task. Fallback prompt: Use the competition-relay-coercion-chain skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-relay-coercion-chain` |
| Canonical name | `competition-relay-coercion-chain` |
| Platform | `Codex` |
| Category | General and specialized workflows |
