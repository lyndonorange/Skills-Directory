...
display_name: competition-request-normalization-smuggling
platform: Codex
category: General and specialized workflows
---

# competition-request-normalization-smuggling - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-request-normalization-smuggling` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for parser differentials, HTTP normalization gaps, ambiguous headers, path decoding drift, transfer-framing mismatches, and request smuggling r

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-request-normalization-smuggling, then write the task. Fallback prompt: Use the competition-request-normalization-smuggling skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-request-normalization-smuggling` |
| Canonical name | `competition-request-normalization-smuggling` |
| Platform | `Codex` |
| Category | General and specialized workflows |
