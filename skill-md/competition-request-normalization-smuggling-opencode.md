...
# competition-request-normalization-smuggling - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-request-normalization-smuggling` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the competition-request-normalization-smuggling skill to...
