...
display_name: competition-runtime-routing
platform: Codex
category: General and specialized workflows
---

# competition-runtime-routing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-runtime-routing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for reverse proxies, Host headers, forwarded headers, vhost routing, websocket upgrades, path-prefix rewriting, base-URL derivation, and multi-

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-runtime-routing, then write the task. Fallback prompt: Use the competition-runtime-routing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-runtime-routing` |
| Canonical name | `competition-runtime-routing` |
| Platform | `Codex` |
| Category | General and specialized workflows |
