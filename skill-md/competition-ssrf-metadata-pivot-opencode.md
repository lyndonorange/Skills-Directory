...
# competition-ssrf-metadata-pivot - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-ssrf-metadata-pivot` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the competition-ssrf-metadata-pivot skill to...
