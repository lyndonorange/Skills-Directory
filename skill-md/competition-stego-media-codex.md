...
display_name: competition-stego-media
platform: Codex
category: General and specialized workflows
---

# competition-stego-media - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-stego-media` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for image, audio, video, document, and container steganography. Use when the user asks to inspect metadata, alpha or palette channels, LSBs, th

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-stego-media, then write the task. Fallback prompt: Use the competition-stego-media skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-stego-media` |
| Canonical name | `competition-stego-media` |
| Platform | `Codex` |
| Category | General and specialized workflows |
