...
# competition-supply-chain - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-supply-chain` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose competition-supply-chain, then write the task. Fallback prompt: Use the competition-supply-chain skill to...
