...
display_name: competition-template-render-path
platform: Codex
category: General and specialized workflows
---

# competition-template-render-path - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-template-render-path` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for SSR, template rendering, route loaders, hydration payloads, server-client render boundaries, and template-to-handler enforcement gaps. Use

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-template-render-path, then write the task. Fallback prompt: Use the competition-template-render-path skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-template-render-path` |
| Canonical name | `competition-template-render-path` |
| Platform | `Codex` |
| Category | General and specialized workflows |
