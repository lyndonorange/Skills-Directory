...
display_name: competition-websocket-runtime
platform: Codex
category: General and specialized workflows
---

# competition-websocket-runtime - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competition-websocket-runtime` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Internal downstream skill for ctf-sandbox-orchestrator. CTF-sandbox workflow for WebSocket and SSE handshakes, auth material, subscription state, realtime message schemas, reconnect behavior, and frame-driven runtime eff

## How To Use It In Codex

In Codex, click the chat box, press /, choose competition-websocket-runtime, then write the task. Fallback prompt: Use the competition-websocket-runtime skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competition-websocket-runtime` |
| Canonical name | `competition-websocket-runtime` |
| Platform | `Codex` |
| Category | General and specialized workflows |
