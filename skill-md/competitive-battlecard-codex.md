---
name: pm-skills-competitive-battlecard
display_name: competitive-battlecard
platform: Codex
category: Business creation, ideas, and validation
---

# competitive-battlecard - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `competitive-battlecard` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose competitive-battlecard, then write the task. Fallback prompt: Use the competitive-battlecard skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `competitive-battlecard` |
| Canonical name | `pm-skills-competitive-battlecard` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
