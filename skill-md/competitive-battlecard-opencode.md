...
# competitive-battlecard - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `competitive-battlecard` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the competitive-battlecard skill to...
