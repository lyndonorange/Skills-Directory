...
# composio-cli - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `composio-cli` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose composio-cli, then write the task. Fallback prompt: Use the composio-cli skill to...
