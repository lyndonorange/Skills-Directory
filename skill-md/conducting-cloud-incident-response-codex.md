...
display_name: conducting-cloud-incident-response
platform: Codex
category: Security, forensics, and incident response
---

# conducting-cloud-incident-response - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `conducting-cloud-incident-response` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose conducting-cloud-incident-response, then write the task. Fallback prompt: Use the conducting-cloud-incident-response skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `conducting-cloud-incident-response` |
| Canonical name | `conducting-cloud-incident-response` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
