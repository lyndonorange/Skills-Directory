...
display_name: conducting-cloud-penetration-testing
platform: Codex
category: Security, forensics, and incident response
---

# conducting-cloud-penetration-testing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `conducting-cloud-penetration-testing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose conducting-cloud-penetration-testing, then write the task. Fallback prompt: Use the conducting-cloud-penetration-testing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `conducting-cloud-penetration-testing` |
| Canonical name | `conducting-cloud-penetration-testing` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
