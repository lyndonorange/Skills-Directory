...
display_name: conducting-domain-persistence-with-dcsync
platform: Codex
category: Security, forensics, and incident response
---

# conducting-domain-persistence-with-dcsync - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `conducting-domain-persistence-with-dcsync` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose conducting-domain-persistence-with-dcsync, then write the task. Fallback prompt: Use the conducting-domain-persistence-with-dcsync skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `conducting-domain-persistence-with-dcsync` |
| Canonical name | `conducting-domain-persistence-with-dcsync` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
