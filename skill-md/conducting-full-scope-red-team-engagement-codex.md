...
display_name: conducting-full-scope-red-team-engagement
platform: Codex
category: Security, forensics, and incident response
---

# conducting-full-scope-red-team-engagement - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `conducting-full-scope-red-team-engagement` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

A full-scope red team engagement simulates real-world adversary behavior across all phases of the cyber kill chain — from initial reconnaissance through data exfiltration — to evaluate an organization's detection, preven

## How To Use It In Codex

In Codex, click the chat box, press /, choose conducting-full-scope-red-team-engagement, then write the task. Fallback prompt: Use the conducting-full-scope-red-team-engagement skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `conducting-full-scope-red-team-engagement` |
| Canonical name | `conducting-full-scope-red-team-engagement` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
