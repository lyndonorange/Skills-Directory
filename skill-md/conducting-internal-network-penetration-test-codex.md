...
display_name: conducting-internal-network-penetration-test
platform: Codex
category: Security, forensics, and incident response
---

# conducting-internal-network-penetration-test - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `conducting-internal-network-penetration-test` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

An internal network penetration test simulates an attacker who has already gained access to the internal network or a malicious insider. The tester operates from an "assumed breach" position — typically a standard domain

## How To Use It In Codex

In Codex, click the chat box, press /, choose conducting-internal-network-penetration-test, then write the task. Fallback prompt: Use the conducting-internal-network-penetration-test skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `conducting-internal-network-penetration-test` |
| Canonical name | `conducting-internal-network-penetration-test` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
