...
display_name: conducting-man-in-the-middle-attack-simulation
platform: Codex
category: Security, forensics, and incident response
---

# conducting-man-in-the-middle-attack-simulation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `conducting-man-in-the-middle-attack-simulation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose conducting-man-in-the-middle-attack-simulation, then write the task. Fallback prompt: Use the conducting-man-in-the-middle-attack-simulation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `conducting-man-in-the-middle-attack-simulation` |
| Canonical name | `conducting-man-in-the-middle-attack-simulation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
