...
display_name: conducting-pass-the-ticket-attack
platform: Codex
category: Security, forensics, and incident response
---

# conducting-pass-the-ticket-attack - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `conducting-pass-the-ticket-attack` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose conducting-pass-the-ticket-attack, then write the task. Fallback prompt: Use the conducting-pass-the-ticket-attack skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `conducting-pass-the-ticket-attack` |
| Canonical name | `conducting-pass-the-ticket-attack` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
