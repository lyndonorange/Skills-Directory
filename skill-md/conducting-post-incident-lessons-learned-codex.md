...
display_name: conducting-post-incident-lessons-learned
platform: Codex
category: Security, forensics, and incident response
---

# conducting-post-incident-lessons-learned - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `conducting-post-incident-lessons-learned` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose conducting-post-incident-lessons-learned, then write the task. Fallback prompt: Use the conducting-post-incident-lessons-learned skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `conducting-post-incident-lessons-learned` |
| Canonical name | `conducting-post-incident-lessons-learned` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
