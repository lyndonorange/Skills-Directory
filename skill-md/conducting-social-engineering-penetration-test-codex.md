...
display_name: conducting-social-engineering-penetration-test
platform: Codex
category: Security, forensics, and incident response
---

# conducting-social-engineering-penetration-test - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `conducting-social-engineering-penetration-test` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Social engineering penetration testing assesses an organization's human attack surface through controlled simulation of real-world deception techniques. According to Verizon DBIR 2024, the human element is involved in ap

## How To Use It In Codex

In Codex, click the chat box, press /, choose conducting-social-engineering-penetration-test, then write the task. Fallback prompt: Use the conducting-social-engineering-penetration-test skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `conducting-social-engineering-penetration-test` |
| Canonical name | `conducting-social-engineering-penetration-test` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
