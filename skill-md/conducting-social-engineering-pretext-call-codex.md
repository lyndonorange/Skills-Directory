...
display_name: conducting-social-engineering-pretext-call
platform: Codex
category: Security, forensics, and incident response
---

# conducting-social-engineering-pretext-call - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `conducting-social-engineering-pretext-call` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

A pretext call (vishing) is a social engineering technique where an attacker impersonates a trusted authority figure over the phone to manipulate targets into divulging sensitive information, performing actions, or grant

## How To Use It In Codex

In Codex, click the chat box, press /, choose conducting-social-engineering-pretext-call, then write the task. Fallback prompt: Use the conducting-social-engineering-pretext-call skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `conducting-social-engineering-pretext-call` |
| Canonical name | `conducting-social-engineering-pretext-call` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
