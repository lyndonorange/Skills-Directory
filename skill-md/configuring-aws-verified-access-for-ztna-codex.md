...
display_name: configuring-aws-verified-access-for-ztna
platform: Codex
category: General and specialized workflows
---

# configuring-aws-verified-access-for-ztna - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `configuring-aws-verified-access-for-ztna` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

AWS Verified Access is a Zero Trust Network Access (ZTNA) service that provides secure, VPN-less access to corporate applications hosted in AWS. It evaluates each access request in real-time against granular conditional 

## How To Use It In Codex

In Codex, click the chat box, press /, choose configuring-aws-verified-access-for-ztna, then write the task. Fallback prompt: Use the configuring-aws-verified-access-for-ztna skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `configuring-aws-verified-access-for-ztna` |
| Canonical name | `configuring-aws-verified-access-for-ztna` |
| Platform | `Codex` |
| Category | General and specialized workflows |
