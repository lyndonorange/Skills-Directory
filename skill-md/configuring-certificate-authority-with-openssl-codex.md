...
display_name: configuring-certificate-authority-with-openssl
platform: Codex
category: General and specialized workflows
---

# configuring-certificate-authority-with-openssl - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `configuring-certificate-authority-with-openssl` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

A Certificate Authority (CA) is the trust anchor in a PKI hierarchy, responsible for issuing, signing, and revoking digital certificates. This skill covers building a two-tier CA hierarchy (Root CA + Intermediate CA) usi

## How To Use It In Codex

In Codex, click the chat box, press /, choose configuring-certificate-authority-with-openssl, then write the task. Fallback prompt: Use the configuring-certificate-authority-with-openssl skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `configuring-certificate-authority-with-openssl` |
| Canonical name | `configuring-certificate-authority-with-openssl` |
| Platform | `Codex` |
| Category | General and specialized workflows |
