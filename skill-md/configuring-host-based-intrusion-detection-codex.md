...
display_name: configuring-host-based-intrusion-detection
platform: Codex
category: General and specialized workflows
---

# configuring-host-based-intrusion-detection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `configuring-host-based-intrusion-detection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose configuring-host-based-intrusion-detection, then write the task. Fallback prompt: Use the configuring-host-based-intrusion-detection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `configuring-host-based-intrusion-detection` |
| Canonical name | `configuring-host-based-intrusion-detection` |
| Platform | `Codex` |
| Category | General and specialized workflows |
