...
display_name: configuring-identity-aware-proxy-with-google-iap
platform: Codex
category: General and specialized workflows
---

# configuring-identity-aware-proxy-with-google-iap - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `configuring-identity-aware-proxy-with-google-iap` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose configuring-identity-aware-proxy-with-google-iap, then write the task. Fallback prompt: Use the configuring-identity-aware-proxy-with-google-iap skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `configuring-identity-aware-proxy-with-google-iap` |
| Canonical name | `configuring-identity-aware-proxy-with-google-iap` |
| Platform | `Codex` |
| Category | General and specialized workflows |
