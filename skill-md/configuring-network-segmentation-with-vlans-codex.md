...
display_name: configuring-network-segmentation-with-vlans
platform: Codex
category: General and specialized workflows
---

# configuring-network-segmentation-with-vlans - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `configuring-network-segmentation-with-vlans` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose configuring-network-segmentation-with-vlans, then write the task. Fallback prompt: Use the configuring-network-segmentation-with-vlans skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `configuring-network-segmentation-with-vlans` |
| Canonical name | `configuring-network-segmentation-with-vlans` |
| Platform | `Codex` |
| Category | General and specialized workflows |
