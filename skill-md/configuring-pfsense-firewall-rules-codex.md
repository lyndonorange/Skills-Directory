...
display_name: configuring-pfsense-firewall-rules
platform: Codex
category: General and specialized workflows
---

# configuring-pfsense-firewall-rules - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `configuring-pfsense-firewall-rules` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose configuring-pfsense-firewall-rules, then write the task. Fallback prompt: Use the configuring-pfsense-firewall-rules skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `configuring-pfsense-firewall-rules` |
| Canonical name | `configuring-pfsense-firewall-rules` |
| Platform | `Codex` |
| Category | General and specialized workflows |
