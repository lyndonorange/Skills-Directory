...
display_name: configuring-snort-ids-for-intrusion-detection
platform: Codex
category: General and specialized workflows
---

# configuring-snort-ids-for-intrusion-detection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `configuring-snort-ids-for-intrusion-detection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose configuring-snort-ids-for-intrusion-detection, then write the task. Fallback prompt: Use the configuring-snort-ids-for-intrusion-detection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `configuring-snort-ids-for-intrusion-detection` |
| Canonical name | `configuring-snort-ids-for-intrusion-detection` |
| Platform | `Codex` |
| Category | General and specialized workflows |
