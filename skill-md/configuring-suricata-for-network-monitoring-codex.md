...
display_name: configuring-suricata-for-network-monitoring
platform: Codex
category: General and specialized workflows
---

# configuring-suricata-for-network-monitoring - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `configuring-suricata-for-network-monitoring` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose configuring-suricata-for-network-monitoring, then write the task. Fallback prompt: Use the configuring-suricata-for-network-monitoring skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `configuring-suricata-for-network-monitoring` |
| Canonical name | `configuring-suricata-for-network-monitoring` |
| Platform | `Codex` |
| Category | General and specialized workflows |
