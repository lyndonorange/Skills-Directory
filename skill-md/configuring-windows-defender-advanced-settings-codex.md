...
display_name: configuring-windows-defender-advanced-settings
platform: Codex
category: General and specialized workflows
---

# configuring-windows-defender-advanced-settings - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `configuring-windows-defender-advanced-settings` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose configuring-windows-defender-advanced-settings, then write the task. Fallback prompt: Use the configuring-windows-defender-advanced-settings skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `configuring-windows-defender-advanced-settings` |
| Canonical name | `configuring-windows-defender-advanced-settings` |
| Platform | `Codex` |
| Category | General and specialized workflows |
