...
display_name: configuring-windows-event-logging-for-detection
platform: Codex
category: General and specialized workflows
---

# configuring-windows-event-logging-for-detection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `configuring-windows-event-logging-for-detection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose configuring-windows-event-logging-for-detection, then write the task. Fallback prompt: Use the configuring-windows-event-logging-for-detection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `configuring-windows-event-logging-for-detection` |
| Canonical name | `configuring-windows-event-logging-for-detection` |
| Platform | `Codex` |
| Category | General and specialized workflows |
