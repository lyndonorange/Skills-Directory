...
display_name: configuring-zscaler-private-access-for-ztna
platform: Codex
category: General and specialized workflows
---

# configuring-zscaler-private-access-for-ztna - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `configuring-zscaler-private-access-for-ztna` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose configuring-zscaler-private-access-for-ztna, then write the task. Fallback prompt: Use the configuring-zscaler-private-access-for-ztna skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `configuring-zscaler-private-access-for-ztna` |
| Canonical name | `configuring-zscaler-private-access-for-ztna` |
| Platform | `Codex` |
| Category | General and specialized workflows |
