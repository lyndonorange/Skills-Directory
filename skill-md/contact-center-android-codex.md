...
display_name: contact-center/android
platform: Codex
category: General and specialized workflows
---

# contact-center/android - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `contact-center/android` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose contact-center/android, then write the task. Fallback prompt: Use the contact-center/android skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `contact-center/android` |
| Canonical name | `contact-center/android` |
| Platform | `Codex` |
| Category | General and specialized workflows |
