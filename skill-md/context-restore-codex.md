...
display_name: context-restore
platform: Codex
category: General and specialized workflows
---

# context-restore - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `context-restore` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose context-restore, then write the task. Fallback prompt: Use the context-restore skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `context-restore` |
| Canonical name | `context-restore` |
| Platform | `Codex` |
| Category | General and specialized workflows |
