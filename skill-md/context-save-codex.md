---
name: context-save
display_name: context-save
platform: Codex
category: General and specialized workflows
---

# context-save - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `context-save` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose context-save, then write the task. Fallback prompt: Use the context-save skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `context-save` |
| Canonical name | `context-save` |
| Platform | `Codex` |
| Category | General and specialized workflows |
