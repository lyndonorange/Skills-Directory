...
# context7-mcp - Local Project Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `context7-mcp` for Local Project Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
From this workspace, type: Use the context7-mcp skill to...
