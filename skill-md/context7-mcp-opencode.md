...
# context7-mcp - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `context7-mcp` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the context7-mcp skill to...
