...
# convex-master - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `convex-master` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose convex-master, then write the task. Fallback prompt: Use the convex-master skill to...
