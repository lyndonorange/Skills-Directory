...
# copy-editing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `copy-editing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose copy-editing, then write the task. Fallback prompt: Use the copy-editing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `copy-editing` |
| Canonical name | `copy-editing` |
| Platform | `Codex` |
| Category | General and specialized workflows |
