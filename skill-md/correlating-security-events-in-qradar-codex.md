...
display_name: correlating-security-events-in-qradar
platform: Codex
category: General and specialized workflows
---

# correlating-security-events-in-qradar - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `correlating-security-events-in-qradar` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose correlating-security-events-in-qradar, then write the task. Fallback prompt: Use the correlating-security-events-in-qradar skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `correlating-security-events-in-qradar` |
| Canonical name | `correlating-security-events-in-qradar` |
| Platform | `Codex` |
| Category | General and specialized workflows |
