...
# Council - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `Council` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Multi-agent collaborative debate producing visible round-by-round transcripts with real intellectual friction. Members custom-composed via ComposeAgent with domain expertise tailored to the topic — never generic. Workflo

## How To Use It In Codex

In Codex, click the chat box, press /, choose Council, then write the task. Fallback prompt: Use the Council skill to...
