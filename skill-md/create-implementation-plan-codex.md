...
# create-implementation-plan - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `create-implementation-plan` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose create-implementation-plan, then write the task. Fallback prompt: Use the create-implementation-plan skill to...
