...
# create-implementation-plan - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `create-implementation-plan` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the create-implementation-plan skill to...
