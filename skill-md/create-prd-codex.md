---
name: pm-skills-create-prd
display_name: create-prd
platform: Codex
category: Product delivery, planning, and execution
---

# create-prd - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `create-prd` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose create-prd, then write the task. Fallback prompt: Use the create-prd skill to...
...
| Canonical name | `pm-skills-create-prd` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
