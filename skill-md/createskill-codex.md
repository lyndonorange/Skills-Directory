...
# CreateSkill - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `CreateSkill` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

MANDATORY for ALL skill work — you MUST invoke this skill BEFORE creating, modifying, adding a workflow/tool to, renaming, validating, or canonicalizing ANY skill. Handrolling skill files (writing SKILL.md or Workflows/T

## How To Use It In Codex

In Codex, click the chat box, press /, choose CreateSkill, then write the task. Fallback prompt: Use the CreateSkill skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `CreateSkill` |
| Canonical name | `CreateSkill` |
| Platform | `Codex` |
| Category | General and specialized workflows |
