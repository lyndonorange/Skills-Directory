...
display_name: creative-portfolio-resume
platform: Codex
category: Design, creative, and media
---

# creative-portfolio-resume - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `creative-portfolio-resume` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose creative-portfolio-resume, then write the task. Fallback prompt: Use the creative-portfolio-resume skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `creative-portfolio-resume` |
| Canonical name | `creative-portfolio-resume` |
| Platform | `Codex` |
| Category | Design, creative, and media |
