...
# css-animations - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `css-animations` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose css-animations, then write the task. Fallback prompt: Use the css-animations skill to...
