...
display_name: ctf-sandbox-orchestrator
platform: Codex
category: General and specialized workflows
---

# ctf-sandbox-orchestrator - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ctf-sandbox-orchestrator` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Default entrypoint and master ctf-sandbox-orchestrator workflow for CTF, exploit, reverse engineering, DFIR, pwnable, crypto, stego, mobile, AI-agent, cloud, container, Active Directory, Windows-host, and identity challe

## How To Use It In Codex

In Codex, click the chat box, press /, choose ctf-sandbox-orchestrator, then write the task. Fallback prompt: Use the ctf-sandbox-orchestrator skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `ctf-sandbox-orchestrator` |
| Canonical name | `ctf-sandbox-orchestrator` |
| Platform | `Codex` |
| Category | General and specialized workflows |
