---
name: pm-skills-customer-journey-map
display_name: customer-journey-map
platform: Codex
category: Business creation, ideas, and validation
---

# customer-journey-map - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `customer-journey-map` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose customer-journey-map, then write the task. Fallback prompt: Use the customer-journey-map skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `customer-journey-map` |
| Canonical name | `pm-skills-customer-journey-map` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
