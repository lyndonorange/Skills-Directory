...
# data-manager-api-audience-ingestion - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `data-manager-api-audience-ingestion` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the data-manager-api-audience-ingestion skill to...
