...
# data-manager-api-audience-ingestion - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `data-manager-api-audience-ingestion` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the data-manager-api-audience-ingestion skill to...
