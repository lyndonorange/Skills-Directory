...
# data-manager-api-setup - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `data-manager-api-setup` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose data-manager-api-setup, then write the task. Fallback prompt: Use the data-manager-api-setup skill to...
