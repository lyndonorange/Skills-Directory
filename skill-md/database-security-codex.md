...
# database-security - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `database-security` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose database-security, then write the task. Fallback prompt: Use the database-security skill to...
