...
# datalineage-bigquery-asset-impact-analysis - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `datalineage-bigquery-asset-impact-analysis` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the datalineage-bigquery-asset-impact-analysis skill to...
