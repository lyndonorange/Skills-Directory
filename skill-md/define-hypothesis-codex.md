---
name: pm-skills-define-hypothesis
display_name: define-hypothesis
platform: Codex
category: Business creation, ideas, and validation
---

# define-hypothesis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `define-hypothesis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

A hypothesis is a testable prediction about how a change will affect user behavior or business outcomes. It transforms assumptions into explicit statements that can be validated or invalidated through experimentation. We

## How To Use It In Codex

In Codex, click the chat box, press /, choose define-hypothesis, then write the task. Fallback prompt: Use the define-hypothesis skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `define-hypothesis` |
| Canonical name | `pm-skills-define-hypothesis` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
