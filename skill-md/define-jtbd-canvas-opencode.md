...
# define-jtbd-canvas - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `define-jtbd-canvas` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the define-jtbd-canvas skill to...
