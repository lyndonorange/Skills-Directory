---
name: pm-skills-define-problem-statement
display_name: define-problem-statement
platform: Codex
category: Business creation, ideas, and validation
---

# define-problem-statement - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `define-problem-statement` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

A problem statement is a concise document that frames the problem you're solving, articulates the impact on users and the business, and defines clear success criteria. It serves as the foundation for all subsequent produ

## How To Use It In Codex

In Codex, click the chat box, press /, choose define-problem-statement, then write the task. Fallback prompt: Use the define-problem-statement skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `define-problem-statement` |
| Canonical name | `pm-skills-define-problem-statement` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
