...
# define-problem-statement - Zed Skill Package

## What This Is

This is a friend-safe Markdown copy of `define-problem-statement` for Zed. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Zed, open the Agent panel and type: Use the define-problem-statement skill to...
