...
# Delegation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `Delegation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Parallelize work via six patterns: built-in agents (Algorithm/Explore/Plan/general-purpose via Task), worktree-isolated agents (conflict-free parallel edits), background agents (run_in_background, non-blocking), custom a

## How To Use It In Codex

In Codex, click the chat box, press /, choose Delegation, then write the task. Fallback prompt: Use the Delegation skill to...
