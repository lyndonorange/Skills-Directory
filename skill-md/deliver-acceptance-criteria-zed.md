...
# deliver-acceptance-criteria - Zed Skill Package

## What This Is

This is a friend-safe Markdown copy of `deliver-acceptance-criteria` for Zed. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Zed, open the Agent panel and type: Use the deliver-acceptance-criteria skill to...
