---
name: pm-skills-deliver-edge-cases
display_name: deliver-edge-cases
platform: Codex
category: Product delivery, planning, and execution
---

# deliver-edge-cases - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `deliver-edge-cases` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

An edge cases document systematically catalogs the unusual, boundary, and error scenarios for a feature. While happy-path flows are typically well-specified, edge cases often get discovered in production . causing bugs, 

## How To Use It In Codex

In Codex, click the chat box, press /, choose deliver-edge-cases, then write the task. Fallback prompt: Use the deliver-edge-cases skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `deliver-edge-cases` |
| Canonical name | `pm-skills-deliver-edge-cases` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
