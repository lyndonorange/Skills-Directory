---
name: pm-skills-deliver-launch-checklist
display_name: deliver-launch-checklist
platform: Codex
category: Product delivery, planning, and execution
---

# deliver-launch-checklist - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `deliver-launch-checklist` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

A launch checklist is a comprehensive verification document that ensures all functions are ready before releasing a feature or product. It coordinates across engineering, QA, design, marketing, support, legal, and operat

## How To Use It In Codex

In Codex, click the chat box, press /, choose deliver-launch-checklist, then write the task. Fallback prompt: Use the deliver-launch-checklist skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `deliver-launch-checklist` |
| Canonical name | `pm-skills-deliver-launch-checklist` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
