...
# deliver-launch-checklist - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `deliver-launch-checklist` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the deliver-launch-checklist skill to...
