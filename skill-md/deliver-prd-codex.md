---
name: pm-skills-deliver-prd
display_name: deliver-prd
platform: Codex
category: Product delivery, planning, and execution
---

# deliver-prd - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `deliver-prd` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose deliver-prd, then write the task. Fallback prompt: Use the deliver-prd skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `deliver-prd` |
| Canonical name | `pm-skills-deliver-prd` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
