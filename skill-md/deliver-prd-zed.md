...
# deliver-prd - Zed Skill Package

## What This Is

This is a friend-safe Markdown copy of `deliver-prd` for Zed. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Zed, open the Agent panel and type: Use the deliver-prd skill to...
