---
name: pm-skills-deliver-release-notes
display_name: deliver-release-notes
platform: Codex
category: Product delivery, planning, and execution
---

# deliver-release-notes - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `deliver-release-notes` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Release notes communicate product changes to users in a way that highlights value and builds excitement. Unlike changelogs (which document what changed technically), release notes translate changes into user benefits. Go

## How To Use It In Codex

In Codex, click the chat box, press /, choose deliver-release-notes, then write the task. Fallback prompt: Use the deliver-release-notes skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `deliver-release-notes` |
| Canonical name | `pm-skills-deliver-release-notes` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
