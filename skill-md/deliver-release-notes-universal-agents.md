...
# deliver-release-notes - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `deliver-release-notes` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the deliver-release-notes skill to...
