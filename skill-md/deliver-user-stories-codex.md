---
name: pm-skills-deliver-user-stories
display_name: deliver-user-stories
platform: Codex
category: Product delivery, planning, and execution
---

# deliver-user-stories - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `deliver-user-stories` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

User stories are concise descriptions of functionality from the user's perspective. They capture who needs something, what they need, and why . without prescribing how to build it. Good user stories enable teams to break

## How To Use It In Codex

In Codex, click the chat box, press /, choose deliver-user-stories, then write the task. Fallback prompt: Use the deliver-user-stories skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `deliver-user-stories` |
| Canonical name | `pm-skills-deliver-user-stories` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
