...
# deliver-user-stories - Zed Skill Package

## What This Is

This is a friend-safe Markdown copy of `deliver-user-stories` for Zed. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Zed, open the Agent panel and type: Use the deliver-user-stories skill to...
