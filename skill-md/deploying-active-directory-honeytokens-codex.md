...
display_name: deploying-active-directory-honeytokens
platform: Codex
category: General and specialized workflows
---

# deploying-active-directory-honeytokens - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `deploying-active-directory-honeytokens` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose deploying-active-directory-honeytokens, then write the task. Fallback prompt: Use the deploying-active-directory-honeytokens skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `deploying-active-directory-honeytokens` |
| Canonical name | `deploying-active-directory-honeytokens` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
- SpecterOps - Kerberoasting and AES-256: https://specterops.io/blog/2025/10/21/is-kerberoasting-still-a-ri[redacted-token]/
