...
display_name: deploying-cloudflare-access-for-zero-trust
platform: Codex
category: General and specialized workflows
---

# deploying-cloudflare-access-for-zero-trust - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `deploying-cloudflare-access-for-zero-trust` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose deploying-cloudflare-access-for-zero-trust, then write the task. Fallback prompt: Use the deploying-cloudflare-access-for-zero-trust skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `deploying-cloudflare-access-for-zero-trust` |
| Canonical name | `deploying-cloudflare-access-for-zero-trust` |
| Platform | `Codex` |
| Category | General and specialized workflows |
