...
display_name: deploying-decoy-files-for-ransomware-detection
platform: Codex
category: General and specialized workflows
---

# deploying-decoy-files-for-ransomware-detection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `deploying-decoy-files-for-ransomware-detection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose deploying-decoy-files-for-ransomware-detection, then write the task. Fallback prompt: Use the deploying-decoy-files-for-ransomware-detection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `deploying-decoy-files-for-ransomware-detection` |
| Canonical name | `deploying-decoy-files-for-ransomware-detection` |
| Platform | `Codex` |
| Category | General and specialized workflows |
