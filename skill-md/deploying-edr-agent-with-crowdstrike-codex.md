...
display_name: deploying-edr-agent-with-crowdstrike
platform: Codex
category: General and specialized workflows
---

# deploying-edr-agent-with-crowdstrike - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `deploying-edr-agent-with-crowdstrike` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose deploying-edr-agent-with-crowdstrike, then write the task. Fallback prompt: Use the deploying-edr-agent-with-crowdstrike skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `deploying-edr-agent-with-crowdstrike` |
| Canonical name | `deploying-edr-agent-with-crowdstrike` |
| Platform | `Codex` |
| Category | General and specialized workflows |
