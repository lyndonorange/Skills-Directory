...
display_name: deploying-osquery-for-endpoint-monitoring
platform: Codex
category: General and specialized workflows
---

# deploying-osquery-for-endpoint-monitoring - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `deploying-osquery-for-endpoint-monitoring` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose deploying-osquery-for-endpoint-monitoring, then write the task. Fallback prompt: Use the deploying-osquery-for-endpoint-monitoring skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `deploying-osquery-for-endpoint-monitoring` |
| Canonical name | `deploying-osquery-for-endpoint-monitoring` |
| Platform | `Codex` |
| Category | General and specialized workflows |
