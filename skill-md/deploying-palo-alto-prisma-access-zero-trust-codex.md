...
display_name: deploying-palo-alto-prisma-access-zero-trust
platform: Codex
category: General and specialized workflows
---

# deploying-palo-alto-prisma-access-zero-trust - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `deploying-palo-alto-prisma-access-zero-trust` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose deploying-palo-alto-prisma-access-zero-trust, then write the task. Fallback prompt: Use the deploying-palo-alto-prisma-access-zero-trust skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `deploying-palo-alto-prisma-access-zero-trust` |
| Canonical name | `deploying-palo-alto-prisma-access-zero-trust` |
| Platform | `Codex` |
| Category | General and specialized workflows |
