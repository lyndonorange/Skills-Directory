...
display_name: deploying-ransomware-canary-files
platform: Codex
category: General and specialized workflows
---

# deploying-ransomware-canary-files - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `deploying-ransomware-canary-files` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose deploying-ransomware-canary-files, then write the task. Fallback prompt: Use the deploying-ransomware-canary-files skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `deploying-ransomware-canary-files` |
| Canonical name | `deploying-ransomware-canary-files` |
| Platform | `Codex` |
| Category | General and specialized workflows |
