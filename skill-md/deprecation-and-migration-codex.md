...
display_name: deprecation-and-migration
platform: Codex
category: Software engineering and app building
---

# deprecation-and-migration - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `deprecation-and-migration` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Code is a liability, not an asset. Every line of code has ongoing maintenance cost — bugs to fix, dependencies to update, security patches to apply, and new engineers to onboard. Deprecation is the discipline of removing

## How To Use It In Codex

In Codex, click the chat box, press /, choose deprecation-and-migration, then write the task. Fallback prompt: Use the deprecation-and-migration skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `deprecation-and-migration` |
| Canonical name | `deprecation-and-migration` |
| Platform | `Codex` |
| Category | Software engineering and app building |
