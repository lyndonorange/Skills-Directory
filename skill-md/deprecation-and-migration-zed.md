...
# deprecation-and-migration - Zed Skill Package

## What This Is

This is a friend-safe Markdown copy of `deprecation-and-migration` for Zed. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Zed, open the Agent panel and type: Use the deprecation-and-migration skill to...
