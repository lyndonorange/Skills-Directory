...
display_name: design-consultation
platform: Codex
category: Design, creative, and media
---

# design-consultation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `design-consultation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose design-consultation, then write the task. Fallback prompt: Use the design-consultation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `design-consultation` |
| Canonical name | `design-consultation` |
| Platform | `Codex` |
| Category | Design, creative, and media |
...
If `BROWSE_NOT_AVAILABLE`: use `open [file URL removed]...` instead of `$B goto` to open
