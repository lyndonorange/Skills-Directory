---
name: design-html
display_name: design-html
platform: Codex
category: Design, creative, and media
---

# design-html - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `design-html` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose design-html, then write the task. Fallback prompt: Use the design-html skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `design-html` |
| Canonical name | `design-html` |
| Platform | `Codex` |
| Category | Design, creative, and media |
...
```bash
$B goto "[file URL removed]<path-to-finalized.html>"
