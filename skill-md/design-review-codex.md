...
# design-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `design-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose design-review, then write the task. Fallback prompt: Use the design-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `design-review` |
| Canonical name | `design-review` |
| Platform | `Codex` |
| Category | Design, creative, and media |
