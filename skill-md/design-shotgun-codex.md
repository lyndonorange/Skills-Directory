---
name: design-shotgun
display_name: design-shotgun
platform: Codex
category: Design, creative, and media
---

# design-shotgun - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `design-shotgun` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose design-shotgun, then write the task. Fallback prompt: Use the design-shotgun skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `design-shotgun` |
| Canonical name | `design-shotgun` |
| Platform | `Codex` |
| Category | Design, creative, and media |
