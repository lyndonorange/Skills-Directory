...
display_name: design-taste-frontend-v1
platform: Codex
category: Design, creative, and media
---

# design-taste-frontend-v1 - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `design-taste-frontend-v1` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose design-taste-frontend-v1, then write the task. Fallback prompt: Use the design-taste-frontend-v1 skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `design-taste-frontend-v1` |
| Canonical name | `design-taste-frontend-v1` |
| Platform | `Codex` |
| Category | Design, creative, and media |
