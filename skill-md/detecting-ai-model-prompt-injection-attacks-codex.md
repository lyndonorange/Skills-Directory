...
display_name: detecting-ai-model-prompt-injection-attacks
platform: Codex
category: Security, forensics, and incident response
---

# detecting-ai-model-prompt-injection-attacks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-ai-model-prompt-injection-attacks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-ai-model-prompt-injection-attacks, then write the task. Fallback prompt: Use the detecting-ai-model-prompt-injection-attacks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-ai-model-prompt-injection-attacks` |
| Canonical name | `detecting-ai-model-prompt-injection-attacks` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
