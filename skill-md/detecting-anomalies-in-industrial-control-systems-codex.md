...
display_name: detecting-anomalies-in-industrial-control-systems
platform: Codex
category: Security, forensics, and incident response
---

# detecting-anomalies-in-industrial-control-systems - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-anomalies-in-industrial-control-systems` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-anomalies-in-industrial-control-systems, then write the task. Fallback prompt: Use the detecting-anomalies-in-industrial-control-systems skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-anomalies-in-industrial-control-systems` |
| Canonical name | `detecting-anomalies-in-industrial-control-systems` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
