...
display_name: detecting-anomalous-authentication-patterns
platform: Codex
category: Security, forensics, and incident response
---

# detecting-anomalous-authentication-patterns - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-anomalous-authentication-patterns` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-anomalous-authentication-patterns, then write the task. Fallback prompt: Use the detecting-anomalous-authentication-patterns skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-anomalous-authentication-patterns` |
| Canonical name | `detecting-anomalous-authentication-patterns` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
