...
display_name: detecting-attacks-on-historian-servers
platform: Codex
category: Security, forensics, and incident response
---

# detecting-attacks-on-historian-servers - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-attacks-on-historian-servers` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-attacks-on-historian-servers, then write the task. Fallback prompt: Use the detecting-attacks-on-historian-servers skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-attacks-on-historian-servers` |
| Canonical name | `detecting-attacks-on-historian-servers` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
