...
display_name: detecting-attacks-on-scada-systems
platform: Codex
category: Security, forensics, and incident response
---

# detecting-attacks-on-scada-systems - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-attacks-on-scada-systems` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-attacks-on-scada-systems, then write the task. Fallback prompt: Use the detecting-attacks-on-scada-systems skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-attacks-on-scada-systems` |
| Canonical name | `detecting-attacks-on-scada-systems` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
