...
display_name: detecting-aws-cloudtrail-anomalies
platform: Codex
category: Security, forensics, and incident response
---

# detecting-aws-cloudtrail-anomalies - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-aws-cloudtrail-anomalies` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

AWS CloudTrail records API calls across AWS services. This skill covers querying CloudTrail events with boto3's `lookup_events` API, building statistical baselines of normal API activity, detecting anomalies such as unus

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-aws-cloudtrail-anomalies, then write the task. Fallback prompt: Use the detecting-aws-cloudtrail-anomalies skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-aws-cloudtrail-anomalies` |
| Canonical name | `detecting-aws-cloudtrail-anomalies` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
