...
display_name: detecting-aws-iam-privilege-escalation
platform: Codex
category: Security, forensics, and incident response
---

# detecting-aws-iam-privilege-escalation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-aws-iam-privilege-escalation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

This skill uses boto3 and Cloudsplaining-style analysis to identify IAM privilege escalation paths in AWS accounts. It downloads the account authorization details, analyzes each policy for dangerous permission combinatio

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-aws-iam-privilege-escalation, then write the task. Fallback prompt: Use the detecting-aws-iam-privilege-escalation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-aws-iam-privilege-escalation` |
| Canonical name | `detecting-aws-iam-privilege-escalation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
