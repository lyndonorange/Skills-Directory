...
display_name: detecting-azure-service-principal-abuse
platform: Codex
category: Security, forensics, and incident response
---

# detecting-azure-service-principal-abuse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-azure-service-principal-abuse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Azure service principals are identity objects used by applications, services, and automation tools to access Azure resources. Attackers exploit service principals for privilege escalation, lateral movement, and persisten

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-azure-service-principal-abuse, then write the task. Fallback prompt: Use the detecting-azure-service-principal-abuse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-azure-service-principal-abuse` |
| Canonical name | `detecting-azure-service-principal-abuse` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
