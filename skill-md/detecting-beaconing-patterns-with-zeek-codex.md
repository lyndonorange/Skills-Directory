...
display_name: detecting-beaconing-patterns-with-zeek
platform: Codex
category: Security, forensics, and incident response
---

# detecting-beaconing-patterns-with-zeek - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-beaconing-patterns-with-zeek` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-beaconing-patterns-with-zeek, then write the task. Fallback prompt: Use the detecting-beaconing-patterns-with-zeek skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-beaconing-patterns-with-zeek` |
| Canonical name | `detecting-beaconing-patterns-with-zeek` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
