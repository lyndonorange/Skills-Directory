...
display_name: detecting-bluetooth-low-energy-attacks
platform: Codex
category: Security, forensics, and incident response
---

# detecting-bluetooth-low-energy-attacks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-bluetooth-low-energy-attacks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

This skill is intended for authorized security testing, penetration testing engagements, CTF competitions, and educational purposes only. Sniffing, intercepting, or manipulating Bluetooth communications without authoriza

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-bluetooth-low-energy-attacks, then write the task. Fallback prompt: Use the detecting-bluetooth-low-energy-attacks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-bluetooth-low-energy-attacks` |
| Canonical name | `detecting-bluetooth-low-energy-attacks` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
