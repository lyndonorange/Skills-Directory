...
display_name: detecting-broken-object-property-level-authorization
platform: Codex
category: Security, forensics, and incident response
---

# detecting-broken-object-property-level-authorization - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-broken-object-property-level-authorization` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Broken Object Property Level Authorization (BOPLA), classified as API3:2023 in the OWASP API Security Top 10, combines two related vulnerability classes: Excessive Data Exposure (API returning more data than needed) and 

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-broken-object-property-level-authorization, then write the task. Fallback prompt: Use the detecting-broken-object-property-level-authorization skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-broken-object-property-level-authorization` |
| Canonical name | `detecting-broken-object-property-level-authorization` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
