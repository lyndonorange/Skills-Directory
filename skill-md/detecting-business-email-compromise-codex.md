...
# detecting-business-email-compromise - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-business-email-compromise` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Business Email Compromise (BEC) is a sophisticated fraud scheme where attackers impersonate executives, vendors, or trusted partners to trick employees into transferring funds, sharing sensitive data, or changing payment

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-business-email-compromise, then write the task. Fallback prompt: Use the detecting-business-email-compromise skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-business-email-compromise` |
| Canonical name | `detecting-business-email-compromise` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
