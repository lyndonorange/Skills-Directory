...
display_name: detecting-cloud-threats-with-guardduty
platform: Codex
category: Security, forensics, and incident response
---

# detecting-cloud-threats-with-guardduty - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-cloud-threats-with-guardduty` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-cloud-threats-with-guardduty, then write the task. Fallback prompt: Use the detecting-cloud-threats-with-guardduty skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-cloud-threats-with-guardduty` |
| Canonical name | `detecting-cloud-threats-with-guardduty` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
