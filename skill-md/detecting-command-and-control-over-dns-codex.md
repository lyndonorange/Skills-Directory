...
display_name: detecting-command-and-control-over-dns
platform: Codex
category: Security, forensics, and incident response
---

# detecting-command-and-control-over-dns - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-command-and-control-over-dns` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-command-and-control-over-dns, then write the task. Fallback prompt: Use the detecting-command-and-control-over-dns skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-command-and-control-over-dns` |
| Canonical name | `detecting-command-and-control-over-dns` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
