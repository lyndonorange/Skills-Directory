...
display_name: detecting-compromised-cloud-credentials
platform: Codex
category: Security, forensics, and incident response
---

# detecting-compromised-cloud-credentials - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-compromised-cloud-credentials` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-compromised-cloud-credentials, then write the task. Fallback prompt: Use the detecting-compromised-cloud-credentials skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-compromised-cloud-credentials` |
| Canonical name | `detecting-compromised-cloud-credentials` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
