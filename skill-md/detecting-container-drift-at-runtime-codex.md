...
display_name: detecting-container-drift-at-runtime
platform: Codex
category: Security, forensics, and incident response
---

# detecting-container-drift-at-runtime - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-container-drift-at-runtime` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Container drift occurs when running containers deviate from their original image state through unauthorized file modifications, unexpected binary execution, configuration changes, or package installations. Since containe

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-container-drift-at-runtime, then write the task. Fallback prompt: Use the detecting-container-drift-at-runtime skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-container-drift-at-runtime` |
| Canonical name | `detecting-container-drift-at-runtime` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
