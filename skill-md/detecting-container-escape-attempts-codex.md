...
display_name: detecting-container-escape-attempts
platform: Codex
category: Security, forensics, and incident response
---

# detecting-container-escape-attempts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-container-escape-attempts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Container escape is a critical attack technique where an adversary breaks out of container isolation to access the host system or other containers. Detection involves monitoring for escape indicators such as namespace ma

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-container-escape-attempts, then write the task. Fallback prompt: Use the detecting-container-escape-attempts skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-container-escape-attempts` |
| Canonical name | `detecting-container-escape-attempts` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
