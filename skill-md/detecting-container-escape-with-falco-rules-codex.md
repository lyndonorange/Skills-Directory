...
# detecting-container-escape-with-falco-rules - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-container-escape-with-falco-rules` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Falco is a CNCF-graduated runtime security tool that monitors Linux syscalls to detect anomalous container behavior. It uses a rules engine to identify container escape techniques such as mounting host filesystems, acces

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-container-escape-with-falco-rules, then write the task. Fallback prompt: Use the detecting-container-escape-with-falco-rules skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-container-escape-with-falco-rules` |
| Canonical name | `detecting-container-escape-with-falco-rules` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
