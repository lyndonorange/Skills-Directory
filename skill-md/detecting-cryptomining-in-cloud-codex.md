...
display_name: detecting-cryptomining-in-cloud
platform: Codex
category: Security, forensics, and incident response
---

# detecting-cryptomining-in-cloud - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-cryptomining-in-cloud` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-cryptomining-in-cloud, then write the task. Fallback prompt: Use the detecting-cryptomining-in-cloud skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-cryptomining-in-cloud` |
| Canonical name | `detecting-cryptomining-in-cloud` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
