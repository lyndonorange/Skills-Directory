...
# detecting-dcsync-attack-in-active-directory - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-dcsync-attack-in-active-directory` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-dcsync-attack-in-active-directory, then write the task. Fallback prompt: Use the detecting-dcsync-attack-in-active-directory skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-dcsync-attack-in-active-directory` |
| Canonical name | `detecting-dcsync-attack-in-active-directory` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
