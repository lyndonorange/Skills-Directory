...
display_name: detecting-deepfake-audio-in-vishing-attacks
platform: Codex
category: Security, forensics, and incident response
---

# detecting-deepfake-audio-in-vishing-attacks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-deepfake-audio-in-vishing-attacks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-deepfake-audio-in-vishing-attacks, then write the task. Fallback prompt: Use the detecting-deepfake-audio-in-vishing-attacks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-deepfake-audio-in-vishing-attacks` |
| Canonical name | `detecting-deepfake-audio-in-vishing-attacks` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
