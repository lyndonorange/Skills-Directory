...
display_name: detecting-dnp3-protocol-anomalies
platform: Codex
category: Security, forensics, and incident response
---

# detecting-dnp3-protocol-anomalies - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-dnp3-protocol-anomalies` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-dnp3-protocol-anomalies, then write the task. Fallback prompt: Use the detecting-dnp3-protocol-anomalies skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-dnp3-protocol-anomalies` |
| Canonical name | `detecting-dnp3-protocol-anomalies` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
