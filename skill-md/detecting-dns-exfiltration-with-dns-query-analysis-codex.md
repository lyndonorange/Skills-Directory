...
display_name: detecting-dns-exfiltration-with-dns-query-analysis
platform: Codex
category: Security, forensics, and incident response
---

# detecting-dns-exfiltration-with-dns-query-analysis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-dns-exfiltration-with-dns-query-analysis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

DNS exfiltration exploits the Domain Name System as a covert channel to extract data from compromised networks. Attackers encode stolen data into DNS query names (subdomains) or DNS response records (TXT, CNAME, NULL), b

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-dns-exfiltration-with-dns-query-analysis, then write the task. Fallback prompt: Use the detecting-dns-exfiltration-with-dns-query-analysis skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-dns-exfiltration-with-dns-query-analysis` |
| Canonical name | `detecting-dns-exfiltration-with-dns-query-analysis` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
