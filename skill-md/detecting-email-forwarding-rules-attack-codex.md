...
display_name: detecting-email-forwarding-rules-attack
platform: Codex
category: Security, forensics, and incident response
---

# detecting-email-forwarding-rules-attack - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-email-forwarding-rules-attack` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-email-forwarding-rules-attack, then write the task. Fallback prompt: Use the detecting-email-forwarding-rules-attack skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-email-forwarding-rules-attack` |
| Canonical name | `detecting-email-forwarding-rules-attack` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
