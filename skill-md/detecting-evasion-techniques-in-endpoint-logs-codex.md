...
# detecting-evasion-techniques-in-endpoint-logs - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-evasion-techniques-in-endpoint-logs` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-evasion-techniques-in-endpoint-logs, then write the task. Fallback prompt: Use the detecting-evasion-techniques-in-endpoint-logs skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-evasion-techniques-in-endpoint-logs` |
| Canonical name | `detecting-evasion-techniques-in-endpoint-logs` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
