...
# detecting-golden-ticket-attacks-in-kerberos-logs - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-golden-ticket-attacks-in-kerberos-logs` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-golden-ticket-attacks-in-kerberos-logs, then write the task. Fallback prompt: Use the detecting-golden-ticket-attacks-in-kerberos-logs skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-golden-ticket-attacks-in-kerberos-logs` |
| Canonical name | `detecting-golden-ticket-attacks-in-kerberos-logs` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
