...
display_name: detecting-insider-threat-behaviors
platform: Codex
category: Security, forensics, and incident response
---

# detecting-insider-threat-behaviors - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-insider-threat-behaviors` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-insider-threat-behaviors, then write the task. Fallback prompt: Use the detecting-insider-threat-behaviors skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-insider-threat-behaviors` |
| Canonical name | `detecting-insider-threat-behaviors` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
