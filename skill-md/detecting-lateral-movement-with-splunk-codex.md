...
display_name: detecting-lateral-movement-with-splunk
platform: Codex
category: Security, forensics, and incident response
---

# detecting-lateral-movement-with-splunk - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-lateral-movement-with-splunk` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-lateral-movement-with-splunk, then write the task. Fallback prompt: Use the detecting-lateral-movement-with-splunk skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-lateral-movement-with-splunk` |
| Canonical name | `detecting-lateral-movement-with-splunk` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
