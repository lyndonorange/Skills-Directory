...
display_name: detecting-living-off-the-land-attacks
platform: Codex
category: Security, forensics, and incident response
---

# detecting-living-off-the-land-attacks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-living-off-the-land-attacks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-living-off-the-land-attacks, then write the task. Fallback prompt: Use the detecting-living-off-the-land-attacks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-living-off-the-land-attacks` |
| Canonical name | `detecting-living-off-the-land-attacks` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
