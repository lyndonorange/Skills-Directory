...
display_name: detecting-living-off-the-land-with-lolbas
platform: Codex
category: Security, forensics, and incident response
---

# detecting-living-off-the-land-with-lolbas - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-living-off-the-land-with-lolbas` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Living Off the Land Binaries, Scripts, and Libraries (LOLBAS) are legitimate system utilities abused by attackers to execute malicious actions while evading detection. This skill covers detecting abuse of certutil.exe, r

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-living-off-the-land-with-lolbas, then write the task. Fallback prompt: Use the detecting-living-off-the-land-with-lolbas skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-living-off-the-land-with-lolbas` |
| Canonical name | `detecting-living-off-the-land-with-lolbas` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
