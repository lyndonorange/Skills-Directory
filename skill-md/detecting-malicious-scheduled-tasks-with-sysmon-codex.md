...
display_name: detecting-malicious-scheduled-tasks-with-sysmon
platform: Codex
category: Security, forensics, and incident response
---

# detecting-malicious-scheduled-tasks-with-sysmon - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-malicious-scheduled-tasks-with-sysmon` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-malicious-scheduled-tasks-with-sysmon, then write the task. Fallback prompt: Use the detecting-malicious-scheduled-tasks-with-sysmon skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-malicious-scheduled-tasks-with-sysmon` |
| Canonical name | `detecting-malicious-scheduled-tasks-with-sysmon` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
