...
display_name: detecting-misconfigured-azure-storage
platform: Codex
category: Security, forensics, and incident response
---

# detecting-misconfigured-azure-storage - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-misconfigured-azure-storage` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-misconfigured-azure-storage, then write the task. Fallback prompt: Use the detecting-misconfigured-azure-storage skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-misconfigured-azure-storage` |
| Canonical name | `detecting-misconfigured-azure-storage` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
