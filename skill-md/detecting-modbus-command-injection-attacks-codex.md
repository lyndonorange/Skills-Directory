...
# detecting-modbus-command-injection-attacks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-modbus-command-injection-attacks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-modbus-command-injection-attacks, then write the task. Fallback prompt: Use the detecting-modbus-command-injection-attacks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-modbus-command-injection-attacks` |
| Canonical name | `detecting-modbus-command-injection-attacks` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
