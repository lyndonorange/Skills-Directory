...
# detecting-modbus-protocol-anomalies - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-modbus-protocol-anomalies` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-modbus-protocol-anomalies, then write the task. Fallback prompt: Use the detecting-modbus-protocol-anomalies skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-modbus-protocol-anomalies` |
| Canonical name | `detecting-modbus-protocol-anomalies` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
