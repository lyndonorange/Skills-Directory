...
display_name: detecting-network-scanning-with-ids-signatures
platform: Codex
category: Security, forensics, and incident response
---

# detecting-network-scanning-with-ids-signatures - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-network-scanning-with-ids-signatures` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Network scanning is typically the first phase of an attack, where adversaries enumerate live hosts, open ports, running services, and OS versions using tools like Nmap, Masscan, ZMap, and custom scanners. Detecting this 

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-network-scanning-with-ids-signatures, then write the task. Fallback prompt: Use the detecting-network-scanning-with-ids-signatures skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-network-scanning-with-ids-signatures` |
| Canonical name | `detecting-network-scanning-with-ids-signatures` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
