...
display_name: detecting-ntlm-relay-with-event-correlation
platform: Codex
category: Security, forensics, and incident response
---

# detecting-ntlm-relay-with-event-correlation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-ntlm-relay-with-event-correlation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

> **Authorized Testing Disclaimer**: The offensive techniques and attack simulations described in this skill are intended exclusively for authorized penetration testing, red team engagements, purple team exercises, and s

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-ntlm-relay-with-event-correlation, then write the task. Fallback prompt: Use the detecting-ntlm-relay-with-event-correlation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-ntlm-relay-with-event-correlation` |
| Canonical name | `detecting-ntlm-relay-with-event-correlation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
