...
# detecting-pass-the-hash-attacks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-pass-the-hash-attacks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-pass-the-hash-attacks, then write the task. Fallback prompt: Use the detecting-pass-the-hash-attacks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-pass-the-hash-attacks` |
| Canonical name | `detecting-pass-the-hash-attacks` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
