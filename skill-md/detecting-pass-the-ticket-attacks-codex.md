...
display_name: detecting-pass-the-ticket-attacks
platform: Codex
category: Security, forensics, and incident response
---

# detecting-pass-the-ticket-attacks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-pass-the-ticket-attacks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Pass-the-Ticket (PtT) is a credential theft technique (MITRE ATT&CK T1550.003) where adversaries steal Kerberos tickets (TGT or TGS) from one system and replay them on another to authenticate without knowing the user's p

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-pass-the-ticket-attacks, then write the task. Fallback prompt: Use the detecting-pass-the-ticket-attacks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-pass-the-ticket-attacks` |
| Canonical name | `detecting-pass-the-ticket-attacks` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
