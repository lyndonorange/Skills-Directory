...
# detecting-privilege-escalation-in-kubernetes-pods - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-privilege-escalation-in-kubernetes-pods` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Privilege escalation in Kubernetes occurs when a pod or container gains elevated permissions beyond its intended scope. This includes running as root, using privileged mode, mounting host filesystems, enabling dangerous 

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-privilege-escalation-in-kubernetes-pods, then write the task. Fallback prompt: Use the detecting-privilege-escalation-in-kubernetes-pods skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-privilege-escalation-in-kubernetes-pods` |
| Canonical name | `detecting-privilege-escalation-in-kubernetes-pods` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
