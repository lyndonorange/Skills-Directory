...
# detecting-process-hollowing-technique - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-process-hollowing-technique` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-process-hollowing-technique, then write the task. Fallback prompt: Use the detecting-process-hollowing-technique skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-process-hollowing-technique` |
| Canonical name | `detecting-process-hollowing-technique` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
