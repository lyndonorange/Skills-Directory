...
# detecting-process-injection-techniques - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-process-injection-techniques` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-process-injection-techniques, then write the task. Fallback prompt: Use the detecting-process-injection-techniques skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-process-injection-techniques` |
| Canonical name | `detecting-process-injection-techniques` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
