...
display_name: detecting-ransomware-encryption-behavior
platform: Codex
category: Security, forensics, and incident response
---

# detecting-ransomware-encryption-behavior - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-ransomware-encryption-behavior` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-ransomware-encryption-behavior, then write the task. Fallback prompt: Use the detecting-ransomware-encryption-behavior skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-ransomware-encryption-behavior` |
| Canonical name | `detecting-ransomware-encryption-behavior` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
