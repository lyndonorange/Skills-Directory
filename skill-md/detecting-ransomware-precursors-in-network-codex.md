...
# detecting-ransomware-precursors-in-network - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-ransomware-precursors-in-network` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-ransomware-precursors-in-network, then write the task. Fallback prompt: Use the detecting-ransomware-precursors-in-network skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-ransomware-precursors-in-network` |
| Canonical name | `detecting-ransomware-precursors-in-network` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
