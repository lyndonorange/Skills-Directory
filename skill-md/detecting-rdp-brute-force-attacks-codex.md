...
display_name: detecting-rdp-brute-force-attacks
platform: Codex
category: Security, forensics, and incident response
---

# detecting-rdp-brute-force-attacks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-rdp-brute-force-attacks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

RDP brute force attacks target Windows Remote Desktop Protocol services by attempting rapid credential guessing against exposed RDP endpoints. Detection relies on analyzing Windows Security Event Logs for Event ID 4625 (

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-rdp-brute-force-attacks, then write the task. Fallback prompt: Use the detecting-rdp-brute-force-attacks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-rdp-brute-force-attacks` |
| Canonical name | `detecting-rdp-brute-force-attacks` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
