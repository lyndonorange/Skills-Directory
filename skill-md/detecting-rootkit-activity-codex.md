...
# detecting-rootkit-activity - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-rootkit-activity` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-rootkit-activity, then write the task. Fallback prompt: Use the detecting-rootkit-activity skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-rootkit-activity` |
| Canonical name | `detecting-rootkit-activity` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
