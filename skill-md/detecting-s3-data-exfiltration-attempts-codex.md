...
# detecting-s3-data-exfiltration-attempts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-s3-data-exfiltration-attempts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-s3-data-exfiltration-attempts, then write the task. Fallback prompt: Use the detecting-s3-data-exfiltration-attempts skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-s3-data-exfiltration-attempts` |
| Canonical name | `detecting-s3-data-exfiltration-attempts` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
