...
display_name: detecting-service-account-abuse
platform: Codex
category: Security, forensics, and incident response
---

# detecting-service-account-abuse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-service-account-abuse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-service-account-abuse, then write the task. Fallback prompt: Use the detecting-service-account-abuse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-service-account-abuse` |
| Canonical name | `detecting-service-account-abuse` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
