...
display_name: detecting-shadow-it-cloud-usage
platform: Codex
category: Security, forensics, and incident response
---

# detecting-shadow-it-cloud-usage - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-shadow-it-cloud-usage` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Shadow IT refers to unauthorized SaaS applications and cloud services used without IT approval. This skill analyzes proxy logs, DNS query logs, and firewall/netflow data to identify unauthorized cloud service usage, clas

## How To Use It In Codex

In Codex, click the chat box, press /, choose detecting-shadow-it-cloud-usage, then write the task. Fallback prompt: Use the detecting-shadow-it-cloud-usage skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-shadow-it-cloud-usage` |
| Canonical name | `detecting-shadow-it-cloud-usage` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
