...
display_name: detecting-stuxnet-style-attacks
platform: Codex
category: Security, forensics, and incident response
---

# detecting-stuxnet-style-attacks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-stuxnet-style-attacks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-stuxnet-style-attacks, then write the task. Fallback prompt: Use the detecting-stuxnet-style-attacks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-stuxnet-style-attacks` |
| Canonical name | `detecting-stuxnet-style-attacks` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
