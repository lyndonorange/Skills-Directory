...
display_name: detecting-supply-chain-attacks-in-ci-cd
platform: Codex
category: Security, forensics, and incident response
---

# detecting-supply-chain-attacks-in-ci-cd - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-supply-chain-attacks-in-ci-cd` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-supply-chain-attacks-in-ci-cd, then write the task. Fallback prompt: Use the detecting-supply-chain-attacks-in-ci-cd skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-supply-chain-attacks-in-ci-cd` |
| Canonical name | `detecting-supply-chain-attacks-in-ci-cd` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
