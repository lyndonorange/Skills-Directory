...
# detecting-suspicious-powershell-execution - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-suspicious-powershell-execution` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-suspicious-powershell-execution, then write the task. Fallback prompt: Use the detecting-suspicious-powershell-execution skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-suspicious-powershell-execution` |
| Canonical name | `detecting-suspicious-powershell-execution` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
