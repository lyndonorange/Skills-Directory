...
# detecting-t1003-credential-dumping-with-edr - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-t1003-credential-dumping-with-edr` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-t1003-credential-dumping-with-edr, then write the task. Fallback prompt: Use the detecting-t1003-credential-dumping-with-edr skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-t1003-credential-dumping-with-edr` |
| Canonical name | `detecting-t1003-credential-dumping-with-edr` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
