...
# detecting-t1055-process-injection-with-sysmon - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `detecting-t1055-process-injection-with-sysmon` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose detecting-t1055-process-injection-with-sysmon, then write the task. Fallback prompt: Use the detecting-t1055-process-injection-with-sysmon skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `detecting-t1055-process-injection-with-sysmon` |
| Canonical name | `detecting-t1055-process-injection-with-sysmon` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
