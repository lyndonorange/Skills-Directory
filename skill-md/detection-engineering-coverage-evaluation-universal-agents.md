...
# detection-engineering-coverage-evaluation - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `detection-engineering-coverage-evaluation` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the detection-engineering-coverage-evaluation skill to...
