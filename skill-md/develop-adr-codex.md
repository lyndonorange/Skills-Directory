---
name: pm-skills-develop-adr
display_name: develop-adr
platform: Codex
category: Product delivery, planning, and execution
---

# develop-adr - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `develop-adr` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

An Architecture Decision Record documents a significant technical decision along with its context and consequences. ADRs capture the "why" behind architectural choices so future team members understand the reasoning . es

## How To Use It In Codex

In Codex, click the chat box, press /, choose develop-adr, then write the task. Fallback prompt: Use the develop-adr skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `develop-adr` |
| Canonical name | `pm-skills-develop-adr` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
