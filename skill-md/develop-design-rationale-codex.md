---
name: pm-skills-develop-design-rationale
display_name: develop-design-rationale
platform: Codex
category: Product delivery, planning, and execution
---

# develop-design-rationale - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `develop-design-rationale` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

A design rationale document captures the "why" behind design decisions.the context, constraints, alternatives considered, and reasoning that led to a particular solution. While designs themselves show what was built, rat

## How To Use It In Codex

In Codex, click the chat box, press /, choose develop-design-rationale, then write the task. Fallback prompt: Use the develop-design-rationale skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `develop-design-rationale` |
| Canonical name | `pm-skills-develop-design-rationale` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
