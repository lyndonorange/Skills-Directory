...
# develop-spike-summary - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `develop-spike-summary` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the develop-spike-summary skill to...
