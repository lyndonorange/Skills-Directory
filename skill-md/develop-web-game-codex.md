...
# develop-web-game - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `develop-web-game` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose develop-web-game, then write the task. Fallback prompt: Use the develop-web-game skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `develop-web-game` |
| Canonical name | `develop-web-game` |
| Platform | `Codex` |
| Category | Software engineering and app building |
