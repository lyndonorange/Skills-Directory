---
name: devex-review
display_name: devex-review
platform: Codex
category: General and specialized workflows
---

# devex-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `devex-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose devex-review, then write the task. Fallback prompt: Use the devex-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `devex-review` |
| Canonical name | `devex-review` |
| Platform | `Codex` |
| Category | General and specialized workflows |
