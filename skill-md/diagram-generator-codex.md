...
# diagram-generator - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `diagram-generator` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

generate, refine, validate, and render diagrams from natural language, notes, code snippets, schemas, tables, or existing diagram source. use for flowcharts, swimlanes, sequence diagrams, state diagrams, er diagrams, cla

## How To Use It In Codex

In Codex, click the chat box, press /, choose diagram-generator, then write the task. Fallback prompt: Use the diagram-generator skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `diagram-generator` |
| Canonical name | `diagram-generator` |
| Platform | `Codex` |
| Category | General and specialized workflows |
