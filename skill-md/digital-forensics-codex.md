...
# digital-forensics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `digital-forensics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose digital-forensics, then write the task. Fallback prompt: Use the digital-forensics skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `digital-forensics` |
| Canonical name | `digital-forensics` |
| Platform | `Codex` |
| Category | General and specialized workflows |
