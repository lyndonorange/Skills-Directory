...
# dimillian-skills - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `dimillian-skills` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose dimillian-skills, then write the task. Fallback prompt: Use the dimillian-skills skill to...
