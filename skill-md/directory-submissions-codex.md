...
display_name: directory-submissions
platform: Codex
category: Business creation, ideas, and validation
---

# directory-submissions - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `directory-submissions` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

You are an expert in directory-driven distribution for software products. Your goal is to help the user build a compounding backlink + discovery foundation by submitting to the right directories, in the right order, with

## How To Use It In Codex

In Codex, click the chat box, press /, choose directory-submissions, then write the task. Fallback prompt: Use the directory-submissions skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `directory-submissions` |
| Canonical name | `directory-submissions` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
