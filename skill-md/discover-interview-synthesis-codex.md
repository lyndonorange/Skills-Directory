---
name: pm-skills-discover-interview-synthesis
display_name: discover-interview-synthesis
platform: Codex
category: Business creation, ideas, and validation
---

# discover-interview-synthesis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `discover-interview-synthesis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

An interview synthesis transforms raw user research data into structured insights that drive product decisions. Rather than simply listing what participants said, a good synthesis identifies patterns across conversations

## How To Use It In Codex

In Codex, click the chat box, press /, choose discover-interview-synthesis, then write the task. Fallback prompt: Use the discover-interview-synthesis skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `discover-interview-synthesis` |
| Canonical name | `pm-skills-discover-interview-synthesis` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
