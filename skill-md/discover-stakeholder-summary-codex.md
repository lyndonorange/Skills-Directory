---
name: pm-skills-discover-stakeholder-summary
display_name: discover-stakeholder-summary
platform: Codex
category: Business creation, ideas, and validation
---

# discover-stakeholder-summary - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `discover-stakeholder-summary` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

A stakeholder summary documents the people and groups who have interest in or influence over a project, capturing their needs, concerns, and relationships. Effective stakeholder management often determines project succes

## How To Use It In Codex

In Codex, click the chat box, press /, choose discover-stakeholder-summary, then write the task. Fallback prompt: Use the discover-stakeholder-summary skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `discover-stakeholder-summary` |
| Canonical name | `pm-skills-discover-stakeholder-summary` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
