...
# doc - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `doc` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose doc, then write the task. Fallback prompt: Use the doc skill to...
...
DOCX -> PDF:
```
soffice -env:UserInstallation=[local file URL removed] --headless --convert-to pdf --outdir $OUTDIR $INPUT_DOCX
```
