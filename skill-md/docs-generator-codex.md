...
# docs-generator - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `docs-generator` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose docs-generator, then write the task. Fallback prompt: Use the docs-generator skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `docs-generator` |
| Canonical name | `docs-generator` |
| Platform | `Codex` |
| Category | General and specialized workflows |
