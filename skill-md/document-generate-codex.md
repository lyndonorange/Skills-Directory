...
display_name: document-generate
platform: Codex
category: General and specialized workflows
---

# document-generate - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `document-generate` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose document-generate, then write the task. Fallback prompt: Use the document-generate skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `document-generate` |
| Canonical name | `document-generate` |
| Platform | `Codex` |
| Category | General and specialized workflows |
