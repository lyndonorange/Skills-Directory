...
display_name: document-release
platform: Codex
category: General and specialized workflows
---

# document-release - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `document-release` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose document-release, then write the task. Fallback prompt: Use the document-release skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `document-release` |
| Canonical name | `document-release` |
| Platform | `Codex` |
| Category | General and specialized workflows |
