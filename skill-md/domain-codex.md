...
# domain - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `domain` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

When you want to brainstorm and check available .com domains for a new project — brand naming, aftermarket pricing (HugeDomains / Afternic / Sedo / Dan), USPTO trademark screening, and social handle availability. Built o

## How To Use It In Codex

In Codex, click the chat box, press /, choose domain, then write the task. Fallback prompt: Use the domain skill to...
