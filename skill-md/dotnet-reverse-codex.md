---
name: dotnet-reverse
display_name: dotnet-reverse
platform: Codex
category: General and specialized workflows
---

# dotnet-reverse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `dotnet-reverse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose dotnet-reverse, then write the task. Fallback prompt: Use the dotnet-reverse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `dotnet-reverse` |
| Canonical name | `dotnet-reverse` |
| Platform | `Codex` |
| Category | General and specialized workflows |
