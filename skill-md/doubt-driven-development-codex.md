...
display_name: doubt-driven-development
platform: Codex
category: Software engineering and app building
---

# doubt-driven-development - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `doubt-driven-development` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

A confident answer is not a correct one. Long sessions accumulate context that quietly turns assumptions into "facts" without anyone noticing. Doubt-driven development is the discipline of materializing a fresh-context r

## How To Use It In Codex

In Codex, click the chat box, press /, choose doubt-driven-development, then write the task. Fallback prompt: Use the doubt-driven-development skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `doubt-driven-development` |
| Canonical name | `doubt-driven-development` |
| Platform | `Codex` |
| Category | Software engineering and app building |
