...
# doubt-driven-development - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `doubt-driven-development` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the doubt-driven-development skill to...
