---
name: pm-skills-draft-nda
display_name: draft-nda
platform: Codex
category: PM operations, communication, and utilities
---

# draft-nda - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `draft-nda` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose draft-nda, then write the task. Fallback prompt: Use the draft-nda skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `draft-nda` |
| Canonical name | `pm-skills-draft-nda` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
