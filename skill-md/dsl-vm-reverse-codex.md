---
name: dsl-vm-reverse
display_name: dsl-vm-reverse
platform: Codex
category: General and specialized workflows
---

# dsl-vm-reverse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `dsl-vm-reverse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose dsl-vm-reverse, then write the task. Fallback prompt: Use the dsl-vm-reverse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `dsl-vm-reverse` |
| Canonical name | `dsl-vm-reverse` |
| Platform | `Codex` |
| Category | General and specialized workflows |
