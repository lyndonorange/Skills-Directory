---
name: pm-skills-dummy-dataset
display_name: dummy-dataset
platform: Codex
category: PM operations, communication, and utilities
---

# dummy-dataset - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `dummy-dataset` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose dummy-dataset, then write the task. Fallback prompt: Use the dummy-dataset skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `dummy-dataset` |
| Canonical name | `pm-skills-dummy-dataset` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
