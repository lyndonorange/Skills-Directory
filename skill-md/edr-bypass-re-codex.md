---
name: edr-bypass-re
display_name: edr-bypass-re
platform: Codex
category: General and specialized workflows
---

# edr-bypass-re - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `edr-bypass-re` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose edr-bypass-re, then write the task. Fallback prompt: Use the edr-bypass-re skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `edr-bypass-re` |
| Canonical name | `edr-bypass-re` |
| Platform | `Codex` |
| Category | General and specialized workflows |
