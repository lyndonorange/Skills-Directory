...
display_name: efficient-fable
platform: Codex
category: General and specialized workflows
---

# efficient-fable - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `efficient-fable` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose efficient-fable, then write the task. Fallback prompt: Use the efficient-fable skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `efficient-fable` |
| Canonical name | `efficient-fable` |
| Platform | `Codex` |
| Category | General and specialized workflows |
