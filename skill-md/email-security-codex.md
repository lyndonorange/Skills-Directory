...
# email-security - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `email-security` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose email-security, then write the task. Fallback prompt: Use the email-security skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `email-security` |
| Canonical name | `email-security` |
| Platform | `Codex` |
| Category | General and specialized workflows |
