...
display_name: emil-design-eng
platform: Codex
category: General and specialized workflows
---

# emil-design-eng - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `emil-design-eng` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose emil-design-eng, then write the task. Fallback prompt: Use the emil-design-eng skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `emil-design-eng` |
| Canonical name | `emil-design-eng` |
| Platform | `Codex` |
| Category | General and specialized workflows |
