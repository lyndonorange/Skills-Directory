...
display_name: executing-active-directory-attack-simulation
platform: Codex
category: General and specialized workflows
---

# executing-active-directory-attack-simulation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `executing-active-directory-attack-simulation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose executing-active-directory-attack-simulation, then write the task. Fallback prompt: Use the executing-active-directory-attack-simulation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `executing-active-directory-attack-simulation` |
| Canonical name | `executing-active-directory-attack-simulation` |
| Platform | `Codex` |
| Category | General and specialized workflows |
