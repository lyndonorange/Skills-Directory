...
display_name: executing-phishing-simulation-campaign
platform: Codex
category: General and specialized workflows
---

# executing-phishing-simulation-campaign - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `executing-phishing-simulation-campaign` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose executing-phishing-simulation-campaign, then write the task. Fallback prompt: Use the executing-phishing-simulation-campaign skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `executing-phishing-simulation-campaign` |
| Canonical name | `executing-phishing-simulation-campaign` |
| Platform | `Codex` |
| Category | General and specialized workflows |
