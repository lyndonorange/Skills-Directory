...
display_name: executing-red-team-exercise
platform: Codex
category: General and specialized workflows
---

# executing-red-team-exercise - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `executing-red-team-exercise` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose executing-red-team-exercise, then write the task. Fallback prompt: Use the executing-red-team-exercise skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `executing-red-team-exercise` |
| Canonical name | `executing-red-team-exercise` |
| Platform | `Codex` |
| Category | General and specialized workflows |
