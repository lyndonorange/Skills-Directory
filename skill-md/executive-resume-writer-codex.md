...
display_name: executive-resume-writer
platform: Codex
category: General and specialized workflows
---

# executive-resume-writer - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `executive-resume-writer` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose executive-resume-writer, then write the task. Fallback prompt: Use the executive-resume-writer skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `executive-resume-writer` |
| Canonical name | `executive-resume-writer` |
| Platform | `Codex` |
| Category | General and specialized workflows |
