...
display_name: extracting-browser-history-artifacts
platform: Codex
category: General and specialized workflows
---

# extracting-browser-history-artifacts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `extracting-browser-history-artifacts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose extracting-browser-history-artifacts, then write the task. Fallback prompt: Use the extracting-browser-history-artifacts skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `extracting-browser-history-artifacts` |
| Canonical name | `extracting-browser-history-artifacts` |
| Platform | `Codex` |
| Category | General and specialized workflows |
