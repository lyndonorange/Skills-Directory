...
display_name: extracting-config-from-agent-tesla-rat
platform: Codex
category: General and specialized workflows
---

# extracting-config-from-agent-tesla-rat - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `extracting-config-from-agent-tesla-rat` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Agent Tesla is a .NET-based Remote Access Trojan (RAT) and keylogger that ranked among the top 10 malware variants in 2024, impacting 6.3% of corporate networks globally. It exfiltrates stolen credentials via SMTP email,

## How To Use It In Codex

In Codex, click the chat box, press /, choose extracting-config-from-agent-tesla-rat, then write the task. Fallback prompt: Use the extracting-config-from-agent-tesla-rat skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `extracting-config-from-agent-tesla-rat` |
| Canonical name | `extracting-config-from-agent-tesla-rat` |
| Platform | `Codex` |
| Category | General and specialized workflows |
