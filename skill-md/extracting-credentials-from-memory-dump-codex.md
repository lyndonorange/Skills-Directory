...
display_name: extracting-credentials-from-memory-dump
platform: Codex
category: General and specialized workflows
---

# extracting-credentials-from-memory-dump - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `extracting-credentials-from-memory-dump` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose extracting-credentials-from-memory-dump, then write the task. Fallback prompt: Use the extracting-credentials-from-memory-dump skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `extracting-credentials-from-memory-dump` |
| Canonical name | `extracting-credentials-from-memory-dump` |
| Platform | `Codex` |
| Category | General and specialized workflows |
