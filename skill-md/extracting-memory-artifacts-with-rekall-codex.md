...
display_name: extracting-memory-artifacts-with-rekall
platform: Codex
category: General and specialized workflows
---

# extracting-memory-artifacts-with-rekall - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `extracting-memory-artifacts-with-rekall` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose extracting-memory-artifacts-with-rekall, then write the task. Fallback prompt: Use the extracting-memory-artifacts-with-rekall skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `extracting-memory-artifacts-with-rekall` |
| Canonical name | `extracting-memory-artifacts-with-rekall` |
| Platform | `Codex` |
| Category | General and specialized workflows |
