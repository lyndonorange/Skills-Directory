...
# extracting-windows-event-logs-artifacts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `extracting-windows-event-logs-artifacts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose extracting-windows-event-logs-artifacts, then write the task. Fallback prompt: Use the extracting-windows-event-logs-artifacts skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `extracting-windows-event-logs-artifacts` |
| Canonical name | `extracting-windows-event-logs-artifacts` |
| Platform | `Codex` |
| Category | General and specialized workflows |
