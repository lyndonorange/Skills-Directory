...
display_name: feedback-quality-analyser
platform: Codex
category: Education and tutoring
---

# feedback-quality-analyser - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `feedback-quality-analyser` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose feedback-quality-analyser, then write the task. Fallback prompt: Use the feedback-quality-analyser skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `feedback-quality-analyser` |
| Canonical name | `feedback-quality-analyser` |
| Platform | `Codex` |
| Category | Education and tutoring |
...
metadata:
  ...
  source_path: skills/memory-learning-science/feedback-quality-analyser/SKILL.md
  source_sha256: 1cf11373442d2a199137df4ea742870c0a4d4257c9512c484fc877284d4e3d2a
