...
display_name: figma-create-design-system-rules
platform: Codex
category: Design, creative, and media
---

# figma-create-design-system-rules - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `figma-create-design-system-rules` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

This skill helps you generate custom design system rules tailored to your project's specific needs. These rules guide AI coding agents to produce consistent, high-quality code when implementing Figma designs, ensuring th

## How To Use It In Codex

In Codex, click the chat box, press /, choose figma-create-design-system-rules, then write the task. Fallback prompt: Use the figma-create-design-system-rules skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `figma-create-design-system-rules` |
| Canonical name | `figma-create-design-system-rules` |
| Platform | `Codex` |
| Category | Design, creative, and media |
