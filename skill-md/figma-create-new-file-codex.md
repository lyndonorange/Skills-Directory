...
display_name: figma-create-new-file
platform: Codex
category: Design, creative, and media
---

# figma-create-new-file - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `figma-create-new-file` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose figma-create-new-file, then write the task. Fallback prompt: Use the figma-create-new-file skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `figma-create-new-file` |
| Canonical name | `figma-create-new-file` |
| Platform | `Codex` |
| Category | Design, creative, and media |
