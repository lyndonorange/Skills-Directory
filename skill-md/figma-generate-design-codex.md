...
display_name: figma-generate-design
platform: Codex
category: Design, creative, and media
---

# figma-generate-design - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `figma-generate-design` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Use this skill to create or update full-page screens in Figma by **reusing the published design system** — components, variables, and styles — rather than drawing primitives with hardcoded values. The key insight: the Fi

## How To Use It In Codex

In Codex, click the chat box, press /, choose figma-generate-design, then write the task. Fallback prompt: Use the figma-generate-design skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `figma-generate-design` |
| Canonical name | `figma-generate-design` |
| Platform | `Codex` |
| Category | Design, creative, and media |
