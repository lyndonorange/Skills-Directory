...
display_name: figma-generate-library
platform: Codex
category: Design, creative, and media
---

# figma-generate-library - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `figma-generate-library` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Build professional-grade design systems in Figma that match code. This skill orchestrates multi-phase workflows across 20–100+ `use_figma` calls, enforcing quality patterns from real-world design systems (Material 3, Pol

## How To Use It In Codex

In Codex, click the chat box, press /, choose figma-generate-library, then write the task. Fallback prompt: Use the figma-generate-library skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `figma-generate-library` |
| Canonical name | `figma-generate-library` |
| Platform | `Codex` |
| Category | Design, creative, and media |
