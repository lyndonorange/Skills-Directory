...
# foundation-meeting-brief - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `foundation-meeting-brief` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the foundation-meeting-brief skill to...
