---
name: pm-skills-foundation-persona
display_name: foundation-persona
platform: Codex
category: Business creation, ideas, and validation
---

# foundation-persona - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `foundation-persona` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose foundation-persona, then write the task. Fallback prompt: Use the foundation-persona skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `foundation-persona` |
| Canonical name | `pm-skills-foundation-persona` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
