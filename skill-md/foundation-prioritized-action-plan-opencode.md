...
# foundation-prioritized-action-plan - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `foundation-prioritized-action-plan` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the foundation-prioritized-action-plan skill to...
