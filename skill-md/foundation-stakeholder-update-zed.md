...
# foundation-stakeholder-update - Zed Skill Package

## What This Is

This is a friend-safe Markdown copy of `foundation-stakeholder-update` for Zed. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Zed, open the Agent panel and type: Use the foundation-stakeholder-update skill to...
