---
name: free-tools
display_name: free-tools
platform: Codex
category: Business creation, ideas, and validation
---

# free-tools - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `free-tools` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose free-tools, then write the task. Fallback prompt: Use the free-tools skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `free-tools` |
| Canonical name | `free-tools` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
