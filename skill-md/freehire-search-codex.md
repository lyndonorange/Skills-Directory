...
display_name: freehire-search
platform: Codex
category: General and specialized workflows
---

# freehire-search - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `freehire-search` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose freehire-search, then write the task. Fallback prompt: Use the freehire-search skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `freehire-search` |
| Canonical name | `freehire-search` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
description: >
  ...
  "are there any technical-role jobs in a place", look up this freehire job posting.
---
