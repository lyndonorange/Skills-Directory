...
# frontend-ui-engineering - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `frontend-ui-engineering` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose frontend-ui-engineering, then write the task. Fallback prompt: Use the frontend-ui-engineering skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `frontend-ui-engineering` |
| Canonical name | `frontend-ui-engineering` |
| Platform | `Codex` |
| Category | Software engineering and app building |
...
Pair with `hallmark` for greenfield visual direction, structural diversification, reference study, redesign, and anti-slop audit. Hallmark owns design judgment; this skill owns production component architecture, accessibility, performance, state, and framework correctness.
