...
# frontend-ui-engineering - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `frontend-ui-engineering` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the frontend-ui-engineering skill to...
