...
# frontend-ui-engineering - Zed Skill Package

## What This Is

This is a friend-safe Markdown copy of `frontend-ui-engineering` for Zed. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Zed, open the Agent panel and type: Use the frontend-ui-engineering skill to...
