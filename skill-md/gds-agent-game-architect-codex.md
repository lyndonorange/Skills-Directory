...
display_name: gds-agent-game-architect
platform: Codex
category: General and specialized workflows
---

# gds-agent-game-architect - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-agent-game-architect` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-agent-game-architect, then write the task. Fallback prompt: Use the gds-agent-game-architect skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-agent-game-architect` |
| Canonical name | `gds-agent-game-architect` |
| Platform | `Codex` |
| Category | General and specialized workflows |
