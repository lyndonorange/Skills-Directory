...
display_name: gds-agent-game-designer
platform: Codex
category: General and specialized workflows
---

# gds-agent-game-designer - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-agent-game-designer` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-agent-game-designer, then write the task. Fallback prompt: Use the gds-agent-game-designer skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-agent-game-designer` |
| Canonical name | `gds-agent-game-designer` |
| Platform | `Codex` |
| Category | General and specialized workflows |
