...
# gds-agent-game-designer - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-agent-game-designer` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the gds-agent-game-designer skill to...
