...
display_name: gds-agent-game-dev
platform: Codex
category: General and specialized workflows
---

# gds-agent-game-dev - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-agent-game-dev` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Consolidated game developer for story execution, code implementation, code review, QA/test authorship, and sprint orchestration. Use when the user asks to talk to Link Freeman, the Game Developer, the Game QA, or the Gam

## How To Use It In Codex

In Codex, click the chat box, press /, choose gds-agent-game-dev, then write the task. Fallback prompt: Use the gds-agent-game-dev skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-agent-game-dev` |
| Canonical name | `gds-agent-game-dev` |
| Platform | `Codex` |
| Category | General and specialized workflows |
