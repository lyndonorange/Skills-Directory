...
display_name: gds-agent-game-solo-dev
platform: Codex
category: General and specialized workflows
---

# gds-agent-game-solo-dev - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-agent-game-solo-dev` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-agent-game-solo-dev, then write the task. Fallback prompt: Use the gds-agent-game-solo-dev skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-agent-game-solo-dev` |
| Canonical name | `gds-agent-game-solo-dev` |
| Platform | `Codex` |
| Category | General and specialized workflows |
