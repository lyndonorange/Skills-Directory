...
# gds-agent-game-solo-dev - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-agent-game-solo-dev` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the gds-agent-game-solo-dev skill to...
