...
display_name: gds-brainstorm-game
platform: Codex
category: General and specialized workflows
---

# gds-brainstorm-game - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-brainstorm-game` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-brainstorm-game, then write the task. Fallback prompt: Use the gds-brainstorm-game skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-brainstorm-game` |
| Canonical name | `gds-brainstorm-game` |
| Platform | `Codex` |
| Category | General and specialized workflows |
