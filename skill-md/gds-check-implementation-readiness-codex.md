...
display_name: gds-check-implementation-readiness
platform: Codex
category: General and specialized workflows
---

# gds-check-implementation-readiness - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-check-implementation-readiness` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-check-implementation-readiness, then write the task. Fallback prompt: Use the gds-check-implementation-readiness skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-check-implementation-readiness` |
| Canonical name | `gds-check-implementation-readiness` |
| Platform | `Codex` |
| Category | General and specialized workflows |
