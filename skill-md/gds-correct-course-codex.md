...
display_name: gds-correct-course
platform: Codex
category: General and specialized workflows
---

# gds-correct-course - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-correct-course` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-correct-course, then write the task. Fallback prompt: Use the gds-correct-course skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-correct-course` |
| Canonical name | `gds-correct-course` |
| Platform | `Codex` |
| Category | General and specialized workflows |
