...
display_name: gds-create-epics-and-stories
platform: Codex
category: General and specialized workflows
---

# gds-create-epics-and-stories - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-create-epics-and-stories` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-create-epics-and-stories, then write the task. Fallback prompt: Use the gds-create-epics-and-stories skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-create-epics-and-stories` |
| Canonical name | `gds-create-epics-and-stories` |
| Platform | `Codex` |
| Category | General and specialized workflows |
