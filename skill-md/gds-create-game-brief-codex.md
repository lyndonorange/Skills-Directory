...
display_name: gds-create-game-brief
platform: Codex
category: General and specialized workflows
---

# gds-create-game-brief - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-create-game-brief` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-create-game-brief, then write the task. Fallback prompt: Use the gds-create-game-brief skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-create-game-brief` |
| Canonical name | `gds-create-game-brief` |
| Platform | `Codex` |
| Category | General and specialized workflows |
