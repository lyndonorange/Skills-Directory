...
# gds-create-game-brief - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-create-game-brief` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the gds-create-game-brief skill to...
