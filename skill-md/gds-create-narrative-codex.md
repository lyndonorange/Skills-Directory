...
display_name: gds-create-narrative
platform: Codex
category: General and specialized workflows
---

# gds-create-narrative - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-create-narrative` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-create-narrative, then write the task. Fallback prompt: Use the gds-create-narrative skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-create-narrative` |
| Canonical name | `gds-create-narrative` |
| Platform | `Codex` |
| Category | General and specialized workflows |
