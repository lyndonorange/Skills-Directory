...
display_name: gds-create-story
platform: Codex
category: General and specialized workflows
---

# gds-create-story - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-create-story` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-create-story, then write the task. Fallback prompt: Use the gds-create-story skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-create-story` |
| Canonical name | `gds-create-story` |
| Platform | `Codex` |
| Category | General and specialized workflows |
