---
name: gds-dev-story
display_name: gds-dev-story
platform: Codex
category: General and specialized workflows
---

# gds-dev-story - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-dev-story` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-dev-story, then write the task. Fallback prompt: Use the gds-dev-story skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-dev-story` |
| Canonical name | `gds-dev-story` |
| Platform | `Codex` |
| Category | General and specialized workflows |
