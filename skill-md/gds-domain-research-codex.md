...
display_name: gds-domain-research
platform: Codex
category: General and specialized workflows
---

# gds-domain-research - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-domain-research` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-domain-research, then write the task. Fallback prompt: Use the gds-domain-research skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-domain-research` |
| Canonical name | `gds-domain-research` |
| Platform | `Codex` |
| Category | General and specialized workflows |
