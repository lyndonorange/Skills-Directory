...
display_name: gds-game-architecture
platform: Codex
category: General and specialized workflows
---

# gds-game-architecture - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-game-architecture` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-game-architecture, then write the task. Fallback prompt: Use the gds-game-architecture skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-game-architecture` |
| Canonical name | `gds-game-architecture` |
| Platform | `Codex` |
| Category | General and specialized workflows |
