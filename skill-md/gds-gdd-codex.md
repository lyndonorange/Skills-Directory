---
name: gds-gdd
display_name: gds-gdd
platform: Codex
category: General and specialized workflows
---

# gds-gdd - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-gdd` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Create, update, or validate a game's Game Design Document. Use when the user wants help producing, editing, or validating a GDD — the primary design artifact covering pillars, mechanics, progression, levels, art, audio,

## How To Use It In Codex

In Codex, click the chat box, press /, choose gds-gdd, then write the task. Fallback prompt: Use the gds-gdd skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-gdd` |
| Canonical name | `gds-gdd` |
| Platform | `Codex` |
| Category | General and specialized workflows |
