...
display_name: gds-generate-project-context
platform: Codex
category: General and specialized workflows
---

# gds-generate-project-context - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-generate-project-context` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-generate-project-context, then write the task. Fallback prompt: Use the gds-generate-project-context skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-generate-project-context` |
| Canonical name | `gds-generate-project-context` |
| Platform | `Codex` |
| Category | General and specialized workflows |
