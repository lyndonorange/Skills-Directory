...
# gds-generate-project-context - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-generate-project-context` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the gds-generate-project-context skill to...
