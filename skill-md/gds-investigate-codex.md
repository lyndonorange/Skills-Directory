...
display_name: gds-investigate
platform: Codex
category: General and specialized workflows
---

# gds-investigate - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-investigate` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Forensic case investigation with evidence-graded findings, calibrated to the input. Use when the user asks to investigate a bug, trace what caused an incident, walk through unfamiliar code, or build a mental model of a c

## How To Use It In Codex

In Codex, click the chat box, press /, choose gds-investigate, then write the task. Fallback prompt: Use the gds-investigate skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-investigate` |
| Canonical name | `gds-investigate` |
| Platform | `Codex` |
| Category | General and specialized workflows |
