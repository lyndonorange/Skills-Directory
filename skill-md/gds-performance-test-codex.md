...
display_name: gds-performance-test
platform: Codex
category: General and specialized workflows
---

# gds-performance-test - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-performance-test` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-performance-test, then write the task. Fallback prompt: Use the gds-performance-test skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-performance-test` |
| Canonical name | `gds-performance-test` |
| Platform | `Codex` |
| Category | General and specialized workflows |
