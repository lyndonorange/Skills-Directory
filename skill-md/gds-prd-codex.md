---
name: gds-prd
display_name: gds-prd
platform: Codex
category: General and specialized workflows
---

# gds-prd - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-prd` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Create, update, validate, or analyze a game project's PRD. Use when the user wants help producing, editing, validating, or analyzing a PRD — often derived from a GDD or prepared for external-tool integration.

## How To Use It In Codex

In Codex, click the chat box, press /, choose gds-prd, then write the task. Fallback prompt: Use the gds-prd skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-prd` |
| Canonical name | `gds-prd` |
| Platform | `Codex` |
| Category | General and specialized workflows |
