...
display_name: gds-retrospective
platform: Codex
category: General and specialized workflows
---

# gds-retrospective - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-retrospective` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-retrospective, then write the task. Fallback prompt: Use the gds-retrospective skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-retrospective` |
| Canonical name | `gds-retrospective` |
| Platform | `Codex` |
| Category | General and specialized workflows |
