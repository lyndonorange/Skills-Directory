...
display_name: gds-sprint-planning
platform: Codex
category: General and specialized workflows
---

# gds-sprint-planning - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-sprint-planning` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-sprint-planning, then write the task. Fallback prompt: Use the gds-sprint-planning skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-sprint-planning` |
| Canonical name | `gds-sprint-planning` |
| Platform | `Codex` |
| Category | General and specialized workflows |
