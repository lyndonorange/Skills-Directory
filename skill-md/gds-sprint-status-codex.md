...
display_name: gds-sprint-status
platform: Codex
category: General and specialized workflows
---

# gds-sprint-status - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-sprint-status` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-sprint-status, then write the task. Fallback prompt: Use the gds-sprint-status skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-sprint-status` |
| Canonical name | `gds-sprint-status` |
| Platform | `Codex` |
| Category | General and specialized workflows |
