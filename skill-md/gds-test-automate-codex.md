...
display_name: gds-test-automate
platform: Codex
category: General and specialized workflows
---

# gds-test-automate - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-test-automate` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-test-automate, then write the task. Fallback prompt: Use the gds-test-automate skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-test-automate` |
| Canonical name | `gds-test-automate` |
| Platform | `Codex` |
| Category | General and specialized workflows |
