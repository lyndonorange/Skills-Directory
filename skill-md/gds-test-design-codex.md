...
display_name: gds-test-design
platform: Codex
category: General and specialized workflows
---

# gds-test-design - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-test-design` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-test-design, then write the task. Fallback prompt: Use the gds-test-design skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-test-design` |
| Canonical name | `gds-test-design` |
| Platform | `Codex` |
| Category | General and specialized workflows |
