...
display_name: gds-test-review
platform: Codex
category: General and specialized workflows
---

# gds-test-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gds-test-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gds-test-review, then write the task. Fallback prompt: Use the gds-test-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gds-test-review` |
| Canonical name | `gds-test-review` |
| Platform | `Codex` |
| Category | General and specialized workflows |
