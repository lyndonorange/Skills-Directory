...
display_name: gemini-agents-api
platform: Codex
category: General and specialized workflows
---

# gemini-agents-api - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gemini-agents-api` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Manages custom Agent resources on Gemini Enterprise Agent Platform. Use when the user wants to programmatically create, configure, list, update, or delete stateful, server-managed Agent resources (including mounting file

## How To Use It In Codex

In Codex, click the chat box, press /, choose gemini-agents-api, then write the task. Fallback prompt: Use the gemini-agents-api skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gemini-agents-api` |
| Canonical name | `gemini-agents-api` |
| Platform | `Codex` |
| Category | General and specialized workflows |
