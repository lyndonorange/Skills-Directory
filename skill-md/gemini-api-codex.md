...
# gemini-api - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gemini-api` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Use when the user asks about using Gemini in an enterprise environment or explicitly mentions Vertex AI, Google Cloud, or Agent Platform. Guides the usage of the Gemini API on Agent Platform with the Google Gen AI SDK. C

## How To Use It In Codex

In Codex, click the chat box, press /, choose gemini-api, then write the task. Fallback prompt: Use the gemini-api skill to...
