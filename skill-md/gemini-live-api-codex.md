...
# gemini-live-api - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gemini-live-api` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Generates a Gemini LiveAPI client service class in the user's chosen programming language. Use when the user wants to build, scaffold, or integrate a client that connects to the Gemini Enterprise LiveAPI websocket endpoi

## How To Use It In Codex

In Codex, click the chat box, press /, choose gemini-live-api, then write the task. Fallback prompt: Use the gemini-live-api skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gemini-live-api` |
| Canonical name | `gemini-live-api` |
| Platform | `Codex` |
| Category | General and specialized workflows |
