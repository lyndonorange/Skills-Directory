...
# gh-fix-ci - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gh-fix-ci` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gh-fix-ci, then write the task. Fallback prompt: Use the gh-fix-ci skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gh-fix-ci` |
| Canonical name | `gh-fix-ci` |
| Platform | `Codex` |
| Category | Software engineering and app building |
