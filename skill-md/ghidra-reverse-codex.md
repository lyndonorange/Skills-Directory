---
name: ghidra-reverse
display_name: ghidra-reverse
platform: Codex
category: General and specialized workflows
---

# ghidra-reverse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ghidra-reverse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose ghidra-reverse, then write the task. Fallback prompt: Use the ghidra-reverse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `ghidra-reverse` |
| Canonical name | `ghidra-reverse` |
| Platform | `Codex` |
| Category | General and specialized workflows |
