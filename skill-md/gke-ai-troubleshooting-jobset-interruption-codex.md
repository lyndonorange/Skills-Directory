...
display_name: gke-ai-troubleshooting-jobset-interruption
platform: Codex
category: General and specialized workflows
---

# gke-ai-troubleshooting-jobset-interruption - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-ai-troubleshooting-jobset-interruption` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Diagnoses GKE JobSet interruptions, restarts, and preemptions for AI/ML training workloads autonomously. Use when troubleshooting JobSet restart loops, spot VM preemptions, node readiness failures, host VM issues, or coo

## How To Use It In Codex

In Codex, click the chat box, press /, choose gke-ai-troubleshooting-jobset-interruption, then write the task. Fallback prompt: Use the gke-ai-troubleshooting-jobset-interruption skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gke-ai-troubleshooting-jobset-interruption` |
| Canonical name | `gke-ai-troubleshooting-jobset-interruption` |
| Platform | `Codex` |
| Category | General and specialized workflows |
