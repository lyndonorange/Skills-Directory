...
display_name: gke-ai-troubleshooting-tpu-vbar-oom
platform: Codex
category: General and specialized workflows
---

# gke-ai-troubleshooting-tpu-vbar-oom - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-ai-troubleshooting-tpu-vbar-oom` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Diagnoses and prevents vbar_control_agent segfaults, out-of-memory (OOM) errors, and TPU device initialization failures on TPU v6e nodes in GKE caused by race conditions during TPU device resets or high-frequency metrics

## How To Use It In Codex

In Codex, click the chat box, press /, choose gke-ai-troubleshooting-tpu-vbar-oom, then write the task. Fallback prompt: Use the gke-ai-troubleshooting-tpu-vbar-oom skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gke-ai-troubleshooting-tpu-vbar-oom` |
| Canonical name | `gke-ai-troubleshooting-tpu-vbar-oom` |
| Platform | `Codex` |
| Category | General and specialized workflows |
