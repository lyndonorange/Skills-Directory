...
display_name: gke-app-onboarding
platform: Codex
category: General and specialized workflows
---

# gke-app-onboarding - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-app-onboarding` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Manages GKE application onboarding, covering containerization, deployment manifests, and migration. Use when onboarding or deploying an application to GKE for the first time, or containerizing an app for GKE. Don't use f

## How To Use It In Codex

In Codex, click the chat box, press /, choose gke-app-onboarding, then write the task. Fallback prompt: Use the gke-app-onboarding skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gke-app-onboarding` |
| Canonical name | `gke-app-onboarding` |
| Platform | `Codex` |
| Category | General and specialized workflows |
