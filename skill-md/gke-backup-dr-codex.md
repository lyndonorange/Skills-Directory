...
# gke-backup-dr - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-backup-dr` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gke-backup-dr, then write the task. Fallback prompt: Use the gke-backup-dr skill to...
