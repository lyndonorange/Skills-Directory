...
# gke-basics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-basics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Manages core GKE cluster provisioning, credentials, Autopilot vs Standard selection, and workload deployment. Use when creating GKE clusters, fetching kubectl credentials, configuring Workload Identity, or deciding betwe

## How To Use It In Codex

In Codex, click the chat box, press /, choose gke-basics, then write the task. Fallback prompt: Use the gke-basics skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gke-basics` |
| Canonical name | `gke-basics` |
| Platform | `Codex` |
| Category | General and specialized workflows |
