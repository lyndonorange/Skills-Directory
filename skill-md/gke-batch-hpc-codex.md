...
# gke-batch-hpc - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-batch-hpc` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gke-batch-hpc, then write the task. Fallback prompt: Use the gke-batch-hpc skill to...
