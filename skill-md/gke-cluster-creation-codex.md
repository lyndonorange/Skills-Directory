...
display_name: gke-cluster-creation
platform: Codex
category: General and specialized workflows
---

# gke-cluster-creation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-cluster-creation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Plans and executes GKE cluster creation, provisioning, and production readiness audits using pre-defined templates (Autopilot, Standard Regional, GPU/AI Inference, AI Hypercompute). Use when creating GKE clusters, provis

## How To Use It In Codex

In Codex, click the chat box, press /, choose gke-cluster-creation, then write the task. Fallback prompt: Use the gke-cluster-creation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gke-cluster-creation` |
| Canonical name | `gke-cluster-creation` |
| Platform | `Codex` |
| Category | General and specialized workflows |
