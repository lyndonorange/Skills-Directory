...
# gke-compute-classes - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-compute-classes` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the gke-compute-classes skill to...
