...
display_name: gke-cost-analysis
platform: Codex
category: General and specialized workflows
---

# gke-cost-analysis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-cost-analysis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Answer natural language questions and perform analysis on GKE cluster and workload costs using BigQuery billing exports, cost allocation data, and live cluster monitoring metrics. Use when querying GKE costs across proje

## How To Use It In Codex

In Codex, click the chat box, press /, choose gke-cost-analysis, then write the task. Fallback prompt: Use the gke-cost-analysis skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gke-cost-analysis` |
| Canonical name | `gke-cost-analysis` |
| Platform | `Codex` |
| Category | General and specialized workflows |
