...
display_name: gke-cost-optimization
platform: Codex
category: General and specialized workflows
---

# gke-cost-optimization - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-cost-optimization` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Optimizes GKE costs, rightsizes workloads, and configures Spot VMs, CUDs, cost allocation, and resource quotas. Use when optimizing GKE cluster or workload costs, configuring GKE cost allocation or quotas, rightsizing CP

## How To Use It In Codex

In Codex, click the chat box, press /, choose gke-cost-optimization, then write the task. Fallback prompt: Use the gke-cost-optimization skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gke-cost-optimization` |
| Canonical name | `gke-cost-optimization` |
| Platform | `Codex` |
| Category | General and specialized workflows |
