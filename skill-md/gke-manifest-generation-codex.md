...
display_name: gke-manifest-generation
platform: Codex
category: General and specialized workflows
---

# gke-manifest-generation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-manifest-generation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Generates and updates secure, production-ready Kubernetes YAML manifests optimized for GKE Autopilot and GKE Standard clusters. Use when creating or modifying GKE deployment manifests, configuring container security cont

## How To Use It In Codex

In Codex, click the chat box, press /, choose gke-manifest-generation, then write the task. Fallback prompt: Use the gke-manifest-generation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gke-manifest-generation` |
| Canonical name | `gke-manifest-generation` |
| Platform | `Codex` |
| Category | General and specialized workflows |
