---
name: gke-networking
display_name: gke-networking
platform: Codex
category: General and specialized workflows
---

# gke-networking - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-networking` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Plans, configures, and manages core GKE cluster networking. Covers private clusters, VPC-native configurations, DNS, node egress, Dataplane V2, and IP planning. Use when designing GKE networking layouts, configuring priv

## How To Use It In Codex

In Codex, click the chat box, press /, choose gke-networking, then write the task. Fallback prompt: Use the gke-networking skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gke-networking` |
| Canonical name | `gke-networking` |
| Platform | `Codex` |
| Category | General and specialized workflows |
