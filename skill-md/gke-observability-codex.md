...
display_name: gke-observability
platform: Codex
category: General and specialized workflows
---

# gke-observability - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-observability` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Configures GKE observability, including Cloud Logging, Cloud Monitoring, and managed Prometheus. Use when configuring GKE monitoring, setting up GKE logging, or configuring Prometheus metrics collection. Don't use to con

## How To Use It In Codex

In Codex, click the chat box, press /, choose gke-observability, then write the task. Fallback prompt: Use the gke-observability skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gke-observability` |
| Canonical name | `gke-observability` |
| Platform | `Codex` |
| Category | General and specialized workflows |
