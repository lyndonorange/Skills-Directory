...
display_name: gke-platform-security
platform: Codex
category: General and specialized workflows
---

# gke-platform-security - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-platform-security` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Plans, configures, and hardens platform-level Google Kubernetes Engine (GKE) cluster security. Covers cluster add-ons (Secret Manager enablement), RBAC hardening (disabling insecure bindings, audit tools), Binary Authori

## How To Use It In Codex

In Codex, click the chat box, press /, choose gke-platform-security, then write the task. Fallback prompt: Use the gke-platform-security skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gke-platform-security` |
| Canonical name | `gke-platform-security` |
| Platform | `Codex` |
| Category | General and specialized workflows |
