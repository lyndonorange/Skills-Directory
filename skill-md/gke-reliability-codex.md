...
display_name: gke-reliability
platform: Codex
category: General and specialized workflows
---

# gke-reliability - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-reliability` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Improves GKE workload reliability, using PDBs, health probes, and topology spread constraints. Use when configuring GKE workload reliability, setting up PDBs, or configuring GKE health probes (liveness, readiness, startu

## How To Use It In Codex

In Codex, click the chat box, press /, choose gke-reliability, then write the task. Fallback prompt: Use the gke-reliability skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gke-reliability` |
| Canonical name | `gke-reliability` |
| Platform | `Codex` |
| Category | General and specialized workflows |
