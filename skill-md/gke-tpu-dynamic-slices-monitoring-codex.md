...
display_name: gke-tpu-dynamic-slices-monitoring
platform: Codex
category: General and specialized workflows
---

# gke-tpu-dynamic-slices-monitoring - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-tpu-dynamic-slices-monitoring` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Monitors, troubleshoots, and manages GKE TPU Dynamic Slices custom resources. Use when checking TPU slice lifecycle states, troubleshooting slice provisioning failures, validating single-slice or multi-slice (JobSet) wor

## How To Use It In Codex

In Codex, click the chat box, press /, choose gke-tpu-dynamic-slices-monitoring, then write the task. Fallback prompt: Use the gke-tpu-dynamic-slices-monitoring skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gke-tpu-dynamic-slices-monitoring` |
| Canonical name | `gke-tpu-dynamic-slices-monitoring` |
| Platform | `Codex` |
| Category | General and specialized workflows |
