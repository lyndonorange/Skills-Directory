...
display_name: gke-workload-troubleshooting
platform: Codex
category: General and specialized workflows
---

# gke-workload-troubleshooting - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gke-workload-troubleshooting` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Diagnoses GKE workload failures (CrashLoopBackOff, OOMKilled, ImagePullBackOff, Pending, etc.) via logs and events. Use when pods fail to start or crash repeatedly. Don't use for GKE cluster infrastructure provisioning,

## How To Use It In Codex

In Codex, click the chat box, press /, choose gke-workload-troubleshooting, then write the task. Fallback prompt: Use the gke-workload-troubleshooting skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gke-workload-troubleshooting` |
| Canonical name | `gke-workload-troubleshooting` |
| Platform | `Codex` |
| Category | General and specialized workflows |
