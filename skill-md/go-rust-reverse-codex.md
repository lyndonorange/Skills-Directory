...
display_name: go-rust-reverse
platform: Codex
category: General and specialized workflows
---

# go-rust-reverse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `go-rust-reverse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose go-rust-reverse, then write the task. Fallback prompt: Use the go-rust-reverse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `go-rust-reverse` |
| Canonical name | `go-rust-reverse` |
| Platform | `Codex` |
| Category | General and specialized workflows |
