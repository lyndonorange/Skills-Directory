...
display_name: google-ads-api-account-diagnostics
platform: Codex
category: General and specialized workflows
---

# google-ads-api-account-diagnostics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-ads-api-account-diagnostics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Diagnoses Google Ads account performance issues such as conversion loss (value or volume), low lead flow/volume, and lost impression share (opportunities) due to ad rank, bids, or budgets. Use when troubleshooting sudden

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-ads-api-account-diagnostics, then write the task. Fallback prompt: Use the google-ads-api-account-diagnostics skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-ads-api-account-diagnostics` |
| Canonical name | `google-ads-api-account-diagnostics` |
| Platform | `Codex` |
| Category | General and specialized workflows |
