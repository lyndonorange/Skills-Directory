...
# google-ads-api-account-diagnostics - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-ads-api-account-diagnostics` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the google-ads-api-account-diagnostics skill to...
