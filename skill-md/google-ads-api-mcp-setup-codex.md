...
display_name: google-ads-api-mcp-setup
platform: Codex
category: General and specialized workflows
---

# google-ads-api-mcp-setup - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-ads-api-mcp-setup` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Guides developers through downloading, configuring, and installing the official open-source Google Ads MCP Server. Use this skill when a user wants to connect their AI assistant (such as Gemini, Claude Code, or Cursor) t

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-ads-api-mcp-setup, then write the task. Fallback prompt: Use the google-ads-api-mcp-setup skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-ads-api-mcp-setup` |
| Canonical name | `google-ads-api-mcp-setup` |
| Platform | `Codex` |
| Category | General and specialized workflows |
