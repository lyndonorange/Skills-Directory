...
# google-agents-cli-onboarding - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-agents-cli-onboarding` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Onboarding entrypoint for agents-cli in Agent Platform. It should be used when the user wants to \"create a new agent\", \"develop an agent\", \"build an agent using ADK\", \"run the agent locally\", \"debug agent code\"

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-agents-cli-onboarding, then write the task. Fallback prompt: Use the google-agents-cli-onboarding skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-agents-cli-onboarding` |
| Canonical name | `google-agents-cli-onboarding` |
| Platform | `Codex` |
| Category | General and specialized workflows |
