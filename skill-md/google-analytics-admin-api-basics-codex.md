...
# google-analytics-admin-api-basics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-analytics-admin-api-basics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose google-analytics-admin-api-basics, then write the task. Fallback prompt: Use the google-analytics-admin-api-basics skill to...
