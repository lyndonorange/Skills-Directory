...
display_name: google-analytics-data-api-basics
platform: Codex
category: General and specialized workflows
---

# google-analytics-data-api-basics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-analytics-data-api-basics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Manages Google Analytics reporting data, enables the Analytics Data API via the Cloud CLI, and creates reports using the Google Analytics Data API (v1beta). Use when you need to interact with Google Analytics properties,

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-analytics-data-api-basics, then write the task. Fallback prompt: Use the google-analytics-data-api-basics skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-analytics-data-api-basics` |
| Canonical name | `google-analytics-data-api-basics` |
| Platform | `Codex` |
| Category | General and specialized workflows |
