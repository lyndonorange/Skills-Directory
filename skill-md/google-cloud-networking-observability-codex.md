...
display_name: google-cloud-networking-observability
platform: Codex
category: General and specialized workflows
---

# google-cloud-networking-observability - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-networking-observability` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Investigates Google Cloud networking issues by analyzing logs, metrics, and diagnostics. Use when investigating VPC Flow Logs (including cost estimation), NAT, firewall, or threat logs, querying latency and throughput me

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-cloud-networking-observability, then write the task. Fallback prompt: Use the google-cloud-networking-observability skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-cloud-networking-observability` |
| Canonical name | `google-cloud-networking-observability` |
| Platform | `Codex` |
| Category | General and specialized workflows |
