...
# google-cloud-recipe-auth - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-recipe-auth` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the google-cloud-recipe-auth skill to...
