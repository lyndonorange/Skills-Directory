...
display_name: google-cloud-recipe-foundation-builder
platform: Codex
category: General and specialized workflows
---

# google-cloud-recipe-foundation-builder - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-recipe-foundation-builder` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Deploys a baseline landing zone foundation for a Google Cloud Organization, establishing security guardrails using Organization Policies, resource hierarchy folders and projects, billing association, and centralized logg

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-cloud-recipe-foundation-builder, then write the task. Fallback prompt: Use the google-cloud-recipe-foundation-builder skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-cloud-recipe-foundation-builder` |
| Canonical name | `google-cloud-recipe-foundation-builder` |
| Platform | `Codex` |
| Category | General and specialized workflows |
