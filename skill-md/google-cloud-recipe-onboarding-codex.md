...
display_name: google-cloud-recipe-onboarding
platform: Codex
category: General and specialized workflows
---

# google-cloud-recipe-onboarding - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-recipe-onboarding` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Guides a developer's first steps on Google Cloud, covering account creation, billing setup, project management, and deploying a first resource. Use when a new developer wants to initialize their first Google Cloud projec

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-cloud-recipe-onboarding, then write the task. Fallback prompt: Use the google-cloud-recipe-onboarding skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-cloud-recipe-onboarding` |
| Canonical name | `google-cloud-recipe-onboarding` |
| Platform | `Codex` |
| Category | General and specialized workflows |
