...
display_name: google-cloud-slo-alert-configuration
platform: Codex
category: General and specialized workflows
---

# google-cloud-slo-alert-configuration - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-slo-alert-configuration` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Configures PromQL-based Service Level Objective (SLO) alerting policies for Google Cloud resources registered in App Hub or individually specified. Generates Terraform output. Use when the user asks to configure an SLO o

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-cloud-slo-alert-configuration, then write the task. Fallback prompt: Use the google-cloud-slo-alert-configuration skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-cloud-slo-alert-configuration` |
| Canonical name | `google-cloud-slo-alert-configuration` |
| Platform | `Codex` |
| Category | General and specialized workflows |
