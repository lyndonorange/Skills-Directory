...
# google-cloud-slo-alert-configuration - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-slo-alert-configuration` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the google-cloud-slo-alert-configuration skill to...
