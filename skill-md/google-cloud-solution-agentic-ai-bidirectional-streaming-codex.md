...
display_name: google-cloud-solution-agentic-ai-bidirectional-streaming
platform: Codex
category: General and specialized workflows
---

# google-cloud-solution-agentic-ai-bidirectional-streaming - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-solution-agentic-ai-bidirectional-streaming` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Guides agents to interactively discover customer requirements for live, bidirectional multi-agent AI systems that process continuous streams of multimodal data for real-time technical guidance and safety monitoring. Gene

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-cloud-solution-agentic-ai-bidirectional-streaming, then write the task. Fallback prompt: Use the google-cloud-solution-agentic-ai-bidirectional-streaming skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-cloud-solution-agentic-ai-bidirectional-streaming` |
| Canonical name | `google-cloud-solution-agentic-ai-bidirectional-streaming` |
| Platform | `Codex` |
| Category | General and specialized workflows |
