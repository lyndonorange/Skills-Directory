...
# google-cloud-solution-agentic-ai-bidirectional-streaming - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-solution-agentic-ai-bidirectional-streaming` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the google-cloud-solution-agentic-ai-bidirectional-streaming skill to...
