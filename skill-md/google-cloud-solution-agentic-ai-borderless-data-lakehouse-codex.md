...
display_name: google-cloud-solution-agentic-ai-borderless-data-lakehouse
platform: Codex
category: General and specialized workflows
---

# google-cloud-solution-agentic-ai-borderless-data-lakehouse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-solution-agentic-ai-borderless-data-lakehouse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Guides agents to discover requirements and design a governed, secure borderless open data lakehouse with agentic AI integration. Use when designing a multi-product architecture that connects data silos to AI agents, join

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-cloud-solution-agentic-ai-borderless-data-lakehouse, then write the task. Fallback prompt: Use the google-cloud-solution-agentic-ai-borderless-data-lakehouse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-cloud-solution-agentic-ai-borderless-data-lakehouse` |
| Canonical name | `google-cloud-solution-agentic-ai-borderless-data-lakehouse` |
| Platform | `Codex` |
| Category | General and specialized workflows |
