...
display_name: google-cloud-solution-agentic-ai-data-science-workflow
platform: Codex
category: General and specialized workflows
---

# google-cloud-solution-agentic-ai-data-science-workflow - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-solution-agentic-ai-data-science-workflow` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Designs a tailored multi-product agentic data science architecture on Google Cloud that incorporates opinionated best practices. Use when architecting multi-product solutions for agent-based data analytics or ML workload

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-cloud-solution-agentic-ai-data-science-workflow, then write the task. Fallback prompt: Use the google-cloud-solution-agentic-ai-data-science-workflow skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-cloud-solution-agentic-ai-data-science-workflow` |
| Canonical name | `google-cloud-solution-agentic-ai-data-science-workflow` |
| Platform | `Codex` |
| Category | General and specialized workflows |
