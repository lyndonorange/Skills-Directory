...
display_name: google-cloud-solution-guided-gke-ai-migration
platform: Codex
category: General and specialized workflows
---

# google-cloud-solution-guided-gke-ai-migration - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-solution-guided-gke-ai-migration` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Guides the migration of existing AI workloads (Cloud Run, Gemini API, Gemini Enterprise Agent Platform) to self-hosted GKE inference using gcloud and kubectl. Use when the user has an existing AI inference workload (on C

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-cloud-solution-guided-gke-ai-migration, then write the task. Fallback prompt: Use the google-cloud-solution-guided-gke-ai-migration skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-cloud-solution-guided-gke-ai-migration` |
| Canonical name | `google-cloud-solution-guided-gke-ai-migration` |
| Platform | `Codex` |
| Category | General and specialized workflows |
