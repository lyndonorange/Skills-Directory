...
display_name: google-cloud-solution-rag-enterprise-search-gke-sqldb
platform: Codex
category: General and specialized workflows
---

# google-cloud-solution-rag-enterprise-search-gke-sqldb - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-solution-rag-enterprise-search-gke-sqldb` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Discovers requirements, and generates architectural, design, and deployment guidance for a retrieval-augmented generation (RAG)-capable enterprise search system in Google Cloud. Use when users need a vector-enabled SQL d

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-cloud-solution-rag-enterprise-search-gke-sqldb, then write the task. Fallback prompt: Use the google-cloud-solution-rag-enterprise-search-gke-sqldb skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-cloud-solution-rag-enterprise-search-gke-sqldb` |
| Canonical name | `google-cloud-solution-rag-enterprise-search-gke-sqldb` |
| Platform | `Codex` |
| Category | General and specialized workflows |
