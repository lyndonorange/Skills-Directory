...
display_name: google-cloud-storage-basics
platform: Codex
category: General and specialized workflows
---

# google-cloud-storage-basics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-storage-basics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Stores, retrieves, and manages data as objects in Cloud Storage (Google Cloud Storage, or GCS) buckets. Use when you need to interact with Cloud Storage \u2014 create or configure buckets, upload, download, stream, or tr

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-cloud-storage-basics, then write the task. Fallback prompt: Use the google-cloud-storage-basics skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-cloud-storage-basics` |
| Canonical name | `google-cloud-storage-basics` |
| Platform | `Codex` |
| Category | General and specialized workflows |
