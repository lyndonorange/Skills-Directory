...
display_name: google-cloud-waf-cost-optimization
platform: Codex
category: General and specialized workflows
---

# google-cloud-waf-cost-optimization - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-waf-cost-optimization` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Generates cost optimization guidance for Google Cloud workloads based on the Google Cloud Well-Architected Framework (WAF). Use this skill to evaluate a workload, identify cost requirements and constraints, and provide a

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-cloud-waf-cost-optimization, then write the task. Fallback prompt: Use the google-cloud-waf-cost-optimization skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-cloud-waf-cost-optimization` |
| Canonical name | `google-cloud-waf-cost-optimization` |
| Platform | `Codex` |
| Category | General and specialized workflows |
