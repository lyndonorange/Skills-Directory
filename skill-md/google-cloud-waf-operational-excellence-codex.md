...
display_name: google-cloud-waf-operational-excellence
platform: Codex
category: General and specialized workflows
---

# google-cloud-waf-operational-excellence - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-waf-operational-excellence` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Generates operations-focused guidance for Google Cloud workloads based on the design principles and recommendations in the Operational Excellence pillar of the Google Cloud Well-Architected Framework (WAF). Use this skil

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-cloud-waf-operational-excellence, then write the task. Fallback prompt: Use the google-cloud-waf-operational-excellence skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-cloud-waf-operational-excellence` |
| Canonical name | `google-cloud-waf-operational-excellence` |
| Platform | `Codex` |
| Category | General and specialized workflows |
