...
display_name: google-cloud-waf-performance-optimization
platform: Codex
category: General and specialized workflows
---

# google-cloud-waf-performance-optimization - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-waf-performance-optimization` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Generates performance-focused guidance for Google Cloud workloads based on the design principles and recommendations in the Performance Optimization pillar of the Google Cloud Well-Architected Framework (WAF). Use this s

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-cloud-waf-performance-optimization, then write the task. Fallback prompt: Use the google-cloud-waf-performance-optimization skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-cloud-waf-performance-optimization` |
| Canonical name | `google-cloud-waf-performance-optimization` |
| Platform | `Codex` |
| Category | General and specialized workflows |
