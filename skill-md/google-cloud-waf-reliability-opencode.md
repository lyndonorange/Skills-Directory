...
# google-cloud-waf-reliability - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-waf-reliability` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the google-cloud-waf-reliability skill to...
