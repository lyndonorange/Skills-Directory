...
# google-cloud-waf-reliability - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-waf-reliability` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the google-cloud-waf-reliability skill to...
