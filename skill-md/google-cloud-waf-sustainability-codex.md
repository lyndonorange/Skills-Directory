...
display_name: google-cloud-waf-sustainability
platform: Codex
category: General and specialized workflows
---

# google-cloud-waf-sustainability - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-cloud-waf-sustainability` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Generates sustainability-focused guidance for Google Cloud workloads based on the design principles and recommendations in the Google Cloud Well-Architected Framework (WAF). Use this skill to evaluate a workload, identif

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-cloud-waf-sustainability, then write the task. Fallback prompt: Use the google-cloud-waf-sustainability skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-cloud-waf-sustainability` |
| Canonical name | `google-cloud-waf-sustainability` |
| Platform | `Codex` |
| Category | General and specialized workflows |
