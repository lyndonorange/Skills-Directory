...
display_name: google-mobile-ads-android-migrate-to-next-gen
platform: Codex
category: General and specialized workflows
---

# google-mobile-ads-android-migrate-to-next-gen - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-mobile-ads-android-migrate-to-next-gen` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Migrates Android applications from the old, legacy Google Mobile Ads (GMA) SDK (com.google.android.gms:play-services-ads) to the new GMA Next-Gen SDK (com.google.android.libraries.ads.mobile.sdk:ads-mobile-sdk). Provides

## How To Use It In Codex

In Codex, click the chat box, press /, choose google-mobile-ads-android-migrate-to-next-gen, then write the task. Fallback prompt: Use the google-mobile-ads-android-migrate-to-next-gen skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `google-mobile-ads-android-migrate-to-next-gen` |
| Canonical name | `google-mobile-ads-android-migrate-to-next-gen` |
| Platform | `Codex` |
| Category | General and specialized workflows |
