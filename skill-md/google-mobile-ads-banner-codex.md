...
# google-mobile-ads-banner - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-mobile-ads-banner` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose google-mobile-ads-banner, then write the task. Fallback prompt: Use the google-mobile-ads-banner skill to...
