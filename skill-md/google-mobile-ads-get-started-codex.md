...
# google-mobile-ads-get-started - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-mobile-ads-get-started` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose google-mobile-ads-get-started, then write the task. Fallback prompt: Use the google-mobile-ads-get-started skill to...
