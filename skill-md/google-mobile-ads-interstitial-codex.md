...
# google-mobile-ads-interstitial - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `google-mobile-ads-interstitial` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose google-mobile-ads-interstitial, then write the task. Fallback prompt: Use the google-mobile-ads-interstitial skill to...
