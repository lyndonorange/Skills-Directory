---
name: gpt-taste
display_name: gpt-taste
platform: Codex
category: General and specialized workflows
---

# gpt-taste - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gpt-taste` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gpt-taste, then write the task. Fallback prompt: Use the gpt-taste skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gpt-taste` |
| Canonical name | `gpt-taste` |
| Platform | `Codex` |
| Category | General and specialized workflows |
