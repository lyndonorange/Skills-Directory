...
# gpt-taste - Local Project Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `gpt-taste` for Local Project Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
From this workspace, type: Use the gpt-taste skill to...
