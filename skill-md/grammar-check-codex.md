---
name: pm-skills-grammar-check
display_name: grammar-check
platform: Codex
category: PM operations, communication, and utilities
---

# grammar-check - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `grammar-check` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose grammar-check, then write the task. Fallback prompt: Use the grammar-check skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `grammar-check` |
| Canonical name | `pm-skills-grammar-check` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
