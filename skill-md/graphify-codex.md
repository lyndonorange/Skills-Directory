...
# graphify - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `graphify` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Use for any question about a codebase, its architecture, file relationships, or project content — especially when graphify-out/ exists, where the question should be treated as a graphify query first. Turns any input (cod

## How To Use It In Codex

In Codex, click the chat box, press /, choose graphify, then write the task. Fallback prompt: Use the graphify skill to...
