---
name: pm-skills-gtm-motions
display_name: gtm-motions
platform: Codex
category: Business creation, ideas, and validation
---

# gtm-motions - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gtm-motions` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gtm-motions, then write the task. Fallback prompt: Use the gtm-motions skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gtm-motions` |
| Canonical name | `pm-skills-gtm-motions` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
