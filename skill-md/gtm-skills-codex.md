...
# gtm-skills - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gtm-skills` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gtm-skills, then write the task. Fallback prompt: Use the gtm-skills skill to...
