---
name: pm-skills-gtm-strategy
display_name: gtm-strategy
platform: Codex
category: Business creation, ideas, and validation
---

# gtm-strategy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `gtm-strategy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose gtm-strategy, then write the task. Fallback prompt: Use the gtm-strategy skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `gtm-strategy` |
| Canonical name | `pm-skills-gtm-strategy` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
