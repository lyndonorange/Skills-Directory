...
display_name: hardening-docker-containers-for-production
platform: Codex
category: Security, forensics, and incident response
---

# hardening-docker-containers-for-production - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hardening-docker-containers-for-production` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Hardening Docker containers for production involves applying security best practices aligned with CIS Docker Benchmark v1.8.0 to minimize attack surface, prevent privilege escalation, and enforce least-privilege principl

## How To Use It In Codex

In Codex, click the chat box, press /, choose hardening-docker-containers-for-production, then write the task. Fallback prompt: Use the hardening-docker-containers-for-production skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hardening-docker-containers-for-production` |
| Canonical name | `hardening-docker-containers-for-production` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
