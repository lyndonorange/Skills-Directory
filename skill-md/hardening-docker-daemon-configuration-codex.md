...
display_name: hardening-docker-daemon-configuration
platform: Codex
category: Security, forensics, and incident response
---

# hardening-docker-daemon-configuration - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hardening-docker-daemon-configuration` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

The Docker daemon (`dockerd`) runs with root privileges and controls all container operations. Hardening its configuration through `/etc/docker/daemon.json`, TLS certificates, user namespace remapping, and network restri

## How To Use It In Codex

In Codex, click the chat box, press /, choose hardening-docker-daemon-configuration, then write the task. Fallback prompt: Use the hardening-docker-daemon-configuration skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hardening-docker-daemon-configuration` |
| Canonical name | `hardening-docker-daemon-configuration` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
