...
display_name: hardening-linux-endpoint-with-cis-benchmark
platform: Codex
category: Security, forensics, and incident response
---

# hardening-linux-endpoint-with-cis-benchmark - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hardening-linux-endpoint-with-cis-benchmark` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hardening-linux-endpoint-with-cis-benchmark, then write the task. Fallback prompt: Use the hardening-linux-endpoint-with-cis-benchmark skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hardening-linux-endpoint-with-cis-benchmark` |
| Canonical name | `hardening-linux-endpoint-with-cis-benchmark` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
