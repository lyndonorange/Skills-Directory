...
# health - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `health` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose health, then write the task. Fallback prompt: Use the health skill to...
