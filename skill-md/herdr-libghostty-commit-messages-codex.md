...
# herdr-libghostty-commit-messages - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `herdr-libghostty-commit-messages` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose herdr-libghostty-commit-messages, then write the task. Fallback prompt: Use the herdr-libghostty-commit-messages skill to...
