...
# herdr-pre-release-audit - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `herdr-pre-release-audit` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose herdr-pre-release-audit, then write the task. Fallback prompt: Use the herdr-pre-release-audit skill to...
