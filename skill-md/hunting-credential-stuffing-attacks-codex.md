...
display_name: hunting-credential-stuffing-attacks
platform: Codex
category: Security, forensics, and incident response
---

# hunting-credential-stuffing-attacks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-credential-stuffing-attacks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-credential-stuffing-attacks, then write the task. Fallback prompt: Use the hunting-credential-stuffing-attacks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-credential-stuffing-attacks` |
| Canonical name | `hunting-credential-stuffing-attacks` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
