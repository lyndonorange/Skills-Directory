...
display_name: hunting-for-anomalous-powershell-execution
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-anomalous-powershell-execution - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-anomalous-powershell-execution` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-anomalous-powershell-execution, then write the task. Fallback prompt: Use the hunting-for-anomalous-powershell-execution skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-anomalous-powershell-execution` |
| Canonical name | `hunting-for-anomalous-powershell-execution` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
