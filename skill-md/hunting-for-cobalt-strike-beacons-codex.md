...
display_name: hunting-for-cobalt-strike-beacons
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-cobalt-strike-beacons - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-cobalt-strike-beacons` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Cobalt Strike is the most prevalent command-and-control framework used by both red teams and threat actors. Beacon, its primary payload, communicates with team servers using configurable HTTP/HTTPS/DNS profiles that can 

## How To Use It In Codex

In Codex, click the chat box, press /, choose hunting-for-cobalt-strike-beacons, then write the task. Fallback prompt: Use the hunting-for-cobalt-strike-beacons skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-cobalt-strike-beacons` |
| Canonical name | `hunting-for-cobalt-strike-beacons` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
