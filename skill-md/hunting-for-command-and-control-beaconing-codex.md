...
# hunting-for-command-and-control-beaconing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-command-and-control-beaconing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-command-and-control-beaconing, then write the task. Fallback prompt: Use the hunting-for-command-and-control-beaconing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-command-and-control-beaconing` |
| Canonical name | `hunting-for-command-and-control-beaconing` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
