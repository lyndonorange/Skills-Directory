...
display_name: hunting-for-data-exfiltration-indicators
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-data-exfiltration-indicators - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-data-exfiltration-indicators` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-data-exfiltration-indicators, then write the task. Fallback prompt: Use the hunting-for-data-exfiltration-indicators skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-data-exfiltration-indicators` |
| Canonical name | `hunting-for-data-exfiltration-indicators` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
