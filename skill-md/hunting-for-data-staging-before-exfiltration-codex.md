...
display_name: hunting-for-data-staging-before-exfiltration
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-data-staging-before-exfiltration - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-data-staging-before-exfiltration` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Before exfiltrating data, adversaries typically stage collected files in a central location (MITRE ATT&CK T1074). This involves creating archives with tools like 7-Zip, RAR, or tar, consolidating files from multiple dire

## How To Use It In Codex

In Codex, click the chat box, press /, choose hunting-for-data-staging-before-exfiltration, then write the task. Fallback prompt: Use the hunting-for-data-staging-before-exfiltration skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-data-staging-before-exfiltration` |
| Canonical name | `hunting-for-data-staging-before-exfiltration` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
