...
display_name: hunting-for-dcom-lateral-movement
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-dcom-lateral-movement - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-dcom-lateral-movement` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-dcom-lateral-movement, then write the task. Fallback prompt: Use the hunting-for-dcom-lateral-movement skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-dcom-lateral-movement` |
| Canonical name | `hunting-for-dcom-lateral-movement` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
