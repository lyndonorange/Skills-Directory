...
display_name: hunting-for-dcsync-attacks
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-dcsync-attacks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-dcsync-attacks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-dcsync-attacks, then write the task. Fallback prompt: Use the hunting-for-dcsync-attacks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-dcsync-attacks` |
| Canonical name | `hunting-for-dcsync-attacks` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
