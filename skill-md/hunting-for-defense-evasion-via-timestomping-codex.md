...
display_name: hunting-for-defense-evasion-via-timestomping
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-defense-evasion-via-timestomping - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-defense-evasion-via-timestomping` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-defense-evasion-via-timestomping, then write the task. Fallback prompt: Use the hunting-for-defense-evasion-via-timestomping skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-defense-evasion-via-timestomping` |
| Canonical name | `hunting-for-defense-evasion-via-timestomping` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
