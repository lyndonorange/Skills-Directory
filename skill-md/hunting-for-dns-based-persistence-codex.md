...
display_name: hunting-for-dns-based-persistence
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-dns-based-persistence - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-dns-based-persistence` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Attackers establish DNS-based persistence by hijacking DNS records, creating unauthorized subdomains, abusing wildcard DNS entries, or modifying NS delegations to redirect traffic through attacker-controlled infrastructu

## How To Use It In Codex

In Codex, click the chat box, press /, choose hunting-for-dns-based-persistence, then write the task. Fallback prompt: Use the hunting-for-dns-based-persistence skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-dns-based-persistence` |
| Canonical name | `hunting-for-dns-based-persistence` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
