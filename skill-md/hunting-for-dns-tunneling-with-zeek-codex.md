...
# hunting-for-dns-tunneling-with-zeek - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-dns-tunneling-with-zeek` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-dns-tunneling-with-zeek, then write the task. Fallback prompt: Use the hunting-for-dns-tunneling-with-zeek skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-dns-tunneling-with-zeek` |
| Canonical name | `hunting-for-dns-tunneling-with-zeek` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
