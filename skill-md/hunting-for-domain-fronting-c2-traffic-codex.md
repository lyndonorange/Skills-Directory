...
display_name: hunting-for-domain-fronting-c2-traffic
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-domain-fronting-c2-traffic - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-domain-fronting-c2-traffic` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Domain fronting (MITRE ATT&CK T1090.004) is a technique where attackers use different domain names in the TLS SNI field and the HTTP Host header to disguise C2 traffic behind legitimate CDN-hosted domains. This skill det

## How To Use It In Codex

In Codex, click the chat box, press /, choose hunting-for-domain-fronting-c2-traffic, then write the task. Fallback prompt: Use the hunting-for-domain-fronting-c2-traffic skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-domain-fronting-c2-traffic` |
| Canonical name | `hunting-for-domain-fronting-c2-traffic` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
