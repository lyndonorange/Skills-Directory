...
display_name: hunting-for-lateral-movement-via-wmi
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-lateral-movement-via-wmi - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-lateral-movement-via-wmi` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Windows Management Instrumentation (WMI) is commonly abused for lateral movement via `wmic process call create` or Win32_Process.Create() to execute commands on remote hosts. Detection focuses on identifying WmiPrvSE.exe

## How To Use It In Codex

In Codex, click the chat box, press /, choose hunting-for-lateral-movement-via-wmi, then write the task. Fallback prompt: Use the hunting-for-lateral-movement-via-wmi skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-lateral-movement-via-wmi` |
| Canonical name | `hunting-for-lateral-movement-via-wmi` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
