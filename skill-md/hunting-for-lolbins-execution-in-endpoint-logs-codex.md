...
# hunting-for-lolbins-execution-in-endpoint-logs - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-lolbins-execution-in-endpoint-logs` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-lolbins-execution-in-endpoint-logs, then write the task. Fallback prompt: Use the hunting-for-lolbins-execution-in-endpoint-logs skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-lolbins-execution-in-endpoint-logs` |
| Canonical name | `hunting-for-lolbins-execution-in-endpoint-logs` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
