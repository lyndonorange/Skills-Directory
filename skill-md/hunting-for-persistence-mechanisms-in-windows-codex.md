...
display_name: hunting-for-persistence-mechanisms-in-windows
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-persistence-mechanisms-in-windows - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-persistence-mechanisms-in-windows` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-persistence-mechanisms-in-windows, then write the task. Fallback prompt: Use the hunting-for-persistence-mechanisms-in-windows skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-persistence-mechanisms-in-windows` |
| Canonical name | `hunting-for-persistence-mechanisms-in-windows` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
