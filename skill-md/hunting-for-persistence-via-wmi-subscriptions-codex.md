...
# hunting-for-persistence-via-wmi-subscriptions - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-persistence-via-wmi-subscriptions` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-persistence-via-wmi-subscriptions, then write the task. Fallback prompt: Use the hunting-for-persistence-via-wmi-subscriptions skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-persistence-via-wmi-subscriptions` |
| Canonical name | `hunting-for-persistence-via-wmi-subscriptions` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
