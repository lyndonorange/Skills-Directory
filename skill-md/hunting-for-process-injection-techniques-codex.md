...
display_name: hunting-for-process-injection-techniques
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-process-injection-techniques - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-process-injection-techniques` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Process injection (MITRE ATT&CK T1055) allows adversaries to execute code in the address space of another process, enabling defense evasion and privilege escalation. This skill detects injection techniques via Sysmon Eve

## How To Use It In Codex

In Codex, click the chat box, press /, choose hunting-for-process-injection-techniques, then write the task. Fallback prompt: Use the hunting-for-process-injection-techniques skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-process-injection-techniques` |
| Canonical name | `hunting-for-process-injection-techniques` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
