...
# hunting-for-scheduled-task-persistence - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-scheduled-task-persistence` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-scheduled-task-persistence, then write the task. Fallback prompt: Use the hunting-for-scheduled-task-persistence skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-scheduled-task-persistence` |
| Canonical name | `hunting-for-scheduled-task-persistence` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
