...
# hunting-for-shadow-copy-deletion - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-shadow-copy-deletion` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-shadow-copy-deletion, then write the task. Fallback prompt: Use the hunting-for-shadow-copy-deletion skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-shadow-copy-deletion` |
| Canonical name | `hunting-for-shadow-copy-deletion` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
