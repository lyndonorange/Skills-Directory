...
display_name: hunting-for-spearphishing-indicators
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-spearphishing-indicators - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-spearphishing-indicators` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-spearphishing-indicators, then write the task. Fallback prompt: Use the hunting-for-spearphishing-indicators skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-spearphishing-indicators` |
| Canonical name | `hunting-for-spearphishing-indicators` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
