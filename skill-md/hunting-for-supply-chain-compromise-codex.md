...
display_name: hunting-for-supply-chain-compromise
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-supply-chain-compromise - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-supply-chain-compromise` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-supply-chain-compromise, then write the task. Fallback prompt: Use the hunting-for-supply-chain-compromise skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-supply-chain-compromise` |
| Canonical name | `hunting-for-supply-chain-compromise` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
