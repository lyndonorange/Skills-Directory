...
# hunting-for-suspicious-scheduled-tasks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-suspicious-scheduled-tasks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-suspicious-scheduled-tasks, then write the task. Fallback prompt: Use the hunting-for-suspicious-scheduled-tasks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-suspicious-scheduled-tasks` |
| Canonical name | `hunting-for-suspicious-scheduled-tasks` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
