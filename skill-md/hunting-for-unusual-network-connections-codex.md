...
# hunting-for-unusual-network-connections - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-unusual-network-connections` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-unusual-network-connections, then write the task. Fallback prompt: Use the hunting-for-unusual-network-connections skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-unusual-network-connections` |
| Canonical name | `hunting-for-unusual-network-connections` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
