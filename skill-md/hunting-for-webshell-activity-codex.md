...
display_name: hunting-for-webshell-activity
platform: Codex
category: Security, forensics, and incident response
---

# hunting-for-webshell-activity - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hunting-for-webshell-activity` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose hunting-for-webshell-activity, then write the task. Fallback prompt: Use the hunting-for-webshell-activity skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hunting-for-webshell-activity` |
| Canonical name | `hunting-for-webshell-activity` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
