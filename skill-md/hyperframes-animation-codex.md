...
display_name: hyperframes-animation
platform: Codex
category: General and specialized workflows
---

# hyperframes-animation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hyperframes-animation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

All animation knowledge for HyperFrames — atomic motion rules, multi-phase scene blueprints, scene transitions, broader motion-design techniques, AND the seven runtime adapters (GSAP default, plus Lottie, Three.js, Anime

## How To Use It In Codex

In Codex, click the chat box, press /, choose hyperframes-animation, then write the task. Fallback prompt: Use the hyperframes-animation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hyperframes-animation` |
| Canonical name | `hyperframes-animation` |
| Platform | `Codex` |
| Category | General and specialized workflows |
