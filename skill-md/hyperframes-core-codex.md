...
display_name: hyperframes-core
platform: Codex
category: General and specialized workflows
---

# hyperframes-core - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hyperframes-core` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

The HyperFrames composition contract — build one renderable project. Use for composition structure, the `data-*` timing attributes, `class="clip"`, tracks, sub-compositions, variables, framework-owned media playback, det

## How To Use It In Codex

In Codex, click the chat box, press /, choose hyperframes-core, then write the task. Fallback prompt: Use the hyperframes-core skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hyperframes-core` |
| Canonical name | `hyperframes-core` |
| Platform | `Codex` |
| Category | General and specialized workflows |
