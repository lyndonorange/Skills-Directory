...
display_name: hyperframes-creative
platform: Codex
category: General and specialized workflows
---

# hyperframes-creative - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `hyperframes-creative` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Non-animation creative direction for HyperFrames videos. Use for design spec (frame.md / design.md) handling, palettes, typography, narration, beat planning, audio-reactive visuals, composition patterns, and brand / styl

## How To Use It In Codex

In Codex, click the chat box, press /, choose hyperframes-creative, then write the task. Fallback prompt: Use the hyperframes-creative skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `hyperframes-creative` |
| Canonical name | `hyperframes-creative` |
| Platform | `Codex` |
| Category | General and specialized workflows |
