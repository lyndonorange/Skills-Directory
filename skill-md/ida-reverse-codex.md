---
name: ida-reverse
display_name: ida-reverse
platform: Codex
category: General and specialized workflows
---

# ida-reverse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ida-reverse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose ida-reverse, then write the task. Fallback prompt: Use the ida-reverse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `ida-reverse` |
| Canonical name | `ida-reverse` |
| Platform | `Codex` |
| Category | General and specialized workflows |
