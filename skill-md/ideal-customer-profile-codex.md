---
name: pm-skills-ideal-customer-profile
display_name: ideal-customer-profile
platform: Codex
category: Business creation, ideas, and validation
---

# ideal-customer-profile - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ideal-customer-profile` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose ideal-customer-profile, then write the task. Fallback prompt: Use the ideal-customer-profile skill to...
...
| Canonical name | `pm-skills-ideal-customer-profile` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
