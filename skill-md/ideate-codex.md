...
# Ideate - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `Ideate` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Evolutionary ideation engine — loop-controlled multi-cycle idea generation through 9 phases (CONSUME, DREAM at noise=0.9, DAYDREAM at 0.5, CONTEMPLATE at 0.1, STEAL cross-domain borrowing, MATE recombination, TEST fitnes

## How To Use It In Codex

In Codex, click the chat box, press /, choose Ideate, then write the task. Fallback prompt: Use the Ideate skill to...
