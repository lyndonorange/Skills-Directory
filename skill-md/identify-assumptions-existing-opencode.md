...
# identify-assumptions-existing - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `identify-assumptions-existing` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the identify-assumptions-existing skill to...
