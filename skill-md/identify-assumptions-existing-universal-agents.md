---
name: pm-skills-identify-assumptions-existing
display_name: identify-assumptions-existing
platform: Universal Agents
category: Business creation, ideas, and validation
---

# identify-assumptions-existing - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `identify-assumptions-existing` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the identify-assumptions-existing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `identify-assumptions-existing` |
| Canonical name | `pm-skills-identify-assumptions-existing` |
| Platform | `Universal Agents` |
| Category | Business creation, ideas, and validation |
