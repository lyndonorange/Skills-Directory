---
name: pm-skills-identify-assumptions-new
display_name: identify-assumptions-new
platform: Codex
category: Business creation, ideas, and validation
---

# identify-assumptions-new - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `identify-assumptions-new` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose identify-assumptions-new, then write the task. Fallback prompt: Use the identify-assumptions-new skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `identify-assumptions-new` |
| Canonical name | `pm-skills-identify-assumptions-new` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
