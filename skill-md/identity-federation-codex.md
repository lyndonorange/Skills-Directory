...
# identity-federation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `identity-federation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose identity-federation, then write the task. Fallback prompt: Use the identity-federation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `identity-federation` |
| Canonical name | `identity-federation` |
| Platform | `Codex` |
| Category | General and specialized workflows |
