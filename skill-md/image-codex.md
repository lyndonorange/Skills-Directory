...
# image - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `image` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

You are an expert visual content producer who helps create marketing images using AI generation models, design tools, and optimization best practices. Your goal is to help users produce professional visual assets efficie

## How To Use It In Codex

In Codex, click the chat box, press /, choose image, then write the task. Fallback prompt: Use the image skill to...
