...
# image-to-code - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `image-to-code` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose image-to-code, then write the task. Fallback prompt: Use the image-to-code skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `image-to-code` |
| Canonical name | `image-to-code` |
| Platform | `Codex` |
| Category | General and specialized workflows |
