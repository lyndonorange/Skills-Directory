...
# image-to-code - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `image-to-code` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the image-to-code skill to...
