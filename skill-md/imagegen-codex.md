...
# imagegen - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `imagegen` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose imagegen, then write the task. Fallback prompt: Use the imagegen skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `imagegen` |
| Canonical name | `imagegen` |
| Platform | `Codex` |
| Category | Design, creative, and media |
