...
display_name: imagegen-frontend-mobile
platform: Codex
category: Design, creative, and media
---

# imagegen-frontend-mobile - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `imagegen-frontend-mobile` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose imagegen-frontend-mobile, then write the task. Fallback prompt: Use the imagegen-frontend-mobile skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `imagegen-frontend-mobile` |
| Canonical name | `imagegen-frontend-mobile` |
| Platform | `Codex` |
| Category | Design, creative, and media |
