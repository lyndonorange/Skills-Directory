...
display_name: imagegen-frontend-web
platform: Codex
category: Design, creative, and media
---

# imagegen-frontend-web - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `imagegen-frontend-web` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose imagegen-frontend-web, then write the task. Fallback prompt: Use the imagegen-frontend-web skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `imagegen-frontend-web` |
| Canonical name | `imagegen-frontend-web` |
| Platform | `Codex` |
| Category | Design, creative, and media |
