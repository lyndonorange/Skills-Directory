...
# impeccable - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `impeccable` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose impeccable, then write the task. Fallback prompt: Use the impeccable skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `impeccable` |
| Canonical name | `impeccable` |
| Platform | `Codex` |
| Category | General and specialized workflows |
