...
display_name: implementing-alert-fatigue-reduction
platform: Codex
category: General and specialized workflows
---

# implementing-alert-fatigue-reduction - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-alert-fatigue-reduction` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-alert-fatigue-reduction, then write the task. Fallback prompt: Use the implementing-alert-fatigue-reduction skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-alert-fatigue-reduction` |
| Canonical name | `implementing-alert-fatigue-reduction` |
| Platform | `Codex` |
| Category | General and specialized workflows |
