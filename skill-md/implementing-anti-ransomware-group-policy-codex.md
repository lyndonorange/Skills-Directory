...
display_name: implementing-anti-ransomware-group-policy
platform: Codex
category: General and specialized workflows
---

# implementing-anti-ransomware-group-policy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-anti-ransomware-group-policy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-anti-ransomware-group-policy, then write the task. Fallback prompt: Use the implementing-anti-ransomware-group-policy skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-anti-ransomware-group-policy` |
| Canonical name | `implementing-anti-ransomware-group-policy` |
| Platform | `Codex` |
| Category | General and specialized workflows |
