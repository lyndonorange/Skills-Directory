...
# implementing-api-abuse-detection-with-rate-limiting - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-api-abuse-detection-with-rate-limiting` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

API rate limiting is a critical security control that restricts the number of requests a client can make within a defined time period. It defends against denial-of-service (DDoS), brute force login attempts, credential s

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-api-abuse-detection-with-rate-limiting, then write the task. Fallback prompt: Use the implementing-api-abuse-detection-with-rate-limiting skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-api-abuse-detection-with-rate-limiting` |
| Canonical name | `implementing-api-abuse-detection-with-rate-limiting` |
| Platform | `Codex` |
| Category | Software engineering and app building |
