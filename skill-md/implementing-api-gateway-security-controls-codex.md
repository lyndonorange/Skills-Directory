...
display_name: implementing-api-gateway-security-controls
platform: Codex
category: Software engineering and app building
---

# implementing-api-gateway-security-controls - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-api-gateway-security-controls` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-api-gateway-security-controls, then write the task. Fallback prompt: Use the implementing-api-gateway-security-controls skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-api-gateway-security-controls` |
| Canonical name | `implementing-api-gateway-security-controls` |
| Platform | `Codex` |
| Category | Software engineering and app building |
