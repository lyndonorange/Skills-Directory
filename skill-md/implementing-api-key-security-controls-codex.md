...
display_name: implementing-api-key-security-controls
platform: Codex
category: Software engineering and app building
---

# implementing-api-key-security-controls - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-api-key-security-controls` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-api-key-security-controls, then write the task. Fallback prompt: Use the implementing-api-key-security-controls skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-api-key-security-controls` |
| Canonical name | `implementing-api-key-security-controls` |
| Platform | `Codex` |
| Category | Software engineering and app building |
