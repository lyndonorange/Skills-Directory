...
display_name: implementing-api-rate-limiting-and-throttling
platform: Codex
category: Software engineering and app building
---

# implementing-api-rate-limiting-and-throttling - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-api-rate-limiting-and-throttling` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-api-rate-limiting-and-throttling, then write the task. Fallback prompt: Use the implementing-api-rate-limiting-and-throttling skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-api-rate-limiting-and-throttling` |
| Canonical name | `implementing-api-rate-limiting-and-throttling` |
| Platform | `Codex` |
| Category | Software engineering and app building |
