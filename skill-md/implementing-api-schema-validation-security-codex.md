...
# implementing-api-schema-validation-security - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-api-schema-validation-security` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

API schema validation enforces that all data exchanged through APIs conforms to a predefined structure defined in OpenAPI Specification (OAS) or JSON Schema documents. This prevents injection attacks (SQLi, XSS, XXE), bl

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-api-schema-validation-security, then write the task. Fallback prompt: Use the implementing-api-schema-validation-security skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-api-schema-validation-security` |
| Canonical name | `implementing-api-schema-validation-security` |
| Platform | `Codex` |
| Category | Software engineering and app building |
