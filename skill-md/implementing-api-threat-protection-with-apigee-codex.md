...
display_name: implementing-api-threat-protection-with-apigee
platform: Codex
category: Software engineering and app building
---

# implementing-api-threat-protection-with-apigee - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-api-threat-protection-with-apigee` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Google Apigee is an enterprise API management platform that provides native security policies for threat protection, including JSON and XML content validation, OAuth 2.0 enforcement, SpikeArrest rate limiting, regular ex

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-api-threat-protection-with-apigee, then write the task. Fallback prompt: Use the implementing-api-threat-protection-with-apigee skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-api-threat-protection-with-apigee` |
| Canonical name | `implementing-api-threat-protection-with-apigee` |
| Platform | `Codex` |
| Category | Software engineering and app building |
