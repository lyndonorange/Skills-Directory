...
display_name: implementing-application-whitelisting-with-applocker
platform: Codex
category: General and specialized workflows
---

# implementing-application-whitelisting-with-applocker - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-application-whitelisting-with-applocker` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-application-whitelisting-with-applocker, then write the task. Fallback prompt: Use the implementing-application-whitelisting-with-applocker skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-application-whitelisting-with-applocker` |
| Canonical name | `implementing-application-whitelisting-with-applocker` |
| Platform | `Codex` |
| Category | General and specialized workflows |
