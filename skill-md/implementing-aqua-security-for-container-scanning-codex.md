...
display_name: implementing-aqua-security-for-container-scanning
platform: Codex
category: General and specialized workflows
---

# implementing-aqua-security-for-container-scanning - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-aqua-security-for-container-scanning` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Aqua Security provides Trivy, the world's most popular open-source universal security scanner, designed to find vulnerabilities, misconfigurations, secrets, SBOM data, and license issues in containers, Kubernetes, code r

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-aqua-security-for-container-scanning, then write the task. Fallback prompt: Use the implementing-aqua-security-for-container-scanning skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-aqua-security-for-container-scanning` |
| Canonical name | `implementing-aqua-security-for-container-scanning` |
| Platform | `Codex` |
| Category | General and specialized workflows |
