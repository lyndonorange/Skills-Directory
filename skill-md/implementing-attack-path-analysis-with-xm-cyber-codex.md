...
# implementing-attack-path-analysis-with-xm-cyber - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-attack-path-analysis-with-xm-cyber` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

XM Cyber is a continuous exposure management platform that uses attack graph analysis to identify how adversaries can chain together exposures -- vulnerabilities, misconfigurations, identity risks, and credential weaknes

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-attack-path-analysis-with-xm-cyber, then write the task. Fallback prompt: Use the implementing-attack-path-analysis-with-xm-cyber skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-attack-path-analysis-with-xm-cyber` |
| Canonical name | `implementing-attack-path-analysis-with-xm-cyber` |
| Platform | `Codex` |
| Category | General and specialized workflows |
