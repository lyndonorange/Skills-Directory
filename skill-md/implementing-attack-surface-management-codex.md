...
display_name: implementing-attack-surface-management
platform: Codex
category: General and specialized workflows
---

# implementing-attack-surface-management - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-attack-surface-management` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-attack-surface-management, then write the task. Fallback prompt: Use the implementing-attack-surface-management skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-attack-surface-management` |
| Canonical name | `implementing-attack-surface-management` |
| Platform | `Codex` |
| Category | General and specialized workflows |
