...
display_name: implementing-aws-config-rules-for-compliance
platform: Codex
category: General and specialized workflows
---

# implementing-aws-config-rules-for-compliance - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-aws-config-rules-for-compliance` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-aws-config-rules-for-compliance, then write the task. Fallback prompt: Use the implementing-aws-config-rules-for-compliance skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-aws-config-rules-for-compliance` |
| Canonical name | `implementing-aws-config-rules-for-compliance` |
| Platform | `Codex` |
| Category | General and specialized workflows |
