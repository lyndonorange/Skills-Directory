...
display_name: implementing-aws-macie-for-data-classification
platform: Codex
category: General and specialized workflows
---

# implementing-aws-macie-for-data-classification - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-aws-macie-for-data-classification` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Amazon Macie is a fully managed data security and privacy service that uses machine learning and pattern matching to discover and protect sensitive data in Amazon S3. Macie automatically evaluates your S3 bucket inventor

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-aws-macie-for-data-classification, then write the task. Fallback prompt: Use the implementing-aws-macie-for-data-classification skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-aws-macie-for-data-classification` |
| Canonical name | `implementing-aws-macie-for-data-classification` |
| Platform | `Codex` |
| Category | General and specialized workflows |
