...
display_name: implementing-aws-security-hub
platform: Codex
category: General and specialized workflows
---

# implementing-aws-security-hub - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-aws-security-hub` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-aws-security-hub, then write the task. Fallback prompt: Use the implementing-aws-security-hub skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-aws-security-hub` |
| Canonical name | `implementing-aws-security-hub` |
| Platform | `Codex` |
| Category | General and specialized workflows |
