...
display_name: implementing-aws-security-hub-compliance
platform: Codex
category: General and specialized workflows
---

# implementing-aws-security-hub-compliance - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-aws-security-hub-compliance` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-aws-security-hub-compliance, then write the task. Fallback prompt: Use the implementing-aws-security-hub-compliance skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-aws-security-hub-compliance` |
| Canonical name | `implementing-aws-security-hub-compliance` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
aws sns publish \
  ...
  --message [file URL removed]daily-summary.json
