...
display_name: implementing-azure-ad-privileged-identity-management
platform: Codex
category: General and specialized workflows
---

# implementing-azure-ad-privileged-identity-management - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-azure-ad-privileged-identity-management` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Microsoft Entra Privileged Identity Management (PIM) provides time-based and approval-based role activation to mitigate risks from excessive, unnecessary, or misused access to critical resources. PIM replaces permanent (

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-azure-ad-privileged-identity-management, then write the task. Fallback prompt: Use the implementing-azure-ad-privileged-identity-management skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-azure-ad-privileged-identity-management` |
| Canonical name | `implementing-azure-ad-privileged-identity-management` |
| Platform | `Codex` |
| Category | General and specialized workflows |
