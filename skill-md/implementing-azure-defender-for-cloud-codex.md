...
display_name: implementing-azure-defender-for-cloud
platform: Codex
category: General and specialized workflows
---

# implementing-azure-defender-for-cloud - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-azure-defender-for-cloud` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-azure-defender-for-cloud, then write the task. Fallback prompt: Use the implementing-azure-defender-for-cloud skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-azure-defender-for-cloud` |
| Canonical name | `implementing-azure-defender-for-cloud` |
| Platform | `Codex` |
| Category | General and specialized workflows |
