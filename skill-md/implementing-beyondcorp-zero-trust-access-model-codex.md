...
# implementing-beyondcorp-zero-trust-access-model - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-beyondcorp-zero-trust-access-model` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-beyondcorp-zero-trust-access-model, then write the task. Fallback prompt: Use the implementing-beyondcorp-zero-trust-access-model skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-beyondcorp-zero-trust-access-model` |
| Canonical name | `implementing-beyondcorp-zero-trust-access-model` |
| Platform | `Codex` |
| Category | General and specialized workflows |
