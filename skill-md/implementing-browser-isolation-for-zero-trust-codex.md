...
display_name: implementing-browser-isolation-for-zero-trust
platform: Codex
category: General and specialized workflows
---

# implementing-browser-isolation-for-zero-trust - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-browser-isolation-for-zero-trust` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-browser-isolation-for-zero-trust, then write the task. Fallback prompt: Use the implementing-browser-isolation-for-zero-trust skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-browser-isolation-for-zero-trust` |
| Canonical name | `implementing-browser-isolation-for-zero-trust` |
| Platform | `Codex` |
| Category | General and specialized workflows |
