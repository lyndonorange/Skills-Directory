...
display_name: implementing-canary-tokens-for-network-intrusion
platform: Codex
category: General and specialized workflows
---

# implementing-canary-tokens-for-network-intrusion - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-canary-tokens-for-network-intrusion` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-canary-tokens-for-network-intrusion, then write the task. Fallback prompt: Use the implementing-canary-tokens-for-network-intrusion skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-canary-tokens-for-network-intrusion` |
| Canonical name | `implementing-canary-tokens-for-network-intrusion` |
| Platform | `Codex` |
| Category | General and specialized workflows |
