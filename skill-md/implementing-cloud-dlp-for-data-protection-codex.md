...
display_name: implementing-cloud-dlp-for-data-protection
platform: Codex
category: General and specialized workflows
---

# implementing-cloud-dlp-for-data-protection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-cloud-dlp-for-data-protection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-cloud-dlp-for-data-protection, then write the task. Fallback prompt: Use the implementing-cloud-dlp-for-data-protection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-cloud-dlp-for-data-protection` |
| Canonical name | `implementing-cloud-dlp-for-data-protection` |
| Platform | `Codex` |
| Category | General and specialized workflows |
