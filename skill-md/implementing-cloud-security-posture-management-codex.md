...
display_name: implementing-cloud-security-posture-management
platform: Codex
category: General and specialized workflows
---

# implementing-cloud-security-posture-management - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-cloud-security-posture-management` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-cloud-security-posture-management, then write the task. Fallback prompt: Use the implementing-cloud-security-posture-management skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-cloud-security-posture-management` |
| Canonical name | `implementing-cloud-security-posture-management` |
| Platform | `Codex` |
| Category | General and specialized workflows |
