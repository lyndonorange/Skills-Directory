...
display_name: implementing-cloud-trail-log-analysis
platform: Codex
category: General and specialized workflows
---

# implementing-cloud-trail-log-analysis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-cloud-trail-log-analysis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-cloud-trail-log-analysis, then write the task. Fallback prompt: Use the implementing-cloud-trail-log-analysis skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-cloud-trail-log-analysis` |
| Canonical name | `implementing-cloud-trail-log-analysis` |
| Platform | `Codex` |
| Category | General and specialized workflows |
