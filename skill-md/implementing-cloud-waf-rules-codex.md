...
display_name: implementing-cloud-waf-rules
platform: Codex
category: General and specialized workflows
---

# implementing-cloud-waf-rules - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-cloud-waf-rules` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-cloud-waf-rules, then write the task. Fallback prompt: Use the implementing-cloud-waf-rules skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-cloud-waf-rules` |
| Canonical name | `implementing-cloud-waf-rules` |
| Platform | `Codex` |
| Category | General and specialized workflows |
