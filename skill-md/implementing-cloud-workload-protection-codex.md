...
display_name: implementing-cloud-workload-protection
platform: Codex
category: General and specialized workflows
---

# implementing-cloud-workload-protection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-cloud-workload-protection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-cloud-workload-protection, then write the task. Fallback prompt: Use the implementing-cloud-workload-protection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-cloud-workload-protection` |
| Canonical name | `implementing-cloud-workload-protection` |
| Platform | `Codex` |
| Category | General and specialized workflows |
