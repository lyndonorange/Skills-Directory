...
display_name: implementing-container-image-minimal-base-with-distroless
platform: Codex
category: Software engineering and app building
---

# implementing-container-image-minimal-base-with-distroless - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-container-image-minimal-base-with-distroless` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Google distroless images contain only your application and its runtime dependencies, without package managers, shells, or other programs found in standard Linux distributions. By eliminating unnecessary OS components, di

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-container-image-minimal-base-with-distroless, then write the task. Fallback prompt: Use the implementing-container-image-minimal-base-with-distroless skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-container-image-minimal-base-with-distroless` |
| Canonical name | `implementing-container-image-minimal-base-with-distroless` |
| Platform | `Codex` |
| Category | Software engineering and app building |
