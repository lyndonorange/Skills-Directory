...
display_name: implementing-container-network-policies-with-calico
platform: Codex
category: Software engineering and app building
---

# implementing-container-network-policies-with-calico - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-container-network-policies-with-calico` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Calico provides Kubernetes-native and extended network policy enforcement through its CNI plugin. This skill covers creating and auditing Calico NetworkPolicy and GlobalNetworkPolicy resources to implement pod-to-pod tra

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-container-network-policies-with-calico, then write the task. Fallback prompt: Use the implementing-container-network-policies-with-calico skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-container-network-policies-with-calico` |
| Canonical name | `implementing-container-network-policies-with-calico` |
| Platform | `Codex` |
| Category | Software engineering and app building |
