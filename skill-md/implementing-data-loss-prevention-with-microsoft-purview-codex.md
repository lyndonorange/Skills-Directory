...
display_name: implementing-data-loss-prevention-with-microsoft-purview
platform: Codex
category: General and specialized workflows
---

# implementing-data-loss-prevention-with-microsoft-purview - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-data-loss-prevention-with-microsoft-purview` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-data-loss-prevention-with-microsoft-purview, then write the task. Fallback prompt: Use the implementing-data-loss-prevention-with-microsoft-purview skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-data-loss-prevention-with-microsoft-purview` |
| Canonical name | `implementing-data-loss-prevention-with-microsoft-purview` |
| Platform | `Codex` |
| Category | General and specialized workflows |
