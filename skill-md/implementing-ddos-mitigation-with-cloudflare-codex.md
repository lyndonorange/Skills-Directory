...
display_name: implementing-ddos-mitigation-with-cloudflare
platform: Codex
category: General and specialized workflows
---

# implementing-ddos-mitigation-with-cloudflare - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-ddos-mitigation-with-cloudflare` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Cloudflare provides multi-layer DDoS protection across its global network of over 300 data centers with 477+ Tbps of capacity. The platform protects against L3/4 volumetric attacks (SYN floods, UDP amplification, DNS ref

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-ddos-mitigation-with-cloudflare, then write the task. Fallback prompt: Use the implementing-ddos-mitigation-with-cloudflare skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-ddos-mitigation-with-cloudflare` |
| Canonical name | `implementing-ddos-mitigation-with-cloudflare` |
| Platform | `Codex` |
| Category | General and specialized workflows |
