...
display_name: implementing-delinea-secret-server-for-pam
platform: Codex
category: General and specialized workflows
---

# implementing-delinea-secret-server-for-pam - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-delinea-secret-server-for-pam` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-delinea-secret-server-for-pam, then write the task. Fallback prompt: Use the implementing-delinea-secret-server-for-pam skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-delinea-secret-server-for-pam` |
| Canonical name | `implementing-delinea-secret-server-for-pam` |
| Platform | `Codex` |
| Category | General and specialized workflows |
