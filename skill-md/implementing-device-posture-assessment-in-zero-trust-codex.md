...
display_name: implementing-device-posture-assessment-in-zero-trust
platform: Codex
category: General and specialized workflows
---

# implementing-device-posture-assessment-in-zero-trust - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-device-posture-assessment-in-zero-trust` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-device-posture-assessment-in-zero-trust, then write the task. Fallback prompt: Use the implementing-device-posture-assessment-in-zero-trust skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-device-posture-assessment-in-zero-trust` |
| Canonical name | `implementing-device-posture-assessment-in-zero-trust` |
| Platform | `Codex` |
| Category | General and specialized workflows |
