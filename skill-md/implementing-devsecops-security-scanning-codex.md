...
display_name: implementing-devsecops-security-scanning
platform: Codex
category: General and specialized workflows
---

# implementing-devsecops-security-scanning - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-devsecops-security-scanning` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-devsecops-security-scanning, then write the task. Fallback prompt: Use the implementing-devsecops-security-scanning skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-devsecops-security-scanning` |
| Canonical name | `implementing-devsecops-security-scanning` |
| Platform | `Codex` |
| Category | General and specialized workflows |
