...
display_name: implementing-digital-signatures-with-ed25519
platform: Codex
category: General and specialized workflows
---

# implementing-digital-signatures-with-ed25519 - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-digital-signatures-with-ed25519` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Ed25519 is a high-performance digital signature algorithm using the Edwards curve Curve25519. It provides 128-bit security with 64-byte signatures and 32-byte keys, offering significant advantages over RSA and ECDSA incl

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-digital-signatures-with-ed25519, then write the task. Fallback prompt: Use the implementing-digital-signatures-with-ed25519 skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-digital-signatures-with-ed25519` |
| Canonical name | `implementing-digital-signatures-with-ed25519` |
| Platform | `Codex` |
| Category | General and specialized workflows |
