---
name: implementing-di[redacted-token]
display_name: implementing-di[redacted-token]
platform: Codex
category: General and specialized workflows
---

# implementing-di[redacted-token] - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-di[redacted-token]` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-di[redacted-token], then write the task. Fallback prompt: Use the implementing-di[redacted-token] skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-di[redacted-token]` |
| Canonical name | `implementing-di[redacted-token]` |
| Platform | `Codex` |
| Category | General and specialized workflows |
