...
display_name: implementing-dragos-platform-for-ot-monitoring
platform: Codex
category: General and specialized workflows
---

# implementing-dragos-platform-for-ot-monitoring - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-dragos-platform-for-ot-monitoring` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-dragos-platform-for-ot-monitoring, then write the task. Fallback prompt: Use the implementing-dragos-platform-for-ot-monitoring skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-dragos-platform-for-ot-monitoring` |
| Canonical name | `implementing-dragos-platform-for-ot-monitoring` |
| Platform | `Codex` |
| Category | General and specialized workflows |
