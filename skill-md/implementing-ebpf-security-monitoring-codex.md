...
display_name: implementing-ebpf-security-monitoring
platform: Codex
category: General and specialized workflows
---

# implementing-ebpf-security-monitoring - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-ebpf-security-monitoring` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-ebpf-security-monitoring, then write the task. Fallback prompt: Use the implementing-ebpf-security-monitoring skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-ebpf-security-monitoring` |
| Canonical name | `implementing-ebpf-security-monitoring` |
| Platform | `Codex` |
| Category | General and specialized workflows |
