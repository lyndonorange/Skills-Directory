...
display_name: implementing-endpoint-detection-with-wazuh
platform: Codex
category: General and specialized workflows
---

# implementing-endpoint-detection-with-wazuh - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-endpoint-detection-with-wazuh` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Wazuh is an open-source SIEM and XDR platform for endpoint monitoring, threat detection, and compliance. This skill covers managing agents via the Wazuh REST API, creating custom decoders and rules in XML for organizatio

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-endpoint-detection-with-wazuh, then write the task. Fallback prompt: Use the implementing-endpoint-detection-with-wazuh skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-endpoint-detection-with-wazuh` |
| Canonical name | `implementing-endpoint-detection-with-wazuh` |
| Platform | `Codex` |
| Category | General and specialized workflows |
