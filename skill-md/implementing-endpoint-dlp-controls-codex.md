...
display_name: implementing-endpoint-dlp-controls
platform: Codex
category: General and specialized workflows
---

# implementing-endpoint-dlp-controls - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-endpoint-dlp-controls` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-endpoint-dlp-controls, then write the task. Fallback prompt: Use the implementing-endpoint-dlp-controls skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-endpoint-dlp-controls` |
| Canonical name | `implementing-endpoint-dlp-controls` |
| Platform | `Codex` |
| Category | General and specialized workflows |
