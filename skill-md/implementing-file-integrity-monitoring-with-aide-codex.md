...
display_name: implementing-file-integrity-monitoring-with-aide
platform: Codex
category: General and specialized workflows
---

# implementing-file-integrity-monitoring-with-aide - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-file-integrity-monitoring-with-aide` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

AIDE (Advanced Intrusion Detection Environment) is a host-based intrusion detection system that monitors file and directory integrity using cryptographic checksums. This skill covers generating AIDE configuration files, 

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-file-integrity-monitoring-with-aide, then write the task. Fallback prompt: Use the implementing-file-integrity-monitoring-with-aide skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-file-integrity-monitoring-with-aide` |
| Canonical name | `implementing-file-integrity-monitoring-with-aide` |
| Platform | `Codex` |
| Category | General and specialized workflows |
