...
display_name: implementing-fuzz-testing-in-cicd-with-aflplusplus
platform: Codex
category: General and specialized workflows
---

# implementing-fuzz-testing-in-cicd-with-aflplusplus - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-fuzz-testing-in-cicd-with-aflplusplus` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

AFL++ (American Fuzzy Lop Plus Plus) is a community-maintained fork of AFL that provides state-of-the-art coverage-guided fuzz testing for discovering vulnerabilities in compiled applications. AFL++ uses genetic algorith

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-fuzz-testing-in-cicd-with-aflplusplus, then write the task. Fallback prompt: Use the implementing-fuzz-testing-in-cicd-with-aflplusplus skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-fuzz-testing-in-cicd-with-aflplusplus` |
| Canonical name | `implementing-fuzz-testing-in-cicd-with-aflplusplus` |
| Platform | `Codex` |
| Category | General and specialized workflows |
