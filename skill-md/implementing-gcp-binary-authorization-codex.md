...
display_name: implementing-gcp-binary-authorization
platform: Codex
category: General and specialized workflows
---

# implementing-gcp-binary-authorization - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-gcp-binary-authorization` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Binary Authorization is a Google Cloud deploy-time security control that ensures only trusted container images are deployed on GKE or Cloud Run. It works through a policy-based model where images must have cryptographic 

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-gcp-binary-authorization, then write the task. Fallback prompt: Use the implementing-gcp-binary-authorization skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-gcp-binary-authorization` |
| Canonical name | `implementing-gcp-binary-authorization` |
| Platform | `Codex` |
| Category | General and specialized workflows |
