...
display_name: implementing-gcp-vpc-firewall-rules
platform: Codex
category: General and specialized workflows
---

# implementing-gcp-vpc-firewall-rules - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-gcp-vpc-firewall-rules` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-gcp-vpc-firewall-rules, then write the task. Fallback prompt: Use the implementing-gcp-vpc-firewall-rules skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-gcp-vpc-firewall-rules` |
| Canonical name | `implementing-gcp-vpc-firewall-rules` |
| Platform | `Codex` |
| Category | General and specialized workflows |
