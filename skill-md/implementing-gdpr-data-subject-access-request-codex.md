...
display_name: implementing-gdpr-data-subject-access-request
platform: Codex
category: General and specialized workflows
---

# implementing-gdpr-data-subject-access-request - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-gdpr-data-subject-access-request` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-gdpr-data-subject-access-request, then write the task. Fallback prompt: Use the implementing-gdpr-data-subject-access-request skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-gdpr-data-subject-access-request` |
| Canonical name | `implementing-gdpr-data-subject-access-request` |
| Platform | `Codex` |
| Category | General and specialized workflows |
