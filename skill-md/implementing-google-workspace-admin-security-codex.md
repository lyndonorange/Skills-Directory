...
display_name: implementing-google-workspace-admin-security
platform: Codex
category: General and specialized workflows
---

# implementing-google-workspace-admin-security - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-google-workspace-admin-security` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-google-workspace-admin-security, then write the task. Fallback prompt: Use the implementing-google-workspace-admin-security skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-google-workspace-admin-security` |
| Canonical name | `implementing-google-workspace-admin-security` |
| Platform | `Codex` |
| Category | General and specialized workflows |
