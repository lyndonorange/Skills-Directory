...
display_name: implementing-ics-firewall-with-tofino
platform: Codex
category: General and specialized workflows
---

# implementing-ics-firewall-with-tofino - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-ics-firewall-with-tofino` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-ics-firewall-with-tofino, then write the task. Fallback prompt: Use the implementing-ics-firewall-with-tofino skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-ics-firewall-with-tofino` |
| Canonical name | `implementing-ics-firewall-with-tofino` |
| Platform | `Codex` |
| Category | General and specialized workflows |
