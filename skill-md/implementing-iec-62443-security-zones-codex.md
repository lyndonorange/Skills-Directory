...
display_name: implementing-iec-62443-security-zones
platform: Codex
category: General and specialized workflows
---

# implementing-iec-62443-security-zones - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-iec-62443-security-zones` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-iec-62443-security-zones, then write the task. Fallback prompt: Use the implementing-iec-62443-security-zones skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-iec-62443-security-zones` |
| Canonical name | `implementing-iec-62443-security-zones` |
| Platform | `Codex` |
| Category | General and specialized workflows |
