...
display_name: implementing-image-provenance-verification-with-cosign
platform: Codex
category: General and specialized workflows
---

# implementing-image-provenance-verification-with-cosign - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-image-provenance-verification-with-cosign` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Cosign is a Sigstore tool for signing, verifying, and attaching metadata to container images and OCI artifacts. It supports both key-based and keyless (OIDC) signing, integrates with Fulcio (certificate authority) and Re

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-image-provenance-verification-with-cosign, then write the task. Fallback prompt: Use the implementing-image-provenance-verification-with-cosign skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-image-provenance-verification-with-cosign` |
| Canonical name | `implementing-image-provenance-verification-with-cosign` |
| Platform | `Codex` |
| Category | General and specialized workflows |
