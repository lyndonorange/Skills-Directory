...
display_name: implementing-infrastructure-as-code-security-scanning
platform: Codex
category: Software engineering and app building
---

# implementing-infrastructure-as-code-security-scanning - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-infrastructure-as-code-security-scanning` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-infrastructure-as-code-security-scanning, then write the task. Fallback prompt: Use the implementing-infrastructure-as-code-security-scanning skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-infrastructure-as-code-security-scanning` |
| Canonical name | `implementing-infrastructure-as-code-security-scanning` |
| Platform | `Codex` |
| Category | Software engineering and app building |
