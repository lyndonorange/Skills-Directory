...
display_name: implementing-kubernetes-pod-security-standards
platform: Codex
category: Software engineering and app building
---

# implementing-kubernetes-pod-security-standards - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-kubernetes-pod-security-standards` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Pod Security Standards (PSS) define three levels of security policies -- Privileged, Baseline, and Restricted -- enforced by the Pod Security Admission (PSA) controller built into Kubernetes 1.25+. PSA replaces the depre

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-kubernetes-pod-security-standards, then write the task. Fallback prompt: Use the implementing-kubernetes-pod-security-standards skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-kubernetes-pod-security-standards` |
| Canonical name | `implementing-kubernetes-pod-security-standards` |
| Platform | `Codex` |
| Category | Software engineering and app building |
