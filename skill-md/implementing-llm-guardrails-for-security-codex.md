...
display_name: implementing-llm-guardrails-for-security
platform: Codex
category: General and specialized workflows
---

# implementing-llm-guardrails-for-security - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-llm-guardrails-for-security` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-llm-guardrails-for-security, then write the task. Fallback prompt: Use the implementing-llm-guardrails-for-security skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-llm-guardrails-for-security` |
| Canonical name | `implementing-llm-guardrails-for-security` |
| Platform | `Codex` |
| Category | General and specialized workflows |
