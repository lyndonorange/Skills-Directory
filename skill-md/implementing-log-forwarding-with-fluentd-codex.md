...
display_name: implementing-log-forwarding-with-fluentd
platform: Codex
category: General and specialized workflows
---

# implementing-log-forwarding-with-fluentd - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-log-forwarding-with-fluentd` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

This skill covers configuring Fluentd and Fluent Bit for centralized log collection, routing, and enrichment. Fluent Bit acts as a lightweight log forwarder on endpoints, while Fluentd serves as the central aggregator an

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-log-forwarding-with-fluentd, then write the task. Fallback prompt: Use the implementing-log-forwarding-with-fluentd skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-log-forwarding-with-fluentd` |
| Canonical name | `implementing-log-forwarding-with-fluentd` |
| Platform | `Codex` |
| Category | General and specialized workflows |
