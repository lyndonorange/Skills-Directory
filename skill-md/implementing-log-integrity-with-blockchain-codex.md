...
display_name: implementing-log-integrity-with-blockchain
platform: Codex
category: General and specialized workflows
---

# implementing-log-integrity-with-blockchain - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-log-integrity-with-blockchain` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-log-integrity-with-blockchain, then write the task. Fallback prompt: Use the implementing-log-integrity-with-blockchain skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-log-integrity-with-blockchain` |
| Canonical name | `implementing-log-integrity-with-blockchain` |
| Platform | `Codex` |
| Category | General and specialized workflows |
