...
display_name: implementing-memory-protection-with-dep-aslr
platform: Codex
category: General and specialized workflows
---

# implementing-memory-protection-with-dep-aslr - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-memory-protection-with-dep-aslr` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-memory-protection-with-dep-aslr, then write the task. Fallback prompt: Use the implementing-memory-protection-with-dep-aslr skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-memory-protection-with-dep-aslr` |
| Canonical name | `implementing-memory-protection-with-dep-aslr` |
| Platform | `Codex` |
| Category | General and specialized workflows |
