...
display_name: implementing-microsegmentation-with-guardicore
platform: Codex
category: General and specialized workflows
---

# implementing-microsegmentation-with-guardicore - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-microsegmentation-with-guardicore` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-microsegmentation-with-guardicore, then write the task. Fallback prompt: Use the implementing-microsegmentation-with-guardicore skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-microsegmentation-with-guardicore` |
| Canonical name | `implementing-microsegmentation-with-guardicore` |
| Platform | `Codex` |
| Category | General and specialized workflows |
