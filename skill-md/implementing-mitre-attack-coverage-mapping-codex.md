...
display_name: implementing-mitre-attack-coverage-mapping
platform: Codex
category: General and specialized workflows
---

# implementing-mitre-attack-coverage-mapping - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-mitre-attack-coverage-mapping` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

MITRE ATT&CK coverage mapping gives SOC teams a structured, adversary-centric lens to evaluate detection capabilities. Enterprise SIEMs on average have detection coverage for only 21% of ATT&CK techniques (2025 CardinalO

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-mitre-attack-coverage-mapping, then write the task. Fallback prompt: Use the implementing-mitre-attack-coverage-mapping skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-mitre-attack-coverage-mapping` |
| Canonical name | `implementing-mitre-attack-coverage-mapping` |
| Platform | `Codex` |
| Category | General and specialized workflows |
