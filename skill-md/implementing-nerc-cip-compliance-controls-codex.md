...
display_name: implementing-nerc-cip-compliance-controls
platform: Codex
category: General and specialized workflows
---

# implementing-nerc-cip-compliance-controls - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-nerc-cip-compliance-controls` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-nerc-cip-compliance-controls, then write the task. Fallback prompt: Use the implementing-nerc-cip-compliance-controls skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-nerc-cip-compliance-controls` |
| Canonical name | `implementing-nerc-cip-compliance-controls` |
| Platform | `Codex` |
| Category | General and specialized workflows |
