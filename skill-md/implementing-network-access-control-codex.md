...
display_name: implementing-network-access-control
platform: Codex
category: General and specialized workflows
---

# implementing-network-access-control - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-network-access-control` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-network-access-control, then write the task. Fallback prompt: Use the implementing-network-access-control skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-network-access-control` |
| Canonical name | `implementing-network-access-control` |
| Platform | `Codex` |
| Category | General and specialized workflows |
