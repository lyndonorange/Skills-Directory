...
display_name: implementing-network-access-control-with-cisco-ise
platform: Codex
category: General and specialized workflows
---

# implementing-network-access-control-with-cisco-ise - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-network-access-control-with-cisco-ise` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Cisco Identity Services Engine (ISE) provides centralized network access control through 802.1X authentication, MAC Authentication Bypass (MAB), posture assessment, and guest access management. ISE acts as a RADIUS polic

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-network-access-control-with-cisco-ise, then write the task. Fallback prompt: Use the implementing-network-access-control-with-cisco-ise skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-network-access-control-with-cisco-ise` |
| Canonical name | `implementing-network-access-control-with-cisco-ise` |
| Platform | `Codex` |
| Category | General and specialized workflows |
