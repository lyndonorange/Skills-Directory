...
display_name: implementing-network-deception-with-honeypots
platform: Codex
category: General and specialized workflows
---

# implementing-network-deception-with-honeypots - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-network-deception-with-honeypots` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-network-deception-with-honeypots, then write the task. Fallback prompt: Use the implementing-network-deception-with-honeypots skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-network-deception-with-honeypots` |
| Canonical name | `implementing-network-deception-with-honeypots` |
| Platform | `Codex` |
| Category | General and specialized workflows |
