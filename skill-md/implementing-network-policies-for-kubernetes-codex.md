...
display_name: implementing-network-policies-for-kubernetes
platform: Codex
category: Software engineering and app building
---

# implementing-network-policies-for-kubernetes - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-network-policies-for-kubernetes` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Kubernetes NetworkPolicies provide pod-level network segmentation by defining ingress and egress rules that control traffic flow between pods, namespaces, and external endpoints. Combined with CNI plugins like Calico or 

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-network-policies-for-kubernetes, then write the task. Fallback prompt: Use the implementing-network-policies-for-kubernetes skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-network-policies-for-kubernetes` |
| Canonical name | `implementing-network-policies-for-kubernetes` |
| Platform | `Codex` |
| Category | Software engineering and app building |
