...
display_name: implementing-network-segmentation-for-ot
platform: Codex
category: General and specialized workflows
---

# implementing-network-segmentation-for-ot - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-network-segmentation-for-ot` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-network-segmentation-for-ot, then write the task. Fallback prompt: Use the implementing-network-segmentation-for-ot skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-network-segmentation-for-ot` |
| Canonical name | `implementing-network-segmentation-for-ot` |
| Platform | `Codex` |
| Category | General and specialized workflows |
