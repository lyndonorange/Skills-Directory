...
display_name: implementing-network-segmentation-with-firewall-zones
platform: Codex
category: General and specialized workflows
---

# implementing-network-segmentation-with-firewall-zones - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-network-segmentation-with-firewall-zones` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Network segmentation divides a flat network into isolated security zones with firewall-enforced boundaries to contain breaches, restrict lateral movement, and enforce least-privilege access between workloads. Segmentatio

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-network-segmentation-with-firewall-zones, then write the task. Fallback prompt: Use the implementing-network-segmentation-with-firewall-zones skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-network-segmentation-with-firewall-zones` |
| Canonical name | `implementing-network-segmentation-with-firewall-zones` |
| Platform | `Codex` |
| Category | General and specialized workflows |
