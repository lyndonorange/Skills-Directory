...
display_name: implementing-network-traffic-analysis-with-arkime
platform: Codex
category: General and specialized workflows
---

# implementing-network-traffic-analysis-with-arkime - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-network-traffic-analysis-with-arkime` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-network-traffic-analysis-with-arkime, then write the task. Fallback prompt: Use the implementing-network-traffic-analysis-with-arkime skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-network-traffic-analysis-with-arkime` |
| Canonical name | `implementing-network-traffic-analysis-with-arkime` |
| Platform | `Codex` |
| Category | General and specialized workflows |
