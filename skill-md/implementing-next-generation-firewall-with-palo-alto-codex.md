...
display_name: implementing-next-generation-firewall-with-palo-alto
platform: Codex
category: General and specialized workflows
---

# implementing-next-generation-firewall-with-palo-alto - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-next-generation-firewall-with-palo-alto` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Palo Alto Networks Next-Generation Firewalls (NGFWs) move beyond traditional port-based rule enforcement to application-aware, identity-driven security policies. By leveraging App-ID for traffic classification, User-ID f

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-next-generation-firewall-with-palo-alto, then write the task. Fallback prompt: Use the implementing-next-generation-firewall-with-palo-alto skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-next-generation-firewall-with-palo-alto` |
| Canonical name | `implementing-next-generation-firewall-with-palo-alto` |
| Platform | `Codex` |
| Category | General and specialized workflows |
