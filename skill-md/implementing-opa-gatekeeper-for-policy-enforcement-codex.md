...
display_name: implementing-opa-gatekeeper-for-policy-enforcement
platform: Codex
category: General and specialized workflows
---

# implementing-opa-gatekeeper-for-policy-enforcement - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-opa-gatekeeper-for-policy-enforcement` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

OPA Gatekeeper is a Kubernetes admission controller that enforces policies written in Rego. It uses ConstraintTemplates (policy blueprints with Rego logic) and Constraints (instantiated policies with parameters) to valid

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-opa-gatekeeper-for-policy-enforcement, then write the task. Fallback prompt: Use the implementing-opa-gatekeeper-for-policy-enforcement skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-opa-gatekeeper-for-policy-enforcement` |
| Canonical name | `implementing-opa-gatekeeper-for-policy-enforcement` |
| Platform | `Codex` |
| Category | General and specialized workflows |
