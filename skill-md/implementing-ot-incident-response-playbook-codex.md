...
display_name: implementing-ot-incident-response-playbook
platform: Codex
category: General and specialized workflows
---

# implementing-ot-incident-response-playbook - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-ot-incident-response-playbook` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-ot-incident-response-playbook, then write the task. Fallback prompt: Use the implementing-ot-incident-response-playbook skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-ot-incident-response-playbook` |
| Canonical name | `implementing-ot-incident-response-playbook` |
| Platform | `Codex` |
| Category | General and specialized workflows |
