...
display_name: implementing-ot-network-traffic-analysis-with-nozomi
platform: Codex
category: General and specialized workflows
---

# implementing-ot-network-traffic-analysis-with-nozomi - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-ot-network-traffic-analysis-with-nozomi` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-ot-network-traffic-analysis-with-nozomi, then write the task. Fallback prompt: Use the implementing-ot-network-traffic-analysis-with-nozomi skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-ot-network-traffic-analysis-with-nozomi` |
| Canonical name | `implementing-ot-network-traffic-analysis-with-nozomi` |
| Platform | `Codex` |
| Category | General and specialized workflows |
