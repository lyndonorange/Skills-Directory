...
display_name: implementing-passwordless-auth-with-microsoft-entra
platform: Codex
category: General and specialized workflows
---

# implementing-passwordless-auth-with-microsoft-entra - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-passwordless-auth-with-microsoft-entra` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-passwordless-auth-with-microsoft-entra, then write the task. Fallback prompt: Use the implementing-passwordless-auth-with-microsoft-entra skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-passwordless-auth-with-microsoft-entra` |
| Canonical name | `implementing-passwordless-auth-with-microsoft-entra` |
| Platform | `Codex` |
| Category | General and specialized workflows |
