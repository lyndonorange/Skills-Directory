...
# implementing-pod-security-admission-controller - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-pod-security-admission-controller` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Pod Security Admission (PSA) is a built-in Kubernetes admission controller (stable since v1.25) that enforces Pod Security Standards at the namespace level. It replaces the deprecated PodSecurityPolicy (PSP) and provides

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-pod-security-admission-controller, then write the task. Fallback prompt: Use the implementing-pod-security-admission-controller skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-pod-security-admission-controller` |
| Canonical name | `implementing-pod-security-admission-controller` |
| Platform | `Codex` |
| Category | General and specialized workflows |
