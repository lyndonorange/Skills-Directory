...
display_name: implementing-policy-as-code-with-open-policy-agent
platform: Codex
category: General and specialized workflows
---

# implementing-policy-as-code-with-open-policy-agent - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-policy-as-code-with-open-policy-agent` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-policy-as-code-with-open-policy-agent, then write the task. Fallback prompt: Use the implementing-policy-as-code-with-open-policy-agent skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-policy-as-code-with-open-policy-agent` |
| Canonical name | `implementing-policy-as-code-with-open-policy-agent` |
| Platform | `Codex` |
| Category | General and specialized workflows |
