...
display_name: implementing-privileged-access-workstation
platform: Codex
category: General and specialized workflows
---

# implementing-privileged-access-workstation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-privileged-access-workstation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

A Privileged Access Workstation (PAW) is a hardened device dedicated to performing sensitive administrative tasks. This skill covers PAW design using the tiered administration model, device compliance enforcement via Mic

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-privileged-access-workstation, then write the task. Fallback prompt: Use the implementing-privileged-access-workstation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-privileged-access-workstation` |
| Canonical name | `implementing-privileged-access-workstation` |
| Platform | `Codex` |
| Category | General and specialized workflows |
