...
display_name: implementing-privileged-session-monitoring
platform: Codex
category: General and specialized workflows
---

# implementing-privileged-session-monitoring - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-privileged-session-monitoring` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-privileged-session-monitoring, then write the task. Fallback prompt: Use the implementing-privileged-session-monitoring skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-privileged-session-monitoring` |
| Canonical name | `implementing-privileged-session-monitoring` |
| Platform | `Codex` |
| Category | General and specialized workflows |
