...
display_name: implementing-purdue-model-network-segmentation
platform: Codex
category: General and specialized workflows
---

# implementing-purdue-model-network-segmentation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-purdue-model-network-segmentation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-purdue-model-network-segmentation, then write the task. Fallback prompt: Use the implementing-purdue-model-network-segmentation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-purdue-model-network-segmentation` |
| Canonical name | `implementing-purdue-model-network-segmentation` |
| Platform | `Codex` |
| Category | General and specialized workflows |
