...
display_name: implementing-ransomware-backup-strategy
platform: Codex
category: General and specialized workflows
---

# implementing-ransomware-backup-strategy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-ransomware-backup-strategy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-ransomware-backup-strategy, then write the task. Fallback prompt: Use the implementing-ransomware-backup-strategy skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-ransomware-backup-strategy` |
| Canonical name | `implementing-ransomware-backup-strategy` |
| Platform | `Codex` |
| Category | General and specialized workflows |
