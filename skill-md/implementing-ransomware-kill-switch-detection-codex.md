...
display_name: implementing-ransomware-kill-switch-detection
platform: Codex
category: General and specialized workflows
---

# implementing-ransomware-kill-switch-detection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-ransomware-kill-switch-detection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-ransomware-kill-switch-detection, then write the task. Fallback prompt: Use the implementing-ransomware-kill-switch-detection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-ransomware-kill-switch-detection` |
| Canonical name | `implementing-ransomware-kill-switch-detection` |
| Platform | `Codex` |
| Category | General and specialized workflows |
