...
display_name: implementing-runtime-application-self-protection
platform: Codex
category: General and specialized workflows
---

# implementing-runtime-application-self-protection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-runtime-application-self-protection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Runtime Application Self-Protection (RASP) instruments application code at runtime to detect and block attacks by examining actual execution context rather than relying solely on network traffic patterns. Unlike WAFs tha

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-runtime-application-self-protection, then write the task. Fallback prompt: Use the implementing-runtime-application-self-protection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-runtime-application-self-protection` |
| Canonical name | `implementing-runtime-application-self-protection` |
| Platform | `Codex` |
| Category | General and specialized workflows |
