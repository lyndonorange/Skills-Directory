...
display_name: implementing-runtime-security-with-tetragon
platform: Codex
category: General and specialized workflows
---

# implementing-runtime-security-with-tetragon - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-runtime-security-with-tetragon` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Tetragon is a CNCF project under Cilium that provides flexible Kubernetes-aware security observability and runtime enforcement using eBPF. By operating at the Linux kernel level, Tetragon can monitor and enforce policies

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-runtime-security-with-tetragon, then write the task. Fallback prompt: Use the implementing-runtime-security-with-tetragon skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-runtime-security-with-tetragon` |
| Canonical name | `implementing-runtime-security-with-tetragon` |
| Platform | `Codex` |
| Category | General and specialized workflows |
