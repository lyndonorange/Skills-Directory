...
display_name: implementing-secret-scanning-with-gitleaks
platform: Codex
category: General and specialized workflows
---

# implementing-secret-scanning-with-gitleaks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-secret-scanning-with-gitleaks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-secret-scanning-with-gitleaks, then write the task. Fallback prompt: Use the implementing-secret-scanning-with-gitleaks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-secret-scanning-with-gitleaks` |
| Canonical name | `implementing-secret-scanning-with-gitleaks` |
| Platform | `Codex` |
| Category | General and specialized workflows |
