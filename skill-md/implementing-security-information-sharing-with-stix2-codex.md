...
display_name: implementing-security-information-sharing-with-stix2
platform: Codex
category: General and specialized workflows
---

# implementing-security-information-sharing-with-stix2 - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-security-information-sharing-with-stix2` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-security-information-sharing-with-stix2, then write the task. Fallback prompt: Use the implementing-security-information-sharing-with-stix2 skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-security-information-sharing-with-stix2` |
| Canonical name | `implementing-security-information-sharing-with-stix2` |
| Platform | `Codex` |
| Category | General and specialized workflows |
