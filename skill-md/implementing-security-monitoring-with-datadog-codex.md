...
display_name: implementing-security-monitoring-with-datadog
platform: Codex
category: General and specialized workflows
---

# implementing-security-monitoring-with-datadog - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-security-monitoring-with-datadog` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-security-monitoring-with-datadog, then write the task. Fallback prompt: Use the implementing-security-monitoring-with-datadog skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-security-monitoring-with-datadog` |
| Canonical name | `implementing-security-monitoring-with-datadog` |
| Platform | `Codex` |
| Category | General and specialized workflows |
