...
display_name: implementing-semgrep-for-custom-sast-rules
platform: Codex
category: General and specialized workflows
---

# implementing-semgrep-for-custom-sast-rules - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-semgrep-for-custom-sast-rules` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Semgrep is an open-source static analysis tool that uses pattern-matching to find bugs, enforce code standards, and detect security vulnerabilities. Custom rules are written in YAML using Semgrep's pattern syntax, making

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-semgrep-for-custom-sast-rules, then write the task. Fallback prompt: Use the implementing-semgrep-for-custom-sast-rules skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-semgrep-for-custom-sast-rules` |
| Canonical name | `implementing-semgrep-for-custom-sast-rules` |
| Platform | `Codex` |
| Category | General and specialized workflows |
