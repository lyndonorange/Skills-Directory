...
display_name: implementing-soar-automation-with-phantom
platform: Codex
category: General and specialized workflows
---

# implementing-soar-automation-with-phantom - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-soar-automation-with-phantom` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-soar-automation-with-phantom, then write the task. Fallback prompt: Use the implementing-soar-automation-with-phantom skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-soar-automation-with-phantom` |
| Canonical name | `implementing-soar-automation-with-phantom` |
| Platform | `Codex` |
| Category | General and specialized workflows |
