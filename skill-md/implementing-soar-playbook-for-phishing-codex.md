...
display_name: implementing-soar-playbook-for-phishing
platform: Codex
category: General and specialized workflows
---

# implementing-soar-playbook-for-phishing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-soar-playbook-for-phishing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

This skill implements a phishing incident response workflow using the Splunk SOAR (formerly Phantom) REST API. When a suspected phishing email is reported, the agent parses email headers and body, creates a SOAR containe

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-soar-playbook-for-phishing, then write the task. Fallback prompt: Use the implementing-soar-playbook-for-phishing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-soar-playbook-for-phishing` |
| Canonical name | `implementing-soar-playbook-for-phishing` |
| Platform | `Codex` |
| Category | General and specialized workflows |
