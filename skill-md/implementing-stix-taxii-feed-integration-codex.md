...
display_name: implementing-stix-taxii-feed-integration
platform: Codex
category: General and specialized workflows
---

# implementing-stix-taxii-feed-integration - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-stix-taxii-feed-integration` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

STIX (Structured Threat Information eXpression) and TAXII (Trusted Automated eXchange of Intelligence Information) are OASIS open standards for representing and transporting cyber threat intelligence. This skill covers i

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-stix-taxii-feed-integration, then write the task. Fallback prompt: Use the implementing-stix-taxii-feed-integration skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-stix-taxii-feed-integration` |
| Canonical name | `implementing-stix-taxii-feed-integration` |
| Platform | `Codex` |
| Category | General and specialized workflows |
