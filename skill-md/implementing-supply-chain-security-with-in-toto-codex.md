...
display_name: implementing-supply-chain-security-with-in-toto
platform: Codex
category: General and specialized workflows
---

# implementing-supply-chain-security-with-in-toto - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-supply-chain-security-with-in-toto` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

in-toto is a CNCF graduated project that ensures the integrity of software supply chains from initiation to end-user installation. It creates a verifiable record of the entire software development lifecycle by generating

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-supply-chain-security-with-in-toto, then write the task. Fallback prompt: Use the implementing-supply-chain-security-with-in-toto skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-supply-chain-security-with-in-toto` |
| Canonical name | `implementing-supply-chain-security-with-in-toto` |
| Platform | `Codex` |
| Category | General and specialized workflows |
