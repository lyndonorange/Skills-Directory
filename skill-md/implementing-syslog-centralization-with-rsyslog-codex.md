...
display_name: implementing-syslog-centralization-with-rsyslog
platform: Codex
category: General and specialized workflows
---

# implementing-syslog-centralization-with-rsyslog - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-syslog-centralization-with-rsyslog` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-syslog-centralization-with-rsyslog, then write the task. Fallback prompt: Use the implementing-syslog-centralization-with-rsyslog skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-syslog-centralization-with-rsyslog` |
| Canonical name | `implementing-syslog-centralization-with-rsyslog` |
| Platform | `Codex` |
| Category | General and specialized workflows |
