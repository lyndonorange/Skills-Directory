...
display_name: implementing-taxii-server-with-opentaxii
platform: Codex
category: General and specialized workflows
---

# implementing-taxii-server-with-opentaxii - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-taxii-server-with-opentaxii` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

TAXII (Trusted Automated eXchange of Intelligence Information) is an OASIS standard protocol for exchanging cyber threat intelligence over HTTPS. OpenTAXII is an open-source TAXII server implementation by EclecticIQ that

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-taxii-server-with-opentaxii, then write the task. Fallback prompt: Use the implementing-taxii-server-with-opentaxii skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-taxii-server-with-opentaxii` |
| Canonical name | `implementing-taxii-server-with-opentaxii` |
| Platform | `Codex` |
| Category | General and specialized workflows |
