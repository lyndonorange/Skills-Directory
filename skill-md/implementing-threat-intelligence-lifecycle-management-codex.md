...
# implementing-threat-intelligence-lifecycle-management - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-threat-intelligence-lifecycle-management` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

The threat intelligence lifecycle is a structured, iterative process for transforming raw data into actionable intelligence. Based on the intelligence cycle used by military and government agencies, it comprises six phas

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-threat-intelligence-lifecycle-management, then write the task. Fallback prompt: Use the implementing-threat-intelligence-lifecycle-management skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-threat-intelligence-lifecycle-management` |
| Canonical name | `implementing-threat-intelligence-lifecycle-management` |
| Platform | `Codex` |
| Category | General and specialized workflows |
