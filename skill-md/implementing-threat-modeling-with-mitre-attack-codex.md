...
display_name: implementing-threat-modeling-with-mitre-attack
platform: Codex
category: General and specialized workflows
---

# implementing-threat-modeling-with-mitre-attack - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-threat-modeling-with-mitre-attack` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-threat-modeling-with-mitre-attack, then write the task. Fallback prompt: Use the implementing-threat-modeling-with-mitre-attack skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-threat-modeling-with-mitre-attack` |
| Canonical name | `implementing-threat-modeling-with-mitre-attack` |
| Platform | `Codex` |
| Category | General and specialized workflows |
