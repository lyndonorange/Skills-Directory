...
# implementing-usb-device-control-policy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-usb-device-control-policy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-usb-device-control-policy, then write the task. Fallback prompt: Use the implementing-usb-device-control-policy skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-usb-device-control-policy` |
| Canonical name | `implementing-usb-device-control-policy` |
| Platform | `Codex` |
| Category | General and specialized workflows |
