...
display_name: implementing-velociraptor-for-ir-collection
platform: Codex
category: General and specialized workflows
---

# implementing-velociraptor-for-ir-collection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-velociraptor-for-ir-collection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Velociraptor is an advanced open-source endpoint monitoring, digital forensics, and incident response platform developed by Rapid7. It uses the Velociraptor Query Language (VQL) to create custom artifacts that collect, q

## How To Use It In Codex

In Codex, click the chat box, press /, choose implementing-velociraptor-for-ir-collection, then write the task. Fallback prompt: Use the implementing-velociraptor-for-ir-collection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-velociraptor-for-ir-collection` |
| Canonical name | `implementing-velociraptor-for-ir-collection` |
| Platform | `Codex` |
| Category | General and specialized workflows |
