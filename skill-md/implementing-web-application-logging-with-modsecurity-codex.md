...
display_name: implementing-web-application-logging-with-modsecurity
platform: Codex
category: General and specialized workflows
---

# implementing-web-application-logging-with-modsecurity - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-web-application-logging-with-modsecurity` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-web-application-logging-with-modsecurity, then write the task. Fallback prompt: Use the implementing-web-application-logging-with-modsecurity skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-web-application-logging-with-modsecurity` |
| Canonical name | `implementing-web-application-logging-with-modsecurity` |
| Platform | `Codex` |
| Category | General and specialized workflows |
