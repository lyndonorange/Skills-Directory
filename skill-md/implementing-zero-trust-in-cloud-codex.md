...
display_name: implementing-zero-trust-in-cloud
platform: Codex
category: General and specialized workflows
---

# implementing-zero-trust-in-cloud - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-zero-trust-in-cloud` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-zero-trust-in-cloud, then write the task. Fallback prompt: Use the implementing-zero-trust-in-cloud skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-zero-trust-in-cloud` |
| Canonical name | `implementing-zero-trust-in-cloud` |
| Platform | `Codex` |
| Category | General and specialized workflows |
