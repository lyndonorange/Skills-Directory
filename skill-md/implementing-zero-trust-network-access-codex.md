...
display_name: implementing-zero-trust-network-access
platform: Codex
category: General and specialized workflows
---

# implementing-zero-trust-network-access - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `implementing-zero-trust-network-access` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose implementing-zero-trust-network-access, then write the task. Fallback prompt: Use the implementing-zero-trust-network-access skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `implementing-zero-trust-network-access` |
| Canonical name | `implementing-zero-trust-network-access` |
| Platform | `Codex` |
| Category | General and specialized workflows |
