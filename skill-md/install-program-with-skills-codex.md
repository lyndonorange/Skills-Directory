...
# install-program-with-skills - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `install-program-with-skills` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose install-program-with-skills, then write the task. Fallback prompt: Use the install-program-with-skills skill to...
