...
display_name: integrating-dast-with-owasp-zap-in-pipeline
platform: Codex
category: General and specialized workflows
---

# integrating-dast-with-owasp-zap-in-pipeline - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `integrating-dast-with-owasp-zap-in-pipeline` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose integrating-dast-with-owasp-zap-in-pipeline, then write the task. Fallback prompt: Use the integrating-dast-with-owasp-zap-in-pipeline skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `integrating-dast-with-owasp-zap-in-pipeline` |
| Canonical name | `integrating-dast-with-owasp-zap-in-pipeline` |
| Platform | `Codex` |
| Category | General and specialized workflows |
