...
display_name: integrating-sast-into-github-actions-pipeline
platform: Codex
category: General and specialized workflows
---

# integrating-sast-into-github-actions-pipeline - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `integrating-sast-into-github-actions-pipeline` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose integrating-sast-into-github-actions-pipeline, then write the task. Fallback prompt: Use the integrating-sast-into-github-actions-pipeline skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `integrating-sast-into-github-actions-pipeline` |
| Canonical name | `integrating-sast-into-github-actions-pipeline` |
| Platform | `Codex` |
| Category | General and specialized workflows |
