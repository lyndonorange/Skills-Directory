---
name: pm-skills-intended-vs-implemented
display_name: intended-vs-implemented
platform: Codex
category: Product delivery, planning, and execution
---

# intended-vs-implemented - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `intended-vs-implemented` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

A linter scans code in a vacuum. It can tell you the code is *internally* consistent; it cannot tell you the code does what you *meant*, because it has no model of your intent. The highest-value security and correctness 

## How To Use It In Codex

In Codex, click the chat box, press /, choose intended-vs-implemented, then write the task. Fallback prompt: Use the intended-vs-implemented skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `intended-vs-implemented` |
| Canonical name | `pm-skills-intended-vs-implemented` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
