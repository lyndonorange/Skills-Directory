...
display_name: intercepting-mobile-traffic-with-burpsuite
platform: Codex
category: General and specialized workflows
---

# intercepting-mobile-traffic-with-burpsuite - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `intercepting-mobile-traffic-with-burpsuite` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose intercepting-mobile-traffic-with-burpsuite, then write the task. Fallback prompt: Use the intercepting-mobile-traffic-with-burpsuite skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `intercepting-mobile-traffic-with-burpsuite` |
| Canonical name | `intercepting-mobile-traffic-with-burpsuite` |
| Platform | `Codex` |
| Category | General and specialized workflows |
