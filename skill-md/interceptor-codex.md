...
# Interceptor - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `Interceptor` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Real Chrome/Brave + macOS Computer Use from inside the browser — zero CDP fingerprint, real sessions, six verb trees (References/CommandReference.md; more triggers in routing table). Mandatory for visual deploy verificat

## How To Use It In Codex

In Codex, click the chat box, press /, choose Interceptor, then write the task. Fallback prompt: Use the Interceptor skill to...
