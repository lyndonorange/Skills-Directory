...
# interview-me - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `interview-me` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

What people ask for and what they actually want are different things. They ask for "a dashboard" because that's what one asks for, not because a dashboard solves their problem. They say "make it faster" without a number 

## How To Use It In Codex

In Codex, click the chat box, press /, choose interview-me, then write the task. Fallback prompt: Use the interview-me skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `interview-me` |
| Canonical name | `interview-me` |
| Platform | `Codex` |
| Category | Software engineering and app building |
