---
name: pm-skills-interview-script
display_name: interview-script
platform: Codex
category: Business creation, ideas, and validation
---

# interview-script - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `interview-script` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose interview-script, then write the task. Fallback prompt: Use the interview-script skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `interview-script` |
| Canonical name | `pm-skills-interview-script` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
