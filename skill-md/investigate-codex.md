...
# investigate - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `investigate` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose investigate, then write the task. Fallback prompt: Use the investigate skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `investigate` |
| Canonical name | `investigate` |
| Platform | `Codex` |
| Category | General and specialized workflows |
