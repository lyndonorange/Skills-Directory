...
display_name: investigating-phishing-email-incident
platform: Codex
category: Security, forensics, and incident response
---

# investigating-phishing-email-incident - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `investigating-phishing-email-incident` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose investigating-phishing-email-incident, then write the task. Fallback prompt: Use the investigating-phishing-email-incident skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `investigating-phishing-email-incident` |
| Canonical name | `investigating-phishing-email-incident` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
