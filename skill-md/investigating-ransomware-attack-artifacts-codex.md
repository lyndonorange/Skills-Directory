...
display_name: investigating-ransomware-attack-artifacts
platform: Codex
category: Security, forensics, and incident response
---

# investigating-ransomware-attack-artifacts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `investigating-ransomware-attack-artifacts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose investigating-ransomware-attack-artifacts, then write the task. Fallback prompt: Use the investigating-ransomware-attack-artifacts skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `investigating-ransomware-attack-artifacts` |
| Canonical name | `investigating-ransomware-attack-artifacts` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
