---
name: ios-clean
display_name: ios-clean
platform: Codex
category: General and specialized workflows
---

# ios-clean - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ios-clean` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose ios-clean, then write the task. Fallback prompt: Use the ios-clean skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `ios-clean` |
| Canonical name | `ios-clean` |
| Platform | `Codex` |
| Category | General and specialized workflows |
