...
display_name: ios-design-review
platform: Codex
category: General and specialized workflows
---

# ios-design-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ios-design-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose ios-design-review, then write the task. Fallback prompt: Use the ios-design-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `ios-design-review` |
| Canonical name | `ios-design-review` |
| Platform | `Codex` |
| Category | General and specialized workflows |
