---
name: ios-fix
display_name: ios-fix
platform: Codex
category: General and specialized workflows
---

# ios-fix - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ios-fix` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose ios-fix, then write the task. Fallback prompt: Use the ios-fix skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `ios-fix` |
| Canonical name | `ios-fix` |
| Platform | `Codex` |
| Category | General and specialized workflows |
