---
name: ios-sync
display_name: ios-sync
platform: Codex
category: General and specialized workflows
---

# ios-sync - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ios-sync` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose ios-sync, then write the task. Fallback prompt: Use the ios-sync skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `ios-sync` |
| Canonical name | `ios-sync` |
| Platform | `Codex` |
| Category | General and specialized workflows |
