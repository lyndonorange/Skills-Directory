...
# ISA - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ISA` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Owns the Ideal State Artifact — universal primitive holding articulated ideal state of any project, task, application, library, or work session as a hard-to-vary explanation. Six workflows: Scaffold (fresh ISA at effort

## How To Use It In Codex

In Codex, click the chat box, press /, choose ISA, then write the task. Fallback prompt: Use the ISA skill to...
