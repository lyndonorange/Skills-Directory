...
# iterate-lessons-log - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `iterate-lessons-log` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the iterate-lessons-log skill to...
