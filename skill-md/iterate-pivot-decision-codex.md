---
name: pm-skills-iterate-pivot-decision
display_name: iterate-pivot-decision
platform: Codex
category: PM operations, communication, and utilities
---

# iterate-pivot-decision - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `iterate-pivot-decision` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

A pivot decision document captures the analysis and rationale behind a strategic direction change.or the decision to stay the course. Based on the Lean Startup concept of "pivot or persevere," this artifact ensures major

## How To Use It In Codex

In Codex, click the chat box, press /, choose iterate-pivot-decision, then write the task. Fallback prompt: Use the iterate-pivot-decision skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `iterate-pivot-decision` |
| Canonical name | `pm-skills-iterate-pivot-decision` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
