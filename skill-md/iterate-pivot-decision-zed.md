...
# iterate-pivot-decision - Zed Skill Package

## What This Is

This is a friend-safe Markdown copy of `iterate-pivot-decision` for Zed. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Zed, open the Agent panel and type: Use the iterate-pivot-decision skill to...
