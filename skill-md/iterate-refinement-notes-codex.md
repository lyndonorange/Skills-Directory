---
name: pm-skills-iterate-refinement-notes
display_name: iterate-refinement-notes
platform: Codex
category: PM operations, communication, and utilities
---

# iterate-refinement-notes - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `iterate-refinement-notes` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Refinement notes capture the outcomes of backlog refinement (grooming) sessions.what was discussed, what was estimated, and what decisions were made. They serve as a quick reference for team members who missed the sessio

## How To Use It In Codex

In Codex, click the chat box, press /, choose iterate-refinement-notes, then write the task. Fallback prompt: Use the iterate-refinement-notes skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `iterate-refinement-notes` |
| Canonical name | `pm-skills-iterate-refinement-notes` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
