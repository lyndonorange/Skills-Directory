...
# iterate-refinement-notes - Zed Skill Package

## What This Is

This is a friend-safe Markdown copy of `iterate-refinement-notes` for Zed. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Zed, open the Agent panel and type: Use the iterate-refinement-notes skill to...
