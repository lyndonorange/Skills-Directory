---
name: IterativeDepth
display_name: IterativeDepth
platform: Codex
category: General and specialized workflows
---

# IterativeDepth - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `IterativeDepth` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Structured multi-angle exploration that runs 2-8 sequential passes through the same problem, each from a different scientific lens, to surface requirements and edge cases invisible from any single angle. Grounded in 20 t

## How To Use It In Codex

In Codex, click the chat box, press /, choose IterativeDepth, then write the task. Fallback prompt: Use the IterativeDepth skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `IterativeDepth` |
| Canonical name | `IterativeDepth` |
| Platform | `Codex` |
| Category | General and specialized workflows |
