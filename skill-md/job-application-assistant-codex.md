...
# job-application-assistant - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `job-application-assistant` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose job-application-assistant, then write the task. Fallback prompt: Use the job-application-assistant skill to...
