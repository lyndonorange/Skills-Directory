---
name: pm-skills-job-stories
display_name: job-stories
platform: Codex
category: Business creation, ideas, and validation
---

# job-stories - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `job-stories` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose job-stories, then write the task. Fallback prompt: Use the job-stories skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `job-stories` |
| Canonical name | `pm-skills-job-stories` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
