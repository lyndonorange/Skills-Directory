...
# kill-ai-slop - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kill-ai-slop` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kill-ai-slop, then write the task. Fallback prompt: Use the kill-ai-slop skill to...
