---
name: kw-apollo-enrich-lead
display_name: kw-apollo-enrich-lead
platform: Codex
category: General and specialized workflows
---

# kw-apollo-enrich-lead - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-apollo-enrich-lead` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-apollo-enrich-lead, then write the task. Fallback prompt: Use the kw-apollo-enrich-lead skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-apollo-enrich-lead` |
| Canonical name | `kw-apollo-enrich-lead` |
| Platform | `Codex` |
| Category | General and specialized workflows |
