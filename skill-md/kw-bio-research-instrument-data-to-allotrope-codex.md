...
display_name: kw-bio-research-instrument-data-to-allotrope
platform: Codex
category: General and specialized workflows
---

# kw-bio-research-instrument-data-to-allotrope - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-bio-research-instrument-data-to-allotrope` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-bio-research-instrument-data-to-allotrope, then write the task. Fallback prompt: Use the kw-bio-research-instrument-data-to-allotrope skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-bio-research-instrument-data-to-allotrope` |
| Canonical name | `kw-bio-research-instrument-data-to-allotrope` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
---
knowledge-work-plugin: bio-research
upstream-skill: instrument-data-to-allotrope
name: kw-bio-research-instrument-data-to-allotrope
