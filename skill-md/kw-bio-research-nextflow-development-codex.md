...
display_name: kw-bio-research-nextflow-development
platform: Codex
category: General and specialized workflows
---

# kw-bio-research-nextflow-development - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-bio-research-nextflow-development` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-bio-research-nextflow-development, then write the task. Fallback prompt: Use the kw-bio-research-nextflow-development skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-bio-research-nextflow-development` |
| Canonical name | `kw-bio-research-nextflow-development` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: nextflow-development
name: kw-bio-research-nextflow-development
