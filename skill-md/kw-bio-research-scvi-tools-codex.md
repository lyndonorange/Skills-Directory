...
display_name: kw-bio-research-scvi-tools
platform: Codex
category: General and specialized workflows
---

# kw-bio-research-scvi-tools - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-bio-research-scvi-tools` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-bio-research-scvi-tools, then write the task. Fallback prompt: Use the kw-bio-research-scvi-tools skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-bio-research-scvi-tools` |
| Canonical name | `kw-bio-research-scvi-tools` |
| Platform | `Codex` |
| Category | General and specialized workflows |
