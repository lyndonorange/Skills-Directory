---
name: kw-brand-voice-discover-brand
display_name: kw-brand-voice-discover-brand
platform: Codex
category: General and specialized workflows
---

# kw-brand-voice-discover-brand - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-brand-voice-discover-brand` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Orchestrate autonomous discovery of brand materials across enterprise platforms. This skill coordinates the discover-brand agent to search connected platforms (Notion, Confluence, Google Drive, Box, Microsoft 365, Figma,

## How To Use It In Codex

In Codex, click the chat box, press /, choose kw-brand-voice-discover-brand, then write the task. Fallback prompt: Use the kw-brand-voice-discover-brand skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-brand-voice-discover-brand` |
| Canonical name | `kw-brand-voice-discover-brand` |
| Platform | `Codex` |
| Category | General and specialized workflows |
