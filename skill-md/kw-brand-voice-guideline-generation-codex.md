---
name: kw-brand-voice-guideline-generation
display_name: kw-brand-voice-guideline-generation
platform: Codex
category: General and specialized workflows
---

# kw-brand-voice-guideline-generation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-brand-voice-guideline-generation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Generate comprehensive, LLM-ready brand voice guidelines from any combination of sources — brand documents, sales call transcripts, discovery reports, or direct user input. Transform raw materials into structured, enforc

## How To Use It In Codex

In Codex, click the chat box, press /, choose kw-brand-voice-guideline-generation, then write the task. Fallback prompt: Use the kw-brand-voice-guideline-generation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-brand-voice-guideline-generation` |
| Canonical name | `kw-brand-voice-guideline-generation` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
---
knowledge-work-plugin: brand-voice
upstream-skill: guideline-generation
name: kw-brand-voice-guideline-generation
description: >
