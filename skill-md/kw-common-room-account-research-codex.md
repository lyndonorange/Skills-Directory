---
name: kw-common-room-account-research
display_name: kw-common-room-account-research
platform: Codex
category: General and specialized workflows
---

# kw-common-room-account-research - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-common-room-account-research` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-common-room-account-research, then write the task. Fallback prompt: Use the kw-common-room-account-research skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-common-room-account-research` |
| Canonical name | `kw-common-room-account-research` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: account-research
name: kw-common-room-account-research
