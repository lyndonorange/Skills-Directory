---
name: kw-common-room-call-prep
display_name: kw-common-room-call-prep
platform: Codex
category: General and specialized workflows
---

# kw-common-room-call-prep - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-common-room-call-prep` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-common-room-call-prep, then write the task. Fallback prompt: Use the kw-common-room-call-prep skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-common-room-call-prep` |
| Canonical name | `kw-common-room-call-prep` |
| Platform | `Codex` |
| Category | General and specialized workflows |
