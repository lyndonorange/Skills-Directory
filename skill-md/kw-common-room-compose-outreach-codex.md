---
name: kw-common-room-compose-outreach
display_name: kw-common-room-compose-outreach
platform: Codex
category: General and specialized workflows
---

# kw-common-room-compose-outreach - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-common-room-compose-outreach` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-common-room-compose-outreach, then write the task. Fallback prompt: Use the kw-common-room-compose-outreach skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-common-room-compose-outreach` |
| Canonical name | `kw-common-room-compose-outreach` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: compose-outreach
name: kw-common-room-compose-outreach
