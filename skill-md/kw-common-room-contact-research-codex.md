---
name: kw-common-room-contact-research
display_name: kw-common-room-contact-research
platform: Codex
category: General and specialized workflows
---

# kw-common-room-contact-research - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-common-room-contact-research` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-common-room-contact-research, then write the task. Fallback prompt: Use the kw-common-room-contact-research skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-common-room-contact-research` |
| Canonical name | `kw-common-room-contact-research` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: contact-research
name: kw-common-room-contact-research
