---
name: kw-common-room-prospect
display_name: kw-common-room-prospect
platform: Codex
category: General and specialized workflows
---

# kw-common-room-prospect - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-common-room-prospect` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Build targeted account and contact lists using Common Room's Prospector. Supports iterative refinement through natural conversation, intent-based discovery, and both net-new prospecting and signal-based queries against e

## How To Use It In Codex

In Codex, click the chat box, press /, choose kw-common-room-prospect, then write the task. Fallback prompt: Use the kw-common-room-prospect skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-common-room-prospect` |
| Canonical name | `kw-common-room-prospect` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
---
knowledge-work-plugin: common-room
upstream-skill: prospect
name: kw-common-room-prospect
