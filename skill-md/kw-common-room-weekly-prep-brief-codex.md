---
name: kw-common-room-weekly-prep-brief
display_name: kw-common-room-weekly-prep-brief
platform: Codex
category: General and specialized workflows
---

# kw-common-room-weekly-prep-brief - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-common-room-weekly-prep-brief` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-common-room-weekly-prep-brief, then write the task. Fallback prompt: Use the kw-common-room-weekly-prep-brief skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-common-room-weekly-prep-brief` |
| Canonical name | `kw-common-room-weekly-prep-brief` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: weekly-prep-brief
name: kw-common-room-weekly-prep-brief
