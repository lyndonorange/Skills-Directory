...
display_name: kw-customer-support-ticket-triage
platform: Codex
category: General and specialized workflows
---

# kw-customer-support-ticket-triage - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-customer-support-ticket-triage` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-customer-support-ticket-triage, then write the task. Fallback prompt: Use the kw-customer-support-ticket-triage skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-customer-support-ticket-triage` |
| Canonical name | `kw-customer-support-ticket-triage` |
| Platform | `Codex` |
| Category | General and specialized workflows |
