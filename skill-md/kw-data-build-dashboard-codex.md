...
display_name: kw-data-build-dashboard
platform: Codex
category: General and specialized workflows
---

# kw-data-build-dashboard - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-data-build-dashboard` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-data-build-dashboard, then write the task. Fallback prompt: Use the kw-data-build-dashboard skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-data-build-dashboard` |
| Canonical name | `kw-data-build-dashboard` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: build-dashboard
name: kw-data-build-dashboard
