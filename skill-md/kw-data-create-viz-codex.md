...
display_name: kw-data-create-viz
platform: Codex
category: General and specialized workflows
---

# kw-data-create-viz - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-data-create-viz` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-data-create-viz, then write the task. Fallback prompt: Use the kw-data-create-viz skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-data-create-viz` |
| Canonical name | `kw-data-create-viz` |
| Platform | `Codex` |
| Category | General and specialized workflows |
