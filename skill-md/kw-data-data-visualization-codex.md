...
display_name: kw-data-data-visualization
platform: Codex
category: General and specialized workflows
---

# kw-data-data-visualization - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-data-data-visualization` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-data-data-visualization, then write the task. Fallback prompt: Use the kw-data-data-visualization skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-data-data-visualization` |
| Canonical name | `kw-data-data-visualization` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: data-visualization
name: kw-data-data-visualization
