...
display_name: kw-data-sql-queries
platform: Codex
category: General and specialized workflows
---

# kw-data-sql-queries - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-data-sql-queries` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-data-sql-queries, then write the task. Fallback prompt: Use the kw-data-sql-queries skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-data-sql-queries` |
| Canonical name | `kw-data-sql-queries` |
| Platform | `Codex` |
| Category | General and specialized workflows |
