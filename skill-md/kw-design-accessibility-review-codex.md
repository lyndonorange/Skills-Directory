...
display_name: kw-design-accessibility-review
platform: Codex
category: General and specialized workflows
---

# kw-design-accessibility-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-design-accessibility-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-design-accessibility-review, then write the task. Fallback prompt: Use the kw-design-accessibility-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-design-accessibility-review` |
| Canonical name | `kw-design-accessibility-review` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: accessibility-review
name: kw-design-accessibility-review
