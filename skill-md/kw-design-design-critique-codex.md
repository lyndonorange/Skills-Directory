...
display_name: kw-design-design-critique
platform: Codex
category: General and specialized workflows
---

# kw-design-design-critique - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-design-design-critique` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-design-design-critique, then write the task. Fallback prompt: Use the kw-design-design-critique skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-design-design-critique` |
| Canonical name | `kw-design-design-critique` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: design-critique
name: kw-design-design-critique
