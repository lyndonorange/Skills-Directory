...
display_name: kw-design-design-handoff
platform: Codex
category: General and specialized workflows
---

# kw-design-design-handoff - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-design-design-handoff` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-design-design-handoff, then write the task. Fallback prompt: Use the kw-design-design-handoff skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-design-design-handoff` |
| Canonical name | `kw-design-design-handoff` |
| Platform | `Codex` |
| Category | General and specialized workflows |
