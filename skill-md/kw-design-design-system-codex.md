...
display_name: kw-design-design-system
platform: Codex
category: General and specialized workflows
---

# kw-design-design-system - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-design-design-system` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-design-design-system, then write the task. Fallback prompt: Use the kw-design-design-system skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-design-design-system` |
| Canonical name | `kw-design-design-system` |
| Platform | `Codex` |
| Category | General and specialized workflows |
