...
display_name: kw-engineering-architecture
platform: Codex
category: General and specialized workflows
---

# kw-engineering-architecture - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-engineering-architecture` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-engineering-architecture, then write the task. Fallback prompt: Use the kw-engineering-architecture skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-engineering-architecture` |
| Canonical name | `kw-engineering-architecture` |
| Platform | `Codex` |
| Category | General and specialized workflows |
