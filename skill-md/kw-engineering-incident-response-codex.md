...
display_name: kw-engineering-incident-response
platform: Codex
category: General and specialized workflows
---

# kw-engineering-incident-response - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-engineering-incident-response` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-engineering-incident-response, then write the task. Fallback prompt: Use the kw-engineering-incident-response skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-engineering-incident-response` |
| Canonical name | `kw-engineering-incident-response` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: incident-response
name: kw-engineering-incident-response
