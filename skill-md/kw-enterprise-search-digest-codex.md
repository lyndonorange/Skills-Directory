...
display_name: kw-enterprise-search-digest
platform: Codex
category: General and specialized workflows
---

# kw-enterprise-search-digest - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-enterprise-search-digest` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-enterprise-search-digest, then write the task. Fallback prompt: Use the kw-enterprise-search-digest skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-enterprise-search-digest` |
| Canonical name | `kw-enterprise-search-digest` |
| Platform | `Codex` |
| Category | General and specialized workflows |
