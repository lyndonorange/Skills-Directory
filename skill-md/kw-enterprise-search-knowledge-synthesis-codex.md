...
display_name: kw-enterprise-search-knowledge-synthesis
platform: Codex
category: General and specialized workflows
---

# kw-enterprise-search-knowledge-synthesis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-enterprise-search-knowledge-synthesis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-enterprise-search-knowledge-synthesis, then write the task. Fallback prompt: Use the kw-enterprise-search-knowledge-synthesis skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-enterprise-search-knowledge-synthesis` |
| Canonical name | `kw-enterprise-search-knowledge-synthesis` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
---
knowledge-work-plugin: enterprise-search
upstream-skill: knowledge-synthesis
name: kw-enterprise-search-knowledge-synthesis
