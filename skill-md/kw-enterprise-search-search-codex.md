...
display_name: kw-enterprise-search-search
platform: Codex
category: General and specialized workflows
---

# kw-enterprise-search-search - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-enterprise-search-search` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-enterprise-search-search, then write the task. Fallback prompt: Use the kw-enterprise-search-search skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-enterprise-search-search` |
| Canonical name | `kw-enterprise-search-search` |
| Platform | `Codex` |
| Category | General and specialized workflows |
