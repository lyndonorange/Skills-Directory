...
display_name: kw-enterprise-search-source-management
platform: Codex
category: General and specialized workflows
---

# kw-enterprise-search-source-management - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-enterprise-search-source-management` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-enterprise-search-source-management, then write the task. Fallback prompt: Use the kw-enterprise-search-source-management skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-enterprise-search-source-management` |
| Canonical name | `kw-enterprise-search-source-management` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: source-management
name: kw-enterprise-search-source-management
