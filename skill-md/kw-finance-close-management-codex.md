...
display_name: kw-finance-close-management
platform: Codex
category: General and specialized workflows
---

# kw-finance-close-management - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-finance-close-management` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-finance-close-management, then write the task. Fallback prompt: Use the kw-finance-close-management skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-finance-close-management` |
| Canonical name | `kw-finance-close-management` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: close-management
name: kw-finance-close-management
