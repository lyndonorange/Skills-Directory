...
display_name: kw-finance-financial-statements
platform: Codex
category: General and specialized workflows
---

# kw-finance-financial-statements - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-finance-financial-statements` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-finance-financial-statements, then write the task. Fallback prompt: Use the kw-finance-financial-statements skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-finance-financial-statements` |
| Canonical name | `kw-finance-financial-statements` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: financial-statements
name: kw-finance-financial-statements
