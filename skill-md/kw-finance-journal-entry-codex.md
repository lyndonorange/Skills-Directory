...
display_name: kw-finance-journal-entry
platform: Codex
category: General and specialized workflows
---

# kw-finance-journal-entry - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-finance-journal-entry` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-finance-journal-entry, then write the task. Fallback prompt: Use the kw-finance-journal-entry skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-finance-journal-entry` |
| Canonical name | `kw-finance-journal-entry` |
| Platform | `Codex` |
| Category | General and specialized workflows |
