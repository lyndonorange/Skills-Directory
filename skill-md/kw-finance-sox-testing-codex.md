...
display_name: kw-finance-sox-testing
platform: Codex
category: General and specialized workflows
---

# kw-finance-sox-testing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-finance-sox-testing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-finance-sox-testing, then write the task. Fallback prompt: Use the kw-finance-sox-testing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-finance-sox-testing` |
| Canonical name | `kw-finance-sox-testing` |
| Platform | `Codex` |
| Category | General and specialized workflows |
