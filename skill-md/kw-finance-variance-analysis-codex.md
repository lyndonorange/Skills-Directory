...
display_name: kw-finance-variance-analysis
platform: Codex
category: General and specialized workflows
---

# kw-finance-variance-analysis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-finance-variance-analysis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-finance-variance-analysis, then write the task. Fallback prompt: Use the kw-finance-variance-analysis skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-finance-variance-analysis` |
| Canonical name | `kw-finance-variance-analysis` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: variance-analysis
name: kw-finance-variance-analysis
