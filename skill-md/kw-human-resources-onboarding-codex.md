...
display_name: kw-human-resources-onboarding
platform: Codex
category: General and specialized workflows
---

# kw-human-resources-onboarding - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-human-resources-onboarding` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-human-resources-onboarding, then write the task. Fallback prompt: Use the kw-human-resources-onboarding skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-human-resources-onboarding` |
| Canonical name | `kw-human-resources-onboarding` |
| Platform | `Codex` |
| Category | General and specialized workflows |
