...
display_name: kw-human-resources-people-report
platform: Codex
category: General and specialized workflows
---

# kw-human-resources-people-report - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-human-resources-people-report` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-human-resources-people-report, then write the task. Fallback prompt: Use the kw-human-resources-people-report skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-human-resources-people-report` |
| Canonical name | `kw-human-resources-people-report` |
| Platform | `Codex` |
| Category | General and specialized workflows |
