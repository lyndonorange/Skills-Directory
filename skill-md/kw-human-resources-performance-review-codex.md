...
display_name: kw-human-resources-performance-review
platform: Codex
category: General and specialized workflows
---

# kw-human-resources-performance-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-human-resources-performance-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-human-resources-performance-review, then write the task. Fallback prompt: Use the kw-human-resources-performance-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-human-resources-performance-review` |
| Canonical name | `kw-human-resources-performance-review` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: performance-review
name: kw-human-resources-performance-review
