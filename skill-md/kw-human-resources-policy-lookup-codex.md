...
display_name: kw-human-resources-policy-lookup
platform: Codex
category: General and specialized workflows
---

# kw-human-resources-policy-lookup - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-human-resources-policy-lookup` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-human-resources-policy-lookup, then write the task. Fallback prompt: Use the kw-human-resources-policy-lookup skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-human-resources-policy-lookup` |
| Canonical name | `kw-human-resources-policy-lookup` |
| Platform | `Codex` |
| Category | General and specialized workflows |
