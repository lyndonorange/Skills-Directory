---
name: kw-legal-brief
display_name: kw-legal-brief
platform: Codex
category: General and specialized workflows
---

# kw-legal-brief - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-legal-brief` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-legal-brief, then write the task. Fallback prompt: Use the kw-legal-brief skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-legal-brief` |
| Canonical name | `kw-legal-brief` |
| Platform | `Codex` |
| Category | General and specialized workflows |
