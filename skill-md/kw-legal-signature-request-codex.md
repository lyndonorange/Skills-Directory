...
display_name: kw-legal-signature-request
platform: Codex
category: General and specialized workflows
---

# kw-legal-signature-request - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-legal-signature-request` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-legal-signature-request, then write the task. Fallback prompt: Use the kw-legal-signature-request skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-legal-signature-request` |
| Canonical name | `kw-legal-signature-request` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: signature-request
name: kw-legal-signature-request
