...
display_name: kw-legal-vendor-check
platform: Codex
category: General and specialized workflows
---

# kw-legal-vendor-check - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-legal-vendor-check` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-legal-vendor-check, then write the task. Fallback prompt: Use the kw-legal-vendor-check skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-legal-vendor-check` |
| Canonical name | `kw-legal-vendor-check` |
| Platform | `Codex` |
| Category | General and specialized workflows |
