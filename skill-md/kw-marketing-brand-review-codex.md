...
display_name: kw-marketing-brand-review
platform: Codex
category: General and specialized workflows
---

# kw-marketing-brand-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-marketing-brand-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-marketing-brand-review, then write the task. Fallback prompt: Use the kw-marketing-brand-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-marketing-brand-review` |
| Canonical name | `kw-marketing-brand-review` |
| Platform | `Codex` |
| Category | General and specialized workflows |
