...
display_name: kw-marketing-campaign-plan
platform: Codex
category: General and specialized workflows
---

# kw-marketing-campaign-plan - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-marketing-campaign-plan` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-marketing-campaign-plan, then write the task. Fallback prompt: Use the kw-marketing-campaign-plan skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-marketing-campaign-plan` |
| Canonical name | `kw-marketing-campaign-plan` |
| Platform | `Codex` |
| Category | General and specialized workflows |
