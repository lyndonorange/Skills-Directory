...
display_name: kw-marketing-draft-content
platform: Codex
category: General and specialized workflows
---

# kw-marketing-draft-content - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-marketing-draft-content` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-marketing-draft-content, then write the task. Fallback prompt: Use the kw-marketing-draft-content skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-marketing-draft-content` |
| Canonical name | `kw-marketing-draft-content` |
| Platform | `Codex` |
| Category | General and specialized workflows |
