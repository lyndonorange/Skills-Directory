...
display_name: kw-marketing-email-sequence
platform: Codex
category: General and specialized workflows
---

# kw-marketing-email-sequence - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-marketing-email-sequence` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-marketing-email-sequence, then write the task. Fallback prompt: Use the kw-marketing-email-sequence skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-marketing-email-sequence` |
| Canonical name | `kw-marketing-email-sequence` |
| Platform | `Codex` |
| Category | General and specialized workflows |
