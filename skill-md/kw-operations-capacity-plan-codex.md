...
display_name: kw-operations-capacity-plan
platform: Codex
category: General and specialized workflows
---

# kw-operations-capacity-plan - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-operations-capacity-plan` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-operations-capacity-plan, then write the task. Fallback prompt: Use the kw-operations-capacity-plan skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-operations-capacity-plan` |
| Canonical name | `kw-operations-capacity-plan` |
| Platform | `Codex` |
| Category | General and specialized workflows |
