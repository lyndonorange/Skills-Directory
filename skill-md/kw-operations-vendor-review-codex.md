...
display_name: kw-operations-vendor-review
platform: Codex
category: General and specialized workflows
---

# kw-operations-vendor-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-operations-vendor-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-operations-vendor-review, then write the task. Fallback prompt: Use the kw-operations-vendor-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-operations-vendor-review` |
| Canonical name | `kw-operations-vendor-review` |
| Platform | `Codex` |
| Category | General and specialized workflows |
