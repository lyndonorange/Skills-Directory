...
display_name: kw-product-management-sprint-planning
platform: Codex
category: General and specialized workflows
---

# kw-product-management-sprint-planning - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-product-management-sprint-planning` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-product-management-sprint-planning, then write the task. Fallback prompt: Use the kw-product-management-sprint-planning skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-product-management-sprint-planning` |
| Canonical name | `kw-product-management-sprint-planning` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: sprint-planning
name: kw-product-management-sprint-planning
