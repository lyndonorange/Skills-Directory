...
display_name: kw-productivity-memory-management
platform: Codex
category: General and specialized workflows
---

# kw-productivity-memory-management - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-productivity-memory-management` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-productivity-memory-management, then write the task. Fallback prompt: Use the kw-productivity-memory-management skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-productivity-memory-management` |
| Canonical name | `kw-productivity-memory-management` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: memory-management
name: kw-productivity-memory-management
