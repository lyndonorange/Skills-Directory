...
display_name: kw-productivity-update
platform: Codex
category: General and specialized workflows
---

# kw-productivity-update - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-productivity-update` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-productivity-update, then write the task. Fallback prompt: Use the kw-productivity-update skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-productivity-update` |
| Canonical name | `kw-productivity-update` |
| Platform | `Codex` |
| Category | General and specialized workflows |
