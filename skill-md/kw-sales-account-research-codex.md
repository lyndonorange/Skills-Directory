...
display_name: kw-sales-account-research
platform: Codex
category: General and specialized workflows
---

# kw-sales-account-research - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-sales-account-research` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-sales-account-research, then write the task. Fallback prompt: Use the kw-sales-account-research skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-sales-account-research` |
| Canonical name | `kw-sales-account-research` |
| Platform | `Codex` |
| Category | General and specialized workflows |
