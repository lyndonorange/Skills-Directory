...
display_name: kw-sales-call-prep
platform: Codex
category: General and specialized workflows
---

# kw-sales-call-prep - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-sales-call-prep` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-sales-call-prep, then write the task. Fallback prompt: Use the kw-sales-call-prep skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-sales-call-prep` |
| Canonical name | `kw-sales-call-prep` |
| Platform | `Codex` |
| Category | General and specialized workflows |
