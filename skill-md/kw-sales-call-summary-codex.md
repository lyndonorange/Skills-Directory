...
display_name: kw-sales-call-summary
platform: Codex
category: General and specialized workflows
---

# kw-sales-call-summary - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-sales-call-summary` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-sales-call-summary, then write the task. Fallback prompt: Use the kw-sales-call-summary skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-sales-call-summary` |
| Canonical name | `kw-sales-call-summary` |
| Platform | `Codex` |
| Category | General and specialized workflows |
