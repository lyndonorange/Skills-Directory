...
display_name: kw-sales-competitive-intelligence
platform: Codex
category: General and specialized workflows
---

# kw-sales-competitive-intelligence - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-sales-competitive-intelligence` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-sales-competitive-intelligence, then write the task. Fallback prompt: Use the kw-sales-competitive-intelligence skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-sales-competitive-intelligence` |
| Canonical name | `kw-sales-competitive-intelligence` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
---
knowledge-work-plugin: sales
upstream-skill: competitive-intelligence
name: kw-sales-competitive-intelligence
...
[View your battlecard]([local file URL removed])
