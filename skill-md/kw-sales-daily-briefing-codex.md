...
display_name: kw-sales-daily-briefing
platform: Codex
category: General and specialized workflows
---

# kw-sales-daily-briefing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-sales-daily-briefing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-sales-daily-briefing, then write the task. Fallback prompt: Use the kw-sales-daily-briefing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-sales-daily-briefing` |
| Canonical name | `kw-sales-daily-briefing` |
| Platform | `Codex` |
| Category | General and specialized workflows |
