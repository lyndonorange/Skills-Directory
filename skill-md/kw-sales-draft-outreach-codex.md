...
display_name: kw-sales-draft-outreach
platform: Codex
category: General and specialized workflows
---

# kw-sales-draft-outreach - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-sales-draft-outreach` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-sales-draft-outreach, then write the task. Fallback prompt: Use the kw-sales-draft-outreach skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-sales-draft-outreach` |
| Canonical name | `kw-sales-draft-outreach` |
| Platform | `Codex` |
| Category | General and specialized workflows |
