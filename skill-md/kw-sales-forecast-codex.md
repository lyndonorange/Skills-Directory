...
display_name: kw-sales-forecast
platform: Codex
category: General and specialized workflows
---

# kw-sales-forecast - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-sales-forecast` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-sales-forecast, then write the task. Fallback prompt: Use the kw-sales-forecast skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-sales-forecast` |
| Canonical name | `kw-sales-forecast` |
| Platform | `Codex` |
| Category | General and specialized workflows |
