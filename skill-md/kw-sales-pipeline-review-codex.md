...
display_name: kw-sales-pipeline-review
platform: Codex
category: General and specialized workflows
---

# kw-sales-pipeline-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-sales-pipeline-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-sales-pipeline-review, then write the task. Fallback prompt: Use the kw-sales-pipeline-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-sales-pipeline-review` |
| Canonical name | `kw-sales-pipeline-review` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: pipeline-review
name: kw-sales-pipeline-review
