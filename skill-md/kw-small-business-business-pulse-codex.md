...
display_name: kw-small-business-business-pulse
platform: Codex
category: General and specialized workflows
---

# kw-small-business-business-pulse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-small-business-business-pulse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

One prompt, one page. Pull live data from every connected tool, synthesize it into a single scannable brief, and surface the single most important thing to act on today. Do the work — don't ask the user to help find the 

## How To Use It In Codex

In Codex, click the chat box, press /, choose kw-small-business-business-pulse, then write the task. Fallback prompt: Use the kw-small-business-business-pulse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-small-business-business-pulse` |
| Canonical name | `kw-small-business-business-pulse` |
| Platform | `Codex` |
| Category | General and specialized workflows |
