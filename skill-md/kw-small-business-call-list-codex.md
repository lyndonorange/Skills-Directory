...
display_name: kw-small-business-call-list
platform: Codex
category: General and specialized workflows
---

# kw-small-business-call-list - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-small-business-call-list` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-small-business-call-list, then write the task. Fallback prompt: Use the kw-small-business-call-list skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-small-business-call-list` |
| Canonical name | `kw-small-business-call-list` |
| Platform | `Codex` |
| Category | General and specialized workflows |
