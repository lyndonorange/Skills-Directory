...
display_name: kw-small-business-cash-flow-snapshot
platform: Codex
category: General and specialized workflows
---

# kw-small-business-cash-flow-snapshot - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-small-business-cash-flow-snapshot` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-small-business-cash-flow-snapshot, then write the task. Fallback prompt: Use the kw-small-business-cash-flow-snapshot skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-small-business-cash-flow-snapshot` |
| Canonical name | `kw-small-business-cash-flow-snapshot` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: cash-flow-snapshot
name: kw-small-business-cash-flow-snapshot
description: >
