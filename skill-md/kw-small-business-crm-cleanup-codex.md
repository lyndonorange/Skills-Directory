...
display_name: kw-small-business-crm-cleanup
platform: Codex
category: General and specialized workflows
---

# kw-small-business-crm-cleanup - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-small-business-crm-cleanup` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-small-business-crm-cleanup, then write the task. Fallback prompt: Use the kw-small-business-crm-cleanup skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-small-business-crm-cleanup` |
| Canonical name | `kw-small-business-crm-cleanup` |
| Platform | `Codex` |
| Category | General and specialized workflows |
