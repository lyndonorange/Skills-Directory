...
display_name: kw-small-business-handle-complaint
platform: Codex
category: General and specialized workflows
---

# kw-small-business-handle-complaint - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-small-business-handle-complaint` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-small-business-handle-complaint, then write the task. Fallback prompt: Use the kw-small-business-handle-complaint skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-small-business-handle-complaint` |
| Canonical name | `kw-small-business-handle-complaint` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
---
knowledge-work-plugin: small-business
upstream-skill: handle-complaint
name: kw-small-business-handle-complaint
