...
display_name: kw-small-business-invoice-chase
platform: Codex
category: General and specialized workflows
---

# kw-small-business-invoice-chase - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-small-business-invoice-chase` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-small-business-invoice-chase, then write the task. Fallback prompt: Use the kw-small-business-invoice-chase skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-small-business-invoice-chase` |
| Canonical name | `kw-small-business-invoice-chase` |
| Platform | `Codex` |
| Category | General and specialized workflows |
