...
display_name: kw-small-business-monday-brief
platform: Codex
category: General and specialized workflows
---

# kw-small-business-monday-brief - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-small-business-monday-brief` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-small-business-monday-brief, then write the task. Fallback prompt: Use the kw-small-business-monday-brief skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-small-business-monday-brief` |
| Canonical name | `kw-small-business-monday-brief` |
| Platform | `Codex` |
| Category | General and specialized workflows |
