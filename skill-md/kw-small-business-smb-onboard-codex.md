...
display_name: kw-small-business-smb-onboard
platform: Codex
category: General and specialized workflows
---

# kw-small-business-smb-onboard - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-small-business-smb-onboard` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-small-business-smb-onboard, then write the task. Fallback prompt: Use the kw-small-business-smb-onboard skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-small-business-smb-onboard` |
| Canonical name | `kw-small-business-smb-onboard` |
| Platform | `Codex` |
| Category | General and specialized workflows |
