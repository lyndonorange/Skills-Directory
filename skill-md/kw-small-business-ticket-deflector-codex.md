...
display_name: kw-small-business-ticket-deflector
platform: Codex
category: General and specialized workflows
---

# kw-small-business-ticket-deflector - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-small-business-ticket-deflector` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Forward or paste a customer email — Claude pulls order status from PayPal, looks up the customer in HubSpot, and drafts a reply in the owner's voice. If a refund is needed, it stages the details and waits for explicit ap

## How To Use It In Codex

In Codex, click the chat box, press /, choose kw-small-business-ticket-deflector, then write the task. Fallback prompt: Use the kw-small-business-ticket-deflector skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-small-business-ticket-deflector` |
| Canonical name | `kw-small-business-ticket-deflector` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
upstream-skill: ticket-deflector
name: kw-small-business-ticket-deflector
description: >
