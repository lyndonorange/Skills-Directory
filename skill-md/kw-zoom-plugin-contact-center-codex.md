---
name: kw-zoom-plugin-contact-center
display_name: kw-zoom-plugin-contact-center
platform: Codex
category: General and specialized workflows
---

# kw-zoom-plugin-contact-center - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-zoom-plugin-contact-center` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-zoom-plugin-contact-center, then write the task. Fallback prompt: Use the kw-zoom-plugin-contact-center skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-zoom-plugin-contact-center` |
| Canonical name | `kw-zoom-plugin-contact-center` |
| Platform | `Codex` |
| Category | General and specialized workflows |
