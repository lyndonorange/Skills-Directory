---
name: kw-zoom-plugin-general
display_name: kw-zoom-plugin-general
platform: Codex
category: General and specialized workflows
---

# kw-zoom-plugin-general - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-zoom-plugin-general` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-zoom-plugin-general, then write the task. Fallback prompt: Use the kw-zoom-plugin-general skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-zoom-plugin-general` |
| Canonical name | `kw-zoom-plugin-general` |
| Platform | `Codex` |
| Category | General and specialized workflows |
