---
name: kw-zoom-plugin-webhooks
display_name: kw-zoom-plugin-webhooks
platform: Codex
category: General and specialized workflows
---

# kw-zoom-plugin-webhooks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `kw-zoom-plugin-webhooks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose kw-zoom-plugin-webhooks, then write the task. Fallback prompt: Use the kw-zoom-plugin-webhooks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `kw-zoom-plugin-webhooks` |
| Canonical name | `kw-zoom-plugin-webhooks` |
| Platform | `Codex` |
| Category | General and specialized workflows |
