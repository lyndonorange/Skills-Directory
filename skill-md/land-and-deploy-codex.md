...
display_name: land-and-deploy
platform: Codex
category: General and specialized workflows
---

# land-and-deploy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `land-and-deploy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose land-and-deploy, then write the task. Fallback prompt: Use the land-and-deploy skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `land-and-deploy` |
| Canonical name | `land-and-deploy` |
| Platform | `Codex` |
| Category | General and specialized workflows |
