---
name: landing-report
display_name: landing-report
platform: Codex
category: General and specialized workflows
---

# landing-report - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `landing-report` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose landing-report, then write the task. Fallback prompt: Use the landing-report skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `landing-report` |
| Canonical name | `landing-report` |
| Platform | `Codex` |
| Category | General and specialized workflows |
