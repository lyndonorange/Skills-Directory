---
name: pm-skills-lean-canvas
display_name: lean-canvas
platform: Codex
category: Business creation, ideas, and validation
---

# lean-canvas - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `lean-canvas` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose lean-canvas, then write the task. Fallback prompt: Use the lean-canvas skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `lean-canvas` |
| Canonical name | `pm-skills-lean-canvas` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
