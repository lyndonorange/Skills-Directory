...
# LifeOS - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `LifeOS` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Install and onboard a user into LifeOS — the Life Operating System (current state → ideal state via TELOS + the Algorithm). The agentic installer detects your OS + harness, wires hooks with permission, scaffolds your USE

## How To Use It In Codex

In Codex, click the chat box, press /, choose LifeOS, then write the task. Fallback prompt: Use the LifeOS skill to...
