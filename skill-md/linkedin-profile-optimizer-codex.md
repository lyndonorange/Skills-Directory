...
display_name: linkedin-profile-optimizer
platform: Codex
category: General and specialized workflows
---

# linkedin-profile-optimizer - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `linkedin-profile-optimizer` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose linkedin-profile-optimizer, then write the task. Fallback prompt: Use the linkedin-profile-optimizer skill to...
...
| Canonical name | `linkedin-profile-optimizer` |
| Platform | `Codex` |
| Category | General and specialized workflows |
