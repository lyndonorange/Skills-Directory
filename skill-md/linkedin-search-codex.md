...
# linkedin-search - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `linkedin-search` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose linkedin-search, then write the task. Fallback prompt: Use the linkedin-search skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `linkedin-search` |
| Canonical name | `linkedin-search` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
description: >
  ...
  positions open, remote jobs, "are there any X jobs in a place", look up this
  job posting.
---
