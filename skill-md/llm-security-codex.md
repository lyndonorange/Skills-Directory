...
# llm-security - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `llm-security` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose llm-security, then write the task. Fallback prompt: Use the llm-security skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `llm-security` |
| Canonical name | `llm-security` |
| Platform | `Codex` |
| Category | General and specialized workflows |
