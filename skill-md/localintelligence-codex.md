...
display_name: LocalIntelligence
platform: Codex
category: General and specialized workflows
---

# LocalIntelligence - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `LocalIntelligence` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose LocalIntelligence, then write the task. Fallback prompt: Use the LocalIntelligence skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `LocalIntelligence` |
| Canonical name | `LocalIntelligence` |
| Platform | `Codex` |
| Category | General and specialized workflows |
