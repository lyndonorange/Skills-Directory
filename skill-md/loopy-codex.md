...
# loopy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `loopy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Discover, find, compare, audit, repair, adapt, craft, run, debrief, save, and prepare repeatable AI-agent loops for publication. Use when a user asks to analyze code or coding threads for recurring work, find a published

## How To Use It In Codex

In Codex, click the chat box, press /, choose loopy, then write the task. Fallback prompt: Use the loopy skill to...
