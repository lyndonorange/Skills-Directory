...
# macos-desktop-agent-development - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `macos-desktop-agent-development` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose macos-desktop-agent-development, then write the task. Fallback prompt: Use the macos-desktop-agent-development skill to...
