---
name: macos-reverse
display_name: macos-reverse
platform: Codex
category: General and specialized workflows
---

# macos-reverse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `macos-reverse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose macos-reverse, then write the task. Fallback prompt: Use the macos-reverse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `macos-reverse` |
| Canonical name | `macos-reverse` |
| Platform | `Codex` |
| Category | General and specialized workflows |
