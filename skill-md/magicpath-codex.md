---
name: magicpath
display_name: magicpath
platform: Codex
category: Design, creative, and media
---

# magicpath - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `magicpath` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose magicpath, then write the task. Fallback prompt: Use the magicpath skill to...
