---
name: make-pdf
display_name: make-pdf
platform: Codex
category: General and specialized workflows
---

# make-pdf - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `make-pdf` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose make-pdf, then write the task. Fallback prompt: Use the make-pdf skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `make-pdf` |
| Canonical name | `make-pdf` |
| Platform | `Codex` |
| Category | General and specialized workflows |
