...
display_name: managed-airflow-migrations
platform: Codex
category: General and specialized workflows
---

# managed-airflow-migrations - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `managed-airflow-migrations` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Provides guidance for migrating Apache Airflow DAGs in Managed Service for Apache Airflow (MSAA; formerly Cloud Composer). Covers migration to Airflow 2.11.1 (MSAA Gen 2 and 3) and Airflow 3 (MSAA Gen 3), including envir

## How To Use It In Codex

In Codex, click the chat box, press /, choose managed-airflow-migrations, then write the task. Fallback prompt: Use the managed-airflow-migrations skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `managed-airflow-migrations` |
| Canonical name | `managed-airflow-migrations` |
| Platform | `Codex` |
| Category | General and specialized workflows |
