...
display_name: managing-cloud-identity-with-okta
platform: Codex
category: General and specialized workflows
---

# managing-cloud-identity-with-okta - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `managing-cloud-identity-with-okta` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose managing-cloud-identity-with-okta, then write the task. Fallback prompt: Use the managing-cloud-identity-with-okta skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `managing-cloud-identity-with-okta` |
| Canonical name | `managing-cloud-identity-with-okta` |
| Platform | `Codex` |
| Category | General and specialized workflows |
