...
# mapping-mitre-attack-techniques - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `mapping-mitre-attack-techniques` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose mapping-mitre-attack-techniques, then write the task. Fallback prompt: Use the mapping-mitre-attack-techniques skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `mapping-mitre-attack-techniques` |
| Canonical name | `mapping-mitre-attack-techniques` |
| Platform | `Codex` |
| Category | General and specialized workflows |
