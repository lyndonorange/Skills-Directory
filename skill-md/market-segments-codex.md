---
name: pm-skills-market-segments
display_name: market-segments
platform: Codex
category: Business creation, ideas, and validation
---

# market-segments - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `market-segments` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Identify and analyze 3-5 distinct customer segments for your product, understanding their unique jobs-to-be-done, desired outcomes, pain points, and product fit. Use this skill to evaluate market opportunities, prioritiz

## How To Use It In Codex

In Codex, click the chat box, press /, choose market-segments, then write the task. Fallback prompt: Use the market-segments skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `market-segments` |
| Canonical name | `pm-skills-market-segments` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
