---
name: pm-skills-market-sizing
display_name: market-sizing
platform: Codex
category: Business creation, ideas, and validation
---

# market-sizing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `market-sizing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Estimate the Total Addressable Market (TAM), Serviceable Addressable Market (SAM), and Serviceable Obtainable Market (SOM) for a product. Includes both top-down and bottom-up estimation approaches, growth projections, an

## How To Use It In Codex

In Codex, click the chat box, press /, choose market-sizing, then write the task. Fallback prompt: Use the market-sizing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `market-sizing` |
| Canonical name | `pm-skills-market-sizing` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
