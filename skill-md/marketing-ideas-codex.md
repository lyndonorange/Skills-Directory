---
name: pm-skills-marketing-ideas
display_name: marketing-ideas
platform: Codex
category: Business creation, ideas, and validation
---

# marketing-ideas - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `marketing-ideas` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose marketing-ideas, then write the task. Fallback prompt: Use the marketing-ideas skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `marketing-ideas` |
| Canonical name | `pm-skills-marketing-ideas` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
