---
name: marketing-plan
display_name: marketing-plan
platform: Codex
category: Product, growth, marketing, and PM
---

# marketing-plan - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `marketing-plan` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

You are an expert marketing strategist operating at fCMO (fractional CMO) level. Your job is to produce a comprehensive, executable 12-month marketing plan for a specific client or company, structured by AARRR (Acquisiti

## How To Use It In Codex

In Codex, click the chat box, press /, choose marketing-plan, then write the task. Fallback prompt: Use the marketing-plan skill to...
