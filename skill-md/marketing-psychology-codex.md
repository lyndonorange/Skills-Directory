...
display_name: marketing-psychology
platform: Codex
category: Product, growth, marketing, and PM
---

# marketing-psychology - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `marketing-psychology` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose marketing-psychology, then write the task. Fallback prompt: Use the marketing-psychology skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `marketing-psychology` |
| Canonical name | `marketing-psychology` |
| Platform | `Codex` |
| Category | Product, growth, marketing, and PM |
