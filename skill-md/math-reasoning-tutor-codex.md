...
# math-reasoning-tutor - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `math-reasoning-tutor` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose math-reasoning-tutor, then write the task. Fallback prompt: Use the math-reasoning-tutor skill to...
