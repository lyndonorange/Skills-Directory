...
# mcp-inspector - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `mcp-inspector` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Interpret and use `mcpjam` probe, doctor, OAuth, XAA (Cross-App Access / ID-JAG), apps conformance, tools, resources, and prompts output conservatively against MCP 2025-11-25. Use when interacting with MCP servers, execu

## How To Use It In Codex

In Codex, click the chat box, press /, choose mcp-inspector, then write the task. Fallback prompt: Use the mcp-inspector skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `mcp-inspector` |
| Canonical name | `mcp-inspector` |
| Platform | `Codex` |
| Category | General and specialized workflows |
