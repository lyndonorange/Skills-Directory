---
name: pm-skills-measure-experiment-design
display_name: measure-experiment-design
platform: Codex
category: Product analytics, experiments, and measurement
---

# measure-experiment-design - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `measure-experiment-design` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

An experiment design document defines all parameters needed to run a rigorous A/B test or controlled experiment. It ensures the team aligns on what you're testing, how you'll measure success, and how long to run the test

## How To Use It In Codex

In Codex, click the chat box, press /, choose measure-experiment-design, then write the task. Fallback prompt: Use the measure-experiment-design skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `measure-experiment-design` |
| Canonical name | `pm-skills-measure-experiment-design` |
| Platform | `Codex` |
| Category | Product analytics, experiments, and measurement |
