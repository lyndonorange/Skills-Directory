---
name: pm-skills-measure-experiment-results
display_name: measure-experiment-results
platform: Codex
category: Product analytics, experiments, and measurement
---

# measure-experiment-results - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `measure-experiment-results` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

An experiment results document captures what happened when you tested a hypothesis, including statistical outcomes, segment analysis, learnings, and clear recommendations. Good results documentation turns individual expe

## How To Use It In Codex

In Codex, click the chat box, press /, choose measure-experiment-results, then write the task. Fallback prompt: Use the measure-experiment-results skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `measure-experiment-results` |
| Canonical name | `pm-skills-measure-experiment-results` |
| Platform | `Codex` |
| Category | Product analytics, experiments, and measurement |
