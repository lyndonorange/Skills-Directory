...
# measure-experiment-results - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `measure-experiment-results` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the measure-experiment-results skill to...
