---
name: pm-skills-measure-instrumentation-spec
display_name: measure-instrumentation-spec
platform: Codex
category: Product analytics, experiments, and measurement
---

# measure-instrumentation-spec - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `measure-instrumentation-spec` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

An instrumentation spec defines what analytics events to track, when to fire them, and what properties to include. It serves as a contract between product and engineering, ensuring consistent data collection that enables

## How To Use It In Codex

In Codex, click the chat box, press /, choose measure-instrumentation-spec, then write the task. Fallback prompt: Use the measure-instrumentation-spec skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `measure-instrumentation-spec` |
| Canonical name | `pm-skills-measure-instrumentation-spec` |
| Platform | `Codex` |
| Category | Product analytics, experiments, and measurement |
