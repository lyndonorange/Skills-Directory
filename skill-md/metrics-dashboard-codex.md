---
name: pm-skills-metrics-dashboard
display_name: metrics-dashboard
platform: Codex
category: Product analytics, experiments, and measurement
---

# metrics-dashboard - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `metrics-dashboard` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose metrics-dashboard, then write the task. Fallback prompt: Use the metrics-dashboard skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `metrics-dashboard` |
| Canonical name | `pm-skills-metrics-dashboard` |
| Platform | `Codex` |
| Category | Product analytics, experiments, and measurement |
