...
# Migrate - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `Migrate` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Intakes external content, classifies chunks against LifeOS taxonomy, commits with provenance. Sources: .md/.txt, stdin, LifeOS dirs, CLAUDE.md/Cursor/OpenAI Custom Instructions, Obsidian/Notion/Apple Notes exports. Migra

## How To Use It In Codex

In Codex, click the chat box, press /, choose Migrate, then write the task. Fallback prompt: Use the Migrate skill to...
