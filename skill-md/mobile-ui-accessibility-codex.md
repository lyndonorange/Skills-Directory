...
# mobile-ui-accessibility - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `mobile-ui-accessibility` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose mobile-ui-accessibility, then write the task. Fallback prompt: Use the mobile-ui-accessibility skill to...
