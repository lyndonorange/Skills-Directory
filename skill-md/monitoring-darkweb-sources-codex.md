...
# monitoring-darkweb-sources - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `monitoring-darkweb-sources` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose monitoring-darkweb-sources, then write the task. Fallback prompt: Use the monitoring-darkweb-sources skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `monitoring-darkweb-sources` |
| Canonical name | `monitoring-darkweb-sources` |
| Platform | `Codex` |
| Category | General and specialized workflows |
