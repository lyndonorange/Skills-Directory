...
display_name: monitoring-scada-modbus-traffic-anomalies
platform: Codex
category: General and specialized workflows
---

# monitoring-scada-modbus-traffic-anomalies - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `monitoring-scada-modbus-traffic-anomalies` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose monitoring-scada-modbus-traffic-anomalies, then write the task. Fallback prompt: Use the monitoring-scada-modbus-traffic-anomalies skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `monitoring-scada-modbus-traffic-anomalies` |
| Canonical name | `monitoring-scada-modbus-traffic-anomalies` |
| Platform | `Codex` |
| Category | General and specialized workflows |
