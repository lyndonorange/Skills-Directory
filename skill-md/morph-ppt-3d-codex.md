---
name: morph-ppt-3d
display_name: morph-ppt-3d
platform: Codex
category: General and specialized workflows
---

# morph-ppt-3d - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `morph-ppt-3d` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose morph-ppt-3d, then write the task. Fallback prompt: Use the morph-ppt-3d skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `morph-ppt-3d` |
| Canonical name | `morph-ppt-3d` |
| Platform | `Codex` |
| Category | General and specialized workflows |
