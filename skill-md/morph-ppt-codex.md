---
name: morph-ppt
display_name: morph-ppt
platform: Codex
category: General and specialized workflows
---

# morph-ppt - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `morph-ppt` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Use this skill when the user wants a .pptx with smooth cross-slide animation — PowerPoint Morph transitions, Keynote-style continuous motion, shapes that grow / move / rotate as the slide advances. Trigger on: 'morph', '

## How To Use It In Codex

In Codex, click the chat box, press /, choose morph-ppt, then write the task. Fallback prompt: Use the morph-ppt skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `morph-ppt` |
| Canonical name | `morph-ppt` |
| Platform | `Codex` |
| Category | General and specialized workflows |
