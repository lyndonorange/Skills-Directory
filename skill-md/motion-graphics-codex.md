...
# motion-graphics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `motion-graphics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose motion-graphics, then write the task. Fallback prompt: Use the motion-graphics skill to...
...
| Canonical name | `motion-graphics` |
| Platform | `Codex` |
| Category | General and specialized workflows |
