---
name: music-to-video
display_name: music-to-video
platform: Codex
category: General and specialized workflows
---

# music-to-video - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `music-to-video` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Turn a music track (an audio file, a video to pull audio from, or a track generated from a mood brief) into a beat-synced video — lyric video, slideshow, or kinetic promo. The music drives all pacing; any user-supplied i

## How To Use It In Codex

In Codex, click the chat box, press /, choose music-to-video, then write the task. Fallback prompt: Use the music-to-video skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `music-to-video` |
| Canonical name | `music-to-video` |
| Platform | `Codex` |
| Category | General and specialized workflows |
