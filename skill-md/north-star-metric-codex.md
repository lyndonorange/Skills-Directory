---
name: pm-skills-north-star-metric
display_name: north-star-metric
platform: Codex
category: Product analytics, experiments, and measurement
---

# north-star-metric - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `north-star-metric` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Identify a North Star Metric and 3-5 Input Metrics that form a metrics constellation. Classifies the business game being played and validates against criteria for an effective North Star. Use when defining key metrics, s

## How To Use It In Codex

In Codex, click the chat box, press /, choose north-star-metric, then write the task. Fallback prompt: Use the north-star-metric skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `north-star-metric` |
| Canonical name | `pm-skills-north-star-metric` |
| Platform | `Codex` |
| Category | Product analytics, experiments, and measurement |
