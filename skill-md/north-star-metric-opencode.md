...
# north-star-metric - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `north-star-metric` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the north-star-metric skill to...
