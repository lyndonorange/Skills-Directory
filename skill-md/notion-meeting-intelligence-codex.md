...
# notion-meeting-intelligence - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `notion-meeting-intelligence` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose notion-meeting-intelligence, then write the task. Fallback prompt: Use the notion-meeting-intelligence skill to...
...
| Canonical name | `notion-meeting-intelligence` |
| Platform | `Codex` |
| Category | General and specialized workflows |
