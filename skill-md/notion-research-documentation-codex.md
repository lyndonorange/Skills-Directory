...
# notion-research-documentation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `notion-research-documentation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose notion-research-documentation, then write the task. Fallback prompt: Use the notion-research-documentation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `notion-research-documentation` |
| Canonical name | `notion-research-documentation` |
| Platform | `Codex` |
| Category | General and specialized workflows |
