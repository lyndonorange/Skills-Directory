...
display_name: observability-and-instrumentation
platform: Codex
category: General and specialized workflows
---

# observability-and-instrumentation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `observability-and-instrumentation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Code you can't observe is code you can't operate. Observability is the ability to answer "what is the system doing and why?" from the outside, using the telemetry the code emits. Instrumentation is not a post-launch add-

## How To Use It In Codex

In Codex, click the chat box, press /, choose observability-and-instrumentation, then write the task. Fallback prompt: Use the observability-and-instrumentation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `observability-and-instrumentation` |
| Canonical name | `observability-and-instrumentation` |
| Platform | `Codex` |
| Category | General and specialized workflows |
