...
# observability-and-instrumentation - Zed Skill Package

## What This Is

This is a friend-safe Markdown copy of `observability-and-instrumentation` for Zed. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Zed, open the Agent panel and type: Use the observability-and-instrumentation skill to...
