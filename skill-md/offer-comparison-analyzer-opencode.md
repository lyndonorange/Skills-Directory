...
# offer-comparison-analyzer - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `offer-comparison-analyzer` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the offer-comparison-analyzer skill to...
