...
# offer-comparison-analyzer - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `offer-comparison-analyzer` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the offer-comparison-analyzer skill to...
