...
# office-hours - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `office-hours` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose office-hours, then write the task. Fallback prompt: Use the office-hours skill to...
...
```bash
$B goto "[file URL removed]$SKETCH_FILE"
