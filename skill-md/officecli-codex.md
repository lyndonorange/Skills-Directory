...
# officecli - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `officecli` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose officecli, then write the task. Fallback prompt: Use the officecli skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `officecli` |
| Canonical name | `officecli` |
| Platform | `Codex` |
| Category | General and specialized workflows |
