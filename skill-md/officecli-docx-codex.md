---
name: officecli-docx
display_name: officecli-docx
platform: Codex
category: General and specialized workflows
---

# officecli-docx - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `officecli-docx` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Use this skill any time a .docx file is involved -- as input, output, or both. This includes: creating Word documents, reports, letters, memos, or proposals; reading, parsing, or extracting text from any .docx file; edit

## How To Use It In Codex

In Codex, click the chat box, press /, choose officecli-docx, then write the task. Fallback prompt: Use the officecli-docx skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `officecli-docx` |
| Canonical name | `officecli-docx` |
| Platform | `Codex` |
| Category | General and specialized workflows |
