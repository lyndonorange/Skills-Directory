...
# officecli-financial-model - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `officecli-financial-model` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the officecli-financial-model skill to...
