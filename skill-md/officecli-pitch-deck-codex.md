...
display_name: officecli-pitch-deck
platform: Codex
category: General and specialized workflows
---

# officecli-pitch-deck - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `officecli-pitch-deck` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Use this skill when the user is building a fundraising / investor pitch deck — seed, Series A / B / C, convertible note, SAFE round, strategic raise. Trigger on: 'pitch deck', 'investor deck', 'Series A deck', 'Series B

## How To Use It In Codex

In Codex, click the chat box, press /, choose officecli-pitch-deck, then write the task. Fallback prompt: Use the officecli-pitch-deck skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `officecli-pitch-deck` |
| Canonical name | `officecli-pitch-deck` |
| Platform | `Codex` |
| Category | General and specialized workflows |
