---
name: officecli-pptx
display_name: officecli-pptx
platform: Codex
category: General and specialized workflows
---

# officecli-pptx - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `officecli-pptx` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Use this skill any time a .pptx file is involved -- as input, output, or both. This includes: creating slide decks, pitch decks, or presentations; reading, parsing, or extracting text from any .pptx file; editing, modify

## How To Use It In Codex

In Codex, click the chat box, press /, choose officecli-pptx, then write the task. Fallback prompt: Use the officecli-pptx skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `officecli-pptx` |
| Canonical name | `officecli-pptx` |
| Platform | `Codex` |
| Category | General and specialized workflows |
