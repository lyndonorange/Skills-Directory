...
display_name: officecli-word-form
platform: Codex
category: General and specialized workflows
---

# officecli-word-form - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `officecli-word-form` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Use this skill to create fillable Word forms (.docx) with real Content Controls (SDT) + legacy FormField checkboxes + MERGEFIELD mail-merge placeholders + document protection. Trigger on: 'fillable form', 'form fields',

## How To Use It In Codex

In Codex, click the chat box, press /, choose officecli-word-form, then write the task. Fallback prompt: Use the officecli-word-form skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `officecli-word-form` |
| Canonical name | `officecli-word-form` |
| Platform | `Codex` |
| Category | General and specialized workflows |
