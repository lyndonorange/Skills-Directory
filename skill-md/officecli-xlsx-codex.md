---
name: officecli-xlsx
display_name: officecli-xlsx
platform: Codex
category: General and specialized workflows
---

# officecli-xlsx - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `officecli-xlsx` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Use this skill any time a .xlsx file is involved -- as input, output, or both. This includes: creating spreadsheets, financial models, dashboards, or trackers; reading, parsing, or extracting data from any .xlsx file; ed

## How To Use It In Codex

In Codex, click the chat box, press /, choose officecli-xlsx, then write the task. Fallback prompt: Use the officecli-xlsx skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `officecli-xlsx` |
| Canonical name | `officecli-xlsx` |
| Platform | `Codex` |
| Category | General and specialized workflows |
