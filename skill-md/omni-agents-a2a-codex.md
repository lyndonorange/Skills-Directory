...
display_name: omni-agents-a2a
platform: Codex
category: General and specialized workflows
---

# omni-agents-a2a - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `omni-agents-a2a` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose omni-agents-a2a, then write the task. Fallback prompt: Use the omni-agents-a2a skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `omni-agents-a2a` |
| Canonical name | `omni-agents-a2a` |
| Platform | `Codex` |
| Category | General and specialized workflows |
