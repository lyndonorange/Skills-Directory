...
# omni-api-keys - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `omni-api-keys` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose omni-api-keys, then write the task. Fallback prompt: Use the omni-api-keys skill to...
