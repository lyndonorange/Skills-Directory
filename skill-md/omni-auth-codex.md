---
name: omni-auth
display_name: omni-auth
platform: Codex
category: General and specialized workflows
---

# omni-auth - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `omni-auth` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose omni-auth, then write the task. Fallback prompt: Use the omni-auth skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `omni-auth` |
| Canonical name | `omni-auth` |
| Platform | `Codex` |
| Category | General and specialized workflows |
