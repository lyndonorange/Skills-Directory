---
name: omni-cli-tools
display_name: omni-cli-tools
platform: Codex
category: General and specialized workflows
---

# omni-cli-tools - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `omni-cli-tools` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose omni-cli-tools, then write the task. Fallback prompt: Use the omni-cli-tools skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `omni-cli-tools` |
| Canonical name | `omni-cli-tools` |
| Platform | `Codex` |
| Category | General and specialized workflows |
