...
display_name: omni-combos-routing
platform: Codex
category: General and specialized workflows
---

# omni-combos-routing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `omni-combos-routing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose omni-combos-routing, then write the task. Fallback prompt: Use the omni-combos-routing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `omni-combos-routing` |
| Canonical name | `omni-combos-routing` |
| Platform | `Codex` |
| Category | General and specialized workflows |
