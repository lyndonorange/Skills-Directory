...
display_name: omni-compression
platform: Codex
category: General and specialized workflows
---

# omni-compression - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `omni-compression` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose omni-compression, then write the task. Fallback prompt: Use the omni-compression skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `omni-compression` |
| Canonical name | `omni-compression` |
| Platform | `Codex` |
| Category | General and specialized workflows |
