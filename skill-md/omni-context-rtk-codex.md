...
# omni-context-rtk - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `omni-context-rtk` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose omni-context-rtk, then write the task. Fallback prompt: Use the omni-context-rtk skill to...
