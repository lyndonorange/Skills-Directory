---
name: omni-inference
display_name: omni-inference
platform: Codex
category: General and specialized workflows
---

# omni-inference - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `omni-inference` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose omni-inference, then write the task. Fallback prompt: Use the omni-inference skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `omni-inference` |
| Canonical name | `omni-inference` |
| Platform | `Codex` |
| Category | General and specialized workflows |
