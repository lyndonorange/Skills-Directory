---
name: omni-mcp
display_name: omni-mcp
platform: Codex
category: General and specialized workflows
---

# omni-mcp - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `omni-mcp` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose omni-mcp, then write the task. Fallback prompt: Use the omni-mcp skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `omni-mcp` |
| Canonical name | `omni-mcp` |
| Platform | `Codex` |
| Category | General and specialized workflows |
