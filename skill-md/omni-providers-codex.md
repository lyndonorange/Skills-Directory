---
name: omni-providers
display_name: omni-providers
platform: Codex
category: General and specialized workflows
---

# omni-providers - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `omni-providers` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose omni-providers, then write the task. Fallback prompt: Use the omni-providers skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `omni-providers` |
| Canonical name | `omni-providers` |
| Platform | `Codex` |
| Category | General and specialized workflows |
