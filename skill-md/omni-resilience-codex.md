...
display_name: omni-resilience
platform: Codex
category: General and specialized workflows
---

# omni-resilience - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `omni-resilience` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose omni-resilience, then write the task. Fallback prompt: Use the omni-resilience skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `omni-resilience` |
| Canonical name | `omni-resilience` |
| Platform | `Codex` |
| Category | General and specialized workflows |
