...
# omni-version-manager - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `omni-version-manager` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the omni-version-manager skill to...
