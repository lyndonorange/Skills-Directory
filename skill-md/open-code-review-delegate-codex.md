...
display_name: open-code-review-delegate
platform: Codex
category: General and specialized workflows
---

# open-code-review-delegate - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `open-code-review-delegate` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose open-code-review-delegate, then write the task. Fallback prompt: Use the open-code-review-delegate skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `open-code-review-delegate` |
| Canonical name | `open-code-review-delegate` |
| Platform | `Codex` |
| Category | General and specialized workflows |
