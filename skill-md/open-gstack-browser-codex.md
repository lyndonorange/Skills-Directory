...
display_name: open-gstack-browser
platform: Codex
category: General and specialized workflows
---

# open-gstack-browser - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `open-gstack-browser` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose open-gstack-browser, then write the task. Fallback prompt: Use the open-gstack-browser skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `open-gstack-browser` |
| Canonical name | `open-gstack-browser` |
| Platform | `Codex` |
| Category | General and specialized workflows |
