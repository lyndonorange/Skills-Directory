...
# open-gstack-browser - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `open-gstack-browser` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the open-gstack-browser skill to...
