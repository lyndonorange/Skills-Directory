...
# openai-docs - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `openai-docs` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Provide authoritative, current guidance from OpenAI developer docs using the developers.openai.com MCP server. "Docs MCP" means `mcp__openaiDeveloperDocs__search_openai_docs` and `mcp__openaiDeveloperDocs__fetch_openai_d

## How To Use It In Codex

In Codex, click the chat box, press /, choose openai-docs, then write the task. Fallback prompt: Use the openai-docs skill to...
