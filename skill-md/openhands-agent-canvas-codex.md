...
# openhands-agent-canvas - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `openhands-agent-canvas` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose openhands-agent-canvas, then write the task. Fallback prompt: Use the openhands-agent-canvas skill to...
