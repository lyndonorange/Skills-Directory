---
name: pm-skills-opportunity-solution-tree
display_name: opportunity-solution-tree
platform: Codex
category: Business creation, ideas, and validation
---

# opportunity-solution-tree - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `opportunity-solution-tree` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose opportunity-solution-tree, then write the task. Fallback prompt: Use the opportunity-solution-tree skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `opportunity-solution-tree` |
| Canonical name | `pm-skills-opportunity-solution-tree` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
