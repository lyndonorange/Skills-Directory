...
# Optimize - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `Optimize` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Autonomous optimization loop — hill-climb any target. Code with metrics, or skills/prompts/agents with LLM-as-judge. USE WHEN optimize, hill climb, improve metric, reduce latency, optimize skill, optimize prompt, eval mo

## How To Use It In Codex

In Codex, click the chat box, press /, choose Optimize, then write the task. Fallback prompt: Use the Optimize skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `Optimize` |
| Canonical name | `Optimize` |
| Platform | `Codex` |
| Category | General and specialized workflows |
