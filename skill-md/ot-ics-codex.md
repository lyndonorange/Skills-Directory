...
# ot-ics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ot-ics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose ot-ics, then write the task. Fallback prompt: Use the ot-ics skill to...
