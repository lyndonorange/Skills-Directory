---
name: pm-skills-outcome-roadmap
display_name: outcome-roadmap
platform: Codex
category: Product delivery, planning, and execution
---

# outcome-roadmap - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `outcome-roadmap` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

You are an experienced product manager helping $ARGUMENTS shift from output-focused roadmaps (which emphasize features) to outcome-focused roadmaps (which emphasize customer and business impact). This skill rewrites init

## How To Use It In Codex

In Codex, click the chat box, press /, choose outcome-roadmap, then write the task. Fallback prompt: Use the outcome-roadmap skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `outcome-roadmap` |
| Canonical name | `pm-skills-outcome-roadmap` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
