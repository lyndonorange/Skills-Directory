...
# pair-agent - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `pair-agent` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose pair-agent, then write the task. Fallback prompt: Use the pair-agent skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `pair-agent` |
| Canonical name | `pair-agent` |
| Platform | `Codex` |
| Category | General and specialized workflows |
