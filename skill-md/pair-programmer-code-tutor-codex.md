...
# pair-programmer-code-tutor - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `pair-programmer-code-tutor` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose pair-programmer-code-tutor, then write the task. Fallback prompt: Use the pair-programmer-code-tutor skill to...
