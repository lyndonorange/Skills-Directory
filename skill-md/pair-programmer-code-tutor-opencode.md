...
# pair-programmer-code-tutor - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `pair-programmer-code-tutor` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the pair-programmer-code-tutor skill to...
