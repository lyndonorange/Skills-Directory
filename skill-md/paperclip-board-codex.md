...
display_name: paperclip-board
platform: Codex
category: General and specialized workflows
---

# paperclip-board - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `paperclip-board` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose paperclip-board, then write the task. Fallback prompt: Use the paperclip-board skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `paperclip-board` |
| Canonical name | `paperclip-board` |
| Platform | `Codex` |
| Category | General and specialized workflows |
