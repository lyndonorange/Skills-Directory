...
# paperclip-converting-plans-to-tasks - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `paperclip-converting-plans-to-tasks` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the paperclip-converting-plans-to-tasks skill to...
