...
# paperclip-converting-plans-to-tasks - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `paperclip-converting-plans-to-tasks` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the paperclip-converting-plans-to-tasks skill to...
