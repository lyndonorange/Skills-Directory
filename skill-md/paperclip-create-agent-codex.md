...
display_name: paperclip-create-agent
platform: Codex
category: General and specialized workflows
---

# paperclip-create-agent - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `paperclip-create-agent` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose paperclip-create-agent, then write the task. Fallback prompt: Use the paperclip-create-agent skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `paperclip-create-agent` |
| Canonical name | `paperclip-create-agent` |
| Platform | `Codex` |
| Category | General and specialized workflows |
