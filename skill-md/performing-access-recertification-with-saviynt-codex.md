...
# performing-access-recertification-with-saviynt - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-access-recertification-with-saviynt` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Access recertification (also called access certification or access review) is a periodic process where designated reviewers validate that users have appropriate access to systems and data. Saviynt Enterprise Identity Clo

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-access-recertification-with-saviynt, then write the task. Fallback prompt: Use the performing-access-recertification-with-saviynt skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-access-recertification-with-saviynt` |
| Canonical name | `performing-access-recertification-with-saviynt` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
