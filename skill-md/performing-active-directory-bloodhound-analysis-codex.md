...
display_name: performing-active-directory-bloodhound-analysis
platform: Codex
category: Security, forensics, and incident response
---

# performing-active-directory-bloodhound-analysis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-active-directory-bloodhound-analysis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

BloodHound is an open-source Active Directory reconnaissance tool that uses graph theory to reveal hidden relationships, attack paths, and privilege escalation opportunities within AD environments. By collecting data wit

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-active-directory-bloodhound-analysis, then write the task. Fallback prompt: Use the performing-active-directory-bloodhound-analysis skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-active-directory-bloodhound-analysis` |
| Canonical name | `performing-active-directory-bloodhound-analysis` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
