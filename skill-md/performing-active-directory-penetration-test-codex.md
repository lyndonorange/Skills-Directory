...
display_name: performing-active-directory-penetration-test
platform: Codex
category: Security, forensics, and incident response
---

# performing-active-directory-penetration-test - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-active-directory-penetration-test` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Active Directory (AD) penetration testing targets the central identity and access management system used by over 95% of Fortune 500 companies. The test identifies misconfigurations, weak credentials, dangerous delegation

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-active-directory-penetration-test, then write the task. Fallback prompt: Use the performing-active-directory-penetration-test skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-active-directory-penetration-test` |
| Canonical name | `performing-active-directory-penetration-test` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
