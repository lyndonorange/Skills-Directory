...
display_name: performing-ai-driven-osint-correlation
platform: Codex
category: Security, forensics, and incident response
---

# performing-ai-driven-osint-correlation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-ai-driven-osint-correlation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-ai-driven-osint-correlation, then write the task. Fallback prompt: Use the performing-ai-driven-osint-correlation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-ai-driven-osint-correlation` |
| Canonical name | `performing-ai-driven-osint-correlation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
