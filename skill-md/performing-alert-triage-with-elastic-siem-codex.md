...
display_name: performing-alert-triage-with-elastic-siem
platform: Codex
category: Security, forensics, and incident response
---

# performing-alert-triage-with-elastic-siem - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-alert-triage-with-elastic-siem` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Alert triage in Elastic Security is the systematic process of reviewing, classifying, and prioritizing security alerts to determine which represent genuine threats. Elastic's AI-driven Attack Discovery feature can triage

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-alert-triage-with-elastic-siem, then write the task. Fallback prompt: Use the performing-alert-triage-with-elastic-siem skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-alert-triage-with-elastic-siem` |
| Canonical name | `performing-alert-triage-with-elastic-siem` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
