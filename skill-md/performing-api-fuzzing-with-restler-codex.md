...
display_name: performing-api-fuzzing-with-restler
platform: Codex
category: Security, forensics, and incident response
---

# performing-api-fuzzing-with-restler - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-api-fuzzing-with-restler` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-api-fuzzing-with-restler, then write the task. Fallback prompt: Use the performing-api-fuzzing-with-restler skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-api-fuzzing-with-restler` |
| Canonical name | `performing-api-fuzzing-with-restler` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
