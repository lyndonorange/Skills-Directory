...
# performing-api-rate-limiting-bypass - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-api-rate-limiting-bypass` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-api-rate-limiting-bypass, then write the task. Fallback prompt: Use the performing-api-rate-limiting-bypass skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-api-rate-limiting-bypass` |
| Canonical name | `performing-api-rate-limiting-bypass` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
