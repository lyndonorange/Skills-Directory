...
display_name: performing-api-security-testing-with-postman
platform: Codex
category: Security, forensics, and incident response
---

# performing-api-security-testing-with-postman - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-api-security-testing-with-postman` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-api-security-testing-with-postman, then write the task. Fallback prompt: Use the performing-api-security-testing-with-postman skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-api-security-testing-with-postman` |
| Canonical name | `performing-api-security-testing-with-postman` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
