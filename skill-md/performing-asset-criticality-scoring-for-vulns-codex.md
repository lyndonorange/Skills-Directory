...
display_name: performing-asset-criticality-scoring-for-vulns
platform: Codex
category: Security, forensics, and incident response
---

# performing-asset-criticality-scoring-for-vulns - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-asset-criticality-scoring-for-vulns` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Asset criticality scoring assigns a business impact rating to each IT asset so that vulnerability remediation efforts focus on systems with the greatest organizational risk. Without criticality context, a CVSS 9.0 vulner

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-asset-criticality-scoring-for-vulns, then write the task. Fallback prompt: Use the performing-asset-criticality-scoring-for-vulns skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-asset-criticality-scoring-for-vulns` |
| Canonical name | `performing-asset-criticality-scoring-for-vulns` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
