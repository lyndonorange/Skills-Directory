...
display_name: performing-authenticated-scan-with-openvas
platform: Codex
category: Security, forensics, and incident response
---

# performing-authenticated-scan-with-openvas - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-authenticated-scan-with-openvas` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

OpenVAS (Open Vulnerability Assessment Scanner) is the scanner component of the Greenbone Vulnerability Management (GVM) framework. Authenticated scans use valid credentials (SSH for Linux, SMB for Windows, ESXi for VMwa

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-authenticated-scan-with-openvas, then write the task. Fallback prompt: Use the performing-authenticated-scan-with-openvas skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-authenticated-scan-with-openvas` |
| Canonical name | `performing-authenticated-scan-with-openvas` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
