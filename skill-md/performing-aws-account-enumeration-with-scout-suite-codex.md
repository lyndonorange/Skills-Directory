...
# performing-aws-account-enumeration-with-scout-suite - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-aws-account-enumeration-with-scout-suite` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

ScoutSuite is an open-source multi-cloud security auditing tool developed by NCC Group that enables comprehensive security posture assessment of AWS environments. It queries AWS APIs to gather configuration data across a

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-aws-account-enumeration-with-scout-suite, then write the task. Fallback prompt: Use the performing-aws-account-enumeration-with-scout-suite skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-aws-account-enumeration-with-scout-suite` |
| Canonical name | `performing-aws-account-enumeration-with-scout-suite` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
