...
display_name: performing-aws-privilege-escalation-assessment
platform: Codex
category: Security, forensics, and incident response
---

# performing-aws-privilege-escalation-assessment - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-aws-privilege-escalation-assessment` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-aws-privilege-escalation-assessment, then write the task. Fallback prompt: Use the performing-aws-privilege-escalation-assessment skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-aws-privilege-escalation-assessment` |
| Canonical name | `performing-aws-privilege-escalation-assessment` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
