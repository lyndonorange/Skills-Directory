...
display_name: performing-bluetooth-security-assessment
platform: Codex
category: Security, forensics, and incident response
---

# performing-bluetooth-security-assessment - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-bluetooth-security-assessment` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

This skill covers performing Bluetooth Low Energy (BLE) security assessments using the Python bleak library. BLE devices are ubiquitous in IoT, healthcare, fitness, and smart home applications, and many ship with weak or

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-bluetooth-security-assessment, then write the task. Fallback prompt: Use the performing-bluetooth-security-assessment skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-bluetooth-security-assessment` |
| Canonical name | `performing-bluetooth-security-assessment` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
