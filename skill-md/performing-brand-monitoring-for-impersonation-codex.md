...
display_name: performing-brand-monitoring-for-impersonation
platform: Codex
category: Security, forensics, and incident response
---

# performing-brand-monitoring-for-impersonation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-brand-monitoring-for-impersonation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Brand impersonation attacks exploit consumer trust through lookalike domains, fake social media profiles, counterfeit mobile apps, and phishing sites that mimic legitimate brands. In 2025, brand impersonation remained on

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-brand-monitoring-for-impersonation, then write the task. Fallback prompt: Use the performing-brand-monitoring-for-impersonation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-brand-monitoring-for-impersonation` |
| Canonical name | `performing-brand-monitoring-for-impersonation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
