...
# performing-clickjacking-attack-test - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-clickjacking-attack-test` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-clickjacking-attack-test, then write the task. Fallback prompt: Use the performing-clickjacking-attack-test skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-clickjacking-attack-test` |
| Canonical name | `performing-clickjacking-attack-test` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
