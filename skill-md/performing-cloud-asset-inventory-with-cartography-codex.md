...
display_name: performing-cloud-asset-inventory-with-cartography
platform: Codex
category: Security, forensics, and incident response
---

# performing-cloud-asset-inventory-with-cartography - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-cloud-asset-inventory-with-cartography` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Cartography is a CNCF sandbox project (originally created at Lyft) that consolidates infrastructure assets and their relationships into a Neo4j graph database. It queries cloud APIs to discover resources, maps relationsh

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-cloud-asset-inventory-with-cartography, then write the task. Fallback prompt: Use the performing-cloud-asset-inventory-with-cartography skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-cloud-asset-inventory-with-cartography` |
| Canonical name | `performing-cloud-asset-inventory-with-cartography` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
