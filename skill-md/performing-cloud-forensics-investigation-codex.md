...
display_name: performing-cloud-forensics-investigation
platform: Codex
category: Security, forensics, and incident response
---

# performing-cloud-forensics-investigation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-cloud-forensics-investigation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-cloud-forensics-investigation, then write the task. Fallback prompt: Use the performing-cloud-forensics-investigation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-cloud-forensics-investigation` |
| Canonical name | `performing-cloud-forensics-investigation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
