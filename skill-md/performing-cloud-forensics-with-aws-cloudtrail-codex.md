...
display_name: performing-cloud-forensics-with-aws-cloudtrail
platform: Codex
category: Security, forensics, and incident response
---

# performing-cloud-forensics-with-aws-cloudtrail - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-cloud-forensics-with-aws-cloudtrail` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-cloud-forensics-with-aws-cloudtrail, then write the task. Fallback prompt: Use the performing-cloud-forensics-with-aws-cloudtrail skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-cloud-forensics-with-aws-cloudtrail` |
| Canonical name | `performing-cloud-forensics-with-aws-cloudtrail` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
