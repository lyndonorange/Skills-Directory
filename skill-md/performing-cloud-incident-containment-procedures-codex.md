...
display_name: performing-cloud-incident-containment-procedures
platform: Codex
category: Security, forensics, and incident response
---

# performing-cloud-incident-containment-procedures - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-cloud-incident-containment-procedures` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-cloud-incident-containment-procedures, then write the task. Fallback prompt: Use the performing-cloud-incident-containment-procedures skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-cloud-incident-containment-procedures` |
| Canonical name | `performing-cloud-incident-containment-procedures` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
