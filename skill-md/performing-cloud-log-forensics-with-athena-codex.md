...
display_name: performing-cloud-log-forensics-with-athena
platform: Codex
category: Security, forensics, and incident response
---

# performing-cloud-log-forensics-with-athena - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-cloud-log-forensics-with-athena` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-cloud-log-forensics-with-athena, then write the task. Fallback prompt: Use the performing-cloud-log-forensics-with-athena skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-cloud-log-forensics-with-athena` |
| Canonical name | `performing-cloud-log-forensics-with-athena` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
