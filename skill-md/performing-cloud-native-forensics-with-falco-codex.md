...
display_name: performing-cloud-native-forensics-with-falco
platform: Codex
category: Security, forensics, and incident response
---

# performing-cloud-native-forensics-with-falco - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-cloud-native-forensics-with-falco` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-cloud-native-forensics-with-falco, then write the task. Fallback prompt: Use the performing-cloud-native-forensics-with-falco skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-cloud-native-forensics-with-falco` |
| Canonical name | `performing-cloud-native-forensics-with-falco` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
