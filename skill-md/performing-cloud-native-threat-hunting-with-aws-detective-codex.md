...
display_name: performing-cloud-native-threat-hunting-with-aws-detective
platform: Codex
category: Security, forensics, and incident response
---

# performing-cloud-native-threat-hunting-with-aws-detective - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-cloud-native-threat-hunting-with-aws-detective` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

AWS Detective automatically collects and analyzes log data from AWS CloudTrail, VPC Flow Logs, GuardDuty findings, and EKS audit logs to build interactive behavior graphs. These graphs enable security analysts to investi

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-cloud-native-threat-hunting-with-aws-detective, then write the task. Fallback prompt: Use the performing-cloud-native-threat-hunting-with-aws-detective skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-cloud-native-threat-hunting-with-aws-detective` |
| Canonical name | `performing-cloud-native-threat-hunting-with-aws-detective` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
