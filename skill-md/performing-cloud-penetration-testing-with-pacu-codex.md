...
display_name: performing-cloud-penetration-testing-with-pacu
platform: Codex
category: Security, forensics, and incident response
---

# performing-cloud-penetration-testing-with-pacu - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-cloud-penetration-testing-with-pacu` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-cloud-penetration-testing-with-pacu, then write the task. Fallback prompt: Use the performing-cloud-penetration-testing-with-pacu skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-cloud-penetration-testing-with-pacu` |
| Canonical name | `performing-cloud-penetration-testing-with-pacu` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
