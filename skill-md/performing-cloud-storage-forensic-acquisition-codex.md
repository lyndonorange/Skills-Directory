...
display_name: performing-cloud-storage-forensic-acquisition
platform: Codex
category: Security, forensics, and incident response
---

# performing-cloud-storage-forensic-acquisition - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-cloud-storage-forensic-acquisition` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Cloud storage forensic acquisition involves collecting digital evidence from services like Google Drive, OneDrive, Dropbox, and Box through both API-based remote acquisition and local endpoint artifact analysis. Modern i

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-cloud-storage-forensic-acquisition, then write the task. Fallback prompt: Use the performing-cloud-storage-forensic-acquisition skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-cloud-storage-forensic-acquisition` |
| Canonical name | `performing-cloud-storage-forensic-acquisition` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
