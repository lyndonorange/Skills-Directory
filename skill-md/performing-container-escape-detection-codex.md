...
display_name: performing-container-escape-detection
platform: Codex
category: Security, forensics, and incident response
---

# performing-container-escape-detection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-container-escape-detection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-container-escape-detection, then write the task. Fallback prompt: Use the performing-container-escape-detection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-container-escape-detection` |
| Canonical name | `performing-container-escape-detection` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
