...
display_name: performing-container-image-hardening
platform: Codex
category: Security, forensics, and incident response
---

# performing-container-image-hardening - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-container-image-hardening` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-container-image-hardening, then write the task. Fallback prompt: Use the performing-container-image-hardening skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-container-image-hardening` |
| Canonical name | `performing-container-image-hardening` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
