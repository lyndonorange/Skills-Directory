...
display_name: performing-container-security-scanning-with-trivy
platform: Codex
category: Security, forensics, and incident response
---

# performing-container-security-scanning-with-trivy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-container-security-scanning-with-trivy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Trivy is an open-source security scanner by Aqua Security that detects vulnerabilities in OS packages and language-specific dependencies, infrastructure-as-code misconfigurations, exposed secrets, and software license is

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-container-security-scanning-with-trivy, then write the task. Fallback prompt: Use the performing-container-security-scanning-with-trivy skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-container-security-scanning-with-trivy` |
| Canonical name | `performing-container-security-scanning-with-trivy` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
