...
display_name: performing-content-security-policy-bypass
platform: Codex
category: Security, forensics, and incident response
---

# performing-content-security-policy-bypass - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-content-security-policy-bypass` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-content-security-policy-bypass, then write the task. Fallback prompt: Use the performing-content-security-policy-bypass skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-content-security-policy-bypass` |
| Canonical name | `performing-content-security-policy-bypass` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
