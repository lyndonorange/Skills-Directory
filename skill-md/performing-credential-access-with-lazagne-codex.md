...
display_name: performing-credential-access-with-lazagne
platform: Codex
category: Security, forensics, and incident response
---

# performing-credential-access-with-lazagne - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-credential-access-with-lazagne` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

LaZagne is an open-source post-exploitation tool designed to retrieve credentials stored on local systems. It supports Windows, Linux, and macOS, with the most extensive module library for Windows. LaZagne recovers passw

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-credential-access-with-lazagne, then write the task. Fallback prompt: Use the performing-credential-access-with-lazagne skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-credential-access-with-lazagne` |
| Canonical name | `performing-credential-access-with-lazagne` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
