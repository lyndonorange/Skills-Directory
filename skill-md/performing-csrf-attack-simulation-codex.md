...
display_name: performing-csrf-attack-simulation
platform: Codex
category: Security, forensics, and incident response
---

# performing-csrf-attack-simulation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-csrf-attack-simulation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-csrf-attack-simulation, then write the task. Fallback prompt: Use the performing-csrf-attack-simulation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-csrf-attack-simulation` |
| Canonical name | `performing-csrf-attack-simulation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
