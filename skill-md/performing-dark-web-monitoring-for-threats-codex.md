...
display_name: performing-dark-web-monitoring-for-threats
platform: Codex
category: Security, forensics, and incident response
---

# performing-dark-web-monitoring-for-threats - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-dark-web-monitoring-for-threats` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Dark web monitoring involves systematically scanning Tor hidden services, underground forums, paste sites, and dark web marketplaces to identify threats targeting an organization, including leaked credentials, data breac

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-dark-web-monitoring-for-threats, then write the task. Fallback prompt: Use the performing-dark-web-monitoring-for-threats skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-dark-web-monitoring-for-threats` |
| Canonical name | `performing-dark-web-monitoring-for-threats` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
