...
display_name: performing-deception-technology-deployment
platform: Codex
category: Security, forensics, and incident response
---

# performing-deception-technology-deployment - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-deception-technology-deployment` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-deception-technology-deployment, then write the task. Fallback prompt: Use the performing-deception-technology-deployment skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-deception-technology-deployment` |
| Canonical name | `performing-deception-technology-deployment` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
