...
display_name: performing-directory-traversal-testing
platform: Codex
category: Security, forensics, and incident response
---

# performing-directory-traversal-testing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-directory-traversal-testing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-directory-traversal-testing, then write the task. Fallback prompt: Use the performing-directory-traversal-testing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-directory-traversal-testing` |
| Canonical name | `performing-directory-traversal-testing` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
