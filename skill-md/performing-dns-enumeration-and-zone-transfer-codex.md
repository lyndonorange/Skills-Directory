...
display_name: performing-dns-enumeration-and-zone-transfer
platform: Codex
category: Security, forensics, and incident response
---

# performing-dns-enumeration-and-zone-transfer - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-dns-enumeration-and-zone-transfer` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-dns-enumeration-and-zone-transfer, then write the task. Fallback prompt: Use the performing-dns-enumeration-and-zone-transfer skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-dns-enumeration-and-zone-transfer` |
| Canonical name | `performing-dns-enumeration-and-zone-transfer` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
