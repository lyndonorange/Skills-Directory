...
display_name: performing-dns-tunneling-detection
platform: Codex
category: Security, forensics, and incident response
---

# performing-dns-tunneling-detection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-dns-tunneling-detection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-dns-tunneling-detection, then write the task. Fallback prompt: Use the performing-dns-tunneling-detection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-dns-tunneling-detection` |
| Canonical name | `performing-dns-tunneling-detection` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
