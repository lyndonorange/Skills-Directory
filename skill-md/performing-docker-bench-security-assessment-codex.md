...
display_name: performing-docker-bench-security-assessment
platform: Codex
category: Security, forensics, and incident response
---

# performing-docker-bench-security-assessment - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-docker-bench-security-assessment` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Docker Bench for Security is an open-source script that checks dozens of common best practices around deploying Docker containers in production. Based on the CIS Docker Benchmark, it audits host configuration, Docker dae

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-docker-bench-security-assessment, then write the task. Fallback prompt: Use the performing-docker-bench-security-assessment skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-docker-bench-security-assessment` |
| Canonical name | `performing-docker-bench-security-assessment` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
