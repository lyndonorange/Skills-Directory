...
display_name: performing-endpoint-forensics-investigation
platform: Codex
category: Security, forensics, and incident response
---

# performing-endpoint-forensics-investigation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-endpoint-forensics-investigation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-endpoint-forensics-investigation, then write the task. Fallback prompt: Use the performing-endpoint-forensics-investigation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-endpoint-forensics-investigation` |
| Canonical name | `performing-endpoint-forensics-investigation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
