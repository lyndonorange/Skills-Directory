...
display_name: performing-entitlement-review-with-sailpoint-iiq
platform: Codex
category: Security, forensics, and incident response
---

# performing-entitlement-review-with-sailpoint-iiq - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-entitlement-review-with-sailpoint-iiq` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-entitlement-review-with-sailpoint-iiq, then write the task. Fallback prompt: Use the performing-entitlement-review-with-sailpoint-iiq skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-entitlement-review-with-sailpoint-iiq` |
| Canonical name | `performing-entitlement-review-with-sailpoint-iiq` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
