...
display_name: performing-external-network-penetration-test
platform: Codex
category: Security, forensics, and incident response
---

# performing-external-network-penetration-test - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-external-network-penetration-test` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

An external network penetration test simulates a real-world attacker targeting an organization's internet-facing assets such as firewalls, web servers, mail servers, DNS servers, VPN gateways, and cloud endpoints. The ob

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-external-network-penetration-test, then write the task. Fallback prompt: Use the performing-external-network-penetration-test skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-external-network-penetration-test` |
| Canonical name | `performing-external-network-penetration-test` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
