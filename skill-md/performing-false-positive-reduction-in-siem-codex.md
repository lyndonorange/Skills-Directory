...
display_name: performing-false-positive-reduction-in-siem
platform: Codex
category: Security, forensics, and incident response
---

# performing-false-positive-reduction-in-siem - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-false-positive-reduction-in-siem` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

False positive alerts are non-malicious events that trigger security rules, overwhelming SOC analysts with noise. Studies show that up to 45% of SIEM alerts are false positives, and a typical SOC analyst can only investi

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-false-positive-reduction-in-siem, then write the task. Fallback prompt: Use the performing-false-positive-reduction-in-siem skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-false-positive-reduction-in-siem` |
| Canonical name | `performing-false-positive-reduction-in-siem` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
