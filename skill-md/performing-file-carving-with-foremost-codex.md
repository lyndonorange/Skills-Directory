...
display_name: performing-file-carving-with-foremost
platform: Codex
category: Security, forensics, and incident response
---

# performing-file-carving-with-foremost - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-file-carving-with-foremost` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-file-carving-with-foremost, then write the task. Fallback prompt: Use the performing-file-carving-with-foremost skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-file-carving-with-foremost` |
| Canonical name | `performing-file-carving-with-foremost` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
