...
display_name: performing-fuzzing-with-aflplusplus
platform: Codex
category: Security, forensics, and incident response
---

# performing-fuzzing-with-aflplusplus - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-fuzzing-with-aflplusplus` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-fuzzing-with-aflplusplus, then write the task. Fallback prompt: Use the performing-fuzzing-with-aflplusplus skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-fuzzing-with-aflplusplus` |
| Canonical name | `performing-fuzzing-with-aflplusplus` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
