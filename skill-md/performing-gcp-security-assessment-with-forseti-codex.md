...
display_name: performing-gcp-security-assessment-with-forseti
platform: Codex
category: Security, forensics, and incident response
---

# performing-gcp-security-assessment-with-forseti - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-gcp-security-assessment-with-forseti` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-gcp-security-assessment-with-forseti, then write the task. Fallback prompt: Use the performing-gcp-security-assessment-with-forseti skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-gcp-security-assessment-with-forseti` |
| Canonical name | `performing-gcp-security-assessment-with-forseti` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
