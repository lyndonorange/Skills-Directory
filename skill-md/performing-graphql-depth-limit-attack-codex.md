...
display_name: performing-graphql-depth-limit-attack
platform: Codex
category: Security, forensics, and incident response
---

# performing-graphql-depth-limit-attack - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-graphql-depth-limit-attack` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

GraphQL depth limit attacks exploit the recursive nature of GraphQL schemas to craft deeply nested queries that consume excessive server resources, leading to denial of service. Unlike REST APIs with fixed endpoints, Gra

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-graphql-depth-limit-attack, then write the task. Fallback prompt: Use the performing-graphql-depth-limit-attack skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-graphql-depth-limit-attack` |
| Canonical name | `performing-graphql-depth-limit-attack` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
