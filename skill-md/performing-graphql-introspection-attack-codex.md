...
display_name: performing-graphql-introspection-attack
platform: Codex
category: Security, forensics, and incident response
---

# performing-graphql-introspection-attack - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-graphql-introspection-attack` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-graphql-introspection-attack, then write the task. Fallback prompt: Use the performing-graphql-introspection-attack skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-graphql-introspection-attack` |
| Canonical name | `performing-graphql-introspection-attack` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
