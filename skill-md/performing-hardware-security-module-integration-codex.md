...
display_name: performing-hardware-security-module-integration
platform: Codex
category: Security, forensics, and incident response
---

# performing-hardware-security-module-integration - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-hardware-security-module-integration` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Hardware Security Modules (HSMs) provide tamper-resistant cryptographic key storage and operations. This skill covers integrating with HSMs via the PKCS#11 standard interface using python-pkcs11, performing key generatio

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-hardware-security-module-integration, then write the task. Fallback prompt: Use the performing-hardware-security-module-integration skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-hardware-security-module-integration` |
| Canonical name | `performing-hardware-security-module-integration` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
