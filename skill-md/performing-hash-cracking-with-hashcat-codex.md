...
display_name: performing-hash-cracking-with-hashcat
platform: Codex
category: Security, forensics, and incident response
---

# performing-hash-cracking-with-hashcat - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-hash-cracking-with-hashcat` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Hash cracking is an essential skill for penetration testers and security auditors to evaluate password strength. Hashcat is the world's fastest password recovery tool, supporting over 300 hash types with GPU acceleration

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-hash-cracking-with-hashcat, then write the task. Fallback prompt: Use the performing-hash-cracking-with-hashcat skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-hash-cracking-with-hashcat` |
| Canonical name | `performing-hash-cracking-with-hashcat` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
