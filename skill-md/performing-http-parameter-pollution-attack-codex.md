...
display_name: performing-http-parameter-pollution-attack
platform: Codex
category: Security, forensics, and incident response
---

# performing-http-parameter-pollution-attack - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-http-parameter-pollution-attack` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-http-parameter-pollution-attack, then write the task. Fallback prompt: Use the performing-http-parameter-pollution-attack skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-http-parameter-pollution-attack` |
| Canonical name | `performing-http-parameter-pollution-attack` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
