...
display_name: performing-ics-asset-discovery-with-claroty
platform: Codex
category: Security, forensics, and incident response
---

# performing-ics-asset-discovery-with-claroty - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-ics-asset-discovery-with-claroty` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-ics-asset-discovery-with-claroty, then write the task. Fallback prompt: Use the performing-ics-asset-discovery-with-claroty skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-ics-asset-discovery-with-claroty` |
| Canonical name | `performing-ics-asset-discovery-with-claroty` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
