...
display_name: performing-indicator-lifecycle-management
platform: Codex
category: Security, forensics, and incident response
---

# performing-indicator-lifecycle-management - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-indicator-lifecycle-management` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Indicator lifecycle management tracks IOCs from initial discovery through validation, enrichment, deployment, monitoring, and eventual retirement. This skill covers implementing systematic processes for IOC quality asses

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-indicator-lifecycle-management, then write the task. Fallback prompt: Use the performing-indicator-lifecycle-management skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-indicator-lifecycle-management` |
| Canonical name | `performing-indicator-lifecycle-management` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
