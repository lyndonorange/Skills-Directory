...
# performing-ioc-enrichment-automation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-ioc-enrichment-automation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-ioc-enrichment-automation, then write the task. Fallback prompt: Use the performing-ioc-enrichment-automation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-ioc-enrichment-automation` |
| Canonical name | `performing-ioc-enrichment-automation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
