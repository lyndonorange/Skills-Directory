...
display_name: performing-ip-reputation-analysis-with-shodan
platform: Codex
category: Security, forensics, and incident response
---

# performing-ip-reputation-analysis-with-shodan - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-ip-reputation-analysis-with-shodan` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Shodan is the world's first search engine for internet-connected devices, continuously scanning the IPv4 and IPv6 address space to catalog open ports, running services, SSL certificates, and known vulnerabilities. This s

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-ip-reputation-analysis-with-shodan, then write the task. Fallback prompt: Use the performing-ip-reputation-analysis-with-shodan skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-ip-reputation-analysis-with-shodan` |
| Canonical name | `performing-ip-reputation-analysis-with-shodan` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
