...
display_name: performing-jwt-none-algorithm-attack
platform: Codex
category: Security, forensics, and incident response
---

# performing-jwt-none-algorithm-attack - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-jwt-none-algorithm-attack` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

The JWT none algorithm attack exploits a vulnerability in JSON Web Token libraries that accept tokens with the `alg` header set to `none`, effectively bypassing signature verification. When a server processes a JWT with 

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-jwt-none-algorithm-attack, then write the task. Fallback prompt: Use the performing-jwt-none-algorithm-attack skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-jwt-none-algorithm-attack` |
| Canonical name | `performing-jwt-none-algorithm-attack` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
