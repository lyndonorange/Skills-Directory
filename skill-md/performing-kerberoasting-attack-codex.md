...
display_name: performing-kerberoasting-attack
platform: Codex
category: Security, forensics, and incident response
---

# performing-kerberoasting-attack - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-kerberoasting-attack` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-kerberoasting-attack, then write the task. Fallback prompt: Use the performing-kerberoasting-attack skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-kerberoasting-attack` |
| Canonical name | `performing-kerberoasting-attack` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
