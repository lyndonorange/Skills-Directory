...
display_name: performing-kubernetes-cis-benchmark-with-kube-bench
platform: Codex
category: Security, forensics, and incident response
---

# performing-kubernetes-cis-benchmark-with-kube-bench - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-kubernetes-cis-benchmark-with-kube-bench` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

kube-bench is an open-source Go tool by Aqua Security that runs the CIS Kubernetes Benchmark checks. It verifies control plane, etcd, worker node, and policy configurations against security best practices, producing acti

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-kubernetes-cis-benchmark-with-kube-bench, then write the task. Fallback prompt: Use the performing-kubernetes-cis-benchmark-with-kube-bench skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-kubernetes-cis-benchmark-with-kube-bench` |
| Canonical name | `performing-kubernetes-cis-benchmark-with-kube-bench` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
