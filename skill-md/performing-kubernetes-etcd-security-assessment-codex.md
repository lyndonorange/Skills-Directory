...
display_name: performing-kubernetes-etcd-security-assessment
platform: Codex
category: Security, forensics, and incident response
---

# performing-kubernetes-etcd-security-assessment - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-kubernetes-etcd-security-assessment` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

etcd is the distributed key-value store that serves as Kubernetes' backing store for all cluster data, including Secrets, RBAC policies, ConfigMaps, and workload configurations. Without proper hardening, etcd exposes all

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-kubernetes-etcd-security-assessment, then write the task. Fallback prompt: Use the performing-kubernetes-etcd-security-assessment skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-kubernetes-etcd-security-assessment` |
| Canonical name | `performing-kubernetes-etcd-security-assessment` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
