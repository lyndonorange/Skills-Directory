...
display_name: performing-kubernetes-penetration-testing
platform: Codex
category: Security, forensics, and incident response
---

# performing-kubernetes-penetration-testing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-kubernetes-penetration-testing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Kubernetes penetration testing systematically evaluates cluster security by simulating attacker techniques against the API server, kubelet, etcd, pods, RBAC, network policies, and secrets. Using tools like kube-hunter, K

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-kubernetes-penetration-testing, then write the task. Fallback prompt: Use the performing-kubernetes-penetration-testing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-kubernetes-penetration-testing` |
| Canonical name | `performing-kubernetes-penetration-testing` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
