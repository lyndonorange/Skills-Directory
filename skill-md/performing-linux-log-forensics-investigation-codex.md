...
display_name: performing-linux-log-forensics-investigation
platform: Codex
category: Security, forensics, and incident response
---

# performing-linux-log-forensics-investigation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-linux-log-forensics-investigation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Linux systems maintain extensive logs that serve as primary evidence sources in forensic investigations. Unlike Windows Event Logs, Linux logs are typically plain-text files stored in /var/log/ and binary journal files m

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-linux-log-forensics-investigation, then write the task. Fallback prompt: Use the performing-linux-log-forensics-investigation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-linux-log-forensics-investigation` |
| Canonical name | `performing-linux-log-forensics-investigation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
