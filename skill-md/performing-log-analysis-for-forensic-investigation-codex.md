...
display_name: performing-log-analysis-for-forensic-investigation
platform: Codex
category: Security, forensics, and incident response
---

# performing-log-analysis-for-forensic-investigation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-log-analysis-for-forensic-investigation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-log-analysis-for-forensic-investigation, then write the task. Fallback prompt: Use the performing-log-analysis-for-forensic-investigation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-log-analysis-for-forensic-investigation` |
| Canonical name | `performing-log-analysis-for-forensic-investigation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
