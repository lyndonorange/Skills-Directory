...
display_name: performing-log-source-onboarding-in-siem
platform: Codex
category: Security, forensics, and incident response
---

# performing-log-source-onboarding-in-siem - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-log-source-onboarding-in-siem` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Log source onboarding is the systematic process of integrating new data sources into a SIEM platform to enable security monitoring and detection. Proper onboarding requires planning data sources, configuring collection a

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-log-source-onboarding-in-siem, then write the task. Fallback prompt: Use the performing-log-source-onboarding-in-siem skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-log-source-onboarding-in-siem` |
| Canonical name | `performing-log-source-onboarding-in-siem` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
