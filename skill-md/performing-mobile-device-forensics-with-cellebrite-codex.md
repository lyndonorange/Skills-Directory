...
display_name: performing-mobile-device-forensics-with-cellebrite
platform: Codex
category: Security, forensics, and incident response
---

# performing-mobile-device-forensics-with-cellebrite - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-mobile-device-forensics-with-cellebrite` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-mobile-device-forensics-with-cellebrite, then write the task. Fallback prompt: Use the performing-mobile-device-forensics-with-cellebrite skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-mobile-device-forensics-with-cellebrite` |
| Canonical name | `performing-mobile-device-forensics-with-cellebrite` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
