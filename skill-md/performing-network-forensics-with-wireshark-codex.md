...
display_name: performing-network-forensics-with-wireshark
platform: Codex
category: Security, forensics, and incident response
---

# performing-network-forensics-with-wireshark - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-network-forensics-with-wireshark` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-network-forensics-with-wireshark, then write the task. Fallback prompt: Use the performing-network-forensics-with-wireshark skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-network-forensics-with-wireshark` |
| Canonical name | `performing-network-forensics-with-wireshark` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
