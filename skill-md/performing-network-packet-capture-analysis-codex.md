...
display_name: performing-network-packet-capture-analysis
platform: Codex
category: Security, forensics, and incident response
---

# performing-network-packet-capture-analysis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-network-packet-capture-analysis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Network packet captures (PCAP/PCAPNG files) represent the ultimate source of truth about network activity and provide irrefutable evidence of communications between hosts. PCAP files log every packet transmitted over a n

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-network-packet-capture-analysis, then write the task. Fallback prompt: Use the performing-network-packet-capture-analysis skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-network-packet-capture-analysis` |
| Canonical name | `performing-network-packet-capture-analysis` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
