...
display_name: performing-oauth-scope-minimization-review
platform: Codex
category: Security, forensics, and incident response
---

# performing-oauth-scope-minimization-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-oauth-scope-minimization-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-oauth-scope-minimization-review, then write the task. Fallback prompt: Use the performing-oauth-scope-minimization-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-oauth-scope-minimization-review` |
| Canonical name | `performing-oauth-scope-minimization-review` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
