...
display_name: performing-oil-gas-cybersecurity-assessment
platform: Codex
category: Security, forensics, and incident response
---

# performing-oil-gas-cybersecurity-assessment - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-oil-gas-cybersecurity-assessment` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-oil-gas-cybersecurity-assessment, then write the task. Fallback prompt: Use the performing-oil-gas-cybersecurity-assessment skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-oil-gas-cybersecurity-assessment` |
| Canonical name | `performing-oil-gas-cybersecurity-assessment` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
