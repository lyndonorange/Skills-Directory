...
display_name: performing-open-source-intelligence-gathering
platform: Codex
category: Security, forensics, and incident response
---

# performing-open-source-intelligence-gathering - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-open-source-intelligence-gathering` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-open-source-intelligence-gathering, then write the task. Fallback prompt: Use the performing-open-source-intelligence-gathering skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-open-source-intelligence-gathering` |
| Canonical name | `performing-open-source-intelligence-gathering` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
