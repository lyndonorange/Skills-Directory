...
display_name: performing-ot-network-security-assessment
platform: Codex
category: Security, forensics, and incident response
---

# performing-ot-network-security-assessment - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-ot-network-security-assessment` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-ot-network-security-assessment, then write the task. Fallback prompt: Use the performing-ot-network-security-assessment skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-ot-network-security-assessment` |
| Canonical name | `performing-ot-network-security-assessment` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
