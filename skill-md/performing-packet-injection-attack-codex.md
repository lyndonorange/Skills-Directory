...
display_name: performing-packet-injection-attack
platform: Codex
category: Security, forensics, and incident response
---

# performing-packet-injection-attack - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-packet-injection-attack` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-packet-injection-attack, then write the task. Fallback prompt: Use the performing-packet-injection-attack skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-packet-injection-attack` |
| Canonical name | `performing-packet-injection-attack` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
