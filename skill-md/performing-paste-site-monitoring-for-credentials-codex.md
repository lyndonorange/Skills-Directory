...
display_name: performing-paste-site-monitoring-for-credentials
platform: Codex
category: Security, forensics, and incident response
---

# performing-paste-site-monitoring-for-credentials - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-paste-site-monitoring-for-credentials` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Paste sites (Pastebin, GitHub Gists, Ghostbin, Dpaste, Hastebin) are frequently used as staging areas for leaked credentials, database dumps, API keys, and sensitive data before wider distribution on dark web forums and 

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-paste-site-monitoring-for-credentials, then write the task. Fallback prompt: Use the performing-paste-site-monitoring-for-credentials skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-paste-site-monitoring-for-credentials` |
| Canonical name | `performing-paste-site-monitoring-for-credentials` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
    ...
    def __init__(self, keywords, output_dir="paste_alerts"):
        ...
        self.credential_patterns = {
            ...
            "github_token": re.compile(
                r'[github-token-prefix-redacted][0-9a-zA-Z]{36}'),
