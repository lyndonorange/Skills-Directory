...
display_name: performing-plc-firmware-security-analysis
platform: Codex
category: Security, forensics, and incident response
---

# performing-plc-firmware-security-analysis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-plc-firmware-security-analysis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-plc-firmware-security-analysis, then write the task. Fallback prompt: Use the performing-plc-firmware-security-analysis skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-plc-firmware-security-analysis` |
| Canonical name | `performing-plc-firmware-security-analysis` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
