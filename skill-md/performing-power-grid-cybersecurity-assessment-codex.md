...
display_name: performing-power-grid-cybersecurity-assessment
platform: Codex
category: Security, forensics, and incident response
---

# performing-power-grid-cybersecurity-assessment - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-power-grid-cybersecurity-assessment` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-power-grid-cybersecurity-assessment, then write the task. Fallback prompt: Use the performing-power-grid-cybersecurity-assessment skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-power-grid-cybersecurity-assessment` |
| Canonical name | `performing-power-grid-cybersecurity-assessment` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
