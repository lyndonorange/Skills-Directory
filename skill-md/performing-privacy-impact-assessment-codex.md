...
display_name: performing-privacy-impact-assessment
platform: Codex
category: Security, forensics, and incident response
---

# performing-privacy-impact-assessment - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-privacy-impact-assessment` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-privacy-impact-assessment, then write the task. Fallback prompt: Use the performing-privacy-impact-assessment skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-privacy-impact-assessment` |
| Canonical name | `performing-privacy-impact-assessment` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
