...
display_name: performing-privilege-escalation-on-linux
platform: Codex
category: Security, forensics, and incident response
---

# performing-privilege-escalation-on-linux - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-privilege-escalation-on-linux` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-privilege-escalation-on-linux, then write the task. Fallback prompt: Use the performing-privilege-escalation-on-linux skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-privilege-escalation-on-linux` |
| Canonical name | `performing-privilege-escalation-on-linux` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
