...
display_name: performing-purple-team-atomic-testing
platform: Codex
category: Security, forensics, and incident response
---

# performing-purple-team-atomic-testing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-purple-team-atomic-testing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-purple-team-atomic-testing, then write the task. Fallback prompt: Use the performing-purple-team-atomic-testing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-purple-team-atomic-testing` |
| Canonical name | `performing-purple-team-atomic-testing` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
