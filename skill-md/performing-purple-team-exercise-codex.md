...
display_name: performing-purple-team-exercise
platform: Codex
category: Security, forensics, and incident response
---

# performing-purple-team-exercise - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-purple-team-exercise` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-purple-team-exercise, then write the task. Fallback prompt: Use the performing-purple-team-exercise skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-purple-team-exercise` |
| Canonical name | `performing-purple-team-exercise` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
