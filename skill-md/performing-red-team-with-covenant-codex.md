...
display_name: performing-red-team-with-covenant
platform: Codex
category: Security, forensics, and incident response
---

# performing-red-team-with-covenant - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-red-team-with-covenant` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Covenant is a collaborative .NET C2 framework for red teamers that provides a Swagger-documented REST API for managing listeners, launchers, grunts (agents), and tasks. This skill covers automating Covenant operations th

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-red-team-with-covenant, then write the task. Fallback prompt: Use the performing-red-team-with-covenant skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-red-team-with-covenant` |
| Canonical name | `performing-red-team-with-covenant` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
