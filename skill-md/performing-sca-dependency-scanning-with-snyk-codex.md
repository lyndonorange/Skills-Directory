...
display_name: performing-sca-dependency-scanning-with-snyk
platform: Codex
category: Security, forensics, and incident response
---

# performing-sca-dependency-scanning-with-snyk - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-sca-dependency-scanning-with-snyk` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-sca-dependency-scanning-with-snyk, then write the task. Fallback prompt: Use the performing-sca-dependency-scanning-with-snyk skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-sca-dependency-scanning-with-snyk` |
| Canonical name | `performing-sca-dependency-scanning-with-snyk` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
