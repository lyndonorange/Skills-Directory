...
display_name: performing-scada-hmi-security-assessment
platform: Codex
category: Security, forensics, and incident response
---

# performing-scada-hmi-security-assessment - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-scada-hmi-security-assessment` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-scada-hmi-security-assessment, then write the task. Fallback prompt: Use the performing-scada-hmi-security-assessment skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-scada-hmi-security-assessment` |
| Canonical name | `performing-scada-hmi-security-assessment` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
