...
display_name: performing-second-order-sql-injection
platform: Codex
category: Security, forensics, and incident response
---

# performing-second-order-sql-injection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-second-order-sql-injection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-second-order-sql-injection, then write the task. Fallback prompt: Use the performing-second-order-sql-injection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-second-order-sql-injection` |
| Canonical name | `performing-second-order-sql-injection` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
