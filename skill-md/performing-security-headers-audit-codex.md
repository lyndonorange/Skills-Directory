...
display_name: performing-security-headers-audit
platform: Codex
category: Security, forensics, and incident response
---

# performing-security-headers-audit - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-security-headers-audit` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-security-headers-audit, then write the task. Fallback prompt: Use the performing-security-headers-audit skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-security-headers-audit` |
| Canonical name | `performing-security-headers-audit` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
