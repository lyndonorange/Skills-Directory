...
display_name: performing-serverless-function-security-review
platform: Codex
category: Security, forensics, and incident response
---

# performing-serverless-function-security-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-serverless-function-security-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-serverless-function-security-review, then write the task. Fallback prompt: Use the performing-serverless-function-security-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-serverless-function-security-review` |
| Canonical name | `performing-serverless-function-security-review` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
