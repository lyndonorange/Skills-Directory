...
display_name: performing-service-account-credential-rotation
platform: Codex
category: Security, forensics, and incident response
---

# performing-service-account-credential-rotation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-service-account-credential-rotation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Service accounts are non-human identities used by applications, daemons, CI/CD pipelines, and automated processes to authenticate to systems and APIs. These accounts often have elevated privileges and their credentials (

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-service-account-credential-rotation, then write the task. Fallback prompt: Use the performing-service-account-credential-rotation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-service-account-credential-rotation` |
| Canonical name | `performing-service-account-credential-rotation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
