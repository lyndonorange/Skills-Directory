...
display_name: performing-soap-web-service-security-testing
platform: Codex
category: Security, forensics, and incident response
---

# performing-soap-web-service-security-testing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-soap-web-service-security-testing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

SOAP (Simple Object Access Protocol) web services remain widely deployed in enterprise environments, financial systems, healthcare, and government integrations. Security testing of SOAP services involves analyzing WSDL (

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-soap-web-service-security-testing, then write the task. Fallback prompt: Use the performing-soap-web-service-security-testing skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-soap-web-service-security-testing` |
| Canonical name | `performing-soap-web-service-security-testing` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
...
<!DOCTYPE foo [
  <!ENTITY xxe SYSTEM "[local file URL removed]">
]>
