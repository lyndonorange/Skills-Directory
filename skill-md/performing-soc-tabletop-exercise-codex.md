...
display_name: performing-soc-tabletop-exercise
platform: Codex
category: Security, forensics, and incident response
---

# performing-soc-tabletop-exercise - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-soc-tabletop-exercise` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-soc-tabletop-exercise, then write the task. Fallback prompt: Use the performing-soc-tabletop-exercise skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-soc-tabletop-exercise` |
| Canonical name | `performing-soc-tabletop-exercise` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
