...
display_name: performing-soc2-type2-audit-preparation
platform: Codex
category: Security, forensics, and incident response
---

# performing-soc2-type2-audit-preparation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-soc2-type2-audit-preparation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-soc2-type2-audit-preparation, then write the task. Fallback prompt: Use the performing-soc2-type2-audit-preparation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-soc2-type2-audit-preparation` |
| Canonical name | `performing-soc2-type2-audit-preparation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
