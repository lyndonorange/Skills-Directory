...
display_name: performing-sqlite-database-forensics
platform: Codex
category: Security, forensics, and incident response
---

# performing-sqlite-database-forensics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-sqlite-database-forensics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

SQLite is the most widely deployed database engine in the world, used by virtually every mobile application, web browser, and many desktop applications to store user data. In digital forensics, SQLite databases are criti

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-sqlite-database-forensics, then write the task. Fallback prompt: Use the performing-sqlite-database-forensics skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-sqlite-database-forensics` |
| Canonical name | `performing-sqlite-database-forensics` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
