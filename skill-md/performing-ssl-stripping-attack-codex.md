...
display_name: performing-ssl-stripping-attack
platform: Codex
category: Security, forensics, and incident response
---

# performing-ssl-stripping-attack - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-ssl-stripping-attack` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-ssl-stripping-attack, then write the task. Fallback prompt: Use the performing-ssl-stripping-attack skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-ssl-stripping-attack` |
| Canonical name | `performing-ssl-stripping-attack` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
