...
display_name: performing-ssl-tls-inspection-configuration
platform: Codex
category: Security, forensics, and incident response
---

# performing-ssl-tls-inspection-configuration - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-ssl-tls-inspection-configuration` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

SSL/TLS inspection (also called SSL decryption, HTTPS inspection, or TLS break-and-inspect) intercepts encrypted traffic between clients and servers to inspect the cleartext content for malware, data exfiltration, policy

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-ssl-tls-inspection-configuration, then write the task. Fallback prompt: Use the performing-ssl-tls-inspection-configuration skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-ssl-tls-inspection-configuration` |
| Canonical name | `performing-ssl-tls-inspection-configuration` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
