...
display_name: performing-ssl-tls-security-assessment
platform: Codex
category: Security, forensics, and incident response
---

# performing-ssl-tls-security-assessment - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-ssl-tls-security-assessment` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Assess SSL/TLS server configurations using sslyze, a fast Python-based scanning library. This skill covers evaluating supported protocol versions (SSLv2/3, TLS 1.0-1.3), cipher suite strength, certificate chain validatio

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-ssl-tls-security-assessment, then write the task. Fallback prompt: Use the performing-ssl-tls-security-assessment skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-ssl-tls-security-assessment` |
| Canonical name | `performing-ssl-tls-security-assessment` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
