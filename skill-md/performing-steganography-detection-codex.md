...
display_name: performing-steganography-detection
platform: Codex
category: Security, forensics, and incident response
---

# performing-steganography-detection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-steganography-detection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-steganography-detection, then write the task. Fallback prompt: Use the performing-steganography-detection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-steganography-detection` |
| Canonical name | `performing-steganography-detection` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
