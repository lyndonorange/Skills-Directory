...
display_name: performing-subdomain-enumeration-with-subfinder
platform: Codex
category: Security, forensics, and incident response
---

# performing-subdomain-enumeration-with-subfinder - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-subdomain-enumeration-with-subfinder` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-subdomain-enumeration-with-subfinder, then write the task. Fallback prompt: Use the performing-subdomain-enumeration-with-subfinder skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-subdomain-enumeration-with-subfinder` |
| Canonical name | `performing-subdomain-enumeration-with-subfinder` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
