...
display_name: performing-supply-chain-attack-simulation
platform: Codex
category: Security, forensics, and incident response
---

# performing-supply-chain-attack-simulation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-supply-chain-attack-simulation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Software supply chain attacks exploit trust in package registries through typosquatting (registering names similar to popular packages), dependency confusion (publishing higher-version public packages matching private na

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-supply-chain-attack-simulation, then write the task. Fallback prompt: Use the performing-supply-chain-attack-simulation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-supply-chain-attack-simulation` |
| Canonical name | `performing-supply-chain-attack-simulation` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
