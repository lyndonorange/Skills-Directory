...
display_name: performing-thick-client-application-penetration-test
platform: Codex
category: Security, forensics, and incident response
---

# performing-thick-client-application-penetration-test - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-thick-client-application-penetration-test` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Thick client (fat client) penetration testing assesses the security of desktop applications that run locally on user machines and communicate with backend servers. Unlike web applications, thick clients present a broader

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-thick-client-application-penetration-test, then write the task. Fallback prompt: Use the performing-thick-client-application-penetration-test skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-thick-client-application-penetration-test` |
| Canonical name | `performing-thick-client-application-penetration-test` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
