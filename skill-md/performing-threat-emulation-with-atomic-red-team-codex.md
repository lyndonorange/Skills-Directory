...
display_name: performing-threat-emulation-with-atomic-red-team
platform: Codex
category: Security, forensics, and incident response
---

# performing-threat-emulation-with-atomic-red-team - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-threat-emulation-with-atomic-red-team` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-threat-emulation-with-atomic-red-team, then write the task. Fallback prompt: Use the performing-threat-emulation-with-atomic-red-team skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-threat-emulation-with-atomic-red-team` |
| Canonical name | `performing-threat-emulation-with-atomic-red-team` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
