...
display_name: performing-threat-hunting-with-elastic-siem
platform: Codex
category: Security, forensics, and incident response
---

# performing-threat-hunting-with-elastic-siem - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-threat-hunting-with-elastic-siem` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-threat-hunting-with-elastic-siem, then write the task. Fallback prompt: Use the performing-threat-hunting-with-elastic-siem skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-threat-hunting-with-elastic-siem` |
| Canonical name | `performing-threat-hunting-with-elastic-siem` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
