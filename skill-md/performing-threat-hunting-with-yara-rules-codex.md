...
display_name: performing-threat-hunting-with-yara-rules
platform: Codex
category: Security, forensics, and incident response
---

# performing-threat-hunting-with-yara-rules - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-threat-hunting-with-yara-rules` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-threat-hunting-with-yara-rules, then write the task. Fallback prompt: Use the performing-threat-hunting-with-yara-rules skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-threat-hunting-with-yara-rules` |
| Canonical name | `performing-threat-hunting-with-yara-rules` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
