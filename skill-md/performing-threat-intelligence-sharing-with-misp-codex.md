...
display_name: performing-threat-intelligence-sharing-with-misp
platform: Codex
category: Security, forensics, and incident response
---

# performing-threat-intelligence-sharing-with-misp - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-threat-intelligence-sharing-with-misp` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

MISP (Malware Information Sharing Platform) is an open-source threat intelligence platform designed for collecting, storing, distributing, and sharing cybersecurity indicators and threat information. PyMISP is the offici

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-threat-intelligence-sharing-with-misp, then write the task. Fallback prompt: Use the performing-threat-intelligence-sharing-with-misp skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-threat-intelligence-sharing-with-misp` |
| Canonical name | `performing-threat-intelligence-sharing-with-misp` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
