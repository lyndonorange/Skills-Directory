...
display_name: performing-threat-landscape-assessment-for-sector
platform: Codex
category: Security, forensics, and incident response
---

# performing-threat-landscape-assessment-for-sector - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-threat-landscape-assessment-for-sector` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

A sector-specific threat landscape assessment analyzes the cyber threat environment facing a particular industry vertical (healthcare, financial services, energy, government, manufacturing) by examining which threat acto

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-threat-landscape-assessment-for-sector, then write the task. Fallback prompt: Use the performing-threat-landscape-assessment-for-sector skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-threat-landscape-assessment-for-sector` |
| Canonical name | `performing-threat-landscape-assessment-for-sector` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
