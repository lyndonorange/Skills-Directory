...
display_name: performing-timeline-reconstruction-with-plaso
platform: Codex
category: Security, forensics, and incident response
---

# performing-timeline-reconstruction-with-plaso - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-timeline-reconstruction-with-plaso` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-timeline-reconstruction-with-plaso, then write the task. Fallback prompt: Use the performing-timeline-reconstruction-with-plaso skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-timeline-reconstruction-with-plaso` |
| Canonical name | `performing-timeline-reconstruction-with-plaso` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
