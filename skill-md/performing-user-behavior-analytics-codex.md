...
display_name: performing-user-behavior-analytics
platform: Codex
category: Security, forensics, and incident response
---

# performing-user-behavior-analytics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-user-behavior-analytics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-user-behavior-analytics, then write the task. Fallback prompt: Use the performing-user-behavior-analytics skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-user-behavior-analytics` |
| Canonical name | `performing-user-behavior-analytics` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
