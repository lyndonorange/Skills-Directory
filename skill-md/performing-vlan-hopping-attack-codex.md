...
display_name: performing-vlan-hopping-attack
platform: Codex
category: Security, forensics, and incident response
---

# performing-vlan-hopping-attack - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-vlan-hopping-attack` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-vlan-hopping-attack, then write the task. Fallback prompt: Use the performing-vlan-hopping-attack skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-vlan-hopping-attack` |
| Canonical name | `performing-vlan-hopping-attack` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
