...
# performing-web-application-firewall-bypass - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-web-application-firewall-bypass` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-web-application-firewall-bypass, then write the task. Fallback prompt: Use the performing-web-application-firewall-bypass skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-web-application-firewall-bypass` |
| Canonical name | `performing-web-application-firewall-bypass` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
