...
display_name: performing-web-application-penetration-test
platform: Codex
category: Security, forensics, and incident response
---

# performing-web-application-penetration-test - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-web-application-penetration-test` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-web-application-penetration-test, then write the task. Fallback prompt: Use the performing-web-application-penetration-test skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-web-application-penetration-test` |
| Canonical name | `performing-web-application-penetration-test` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
...
- **XML External Entity (XXE)**: Submit XML payloads with external entity declarations (`<!DOCTYPE foo [<!ENTITY xxe SYSTEM "[local file URL removed]">]>`) in XML upload or API endpoints
