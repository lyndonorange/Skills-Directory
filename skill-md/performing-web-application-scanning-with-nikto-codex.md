...
display_name: performing-web-application-scanning-with-nikto
platform: Codex
category: Security, forensics, and incident response
---

# performing-web-application-scanning-with-nikto - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-web-application-scanning-with-nikto` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Nikto is an open-source web server and web application scanner that tests against over 7,000 potentially dangerous files/programs, checks for outdated versions of over 1,250 servers, and identifies version-specific probl

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-web-application-scanning-with-nikto, then write the task. Fallback prompt: Use the performing-web-application-scanning-with-nikto skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-web-application-scanning-with-nikto` |
| Canonical name | `performing-web-application-scanning-with-nikto` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
