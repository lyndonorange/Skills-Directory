...
display_name: performing-web-cache-poisoning-attack
platform: Codex
category: Security, forensics, and incident response
---

# performing-web-cache-poisoning-attack - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-web-cache-poisoning-attack` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-web-cache-poisoning-attack, then write the task. Fallback prompt: Use the performing-web-cache-poisoning-attack skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-web-cache-poisoning-attack` |
| Canonical name | `performing-web-cache-poisoning-attack` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
