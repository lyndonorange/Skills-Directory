...
display_name: performing-wifi-password-cracking-with-aircrack
platform: Codex
category: Security, forensics, and incident response
---

# performing-wifi-password-cracking-with-aircrack - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-wifi-password-cracking-with-aircrack` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose performing-wifi-password-cracking-with-aircrack, then write the task. Fallback prompt: Use the performing-wifi-password-cracking-with-aircrack skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-wifi-password-cracking-with-aircrack` |
| Canonical name | `performing-wifi-password-cracking-with-aircrack` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
