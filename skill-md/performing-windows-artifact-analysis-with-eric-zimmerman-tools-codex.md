...
display_name: performing-windows-artifact-analysis-with-eric-zimmerman-tools
platform: Codex
category: Security, forensics, and incident response
---

# performing-windows-artifact-analysis-with-eric-zimmerman-tools - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-windows-artifact-analysis-with-eric-zimmerman-tools` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Eric Zimmerman's EZ Tools suite is a collection of open-source forensic utilities that have become the global standard for Windows digital forensics investigations. Originally developed by a former FBI agent and current 

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-windows-artifact-analysis-with-eric-zimmerman-tools, then write the task. Fallback prompt: Use the performing-windows-artifact-analysis-with-eric-zimmerman-tools skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-windows-artifact-analysis-with-eric-zimmerman-tools` |
| Canonical name | `performing-windows-artifact-analysis-with-eric-zimmerman-tools` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
