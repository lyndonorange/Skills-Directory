...
display_name: performing-wireless-network-penetration-test
platform: Codex
category: Security, forensics, and incident response
---

# performing-wireless-network-penetration-test - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-wireless-network-penetration-test` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Wireless penetration testing evaluates the security of an organization's WiFi infrastructure including encryption strength, authentication mechanisms, rogue access point detection, client isolation, and network segmentat

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-wireless-network-penetration-test, then write the task. Fallback prompt: Use the performing-wireless-network-penetration-test skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-wireless-network-penetration-test` |
| Canonical name | `performing-wireless-network-penetration-test` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
