...
display_name: performing-wireless-security-assessment-with-kismet
platform: Codex
category: Security, forensics, and incident response
---

# performing-wireless-security-assessment-with-kismet - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-wireless-security-assessment-with-kismet` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Kismet is an open-source wireless network detector, packet sniffer, and wireless intrusion detection system (WIDS) supporting 802.11a/b/g/n/ac/ax. Unlike active scanners, Kismet operates in passive monitor mode, making i

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-wireless-security-assessment-with-kismet, then write the task. Fallback prompt: Use the performing-wireless-security-assessment-with-kismet skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-wireless-security-assessment-with-kismet` |
| Canonical name | `performing-wireless-security-assessment-with-kismet` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
