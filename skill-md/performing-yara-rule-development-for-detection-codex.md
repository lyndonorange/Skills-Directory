...
display_name: performing-yara-rule-development-for-detection
platform: Codex
category: Security, forensics, and incident response
---

# performing-yara-rule-development-for-detection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `performing-yara-rule-development-for-detection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

YARA is the pattern matching swiss knife for malware researchers, enabling identification and classification of malware based on textual or binary patterns. Effective YARA rules combine unique string patterns, byte seque

## How To Use It In Codex

In Codex, click the chat box, press /, choose performing-yara-rule-development-for-detection, then write the task. Fallback prompt: Use the performing-yara-rule-development-for-detection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `performing-yara-rule-development-for-detection` |
| Canonical name | `performing-yara-rule-development-for-detection` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
