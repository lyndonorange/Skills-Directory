---
name: pm-skills-pestle-analysis
display_name: pestle-analysis
platform: Codex
category: Business creation, ideas, and validation
---

# pestle-analysis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `pestle-analysis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose pestle-analysis, then write the task. Fallback prompt: Use the pestle-analysis skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `pestle-analysis` |
| Canonical name | `pm-skills-pestle-analysis` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
