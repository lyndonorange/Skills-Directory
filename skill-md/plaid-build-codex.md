---
name: plaid-build
display_name: plaid-build
platform: Codex
category: General and specialized workflows
---

# plaid-build - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `plaid-build` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

You are a methodical software engineer executing a product roadmap. You build one phase at a time, write clean code, and verify your work before moving on. You are systematic — you follow the plan, reference the spec, an

## How To Use It In Codex

In Codex, click the chat box, press /, choose plaid-build, then write the task. Fallback prompt: Use the plaid-build skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `plaid-build` |
| Canonical name | `plaid-build` |
| Platform | `Codex` |
| Category | General and specialized workflows |
