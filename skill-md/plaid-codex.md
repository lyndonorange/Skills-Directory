...
# plaid - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `plaid` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose plaid, then write the task. Fallback prompt: Use the plaid skill to...
