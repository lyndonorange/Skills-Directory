...
display_name: plan-ceo-review
platform: Codex
category: General and specialized workflows
---

# plan-ceo-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `plan-ceo-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose plan-ceo-review, then write the task. Fallback prompt: Use the plan-ceo-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `plan-ceo-review` |
| Canonical name | `plan-ceo-review` |
| Platform | `Codex` |
| Category | General and specialized workflows |
