...
display_name: plan-design-review
platform: Codex
category: General and specialized workflows
---

# plan-design-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `plan-design-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose plan-design-review, then write the task. Fallback prompt: Use the plan-design-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `plan-design-review` |
| Canonical name | `plan-design-review` |
| Platform | `Codex` |
| Category | General and specialized workflows |
