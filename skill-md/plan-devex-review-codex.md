...
display_name: plan-devex-review
platform: Codex
category: General and specialized workflows
---

# plan-devex-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `plan-devex-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose plan-devex-review, then write the task. Fallback prompt: Use the plan-devex-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `plan-devex-review` |
| Canonical name | `plan-devex-review` |
| Platform | `Codex` |
| Category | General and specialized workflows |
