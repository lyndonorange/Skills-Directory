...
# plan-devex-review - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `plan-devex-review` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the plan-devex-review skill to...
