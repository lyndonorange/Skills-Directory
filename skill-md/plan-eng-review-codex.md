...
display_name: plan-eng-review
platform: Codex
category: General and specialized workflows
---

# plan-eng-review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `plan-eng-review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose plan-eng-review, then write the task. Fallback prompt: Use the plan-eng-review skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `plan-eng-review` |
| Canonical name | `plan-eng-review` |
| Platform | `Codex` |
| Category | General and specialized workflows |
