---
name: plan-tune
display_name: plan-tune
platform: Codex
category: General and specialized workflows
---

# plan-tune - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `plan-tune` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose plan-tune, then write the task. Fallback prompt: Use the plan-tune skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `plan-tune` |
| Canonical name | `plan-tune` |
| Platform | `Codex` |
| Category | General and specialized workflows |
