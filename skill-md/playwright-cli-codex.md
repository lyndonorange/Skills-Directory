...
# playwright-cli - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `playwright-cli` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose playwright-cli, then write the task. Fallback prompt: Use the playwright-cli skill to...
