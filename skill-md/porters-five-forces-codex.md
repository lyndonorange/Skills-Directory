---
name: pm-skills-porters-five-forces
display_name: porters-five-forces
platform: Codex
category: Business creation, ideas, and validation
---

# porters-five-forces - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `porters-five-forces` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose porters-five-forces, then write the task. Fallback prompt: Use the porters-five-forces skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `porters-five-forces` |
| Canonical name | `pm-skills-porters-five-forces` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
