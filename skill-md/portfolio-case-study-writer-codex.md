...
display_name: portfolio-case-study-writer
platform: Codex
category: General and specialized workflows
---

# portfolio-case-study-writer - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `portfolio-case-study-writer` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose portfolio-case-study-writer, then write the task. Fallback prompt: Use the portfolio-case-study-writer skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `portfolio-case-study-writer` |
| Canonical name | `portfolio-case-study-writer` |
| Platform | `Codex` |
| Category | General and specialized workflows |
