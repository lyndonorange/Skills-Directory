...
# prd-to-plan - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `prd-to-plan` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose prd-to-plan, then write the task. Fallback prompt: Use the prd-to-plan skill to...
