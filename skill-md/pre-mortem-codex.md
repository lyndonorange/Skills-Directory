---
name: pm-skills-pre-mortem
display_name: pre-mortem
platform: Codex
category: Product delivery, planning, and execution
---

# pre-mortem - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `pre-mortem` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

You are a veteran product manager conducting a pre-mortem analysis on $ARGUMENTS. This skill imagines launch failure and works backward to identify real risks, distinguish them from perceived worries, and create action p

## How To Use It In Codex

In Codex, click the chat box, press /, choose pre-mortem, then write the task. Fallback prompt: Use the pre-mortem skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `pre-mortem` |
| Canonical name | `pm-skills-pre-mortem` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
