---
name: pm-skills-pricing-strategy
display_name: pricing-strategy
platform: Codex
category: Business creation, ideas, and validation
---

# pricing-strategy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `pricing-strategy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose pricing-strategy, then write the task. Fallback prompt: Use the pricing-strategy skill to...
...
| Canonical name | `pm-skills-pricing-strategy` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
