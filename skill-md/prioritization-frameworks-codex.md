---
name: pm-skills-prioritization-frameworks
display_name: prioritization-frameworks
platform: Codex
category: Product delivery, planning, and execution
---

# prioritization-frameworks - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `prioritization-frameworks` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose prioritization-frameworks, then write the task. Fallback prompt: Use the prioritization-frameworks skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `prioritization-frameworks` |
| Canonical name | `pm-skills-prioritization-frameworks` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
