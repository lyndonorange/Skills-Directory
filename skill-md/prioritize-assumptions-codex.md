...
# prioritize-assumptions - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `prioritize-assumptions` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose prioritize-assumptions, then write the task. Fallback prompt: Use the prioritize-assumptions skill to...
