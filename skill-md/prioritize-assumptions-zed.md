...
# prioritize-assumptions - Zed Skill Package

## What This Is

This is a friend-safe Markdown copy of `prioritize-assumptions` for Zed. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Zed, open the Agent panel and type: Use the prioritize-assumptions skill to...
