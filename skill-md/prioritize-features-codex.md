---
name: pm-skills-prioritize-features
display_name: prioritize-features
platform: Codex
category: Product delivery, planning, and execution
---

# prioritize-features - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `prioritize-features` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose prioritize-features, then write the task. Fallback prompt: Use the prioritize-features skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `prioritize-features` |
| Canonical name | `pm-skills-prioritize-features` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
