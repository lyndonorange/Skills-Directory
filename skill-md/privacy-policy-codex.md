---
name: pm-skills-privacy-policy
display_name: privacy-policy
platform: Codex
category: PM operations, communication, and utilities
---

# privacy-policy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `privacy-policy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose privacy-policy, then write the task. Fallback prompt: Use the privacy-policy skill to...
...
| Canonical name | `pm-skills-privacy-policy` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
