...
# privacy-policy - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `privacy-policy` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the privacy-policy skill to...
