...
display_name: PrivateInvestigator
platform: Codex
category: General and specialized workflows
---

# PrivateInvestigator - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `PrivateInvestigator` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Ethical people-finding and identity verification using 15 parallel research agents (45 concurrent search threads) across people-search aggregators, social media x-ray searches, public records (voter, property, court port

## How To Use It In Codex

In Codex, click the chat box, press /, choose PrivateInvestigator, then write the task. Fallback prompt: Use the PrivateInvestigator skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `PrivateInvestigator` |
| Canonical name | `PrivateInvestigator` |
| Platform | `Codex` |
| Category | General and specialized workflows |
