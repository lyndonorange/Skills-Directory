...
# processing-stix-taxii-feeds - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `processing-stix-taxii-feeds` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose processing-stix-taxii-feeds, then write the task. Fallback prompt: Use the processing-stix-taxii-feeds skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `processing-stix-taxii-feeds` |
| Canonical name | `processing-stix-taxii-feeds` |
| Platform | `Codex` |
| Category | General and specialized workflows |
