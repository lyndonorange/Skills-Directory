...
display_name: product-launch-video
platform: Codex
category: Product, growth, marketing, and PM
---

# product-launch-video - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `product-launch-video` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Turn a product or marketing URL, pasted script, or brief into a product launch / promo video — SaaS promos, feature reveals, product demos, app and company launches. Use when the user wants to market, launch, promote, or

## How To Use It In Codex

In Codex, click the chat box, press /, choose product-launch-video, then write the task. Fallback prompt: Use the product-launch-video skill to...
...
| Canonical name | `product-launch-video` |
| Platform | `Codex` |
| Category | Product, growth, marketing, and PM |
