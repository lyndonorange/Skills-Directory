...
# product-launch-video - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `product-launch-video` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the product-launch-video skill to...
