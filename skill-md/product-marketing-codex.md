...
# product-marketing - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `product-marketing` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose product-marketing, then write the task. Fallback prompt: Use the product-marketing skill to...
...
| Canonical name | `product-marketing` |
| Platform | `Codex` |
| Category | Product, growth, marketing, and PM |
