---
name: pm-skills-product-name
display_name: product-name
platform: Codex
category: Business creation, ideas, and validation
---

# product-name - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `product-name` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose product-name, then write the task. Fallback prompt: Use the product-name skill to...
...
| Canonical name | `pm-skills-product-name` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
