---
name: pm-skills-product-strategy
display_name: product-strategy
platform: Codex
category: Business creation, ideas, and validation
---

# product-strategy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `product-strategy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose product-strategy, then write the task. Fallback prompt: Use the product-strategy skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `product-strategy` |
| Canonical name | `pm-skills-product-strategy` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
