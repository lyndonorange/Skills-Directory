---
name: pm-skills-product-vision
display_name: product-vision
platform: Codex
category: Business creation, ideas, and validation
---

# product-vision - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `product-vision` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose product-vision, then write the task. Fallback prompt: Use the product-vision skill to...
...
| Canonical name | `pm-skills-product-vision` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
