...
# profiling-threat-actor-groups - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `profiling-threat-actor-groups` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose profiling-threat-actor-groups, then write the task. Fallback prompt: Use the profiling-threat-actor-groups skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `profiling-threat-actor-groups` |
| Canonical name | `profiling-threat-actor-groups` |
| Platform | `Codex` |
| Category | General and specialized workflows |
