...
display_name: protocol-reverse
platform: Codex
category: General and specialized workflows
---

# protocol-reverse - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `protocol-reverse` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose protocol-reverse, then write the task. Fallback prompt: Use the protocol-reverse skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `protocol-reverse` |
| Canonical name | `protocol-reverse` |
| Platform | `Codex` |
| Category | General and specialized workflows |
