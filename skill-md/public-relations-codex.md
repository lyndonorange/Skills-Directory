...
# public-relations - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `public-relations` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose public-relations, then write the task. Fallback prompt: Use the public-relations skill to...
...
| Canonical name | `public-relations` |
| Platform | `Codex` |
| Category | General and specialized workflows |
