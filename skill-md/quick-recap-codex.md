---
name: quick-recap
display_name: quick-recap
platform: Codex
category: General and specialized workflows
---

# quick-recap - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `quick-recap` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose quick-recap, then write the task. Fallback prompt: Use the quick-recap skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `quick-recap` |
| Canonical name | `quick-recap` |
| Platform | `Codex` |
| Category | General and specialized workflows |
