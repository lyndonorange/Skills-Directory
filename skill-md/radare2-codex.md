...
# radare2 - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `radare2` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose radare2, then write the task. Fallback prompt: Use the radare2 skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `radare2` |
| Canonical name | `radare2` |
| Platform | `Codex` |
| Category | General and specialized workflows |
