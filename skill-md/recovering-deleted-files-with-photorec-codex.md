...
display_name: recovering-deleted-files-with-photorec
platform: Codex
category: General and specialized workflows
---

# recovering-deleted-files-with-photorec - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `recovering-deleted-files-with-photorec` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose recovering-deleted-files-with-photorec, then write the task. Fallback prompt: Use the recovering-deleted-files-with-photorec skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `recovering-deleted-files-with-photorec` |
| Canonical name | `recovering-deleted-files-with-photorec` |
| Platform | `Codex` |
| Category | General and specialized workflows |
