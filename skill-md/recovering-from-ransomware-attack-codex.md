...
# recovering-from-ransomware-attack - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `recovering-from-ransomware-attack` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose recovering-from-ransomware-attack, then write the task. Fallback prompt: Use the recovering-from-ransomware-attack skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `recovering-from-ransomware-attack` |
| Canonical name | `recovering-from-ransomware-attack` |
| Platform | `Codex` |
| Category | General and specialized workflows |
