...
display_name: reference-list-builder
platform: Codex
category: General and specialized workflows
---

# reference-list-builder - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `reference-list-builder` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose reference-list-builder, then write the task. Fallback prompt: Use the reference-list-builder skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `reference-list-builder` |
| Canonical name | `reference-list-builder` |
| Platform | `Codex` |
| Category | General and specialized workflows |
