...
# reference-to-swiftui - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `reference-to-swiftui` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose reference-to-swiftui, then write the task. Fallback prompt: Use the reference-to-swiftui skill to...
