---
name: pm-skills-release-notes
display_name: release-notes
platform: Codex
category: Product delivery, planning, and execution
---

# release-notes - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `release-notes` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose release-notes, then write the task. Fallback prompt: Use the release-notes skill to...
...
| Canonical name | `pm-skills-release-notes` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
