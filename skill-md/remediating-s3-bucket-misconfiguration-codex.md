...
# remediating-s3-bucket-misconfiguration - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `remediating-s3-bucket-misconfiguration` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose remediating-s3-bucket-misconfiguration, then write the task. Fallback prompt: Use the remediating-s3-bucket-misconfiguration skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `remediating-s3-bucket-misconfiguration` |
| Canonical name | `remediating-s3-bucket-misconfiguration` |
| Platform | `Codex` |
| Category | General and specialized workflows |
