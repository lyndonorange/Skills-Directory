...
# remotion-best-practices - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `remotion-best-practices` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the remotion-best-practices skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `remotion-best-practices` |
| Canonical name | `remotion-best-practices` |
| Platform | `Universal Agents` |
| Category | Design, creative, and media |
