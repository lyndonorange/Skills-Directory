...
display_name: remotion-to-hyperframes
platform: Codex
category: Design, creative, and media
---

# remotion-to-hyperframes - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `remotion-to-hyperframes` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

'Port an existing Remotion (React) composition''s source to HyperFrames HTML. Use ONLY on an explicit ask to port/convert/migrate/translate a Remotion source — one-way, Remotion-only. A passing Remotion mention, referenc

## How To Use It In Codex

In Codex, click the chat box, press /, choose remotion-to-hyperframes, then write the task. Fallback prompt: Use the remotion-to-hyperframes skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `remotion-to-hyperframes` |
| Canonical name | `remotion-to-hyperframes` |
| Platform | `Codex` |
| Category | Design, creative, and media |
