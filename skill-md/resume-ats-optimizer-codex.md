...
# resume-ats-optimizer - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `resume-ats-optimizer` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose resume-ats-optimizer, then write the task. Fallback prompt: Use the resume-ats-optimizer skill to...
