...
display_name: resume-bullet-writer
platform: Codex
category: General and specialized workflows
---

# resume-bullet-writer - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `resume-bullet-writer` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose resume-bullet-writer, then write the task. Fallback prompt: Use the resume-bullet-writer skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `resume-bullet-writer` |
| Canonical name | `resume-bullet-writer` |
| Platform | `Codex` |
| Category | General and specialized workflows |
