...
display_name: resume-version-manager
platform: Codex
category: General and specialized workflows
---

# resume-version-manager - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `resume-version-manager` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose resume-version-manager, then write the task. Fallback prompt: Use the resume-version-manager skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `resume-version-manager` |
| Canonical name | `resume-version-manager` |
| Platform | `Codex` |
| Category | General and specialized workflows |
