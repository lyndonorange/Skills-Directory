...
# reverse-engineering - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `reverse-engineering` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Provides reverse engineering techniques. Use when the main job is to understand how a compiled, obfuscated, packed, or virtualized target works before exploiting or solving it, including binaries, APKs, WASM, firmware, c

## How To Use It In Codex

In Codex, click the chat box, press /, choose reverse-engineering, then write the task. Fallback prompt: Use the reverse-engineering skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `reverse-engineering` |
| Canonical name | `reverse-engineering` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
