...
display_name: reverse-engineering-ransomware-encryption-routine
platform: Codex
category: Security, forensics, and incident response
---

# reverse-engineering-ransomware-encryption-routine - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `reverse-engineering-ransomware-encryption-routine` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Modern ransomware uses hybrid encryption combining symmetric algorithms (AES-256-CBC/CTR, ChaCha20, Salsa20) for file encryption with asymmetric algorithms (RSA-2048/4096, Curve25519) for key protection. The encryption r

## How To Use It In Codex

In Codex, click the chat box, press /, choose reverse-engineering-ransomware-encryption-routine, then write the task. Fallback prompt: Use the reverse-engineering-ransomware-encryption-routine skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `reverse-engineering-ransomware-encryption-routine` |
| Canonical name | `reverse-engineering-ransomware-encryption-routine` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
