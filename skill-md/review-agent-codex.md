...
# review-agent - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `review-agent` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Perform a read-only, defect-first review of a specified code change and return every actionable finding. Use when another agent delegates review of uncommitted changes, a base-branch diff, a commit, or custom review inst

## How To Use It In Codex

In Codex, click the chat box, press /, choose review-agent, then write the task. Fallback prompt: Use the review-agent skill to...
