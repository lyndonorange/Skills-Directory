...
display_name: review-animations
platform: Codex
category: General and specialized workflows
---

# review-animations - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `review-animations` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose review-animations, then write the task. Fallback prompt: Use the review-animations skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `review-animations` |
| Canonical name | `review-animations` |
| Platform | `Codex` |
| Category | General and specialized workflows |
