...
# review - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `review` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose review, then write the task. Fallback prompt: Use the review skill to...
