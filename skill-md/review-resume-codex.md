---
name: pm-skills-review-resume
display_name: review-resume
platform: Codex
category: PM operations, communication, and utilities
---

# review-resume - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `review-resume` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose review-resume, then write the task. Fallback prompt: Use the review-resume skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `review-resume` |
| Canonical name | `pm-skills-review-resume` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
