...
display_name: RootCauseAnalysis
platform: Codex
category: General and specialized workflows
---

# RootCauseAnalysis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `RootCauseAnalysis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Structured incident investigation grounded in Toyota TPS, Ishikawa, Reason's Swiss Cheese, Gano's Apollo, Google SRE blameless culture. Five workflows: FiveWhys (linear/branching causal chain), Fishbone (6 M's or 4 P's m

## How To Use It In Codex

In Codex, click the chat box, press /, choose RootCauseAnalysis, then write the task. Fallback prompt: Use the RootCauseAnalysis skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `RootCauseAnalysis` |
| Canonical name | `RootCauseAnalysis` |
| Platform | `Codex` |
| Category | General and specialized workflows |
