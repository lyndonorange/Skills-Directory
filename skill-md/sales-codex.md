...
# Sales - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `Sales` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Transforms product documentation into sales-ready narrative packages: story explanation, charcoal gestural sketch art (the mandatory visual style), and talking points. Pipeline: extract narrative arc -> determine emotion

## How To Use It In Codex

In Codex, click the chat box, press /, choose Sales, then write the task. Fallback prompt: Use the Sales skill to...
