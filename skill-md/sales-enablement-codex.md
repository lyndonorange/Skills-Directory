...
# sales-enablement - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `sales-enablement` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose sales-enablement, then write the task. Fallback prompt: Use the sales-enablement skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `sales-enablement` |
| Canonical name | `sales-enablement` |
| Platform | `Codex` |
| Category | Product, growth, marketing, and PM |
