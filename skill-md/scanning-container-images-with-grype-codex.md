...
display_name: scanning-container-images-with-grype
platform: Codex
category: General and specialized workflows
---

# scanning-container-images-with-grype - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `scanning-container-images-with-grype` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Grype is an open-source vulnerability scanner from Anchore that inspects container images, filesystems, and SBOMs for known CVEs. It leverages Syft-generated SBOMs to match packages against multiple vulnerability databas

## How To Use It In Codex

In Codex, click the chat box, press /, choose scanning-container-images-with-grype, then write the task. Fallback prompt: Use the scanning-container-images-with-grype skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `scanning-container-images-with-grype` |
| Canonical name | `scanning-container-images-with-grype` |
| Platform | `Codex` |
| Category | General and specialized workflows |
