...
display_name: scanning-containers-with-trivy-in-cicd
platform: Codex
category: General and specialized workflows
---

# scanning-containers-with-trivy-in-cicd - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `scanning-containers-with-trivy-in-cicd` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose scanning-containers-with-trivy-in-cicd, then write the task. Fallback prompt: Use the scanning-containers-with-trivy-in-cicd skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `scanning-containers-with-trivy-in-cicd` |
| Canonical name | `scanning-containers-with-trivy-in-cicd` |
| Platform | `Codex` |
| Category | General and specialized workflows |
