...
display_name: scanning-docker-images-with-trivy
platform: Codex
category: General and specialized workflows
---

# scanning-docker-images-with-trivy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `scanning-docker-images-with-trivy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Trivy is a comprehensive open-source vulnerability scanner by Aqua Security that detects vulnerabilities in OS packages, language-specific dependencies, misconfigurations, secrets, and license violations within container

## How To Use It In Codex

In Codex, click the chat box, press /, choose scanning-docker-images-with-trivy, then write the task. Fallback prompt: Use the scanning-docker-images-with-trivy skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `scanning-docker-images-with-trivy` |
| Canonical name | `scanning-docker-images-with-trivy` |
| Platform | `Codex` |
| Category | General and specialized workflows |
