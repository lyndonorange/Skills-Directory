...
display_name: scanning-kubernetes-manifests-with-kubesec
platform: Codex
category: General and specialized workflows
---

# scanning-kubernetes-manifests-with-kubesec - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `scanning-kubernetes-manifests-with-kubesec` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Kubesec is an open-source security risk analysis tool developed by ControlPlane that inspects Kubernetes resource manifests for common exploitable risks such as privilege escalation, writable host mounts, and excessive c

## How To Use It In Codex

In Codex, click the chat box, press /, choose scanning-kubernetes-manifests-with-kubesec, then write the task. Fallback prompt: Use the scanning-kubernetes-manifests-with-kubesec skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `scanning-kubernetes-manifests-with-kubesec` |
| Canonical name | `scanning-kubernetes-manifests-with-kubesec` |
| Platform | `Codex` |
| Category | General and specialized workflows |
