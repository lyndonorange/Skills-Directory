...
display_name: scanning-network-with-nmap-advanced
platform: Codex
category: General and specialized workflows
---

# scanning-network-with-nmap-advanced - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `scanning-network-with-nmap-advanced` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose scanning-network-with-nmap-advanced, then write the task. Fallback prompt: Use the scanning-network-with-nmap-advanced skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `scanning-network-with-nmap-advanced` |
| Canonical name | `scanning-network-with-nmap-advanced` |
| Platform | `Codex` |
| Category | General and specialized workflows |
