...
# Science - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `Science` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

The scientific method as a universal problem-solving algorithm — goal-first, hypothesis-plural, falsifiable experiments, honest measurement. Seven workflows: DefineGoal, GenerateHypotheses (min 3 — single-hypothesis is c

## How To Use It In Codex

In Codex, click the chat box, press /, choose Science, then write the task. Fallback prompt: Use the Science skill to...
