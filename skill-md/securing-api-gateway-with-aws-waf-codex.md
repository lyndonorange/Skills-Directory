...
display_name: securing-api-gateway-with-aws-waf
platform: Codex
category: General and specialized workflows
---

# securing-api-gateway-with-aws-waf - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `securing-api-gateway-with-aws-waf` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose securing-api-gateway-with-aws-waf, then write the task. Fallback prompt: Use the securing-api-gateway-with-aws-waf skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `securing-api-gateway-with-aws-waf` |
| Canonical name | `securing-api-gateway-with-aws-waf` |
| Platform | `Codex` |
| Category | General and specialized workflows |
