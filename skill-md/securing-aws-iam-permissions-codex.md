...
display_name: securing-aws-iam-permissions
platform: Codex
category: General and specialized workflows
---

# securing-aws-iam-permissions - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `securing-aws-iam-permissions` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose securing-aws-iam-permissions, then write the task. Fallback prompt: Use the securing-aws-iam-permissions skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `securing-aws-iam-permissions` |
| Canonical name | `securing-aws-iam-permissions` |
| Platform | `Codex` |
| Category | General and specialized workflows |
