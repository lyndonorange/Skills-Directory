...
display_name: securing-aws-lambda-execution-roles
platform: Codex
category: General and specialized workflows
---

# securing-aws-lambda-execution-roles - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `securing-aws-lambda-execution-roles` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose securing-aws-lambda-execution-roles, then write the task. Fallback prompt: Use the securing-aws-lambda-execution-roles skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `securing-aws-lambda-execution-roles` |
| Canonical name | `securing-aws-lambda-execution-roles` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
aws iam create-policy \
  ...
  --policy-document [file URL removed]lambda-scoped-policy.json
...
aws iam create-role \
  ...
  --assume-role-policy-document [file URL removed]lambda-trust-policy.json
...
aws iam create-policy \
  ...
  --policy-document [file URL removed]lambda-permission-boundary.json
...
aws accessanalyzer check-no-new-access \
  --new-policy-document [file URL removed]lambda-scoped-policy.json \
  --existing-policy-document [file URL removed]old-broad-policy.json \
  --policy-type IDENTITY_POLICY
...
aws organizations create-policy \
  ...
  --content [file URL removed]scp-deny-lambda-admin.json
```
