...
display_name: securing-azure-with-microsoft-defender
platform: Codex
category: General and specialized workflows
---

# securing-azure-with-microsoft-defender - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `securing-azure-with-microsoft-defender` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose securing-azure-with-microsoft-defender, then write the task. Fallback prompt: Use the securing-azure-with-microsoft-defender skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `securing-azure-with-microsoft-defender` |
| Canonical name | `securing-azure-with-microsoft-defender` |
| Platform | `Codex` |
| Category | General and specialized workflows |
