...
display_name: securing-container-registry-images
platform: Codex
category: General and specialized workflows
---

# securing-container-registry-images - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `securing-container-registry-images` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose securing-container-registry-images, then write the task. Fallback prompt: Use the securing-container-registry-images skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `securing-container-registry-images` |
| Canonical name | `securing-container-registry-images` |
| Platform | `Codex` |
| Category | General and specialized workflows |
