...
display_name: securing-container-registry-with-harbor
platform: Codex
category: General and specialized workflows
---

# securing-container-registry-with-harbor - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `securing-container-registry-with-harbor` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Harbor is an open-source container registry that provides security features including vulnerability scanning (integrated Trivy), image signing (Notary/Cosign), RBAC, content trust policies, replication, and audit logging

## How To Use It In Codex

In Codex, click the chat box, press /, choose securing-container-registry-with-harbor, then write the task. Fallback prompt: Use the securing-container-registry-with-harbor skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `securing-container-registry-with-harbor` |
| Canonical name | `securing-container-registry-with-harbor` |
| Platform | `Codex` |
| Category | General and specialized workflows |
