...
display_name: securing-github-actions-workflows
platform: Codex
category: General and specialized workflows
---

# securing-github-actions-workflows - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `securing-github-actions-workflows` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose securing-github-actions-workflows, then write the task. Fallback prompt: Use the securing-github-actions-workflows skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `securing-github-actions-workflows` |
| Canonical name | `securing-github-actions-workflows` |
| Platform | `Codex` |
| Category | General and specialized workflows |
