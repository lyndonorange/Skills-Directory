...
display_name: securing-kubernetes-on-cloud
platform: Codex
category: General and specialized workflows
---

# securing-kubernetes-on-cloud - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `securing-kubernetes-on-cloud` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose securing-kubernetes-on-cloud, then write the task. Fallback prompt: Use the securing-kubernetes-on-cloud skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `securing-kubernetes-on-cloud` |
| Canonical name | `securing-kubernetes-on-cloud` |
| Platform | `Codex` |
| Category | General and specialized workflows |
