...
display_name: securing-serverless-functions
platform: Codex
category: General and specialized workflows
---

# securing-serverless-functions - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `securing-serverless-functions` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose securing-serverless-functions, then write the task. Fallback prompt: Use the securing-serverless-functions skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `securing-serverless-functions` |
| Canonical name | `securing-serverless-functions` |
| Platform | `Codex` |
| Category | General and specialized workflows |
