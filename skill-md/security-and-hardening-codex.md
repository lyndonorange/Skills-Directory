...
display_name: security-and-hardening
platform: Codex
category: General and specialized workflows
---

# security-and-hardening - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `security-and-hardening` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Security-first development practices for web applications. Treat every external input as hostile, every secret as sacred, and every authorization check as mandatory. Security isn't a phase — it's a constraint on every li

## How To Use It In Codex

In Codex, click the chat box, press /, choose security-and-hardening, then write the task. Fallback prompt: Use the security-and-hardening skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `security-and-hardening` |
| Canonical name | `security-and-hardening` |
| Platform | `Codex` |
| Category | General and specialized workflows |
