...
# security-best-practices - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `security-best-practices` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

This skill provides a description of how to identify the language and frameworks used by the current context, and then to load information from this skill's references directory about the security best practices for this

## How To Use It In Codex

In Codex, click the chat box, press /, choose security-best-practices, then write the task. Fallback prompt: Use the security-best-practices skill to...
...
| Canonical name | `security-best-practices` |
| Platform | `Codex` |
| Category | General and specialized workflows |
