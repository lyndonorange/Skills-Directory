...
# security-ownership-map - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `security-ownership-map` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Build a bipartite graph of people and files from git history, then compute ownership risk and export graph artifacts for Neo4j/Gephi. Also build a file co-change graph (Jaccard similarity on shared commits) to cluster fi

## How To Use It In Codex

In Codex, click the chat box, press /, choose security-ownership-map, then write the task. Fallback prompt: Use the security-ownership-map skill to...
...
| Canonical name | `security-ownership-map` |
| Platform | `Codex` |
| Category | General and specialized workflows |
