...
# security-threat-model - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `security-threat-model` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Deliver an actionable AppSec-grade threat model that is specific to the repository or a project path, not a generic checklist. Anchor every architectural claim to evidence in the repo and keep assumptions explicit. Prior

## How To Use It In Codex

In Codex, click the chat box, press /, choose security-threat-model, then write the task. Fallback prompt: Use the security-threat-model skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `security-threat-model` |
| Canonical name | `security-threat-model` |
| Platform | `Codex` |
| Category | General and specialized workflows |
