---
name: pm-skills-sentiment-analysis
display_name: sentiment-analysis
platform: Codex
category: Business creation, ideas, and validation
---

# sentiment-analysis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `sentiment-analysis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Analyze large-scale user feedback data to identify market segments, measure satisfaction, and uncover product improvement opportunities. This skill synthesizes feedback into actionable insights organized by user segment,

## How To Use It In Codex

In Codex, click the chat box, press /, choose sentiment-analysis, then write the task. Fallback prompt: Use the sentiment-analysis skill to...
...
| Canonical name | `pm-skills-sentiment-analysis` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
