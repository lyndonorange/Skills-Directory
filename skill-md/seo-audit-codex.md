...
# seo-audit - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `seo-audit` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose seo-audit, then write the task. Fallback prompt: Use the seo-audit skill to...
