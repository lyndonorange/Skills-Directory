...
# seo-audit - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `seo-audit` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the seo-audit skill to...
