...
display_name: setup-browser-cookies
platform: Codex
category: General and specialized workflows
---

# setup-browser-cookies - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `setup-browser-cookies` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose setup-browser-cookies, then write the task. Fallback prompt: Use the setup-browser-cookies skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `setup-browser-cookies` |
| Canonical name | `setup-browser-cookies` |
| Platform | `Codex` |
| Category | General and specialized workflows |
