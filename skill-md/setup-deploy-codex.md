...
# setup-deploy - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `setup-deploy` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose setup-deploy, then write the task. Fallback prompt: Use the setup-deploy skill to...
