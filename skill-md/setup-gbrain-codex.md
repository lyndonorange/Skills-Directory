---
name: setup-gbrain
display_name: setup-gbrain
platform: Codex
category: General and specialized workflows
---

# setup-gbrain - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `setup-gbrain` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose setup-gbrain, then write the task. Fallback prompt: Use the setup-gbrain skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `setup-gbrain` |
| Canonical name | `setup-gbrain` |
| Platform | `Codex` |
| Category | General and specialized workflows |
