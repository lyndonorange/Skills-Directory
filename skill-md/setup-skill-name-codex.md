...
display_name: {setup-skill-name}
platform: Codex
category: General and specialized workflows
---

# {setup-skill-name} - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `{setup-skill-name}` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose {setup-skill-name}, then write the task. Fallback prompt: Use the {setup-skill-name} skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `{setup-skill-name}` |
| Canonical name | `{setup-skill-name}` |
| Platform | `Codex` |
| Category | General and specialized workflows |
