---
name: pm-skills-shipping-artifacts
display_name: shipping-artifacts
platform: Codex
category: Product delivery, planning, and execution
---

# shipping-artifacts - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `shipping-artifacts` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

AI agents write code fast, but they leave no durable record of *intent* — what the system is supposed to do, who is allowed to do what, where the secrets live, which rules are actually verified. Without that record, no h

## How To Use It In Codex

In Codex, click the chat box, press /, choose shipping-artifacts, then write the task. Fallback prompt: Use the shipping-artifacts skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `shipping-artifacts` |
| Canonical name | `pm-skills-shipping-artifacts` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
