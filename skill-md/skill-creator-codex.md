...
# skill-creator - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `skill-creator` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose skill-creator, then write the task. Fallback prompt: Use the skill-creator skill to...
