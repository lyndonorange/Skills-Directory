...
# skill-lens - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `skill-lens` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose skill-lens, then write the task. Fallback prompt: Use the skill-lens skill to...
