...
# skillify - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `skillify` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose skillify, then write the task. Fallback prompt: Use the skillify skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `skillify` |
| Canonical name | `skillify` |
| Platform | `Codex` |
| Category | General and specialized workflows |
