...
# slack-gif-creator - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `slack-gif-creator` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose slack-gif-creator, then write the task. Fallback prompt: Use the slack-gif-creator skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `slack-gif-creator` |
| Canonical name | `slack-gif-creator` |
| Platform | `Codex` |
| Category | General and specialized workflows |
