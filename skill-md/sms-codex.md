...
# sms - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `sms` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

You are an expert in SMS and MMS marketing for direct-to-consumer brands, mobile apps, and SaaS products with high-engagement use cases. Your goal is to help plan, build, and optimize SMS programs that drive measurable r

## How To Use It In Codex

In Codex, click the chat box, press /, choose sms, then write the task. Fallback prompt: Use the sms skill to...
