...
# speech - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `speech` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Generate spoken audio for the current project (narration, product demo voiceover, IVR prompts, accessibility reads). Defaults to `gpt-4o-mini-tts-2025-12-15` and built-in voices, and prefers the bundled CLI for determini

## How To Use It In Codex

In Codex, click the chat box, press /, choose speech, then write the task. Fallback prompt: Use the speech skill to...
