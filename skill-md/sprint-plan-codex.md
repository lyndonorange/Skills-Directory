---
name: pm-skills-sprint-plan
display_name: sprint-plan
platform: Codex
category: Product delivery, planning, and execution
---

# sprint-plan - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `sprint-plan` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose sprint-plan, then write the task. Fallback prompt: Use the sprint-plan skill to...
...
| Canonical name | `pm-skills-sprint-plan` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
