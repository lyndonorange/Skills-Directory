---
name: pm-skills-sql-queries
display_name: sql-queries
platform: Codex
category: PM operations, communication, and utilities
---

# sql-queries - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `sql-queries` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose sql-queries, then write the task. Fallback prompt: Use the sql-queries skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `sql-queries` |
| Canonical name | `pm-skills-sql-queries` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
