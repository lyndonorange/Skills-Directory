---
name: pm-skills-stakeholder-map
display_name: stakeholder-map
platform: Codex
category: PM operations, communication, and utilities
---

# stakeholder-map - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `stakeholder-map` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose stakeholder-map, then write the task. Fallback prompt: Use the stakeholder-map skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `stakeholder-map` |
| Canonical name | `pm-skills-stakeholder-map` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
