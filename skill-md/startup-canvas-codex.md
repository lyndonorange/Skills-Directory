---
name: pm-skills-startup-canvas
display_name: startup-canvas
platform: Codex
category: Business creation, ideas, and validation
---

# startup-canvas - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `startup-canvas` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose startup-canvas, then write the task. Fallback prompt: Use the startup-canvas skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `startup-canvas` |
| Canonical name | `pm-skills-startup-canvas` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
