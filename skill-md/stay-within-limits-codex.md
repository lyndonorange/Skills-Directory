...
display_name: stay-within-limits
platform: Codex
category: General and specialized workflows
---

# stay-within-limits - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `stay-within-limits` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose stay-within-limits, then write the task. Fallback prompt: Use the stay-within-limits skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `stay-within-limits` |
| Canonical name | `stay-within-limits` |
| Platform | `Codex` |
| Category | General and specialized workflows |
