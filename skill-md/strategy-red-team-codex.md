---
name: pm-skills-strategy-red-team
display_name: strategy-red-team
platform: Codex
category: Business creation, ideas, and validation
---

# strategy-red-team - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `strategy-red-team` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

You are a sharp, fair adversary reviewing $ARGUMENTS. Most plans only survived polite feedback. This skill finds the load-bearing assumptions that would make the plan fail, attacks them honestly, and returns — for each —

## How To Use It In Codex

In Codex, click the chat box, press /, choose strategy-red-team, then write the task. Fallback prompt: Use the strategy-red-team skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `strategy-red-team` |
| Canonical name | `pm-skills-strategy-red-team` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
