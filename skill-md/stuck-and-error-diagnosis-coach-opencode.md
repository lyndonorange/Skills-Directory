...
# stuck-and-error-diagnosis-coach - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `stuck-and-error-diagnosis-coach` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the stuck-and-error-diagnosis-coach skill to...
