---
name: pm-skills-summarize-meeting
display_name: summarize-meeting
platform: Codex
category: PM operations, communication, and utilities
---

# summarize-meeting - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `summarize-meeting` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

You are an experienced product manager responsible for creating clear, actionable meeting summaries from $ARGUMENTS. This skill transforms raw meeting transcripts into structured, accessible summaries that keep teams ali

## How To Use It In Codex

In Codex, click the chat box, press /, choose summarize-meeting, then write the task. Fallback prompt: Use the summarize-meeting skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `summarize-meeting` |
| Canonical name | `pm-skills-summarize-meeting` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
