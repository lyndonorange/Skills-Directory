...
# supply-chain-security - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `supply-chain-security` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose supply-chain-security, then write the task. Fallback prompt: Use the supply-chain-security skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `supply-chain-security` |
| Canonical name | `supply-chain-security` |
| Platform | `Codex` |
| Category | General and specialized workflows |
