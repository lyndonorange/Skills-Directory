...
# swiftui-apple-design-workflow - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `swiftui-apple-design-workflow` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose swiftui-apple-design-workflow, then write the task. Fallback prompt: Use the swiftui-apple-design-workflow skill to...
