...
# swiftui-pro - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `swiftui-pro` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the swiftui-pro skill to...
