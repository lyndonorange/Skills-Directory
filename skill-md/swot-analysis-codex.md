---
name: pm-skills-swot-analysis
display_name: swot-analysis
platform: Codex
category: Business creation, ideas, and validation
---

# swot-analysis - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `swot-analysis` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose swot-analysis, then write the task. Fallback prompt: Use the swot-analysis skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `swot-analysis` |
| Canonical name | `pm-skills-swot-analysis` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
