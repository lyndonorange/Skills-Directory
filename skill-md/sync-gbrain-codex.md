---
name: sync-gbrain
display_name: sync-gbrain
platform: Codex
category: General and specialized workflows
---

# sync-gbrain - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `sync-gbrain` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose sync-gbrain, then write the task. Fallback prompt: Use the sync-gbrain skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `sync-gbrain` |
| Canonical name | `sync-gbrain` |
| Platform | `Codex` |
| Category | General and specialized workflows |
