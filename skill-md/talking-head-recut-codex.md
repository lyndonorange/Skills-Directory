...
display_name: talking-head-recut
platform: Codex
category: General and specialized workflows
---

# talking-head-recut - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `talking-head-recut` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Package an existing talking-head / interview / podcast video with timed, designed GRAPHIC OVERLAY cards — kinetic titles, lower-thirds, data callouts, quotes, side panels, picture-in-picture — synced to the transcript, o

## How To Use It In Codex

In Codex, click the chat box, press /, choose talking-head-recut, then write the task. Fallback prompt: Use the talking-head-recut skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `talking-head-recut` |
| Canonical name | `talking-head-recut` |
| Platform | `Codex` |
| Category | General and specialized workflows |
