...
display_name: tech-resume-optimizer
platform: Codex
category: General and specialized workflows
---

# tech-resume-optimizer - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `tech-resume-optimizer` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose tech-resume-optimizer, then write the task. Fallback prompt: Use the tech-resume-optimizer skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `tech-resume-optimizer` |
| Canonical name | `tech-resume-optimizer` |
| Platform | `Codex` |
| Category | General and specialized workflows |
