---
name: pm-skills-test-scenarios
display_name: test-scenarios
platform: Codex
category: Product delivery, planning, and execution
---

# test-scenarios - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `test-scenarios` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose test-scenarios, then write the task. Fallback prompt: Use the test-scenarios skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `test-scenarios` |
| Canonical name | `pm-skills-test-scenarios` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
