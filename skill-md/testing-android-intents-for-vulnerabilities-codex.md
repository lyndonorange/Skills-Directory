...
display_name: testing-android-intents-for-vulnerabilities
platform: Codex
category: General and specialized workflows
---

# testing-android-intents-for-vulnerabilities - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-android-intents-for-vulnerabilities` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-android-intents-for-vulnerabilities, then write the task. Fallback prompt: Use the testing-android-intents-for-vulnerabilities skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-android-intents-for-vulnerabilities` |
| Canonical name | `testing-android-intents-for-vulnerabilities` |
| Platform | `Codex` |
| Category | General and specialized workflows |
