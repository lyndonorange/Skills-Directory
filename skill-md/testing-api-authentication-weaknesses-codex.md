...
# testing-api-authentication-weaknesses - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-api-authentication-weaknesses` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-api-authentication-weaknesses, then write the task. Fallback prompt: Use the testing-api-authentication-weaknesses skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-api-authentication-weaknesses` |
| Canonical name | `testing-api-authentication-weaknesses` |
| Platform | `Codex` |
| Category | Software engineering and app building |
