...
# testing-api-for-broken-object-level-authorization - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-api-for-broken-object-level-authorization` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-api-for-broken-object-level-authorization, then write the task. Fallback prompt: Use the testing-api-for-broken-object-level-authorization skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-api-for-broken-object-level-authorization` |
| Canonical name | `testing-api-for-broken-object-level-authorization` |
| Platform | `Codex` |
| Category | Software engineering and app building |
