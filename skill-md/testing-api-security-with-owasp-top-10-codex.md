...
display_name: testing-api-security-with-owasp-top-10
platform: Codex
category: Software engineering and app building
---

# testing-api-security-with-owasp-top-10 - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-api-security-with-owasp-top-10` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-api-security-with-owasp-top-10, then write the task. Fallback prompt: Use the testing-api-security-with-owasp-top-10 skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-api-security-with-owasp-top-10` |
| Canonical name | `testing-api-security-with-owasp-top-10` |
| Platform | `Codex` |
| Category | Software engineering and app building |
