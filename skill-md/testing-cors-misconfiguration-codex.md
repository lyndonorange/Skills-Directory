...
display_name: testing-cors-misconfiguration
platform: Codex
category: General and specialized workflows
---

# testing-cors-misconfiguration - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-cors-misconfiguration` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-cors-misconfiguration, then write the task. Fallback prompt: Use the testing-cors-misconfiguration skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-cors-misconfiguration` |
| Canonical name | `testing-cors-misconfiguration` |
| Platform | `Codex` |
| Category | General and specialized workflows |
