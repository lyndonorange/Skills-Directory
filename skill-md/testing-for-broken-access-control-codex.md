...
display_name: testing-for-broken-access-control
platform: Codex
category: General and specialized workflows
---

# testing-for-broken-access-control - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-for-broken-access-control` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-for-broken-access-control, then write the task. Fallback prompt: Use the testing-for-broken-access-control skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-for-broken-access-control` |
| Canonical name | `testing-for-broken-access-control` |
| Platform | `Codex` |
| Category | General and specialized workflows |
