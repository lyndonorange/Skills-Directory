...
display_name: testing-for-business-logic-vulnerabilities
platform: Codex
category: General and specialized workflows
---

# testing-for-business-logic-vulnerabilities - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-for-business-logic-vulnerabilities` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-for-business-logic-vulnerabilities, then write the task. Fallback prompt: Use the testing-for-business-logic-vulnerabilities skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-for-business-logic-vulnerabilities` |
| Canonical name | `testing-for-business-logic-vulnerabilities` |
| Platform | `Codex` |
| Category | General and specialized workflows |
