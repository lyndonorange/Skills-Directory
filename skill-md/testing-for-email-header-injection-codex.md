...
display_name: testing-for-email-header-injection
platform: Codex
category: General and specialized workflows
---

# testing-for-email-header-injection - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-for-email-header-injection` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-for-email-header-injection, then write the task. Fallback prompt: Use the testing-for-email-header-injection skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-for-email-header-injection` |
| Canonical name | `testing-for-email-header-injection` |
| Platform | `Codex` |
| Category | General and specialized workflows |
