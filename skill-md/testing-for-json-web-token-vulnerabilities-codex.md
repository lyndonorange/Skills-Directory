...
display_name: testing-for-json-web-token-vulnerabilities
platform: Codex
category: General and specialized workflows
---

# testing-for-json-web-token-vulnerabilities - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-for-json-web-token-vulnerabilities` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-for-json-web-token-vulnerabilities, then write the task. Fallback prompt: Use the testing-for-json-web-token-vulnerabilities skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-for-json-web-token-vulnerabilities` |
| Canonical name | `testing-for-json-web-token-vulnerabilities` |
| Platform | `Codex` |
| Category | General and specialized workflows |
