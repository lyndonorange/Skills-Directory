...
display_name: testing-for-open-redirect-vulnerabilities
platform: Codex
category: General and specialized workflows
---

# testing-for-open-redirect-vulnerabilities - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-for-open-redirect-vulnerabilities` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-for-open-redirect-vulnerabilities, then write the task. Fallback prompt: Use the testing-for-open-redirect-vulnerabilities skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-for-open-redirect-vulnerabilities` |
| Canonical name | `testing-for-open-redirect-vulnerabilities` |
| Platform | `Codex` |
| Category | General and specialized workflows |
