...
display_name: testing-for-sensitive-data-exposure
platform: Codex
category: General and specialized workflows
---

# testing-for-sensitive-data-exposure - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-for-sensitive-data-exposure` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-for-sensitive-data-exposure, then write the task. Fallback prompt: Use the testing-for-sensitive-data-exposure skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-for-sensitive-data-exposure` |
| Canonical name | `testing-for-sensitive-data-exposure` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
curl -s "https://target.example.com/static/app.js" | grep -nP \
  "(AIza[0-9A-Za-z-_]{35}|AKIA[0-9A-Z]{16}|sk-[a-zA-Z0-9]{48}|[github-token-prefix-redacted][a-zA-Z0-9]{36}|xox[bpsa]-[0-9a-zA-Z-]{10,})"
