...
display_name: testing-for-xml-injection-vulnerabilities
platform: Codex
category: General and specialized workflows
---

# testing-for-xml-injection-vulnerabilities - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-for-xml-injection-vulnerabilities` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-for-xml-injection-vulnerabilities, then write the task. Fallback prompt: Use the testing-for-xml-injection-vulnerabilities skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-for-xml-injection-vulnerabilities` |
| Canonical name | `testing-for-xml-injection-vulnerabilities` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
<!ENTITY % file SYSTEM "[local file URL removed]">
...
|---|------|----------|---------|--------|
| 1 | XXE File Read | POST /api/import | SYSTEM "[local file URL removed]" | Local File Disclosure |
