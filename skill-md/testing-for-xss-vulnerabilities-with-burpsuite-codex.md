...
display_name: testing-for-xss-vulnerabilities-with-burpsuite
platform: Codex
category: General and specialized workflows
---

# testing-for-xss-vulnerabilities-with-burpsuite - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-for-xss-vulnerabilities-with-burpsuite` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-for-xss-vulnerabilities-with-burpsuite, then write the task. Fallback prompt: Use the testing-for-xss-vulnerabilities-with-burpsuite skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-for-xss-vulnerabilities-with-burpsuite` |
| Canonical name | `testing-for-xss-vulnerabilities-with-burpsuite` |
| Platform | `Codex` |
| Category | General and specialized workflows |
