...
display_name: testing-for-xxe-injection-vulnerabilities
platform: Codex
category: General and specialized workflows
---

# testing-for-xxe-injection-vulnerabilities - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-for-xxe-injection-vulnerabilities` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-for-xxe-injection-vulnerabilities, then write the task. Fallback prompt: Use the testing-for-xxe-injection-vulnerabilities skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-for-xxe-injection-vulnerabilities` |
| Canonical name | `testing-for-xxe-injection-vulnerabilities` |
| Platform | `Codex` |
| Category | General and specialized workflows |
...
2. Include DTD with external entity: <!ENTITY xxe SYSTEM "[local file URL removed]">
