...
display_name: testing-jwt-token-security
platform: Codex
category: General and specialized workflows
---

# testing-jwt-token-security - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-jwt-token-security` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-jwt-token-security, then write the task. Fallback prompt: Use the testing-jwt-token-security skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-jwt-token-security` |
| Canonical name | `testing-jwt-token-security` |
| Platform | `Codex` |
| Category | General and specialized workflows |
