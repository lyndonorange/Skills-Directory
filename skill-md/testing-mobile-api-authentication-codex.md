...
display_name: testing-mobile-api-authentication
platform: Codex
category: General and specialized workflows
---

# testing-mobile-api-authentication - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-mobile-api-authentication` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-mobile-api-authentication, then write the task. Fallback prompt: Use the testing-mobile-api-authentication skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-mobile-api-authentication` |
| Canonical name | `testing-mobile-api-authentication` |
| Platform | `Codex` |
| Category | General and specialized workflows |
