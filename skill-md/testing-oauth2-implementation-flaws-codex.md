...
# testing-oauth2-implementation-flaws - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-oauth2-implementation-flaws` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-oauth2-implementation-flaws, then write the task. Fallback prompt: Use the testing-oauth2-implementation-flaws skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-oauth2-implementation-flaws` |
| Canonical name | `testing-oauth2-implementation-flaws` |
| Platform | `Codex` |
| Category | Software engineering and app building |
