...
# testing-websocket-api-security - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `testing-websocket-api-security` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose testing-websocket-api-security, then write the task. Fallback prompt: Use the testing-websocket-api-security skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `testing-websocket-api-security` |
| Canonical name | `testing-websocket-api-security` |
| Platform | `Codex` |
| Category | General and specialized workflows |
