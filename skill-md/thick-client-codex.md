---
name: thick-client
display_name: thick-client
platform: Codex
category: General and specialized workflows
---

# thick-client - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `thick-client` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose thick-client, then write the task. Fallback prompt: Use the thick-client skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `thick-client` |
| Canonical name | `thick-client` |
| Platform | `Codex` |
| Category | General and specialized workflows |
