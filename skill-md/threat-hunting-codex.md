...
# threat-hunting - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `threat-hunting` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose threat-hunting, then write the task. Fallback prompt: Use the threat-hunting skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `threat-hunting` |
| Canonical name | `threat-hunting` |
| Platform | `Codex` |
| Category | General and specialized workflows |
