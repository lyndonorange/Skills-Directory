...
# to-questionnaire - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `to-questionnaire` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose to-questionnaire, then write the task. Fallback prompt: Use the to-questionnaire skill to...
...
| Canonical name | `to-questionnaire` |
| Platform | `Codex` |
| Category | General and specialized workflows |
