...
# tool-design-sprint-test-and-score - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `tool-design-sprint-test-and-score` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the tool-design-sprint-test-and-score skill to...
