...
# tool-foundation-sprint-brief - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `tool-foundation-sprint-brief` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the tool-foundation-sprint-brief skill to...
