...
# tool-foundation-sprint-founding-hypothesis - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `tool-foundation-sprint-founding-hypothesis` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the tool-foundation-sprint-founding-hypothesis skill to...
