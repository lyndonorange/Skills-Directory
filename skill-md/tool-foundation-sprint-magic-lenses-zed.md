...
# tool-foundation-sprint-magic-lenses - Zed Skill Package

## What This Is

This is a friend-safe Markdown copy of `tool-foundation-sprint-magic-lenses` for Zed. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Zed, open the Agent panel and type: Use the tool-foundation-sprint-magic-lenses skill to...
