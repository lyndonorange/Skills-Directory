...
# tool-foundation-sprint-readiness - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `tool-foundation-sprint-readiness` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the tool-foundation-sprint-readiness skill to...
