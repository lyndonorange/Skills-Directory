...
display_name: tracking-threat-actor-infrastructure
platform: Codex
category: General and specialized workflows
---

# tracking-threat-actor-infrastructure - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `tracking-threat-actor-infrastructure` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Threat actor infrastructure tracking involves monitoring and mapping adversary-controlled assets including command-and-control (C2) servers, phishing domains, exploit kit hosts, bulletproof hosting, and staging servers. 

## How To Use It In Codex

In Codex, click the chat box, press /, choose tracking-threat-actor-infrastructure, then write the task. Fallback prompt: Use the tracking-threat-actor-infrastructure skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `tracking-threat-actor-infrastructure` |
| Canonical name | `tracking-threat-actor-infrastructure` |
| Platform | `Codex` |
| Category | General and specialized workflows |
