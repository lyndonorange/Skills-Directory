...
display_name: triaging-security-incident-with-ir-playbook
platform: Codex
category: Security, forensics, and incident response
---

# triaging-security-incident-with-ir-playbook - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `triaging-security-incident-with-ir-playbook` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose triaging-security-incident-with-ir-playbook, then write the task. Fallback prompt: Use the triaging-security-incident-with-ir-playbook skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `triaging-security-incident-with-ir-playbook` |
| Canonical name | `triaging-security-incident-with-ir-playbook` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
