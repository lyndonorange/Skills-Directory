...
display_name: triaging-vulnerabilities-with-ssvc-framework
platform: Codex
category: Security, forensics, and incident response
---

# triaging-vulnerabilities-with-ssvc-framework - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `triaging-vulnerabilities-with-ssvc-framework` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

The Stakeholder-Specific Vulnerability Categorization (SSVC) framework, developed by Carnegie Mellon University's Software Engineering Institute (SEI) in collaboration with CISA, provides a structured decision-tree metho

## How To Use It In Codex

In Codex, click the chat box, press /, choose triaging-vulnerabilities-with-ssvc-framework, then write the task. Fallback prompt: Use the triaging-vulnerabilities-with-ssvc-framework skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `triaging-vulnerabilities-with-ssvc-framework` |
| Canonical name | `triaging-vulnerabilities-with-ssvc-framework` |
| Platform | `Codex` |
| Category | Security, forensics, and incident response |
