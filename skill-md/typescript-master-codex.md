...
# typescript-master - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `typescript-master` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose typescript-master, then write the task. Fallback prompt: Use the typescript-master skill to...
