...
# ui-ux-pro-max - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `ui-ux-pro-max` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

UI/UX design intelligence for web and mobile. Searchable local database with 84 styles, 192 color palettes, 74 font pairings, 192 product types, 98 UX guidelines, 104 icon entries, 16 GSAP motion presets, and 25 chart ty

## How To Use It In Codex

In Codex, click the chat box, press /, choose ui-ux-pro-max, then write the task. Fallback prompt: Use the ui-ux-pro-max skill to...
