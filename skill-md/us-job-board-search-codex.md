...
# us-job-board-search - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `us-job-board-search` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose us-job-board-search, then write the task. Fallback prompt: Use the us-job-board-search skill to...
