---
name: pm-skills-user-personas
display_name: user-personas
platform: Universal Agents
category: Business creation, ideas, and validation
---

# user-personas - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `user-personas` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Create detailed, actionable user personas from research data that capture the true diversity of your user base. This skill generates research-backed personas with jobs-to-be-done, pain points, desired outcomes, and unexp

## How To Use It In Universal Agents

In tools that read ~/.agents/skills, type: Use the user-personas skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `user-personas` |
| Canonical name | `pm-skills-user-personas` |
| Platform | `Universal Agents` |
| Category | Business creation, ideas, and validation |
