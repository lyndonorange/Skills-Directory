---
name: pm-skills-user-segmentation
display_name: user-segmentation
platform: Codex
category: Business creation, ideas, and validation
---

# user-segmentation - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `user-segmentation` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Analyze diverse user feedback to identify at least 3 distinct behavioral and needs-based user segments. This skill surfaces hidden customer groups based on jobs-to-be-done, behaviors, and motivations rather than demograp

## How To Use It In Codex

In Codex, click the chat box, press /, choose user-segmentation, then write the task. Fallback prompt: Use the user-segmentation skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `user-segmentation` |
| Canonical name | `pm-skills-user-segmentation` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
