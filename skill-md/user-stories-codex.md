---
name: pm-skills-user-stories
display_name: user-stories
platform: Codex
category: Product delivery, planning, and execution
---

# user-stories - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `user-stories` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose user-stories, then write the task. Fallback prompt: Use the user-stories skill to...
...
| Canonical name | `pm-skills-user-stories` |
| Platform | `Codex` |
| Category | Product delivery, planning, and execution |
