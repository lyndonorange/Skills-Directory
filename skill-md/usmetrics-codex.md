---
name: USMetrics
display_name: USMetrics
platform: Codex
category: General and specialized workflows
---

# USMetrics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `USMetrics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Analyze and update 68 US economic and social indicators from five government APIs (FRED, EIA, Treasury, BLS, Census) across 10 categories: GDP, Inflation, Employment, Housing, Consumer Finance, Markets, Trade, Government

## How To Use It In Codex

In Codex, click the chat box, press /, choose USMetrics, then write the task. Fallback prompt: Use the USMetrics skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `USMetrics` |
| Canonical name | `USMetrics` |
| Platform | `Codex` |
| Category | General and specialized workflows |
