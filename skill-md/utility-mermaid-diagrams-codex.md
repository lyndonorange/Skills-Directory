---
name: pm-skills-utility-mermaid-diagrams
display_name: utility-mermaid-diagrams
platform: Codex
category: PM operations, communication, and utilities
---

# utility-mermaid-diagrams - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `utility-mermaid-diagrams` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose utility-mermaid-diagrams, then write the task. Fallback prompt: Use the utility-mermaid-diagrams skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `utility-mermaid-diagrams` |
| Canonical name | `pm-skills-utility-mermaid-diagrams` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
