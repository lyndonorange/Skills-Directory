---
name: pm-skills-utility-pm-changelog-curator
display_name: utility-pm-changelog-curator
platform: Codex
category: PM operations, communication, and utilities
---

# utility-pm-changelog-curator - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `utility-pm-changelog-curator` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose utility-pm-changelog-curator, then write the task. Fallback prompt: Use the utility-pm-changelog-curator skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `utility-pm-changelog-curator` |
| Canonical name | `pm-skills-utility-pm-changelog-curator` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
