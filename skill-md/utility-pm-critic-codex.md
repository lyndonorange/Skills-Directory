---
name: pm-skills-utility-pm-critic
display_name: utility-pm-critic
platform: Codex
category: PM operations, communication, and utilities
---

# utility-pm-critic - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `utility-pm-critic` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

This skill is a cross-client dispatch wrapper for the `pm-critic` sub-agent. It exists so that users on non-Claude clients can run adversarial review with the same intent as Claude Code users, without depending on native

## How To Use It In Codex

In Codex, click the chat box, press /, choose utility-pm-critic, then write the task. Fallback prompt: Use the utility-pm-critic skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `utility-pm-critic` |
| Canonical name | `pm-skills-utility-pm-critic` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
