...
# utility-pm-release-conductor - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `utility-pm-release-conductor` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the utility-pm-release-conductor skill to...
