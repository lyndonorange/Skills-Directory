---
name: pm-skills-utility-pm-skill-iterate
display_name: utility-pm-skill-iterate
platform: Codex
category: PM operations, communication, and utilities
---

# utility-pm-skill-iterate - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `utility-pm-skill-iterate` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose utility-pm-skill-iterate, then write the task. Fallback prompt: Use the utility-pm-skill-iterate skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `utility-pm-skill-iterate` |
| Canonical name | `pm-skills-utility-pm-skill-iterate` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
