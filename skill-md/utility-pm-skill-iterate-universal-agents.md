...
# utility-pm-skill-iterate - Universal Agents Skill Package

## What This Is

This is a friend-safe Markdown copy of `utility-pm-skill-iterate` for Universal Agents. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In tools that read ~/.agents/skills, type: Use the utility-pm-skill-iterate skill to...
