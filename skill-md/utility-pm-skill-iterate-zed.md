...
# utility-pm-skill-iterate - Zed Skill Package

## What This Is

This is a friend-safe Markdown copy of `utility-pm-skill-iterate` for Zed. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Zed, open the Agent panel and type: Use the utility-pm-skill-iterate skill to...
