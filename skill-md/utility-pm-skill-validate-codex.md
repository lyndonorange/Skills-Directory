---
name: pm-skills-utility-pm-skill-validate
display_name: utility-pm-skill-validate
platform: Codex
category: PM operations, communication, and utilities
---

# utility-pm-skill-validate - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `utility-pm-skill-validate` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose utility-pm-skill-validate, then write the task. Fallback prompt: Use the utility-pm-skill-validate skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `utility-pm-skill-validate` |
| Canonical name | `pm-skills-utility-pm-skill-validate` |
| Platform | `Codex` |
| Category | PM operations, communication, and utilities |
