...
display_name: validating-backup-integrity-for-recovery
platform: Codex
category: General and specialized workflows
---

# validating-backup-integrity-for-recovery - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `validating-backup-integrity-for-recovery` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose validating-backup-integrity-for-recovery, then write the task. Fallback prompt: Use the validating-backup-integrity-for-recovery skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `validating-backup-integrity-for-recovery` |
| Canonical name | `validating-backup-integrity-for-recovery` |
| Platform | `Codex` |
| Category | General and specialized workflows |
