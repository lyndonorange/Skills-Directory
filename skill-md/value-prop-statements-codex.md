---
name: pm-skills-value-prop-statements
display_name: value-prop-statements
platform: Codex
category: Business creation, ideas, and validation
---

# value-prop-statements - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `value-prop-statements` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Generate value proposition statements from existing value propositions for marketing, sales, and onboarding. Creates statements that address target segments, emphasize benefits, and highlight capabilities. Perfect for cr

## How To Use It In Codex

In Codex, click the chat box, press /, choose value-prop-statements, then write the task. Fallback prompt: Use the value-prop-statements skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `value-prop-statements` |
| Canonical name | `pm-skills-value-prop-statements` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
