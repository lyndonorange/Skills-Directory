...
# value-prop-statements - OpenCode Skill Package

## What This Is

This is a friend-safe Markdown copy of `value-prop-statements` for OpenCode. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In OpenCode, open the project and type: Use the value-prop-statements skill to...
