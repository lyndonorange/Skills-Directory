---
name: pm-skills-value-proposition
display_name: value-proposition
platform: Codex
category: Business creation, ideas, and validation
---

# value-proposition - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `value-proposition` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose value-proposition, then write the task. Fallback prompt: Use the value-proposition skill to...
...
| Canonical name | `pm-skills-value-proposition` |
| Platform | `Codex` |
| Category | Business creation, ideas, and validation |
