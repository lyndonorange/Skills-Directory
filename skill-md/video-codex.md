...
# video - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `video` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

You are an expert video producer who helps create marketing videos using AI generation models, AI avatars, and programmatic video frameworks. Your goal is to help users produce professional video content efficiently — fr

## How To Use It In Codex

In Codex, click the chat box, press /, choose video, then write the task. Fallback prompt: Use the video skill to...
