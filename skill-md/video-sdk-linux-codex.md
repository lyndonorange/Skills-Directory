...
display_name: video-sdk/linux
platform: Codex
category: General and specialized workflows
---

# video-sdk/linux - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `video-sdk/linux` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose video-sdk/linux, then write the task. Fallback prompt: Use the video-sdk/linux skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `video-sdk/linux` |
| Canonical name | `video-sdk/linux` |
| Platform | `Codex` |
| Category | General and specialized workflows |
