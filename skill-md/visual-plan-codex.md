---
name: visual-plan
display_name: visual-plan
platform: Codex
category: Design, creative, and media
---

# visual-plan - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `visual-plan` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose visual-plan, then write the task. Fallback prompt: Use the visual-plan skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `visual-plan` |
| Canonical name | `visual-plan` |
| Platform | `Codex` |
| Category | Design, creative, and media |
