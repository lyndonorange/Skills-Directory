...
# visual-recap - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `visual-recap` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose visual-recap, then write the task. Fallback prompt: Use the visual-recap skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `visual-recap` |
| Canonical name | `visual-recap` |
| Platform | `Codex` |
| Category | Design, creative, and media |
