...
# web-artifacts-builder - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `web-artifacts-builder` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose web-artifacts-builder, then write the task. Fallback prompt: Use the web-artifacts-builder skill to...
...
| Canonical name | `web-artifacts-builder` |
| Platform | `Codex` |
| Category | General and specialized workflows |
