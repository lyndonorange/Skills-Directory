---
name: Webdesign
display_name: Webdesign
platform: Codex
category: General and specialized workflows
---

# Webdesign - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `Webdesign` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Design and integrate web interfaces via three paths: DirectDesign (write design inline with Anthropic frontend-design philosophy — the default workhorse), native /design + /design-sync Claude Code commands (preferred for

## How To Use It In Codex

In Codex, click the chat box, press /, choose Webdesign, then write the task. Fallback prompt: Use the Webdesign skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `Webdesign` |
| Canonical name | `Webdesign` |
| Platform | `Codex` |
| Category | General and specialized workflows |
