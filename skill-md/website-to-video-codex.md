...
display_name: website-to-video
platform: Codex
category: General and specialized workflows
---

# website-to-video - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `website-to-video` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Capture a general website/URL and turn it into a video OF the site — tour, showcase, or social clip built from captured screenshots and the site's own brand assets. Use for portfolio / blog / docs / landing-page showcase

## How To Use It In Codex

In Codex, click the chat box, press /, choose website-to-video, then write the task. Fallback prompt: Use the website-to-video skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `website-to-video` |
| Canonical name | `website-to-video` |
| Platform | `Codex` |
| Category | General and specialized workflows |
