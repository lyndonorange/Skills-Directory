---
name: wifi-wireless
display_name: wifi-wireless
platform: Codex
category: General and specialized workflows
---

# wifi-wireless - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `wifi-wireless` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose wifi-wireless, then write the task. Fallback prompt: Use the wifi-wireless skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `wifi-wireless` |
| Canonical name | `wifi-wireless` |
| Platform | `Codex` |
| Category | General and specialized workflows |
