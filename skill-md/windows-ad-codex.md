...
# windows-ad - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `windows-ad` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose windows-ad, then write the task. Fallback prompt: Use the windows-ad skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `windows-ad` |
| Canonical name | `windows-ad` |
| Platform | `Codex` |
| Category | General and specialized workflows |
