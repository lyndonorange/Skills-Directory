...
# wizard - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `wizard` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Generate an interactive bash wizard that walks a human through steps only they can perform. Use when provisioning infrastructure, setting up credentials or CI secrets, walking an unfamiliar third-party dashboard, or runn

## How To Use It In Codex

In Codex, click the chat box, press /, choose wizard, then write the task. Fallback prompt: Use the wizard skill to...
