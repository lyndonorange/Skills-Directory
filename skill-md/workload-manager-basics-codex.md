...
# workload-manager-basics - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `workload-manager-basics` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose workload-manager-basics, then write the task. Fallback prompt: Use the workload-manager-basics skill to...
