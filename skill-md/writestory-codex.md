---
name: WriteStory
display_name: WriteStory
platform: Codex
category: General and specialized workflows
---

# WriteStory - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `WriteStory` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.

## When To Use This Skill

Use this skill when your task matches this description:

Scaffolding that helps a writer build a story they already want to tell — fills in the hard parts (structure, hidden wound, theme, prose) from the writer's OWN material, never substituting for the creator. Seven narrativ

## How To Use It In Codex

In Codex, click the chat box, press /, choose WriteStory, then write the task. Fallback prompt: Use the WriteStory skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `WriteStory` |
| Canonical name | `WriteStory` |
| Platform | `Codex` |
| Category | General and specialized workflows |
