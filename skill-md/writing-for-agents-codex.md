...
# writing-for-agents - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `writing-for-agents` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose writing-for-agents, then write the task. Fallback prompt: Use the writing-for-agents skill to...
...
| Canonical name | `writing-for-agents` |
| Platform | `Codex` |
| Category | General and specialized workflows |
