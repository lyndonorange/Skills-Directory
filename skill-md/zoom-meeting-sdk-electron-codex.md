...
display_name: zoom-meeting-sdk-electron
platform: Codex
category: General and specialized workflows
---

# zoom-meeting-sdk-electron - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `zoom-meeting-sdk-electron` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose zoom-meeting-sdk-electron, then write the task. Fallback prompt: Use the zoom-meeting-sdk-electron skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `zoom-meeting-sdk-electron` |
| Canonical name | `zoom-meeting-sdk-electron` |
| Platform | `Codex` |
| Category | General and specialized workflows |
