...
display_name: zoom-meeting-sdk-react-native
platform: Codex
category: General and specialized workflows
---

# zoom-meeting-sdk-react-native - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `zoom-meeting-sdk-react-native` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose zoom-meeting-sdk-react-native, then write the task. Fallback prompt: Use the zoom-meeting-sdk-react-native skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `zoom-meeting-sdk-react-native` |
| Canonical name | `zoom-meeting-sdk-react-native` |
| Platform | `Codex` |
| Category | General and specialized workflows |
