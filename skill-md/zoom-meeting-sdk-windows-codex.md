...
display_name: zoom-meeting-sdk-windows
platform: Codex
category: General and specialized workflows
---

# zoom-meeting-sdk-windows - Codex Skill Package

## What This Is

This is a friend-safe Markdown copy of `zoom-meeting-sdk-windows` for Codex. It removes local filesystem paths, Finder-only links, and machine-specific source locations.
...
In Codex, click the chat box, press /, choose zoom-meeting-sdk-windows, then write the task. Fallback prompt: Use the zoom-meeting-sdk-windows skill to...

## Skill Metadata

| Field | Value |
| --- | --- |
| Display name | `zoom-meeting-sdk-windows` |
| Canonical name | `zoom-meeting-sdk-windows` |
| Platform | `Codex` |
| Category | General and specialized workflows |
